...
export function ConnectedButton(props) {
    ...
    return (_jsx(ThemedButton, { theme: theme, onPress: () => {
            ...
            paddingVertical: spacing.smd,
                            ...
                            }, children: [formatBalanceOnButton(Number(balanceQuery.data.displayValue)), " ", balanceQuery.data?.symbol] })) : (_jsx(Skeleton, { theme: theme, style: { width: 80, height: 16 }, color: theme.colors.secondaryText }))] })] }) }));
}
