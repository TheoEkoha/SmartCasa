...
export function InAppWalletUI(props) {
    ...
    return (_jsxs(View, { style: styles.container, children: [_jsx(View, { style: styles.row, children: socialLogins.map((auth) => (_jsx(SocialLogin, { auth: auth, ...props }, auth))) }), authOptions.includes("email") ? (inputMode === "email" ? (_jsx(PreOtpLogin, { auth: "email", ...props })) : (_jsx(ThemedButtonWithIcon, { theme: theme, title: "Email address", icon: getWalletIcon("email"), onPress: () => setInputMode("email") }))) : null, authOptions.includes("phone") ? (inputMode === "phone" ? (_jsx(PreOtpLogin, { auth: "phone", ...props })) : (_jsx(ThemedButtonWithIcon, { theme: theme, title: "Phone number", icon: getWalletIcon("phone"), onPress: () => setInputMode("phone") }))) : null, authOptions.includes("passkey") ? (_jsx(ThemedButtonWithIcon, { theme: theme, title: "Passkey", icon: getWalletIcon("passkey"), onPress: () => {
...
export function PasskeyView(props) {
    ...
    return (wallet && (_jsxs(View, { style: {
            ...
            justifyContent: "center",
            padding: spacing.xl,
        }, children: [_jsx(RNImage, { theme: theme, size: 90, data: getWalletIcon("passkey") }), _jsx(Spacer, { size: "xxl" }), _jsx(ThemedButton, { theme: theme, variant: "accent", style: { width: "100%" }, onPress: async () => {
                    setScreen("signup");
