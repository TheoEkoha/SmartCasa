...
import { APPLE_ICON, DISCORD_ICON, FACEBOOK_ICON, FARCASTER_ICON, GOOGLE_ICON, TELEGRAM_ICON, WALLET_ICON, } from "../icons/svgs.js";
...
export const WalletImage = (props) => {
    ...
    return _jsx(RNImage, { theme: props.theme, data: data, size: size });
};
export function getAuthProviderImage(lastAuthProvider) {
