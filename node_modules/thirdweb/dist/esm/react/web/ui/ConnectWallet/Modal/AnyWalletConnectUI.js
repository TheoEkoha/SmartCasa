...
export function AnyWalletConnectUI(props) {
    ...
    if (!walletInfo.data) {
        ...
        return (_jsxs(Container, { animate: "fadein", fullHeight: true, flex: "column", children: [_jsx(Container, { p: "lg", children: _jsx(ModalHeader, { title: "Not Supported", onBack: props.onBack }) }), _jsxs(Container, { flex: "column", expand: true, center: "both", p: "lg", style: {
                        minHeight: "300px",
                    }, children: [_jsx(AccentFailIcon, { size: iconSize["3xl"] }), _jsx(Spacer, { y: "lg" }), _jsx(Text, { color: "primaryText", center: true, children: "Wallet is not supported" }), _jsx(Spacer, { y: "xxl" })] })] }));
    }
    ...
    if (props.wallet.id === "inApp" || props.wallet.id === "embedded") {
        return (_jsx(Suspense, { fallback: _jsx(LoadingScreen, {}), children: _jsx(InAppWalletConnectUI, { wallet: props.wallet, done: props.done, goBack: props.onBack, chain: props.chain, client: props.client, size: props.size, walletConnect: props.walletConnect, connectLocale: props.connectLocale, meta: props.meta }) }));
    }
    if (isEcosystemWallet(props.wallet.id)) {
        return (_jsx(Suspense, { fallback: _jsx(LoadingScreen, {}), children: _jsx(EcosystemWalletConnectUI, { wallet: props.wallet, done: props.done, goBack: props.onBack, chain: props.chain, client: props.client, size: props.size, meta: props.meta, connectLocale: props.connectLocale }) }));
    }
