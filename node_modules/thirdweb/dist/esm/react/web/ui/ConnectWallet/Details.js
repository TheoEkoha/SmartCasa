...
export const ConnectedWalletDetails = (props) => {
    ...
    return (_jsxs(WalletInfoButton, { type: "button", className: `${TW_CONNECTED_WALLET} ${props.detailsButton?.className || ""}`, style: props.detailsButton?.style, "data-test": "connected-wallet-details", onClick: openModal, children: [_jsx(Container, { style: {
                    borderRadius: "100%",
                    overflow: "hidden",
                    width: "35px",
                    height: "35px",
...
function DetailsModal(props) {
    ...
    let content = (_jsxs("div", { children: [_jsx(Spacer, { y: "xs" }), _jsxs(Container, { p: "lg", gap: "sm", flex: "row", center: "y", children: [props.detailsModal?.hideSwitchWallet ? (avatarContent) : (_jsx(ToolTip, { tip: "Switch wallet", children: _jsx("div", { style: {
                                cursor: "pointer",
                            }, onKeyDown: (e) => {
                                if (e.key === "w") {
                                ...
                                setScreen("wallet-manager");
                                    ...
                                    gap: spacing.xxs,
                                    alignItems: "center",
                                }, children: [_jsx(Text, { color: "primaryText", weight: 500, size: "md", children: props.detailsModal?.connectedAccountName ?? addressOrENS }), _jsx(IconButton, { children: _jsx(CopyIcon, { text: activeAccount?.address || "", tip: locale.copyAddress }) })] }), _jsx(InAppWalletUserInfo, { client: client, locale: locale })] })] }), _jsx(Container, { px: "lg", children: _jsxs(Container, { style: {
                        display: "grid",
...
function InAppWalletUserInfo(props) {
    ...
    if (userInfoQuery.data || walletInfo) {
        return (_jsx(Text, { size: "xs", weight: 400, children: userInfoQuery.data || walletInfo?.name }));
    }
