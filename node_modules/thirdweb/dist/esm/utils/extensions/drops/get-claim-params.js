...
export async function getClaimParams(options) {
    const cc = await (async () => {
        ...
        if (options.type === "erc721") {
            // lazy-load the getActiveClaimCondition function
            const { getActiveClaimCondition } = await import("../../../extensions/erc721/drops/read/getActiveClaimCondition.js");
            return await getActiveClaimCondition({
                contract: options.contract,
            });
        }
        ...
        // lazy-load the getActiveClaimCondition function
        const { getActiveClaimCondition } = await import("../../../extensions/erc20/drops/read/getActiveClaimCondition.js");
        return await getActiveClaimCondition({
            contract: options.contract,
        });
    })();
    ...
    const allowlistProof = await (async () => {
        ...
        const { fetchProofsForClaimer } = await import("./fetch-proofs-for-claimers.js");
