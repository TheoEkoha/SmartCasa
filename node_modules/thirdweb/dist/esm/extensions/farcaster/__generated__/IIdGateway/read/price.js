...
export const FN_SELECTOR = "0x26a49e37";
const FN_INPUTS = [
    {
        type: "uint256",
        name: "extraStorage",
 ...
 * ```
 */
export function isPriceSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function encodePriceParams(options) {
 ...
 * ```
 */
export function encodePrice(options) {
 ...
 * ```
 */
export function decodePriceResult(result) {
