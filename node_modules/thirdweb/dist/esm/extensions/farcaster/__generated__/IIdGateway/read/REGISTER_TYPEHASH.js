...
export const FN_SELECTOR = "0x6a5306a3";
const FN_INPUTS = [];
const FN_OUTPUTS = [
    {
        type: "bytes32",
 ...
 * ```
 */
export function isREGISTER_TYPEHASHSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function decodeREGISTER_TYPEHASHResult(result) {
 ...
 * ```
 */
export async function REGISTER_TYPEHASH(options) {
    return readContract({
