...
export const FN_SELECTOR = "0x4ec77b45";
const FN_INPUTS = [];
const FN_OUTPUTS = [
    {
        type: "address",
 ...
 * ```
 */
export function isStorageRegistrySupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function decodeStorageRegistryResult(result) {
 ...
 * ```
 */
export async function storageRegistry(options) {
    return readContract({
