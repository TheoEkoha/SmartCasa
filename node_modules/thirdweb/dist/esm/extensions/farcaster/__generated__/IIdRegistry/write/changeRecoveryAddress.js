...
export const FN_SELECTOR = "0xf1f0b224";
const FN_INPUTS = [
    {
        type: "address",
        name: "recovery",
 ...
 * ```
 */
export function isChangeRecoveryAddressSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function encodeChangeRecoveryAddress(options) {
