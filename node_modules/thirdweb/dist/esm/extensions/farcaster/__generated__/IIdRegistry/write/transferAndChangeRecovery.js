...
export const FN_SELECTOR = "0x3ab8465d";
const FN_INPUTS = [
    {
        type: "address",
        name: "to",
 ...
 * ```
 */
export function isTransferAndChangeRecoverySupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function encodeTransferAndChangeRecoveryParams(options) {
 ...
 * ```
 */
export function encodeTransferAndChangeRecovery(options) {
 ...
 * ```
 */
export function transferAndChangeRecovery(options) {
