...
export const FN_SELECTOR = "0x00bf26f4";
const FN_INPUTS = [];
const FN_OUTPUTS = [
    {
        type: "bytes32",
 ...
 * ```
 */
export function isTRANSFER_TYPEHASHSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function decodeTRANSFER_TYPEHASHResult(result) {
 ...
 * ```
 */
export async function TRANSFER_TYPEHASH(options) {
    return readContract({
