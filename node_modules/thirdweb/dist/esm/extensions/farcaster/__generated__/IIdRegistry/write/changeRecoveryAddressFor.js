...
export const FN_SELECTOR = "0x9cbef8dc";
const FN_INPUTS = [
    {
        type: "address",
        name: "owner",
 ...
 * ```
 */
export function isChangeRecoveryAddressForSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function encodeChangeRecoveryAddressForParams(options) {
 ...
 * ```
 */
export function encodeChangeRecoveryAddressFor(options) {
 ...
 * ```
 */
export function changeRecoveryAddressFor(options) {
