...
export const FN_SELECTOR = "0xfa1a1b25";
const FN_INPUTS = [
    {
        type: "uint256",
        name: "fid",
 ...
 * ```
 */
export function isRecoveryOfSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function encodeRecoveryOfParams(options) {
 ...
 * ```
 */
export function encodeRecoveryOf(options) {
    // we do a "manual" concat here to avoid the overhead of the "concatHex" function
    // we can do this because we know the specific formats of the values
    return (FN_SELECTOR +
        encodeRecoveryOfParams(options).slice(2));
}
/**
 ...
 * ```
 */
export function decodeRecoveryOfResult(result) {
 ...
 * ```
 */
export async function recoveryOf(options) {
    return readContract({
