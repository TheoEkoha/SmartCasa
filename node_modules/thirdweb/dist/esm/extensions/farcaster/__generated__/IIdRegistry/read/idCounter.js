...
export const FN_SELECTOR = "0xeb08ab28";
const FN_INPUTS = [];
const FN_OUTPUTS = [
    {
        type: "uint256",
 ...
 * ```
 */
export function isIdCounterSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function decodeIdCounterResult(result) {
 ...
 * ```
 */
export async function idCounter(options) {
    return readContract({
