...
export const FN_SELECTOR = "0x65269e47";
const FN_INPUTS = [
    {
        type: "uint256",
        name: "fid",
 ...
 * ```
 */
export function isCustodyOfSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function encodeCustodyOfParams(options) {
 ...
 * ```
 */
export function encodeCustodyOf(options) {
 ...
 * ```
 */
export function decodeCustodyOfResult(result) {
 ...
 * ```
 */
export async function custodyOf(options) {
    return readContract({
