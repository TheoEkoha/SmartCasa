...
export const FN_SELECTOR = "0xd94fe832";
const FN_INPUTS = [
    {
        type: "address",
        name: "owner",
 ...
 * ```
 */
export function isIdOfSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function encodeIdOfParams(options) {
 ...
 * ```
 */
export function encodeIdOf(options) {
 ...
 * ```
 */
export function decodeIdOfResult(result) {
 ...
 * ```
 */
export async function idOf(options) {
    return readContract({
