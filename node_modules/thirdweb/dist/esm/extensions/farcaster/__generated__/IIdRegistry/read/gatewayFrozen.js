...
export const FN_SELECTOR = "0x95e7549f";
const FN_INPUTS = [];
const FN_OUTPUTS = [
    {
        type: "bool",
 ...
 * ```
 */
export function isGatewayFrozenSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function decodeGatewayFrozenResult(result) {
 ...
 * ```
 */
export async function gatewayFrozen(options) {
    return readContract({
