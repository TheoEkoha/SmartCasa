...
export const FN_SELECTOR = "0x4c5cbb34";
const FN_INPUTS = [
    {
        type: "address",
        name: "from",
 ...
 * ```
 */
export function isTransferAndChangeRecoveryForSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function encodeTransferAndChangeRecoveryForParams(options) {
 ...
 * ```
 */
export function encodeTransferAndChangeRecoveryFor(options) {
 ...
 * ```
 */
export function transferAndChangeRecoveryFor(options) {
