...
export const FN_SELECTOR = "0x2a42ede3";
const FN_INPUTS = [
    {
        type: "address",
        name: "from",
 ...
 * ```
 */
export function isRecoverSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function encodeRecoverParams(options) {
 ...
 * ```
 */
export function encodeRecover(options) {
