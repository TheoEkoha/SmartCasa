...
export const FN_SELECTOR = "0x16f72842";
const FN_INPUTS = [
    {
        type: "address",
        name: "from",
 ...
 * ```
 */
export function isTransferForSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function encodeTransferForParams(options) {
 ...
 * ```
 */
export function encodeTransferFor(options) {
 ...
 * ```
 */
export function transferFor(options) {
