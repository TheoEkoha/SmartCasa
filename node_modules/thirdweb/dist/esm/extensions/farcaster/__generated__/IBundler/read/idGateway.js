...
export const FN_SELECTOR = "0x4b57a600";
const FN_INPUTS = [];
const FN_OUTPUTS = [
    {
        type: "address",
 ...
 * ```
 */
export function isIdGatewaySupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function decodeIdGatewayResult(result) {
 ...
 * ```
 */
export async function idGateway(options) {
    return readContract({
