...
export const FN_SELECTOR = "0xac34cc5a";
const FN_INPUTS = [
    {
        type: "uint256",
        name: "fid",
 ...
 * ```
 */
export function isKeyDataOfSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function encodeKeyDataOfParams(options) {
 ...
 * ```
 */
export function encodeKeyDataOf(options) {
 ...
 * ```
 */
export function decodeKeyDataOfResult(result) {
 ...
 * ```
 */
export async function keyDataOf(options) {
    return readContract({
