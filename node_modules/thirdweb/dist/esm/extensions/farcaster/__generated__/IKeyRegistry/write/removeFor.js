...
export const FN_SELECTOR = "0x787bd966";
const FN_INPUTS = [
    {
        type: "address",
        name: "fidOwner",
 ...
 * ```
 */
export function isRemoveForSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function encodeRemoveForParams(options) {
 ...
 * ```
 */
export function encodeRemoveFor(options) {
 ...
 * ```
 */
export function removeFor(options) {
