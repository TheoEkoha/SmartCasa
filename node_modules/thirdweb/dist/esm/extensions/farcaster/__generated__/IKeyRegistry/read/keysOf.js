...
export const FN_SELECTOR = "0x1f64222f";
const FN_INPUTS = [
    {
        type: "uint256",
        name: "fid",
 ...
 * ```
 */
export function isKeysOfSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function encodeKeysOfParams(options) {
 ...
 * ```
 */
export function encodeKeysOf(options) {
 ...
 * ```
 */
export function decodeKeysOfResult(result) {
 ...
 * ```
 */
export async function keysOf(options) {
    return readContract({
