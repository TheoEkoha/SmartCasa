...
export const FN_SELECTOR = "0x0ea9442c";
const FN_INPUTS = [
    {
        type: "uint256",
        name: "fid",
 ...
 * ```
 */
export function isKeyAtSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function encodeKeyAtParams(options) {
 ...
 * ```
 */
export function encodeKeyAt(options) {
 ...
 * ```
 */
export function decodeKeyAtResult(result) {
 ...
 * ```
 */
export async function keyAt(options) {
    return readContract({
