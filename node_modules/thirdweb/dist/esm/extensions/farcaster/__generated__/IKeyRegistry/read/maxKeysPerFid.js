...
export const FN_SELECTOR = "0xe33acf38";
const FN_INPUTS = [];
const FN_OUTPUTS = [
    {
        type: "uint256",
 ...
 * ```
 */
export function isMaxKeysPerFidSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function decodeMaxKeysPerFidResult(result) {
 ...
 * ```
 */
export async function maxKeysPerFid(options) {
    return readContract({
