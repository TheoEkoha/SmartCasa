...
export const FN_SELECTOR = "0x0aa13b8c";
const FN_INPUTS = [];
const FN_OUTPUTS = [
    {
        type: "address",
 ...
 * ```
 */
export function isIdRegistrySupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function decodeIdRegistryResult(result) {
 ...
 * ```
 */
export async function idRegistry(options) {
    return readContract({
