...
export const FN_SELECTOR = "0xb5775561";
const FN_INPUTS = [];
const FN_OUTPUTS = [
    {
        type: "bytes32",
 ...
 * ```
 */
export function isREMOVE_TYPEHASHSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function decodeREMOVE_TYPEHASHResult(result) {
 ...
 * ```
 */
export async function REMOVE_TYPEHASH(options) {
    return readContract({
