...
export const FN_SELECTOR = "0x80334737";
const FN_INPUTS = [];
const FN_OUTPUTS = [
    {
        type: "address",
 ...
 * ```
 */
export function isKeyGatewaySupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function decodeKeyGatewayResult(result) {
 ...
 * ```
 */
export async function keyGateway(options) {
    return readContract({
