...
export const FN_SELECTOR = "0x086b5198";
const FN_INPUTS = [];
const FN_OUTPUTS = [
    {
        type: "address",
 ...
 * ```
 */
export function isKeyRegistrySupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function decodeKeyRegistryResult(result) {
 ...
 * ```
 */
export async function keyRegistry(options) {
    return readContract({
