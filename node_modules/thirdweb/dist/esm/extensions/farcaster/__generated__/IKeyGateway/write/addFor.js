...
export const FN_SELECTOR = "0xa005d3d2";
const FN_INPUTS = [
    {
        type: "address",
        name: "fidOwner",
 ...
 * ```
 */
export function isAddForSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function encodeAddForParams(options) {
 ...
 * ```
 */
export function encodeAddFor(options) {
 ...
 * ```
 */
export function addFor(options) {
