...
export const FN_SELECTOR = "0x22b1a414";
const FN_INPUTS = [
    {
        type: "uint32",
        name: "keyType",
 ...
 * ```
 */
export function isAddSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function encodeAddParams(options) {
 ...
 * ```
 */
export function encodeAdd(options) {
