...
export const FN_SELECTOR = "0xab583c1b";
const FN_INPUTS = [];
const FN_OUTPUTS = [
    {
        type: "bytes32",
 ...
 * ```
 */
export function isADD_TYPEHASHSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function decodeADD_TYPEHASHResult(result) {
 ...
 * ```
 */
export async function ADD_TYPEHASH(options) {
    return readContract({
