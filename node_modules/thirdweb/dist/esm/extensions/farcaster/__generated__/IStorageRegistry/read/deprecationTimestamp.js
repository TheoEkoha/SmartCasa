...
export const FN_SELECTOR = "0x2c39d670";
const FN_INPUTS = [];
const FN_OUTPUTS = [
    {
        type: "uint256",
 ...
 * ```
 */
export function isDeprecationTimestampSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function decodeDeprecationTimestampResult(result) {
 ...
 * ```
 */
export async function deprecationTimestamp(options) {
    return readContract({
