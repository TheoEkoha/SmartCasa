...
export const FN_SELECTOR = "0x40df0ba0";
const FN_INPUTS = [];
const FN_OUTPUTS = [
    {
        type: "uint256",
 ...
 * ```
 */
export function isUsdUnitPriceSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function decodeUsdUnitPriceResult(result) {
 ...
 * ```
 */
export async function usdUnitPrice(options) {
    return readContract({
