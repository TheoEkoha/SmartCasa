...
export const FN_SELECTOR = "0x06517a29";
const FN_INPUTS = [];
const FN_OUTPUTS = [
    {
        type: "uint256",
 ...
 * ```
 */
export function isMaxUnitsSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function decodeMaxUnitsResult(result) {
 ...
 * ```
 */
export async function maxUnits(options) {
    return readContract({
