...
export const FN_SELECTOR = "0xe73faa2d";
const FN_INPUTS = [];
const FN_OUTPUTS = [
    {
        type: "uint256",
 ...
 * ```
 */
export function isUnitPriceSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function decodeUnitPriceResult(result) {
 ...
 * ```
 */
export async function unitPrice(options) {
    return readContract({
