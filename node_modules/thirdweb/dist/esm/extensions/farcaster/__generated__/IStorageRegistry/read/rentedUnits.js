...
export const FN_SELECTOR = "0x2751c4fd";
const FN_INPUTS = [];
const FN_OUTPUTS = [
    {
        type: "uint256",
 ...
 * ```
 */
export function isRentedUnitsSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function decodeRentedUnitsResult(result) {
 ...
 * ```
 */
export async function rentedUnits(options) {
    return readContract({
