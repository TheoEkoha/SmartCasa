...
export const FN_SELECTOR = "0x48dd77df";
const FN_INPUTS = [
    {
        type: "uint256",
        name: "_listingId",
 ...
 * ```
 */
export function isApproveBuyerForListingSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function encodeApproveBuyerForListing(options) {
