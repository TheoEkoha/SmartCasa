...
export const FN_SELECTOR = "0xa8519047";
const FN_INPUTS = [
    {
        type: "uint256",
        name: "_listingId",
 ...
 * ```
 */
export function isIsCurrencyApprovedForListingSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function encodeIsCurrencyApprovedForListingParams(options) {
 ...
 * ```
 */
export function encodeIsCurrencyApprovedForListing(options) {
 ...
 * ```
 */
export function decodeIsCurrencyApprovedForListingResult(result) {
 ...
 * ```
 */
export async function isCurrencyApprovedForListing(options) {
    return readContract({
