...
export const FN_SELECTOR = "0xea8f9a3c";
const FN_INPUTS = [
    {
        type: "uint256",
        name: "_listingId",
 ...
 * ```
 */
export function isApproveCurrencyForListingSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function encodeApproveCurrencyForListing(options) {
