...
export const FN_SELECTOR = "0x704232dc";
const FN_INPUTS = [
    {
        type: "uint256",
        name: "_listingId",
 ...
 * ```
 */
export function encodeBuyFromListingParams(options) {
 ...
 * ```
 */
export function encodeBuyFromListing(options) {
    // we do a "manual" concat here to avoid the overhead of the "concatHex" function
    // we can do this because we know the specific formats of the values
    return (FN_SELECTOR +
        encodeBuyFromListingParams(options).slice(2));
}
/**
