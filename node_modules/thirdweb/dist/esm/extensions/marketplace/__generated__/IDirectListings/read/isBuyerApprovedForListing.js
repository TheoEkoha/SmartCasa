...
export const FN_SELECTOR = "0x9cfbe2a6";
const FN_INPUTS = [
    {
        type: "uint256",
        name: "_listingId",
 ...
 * ```
 */
export function isIsBuyerApprovedForListingSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function encodeIsBuyerApprovedForListingParams(options) {
 ...
 * ```
 */
export function encodeIsBuyerApprovedForListing(options) {
 ...
 * ```
 */
export function decodeIsBuyerApprovedForListingResult(result) {
