...
export const FN_SELECTOR = "0xfb14079d";
const FN_INPUTS = [
    {
        type: "uint256",
        name: "_listingId",
 ...
 * ```
 */
export function isCurrencyPriceForListingSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function encodeCurrencyPriceForListingParams(options) {
 ...
 * ```
 */
export function encodeCurrencyPriceForListing(options) {
 ...
 * ```
 */
export function decodeCurrencyPriceForListingResult(result) {
 ...
 * ```
 */
export async function currencyPriceForListing(options) {
    return readContract({
