...
export const FN_SELECTOR = "0xc78b616c";
const FN_INPUTS = [];
const FN_OUTPUTS = [
    {
        type: "uint256",
 ...
 * ```
 */
export function isTotalListingsSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function decodeTotalListingsResult(result) {
 ...
 * ```
 */
export async function totalListings(options) {
    return readContract({
