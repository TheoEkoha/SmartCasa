...
export const FN_SELECTOR = "0x305a67a8";
const FN_INPUTS = [
    {
        type: "uint256",
        name: "_listingId",
 ...
 * ```
 */
export function isCancelListingSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function encodeCancelListingParams(options) {
 ...
 * ```
 */
export function encodeCancelListing(options) {
 ...
 * ```
 */
export function cancelListing(options) {
