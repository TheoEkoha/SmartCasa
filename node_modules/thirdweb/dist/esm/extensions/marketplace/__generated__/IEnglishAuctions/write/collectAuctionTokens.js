...
export const FN_SELECTOR = "0x03a54fe0";
const FN_INPUTS = [
    {
        type: "uint256",
        name: "_auctionId",
 ...
 * ```
 */
export function isCollectAuctionTokensSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function encodeCollectAuctionTokensParams(options) {
 ...
 * ```
 */
export function encodeCollectAuctionTokens(options) {
 ...
 * ```
 */
export function collectAuctionTokens(options) {
