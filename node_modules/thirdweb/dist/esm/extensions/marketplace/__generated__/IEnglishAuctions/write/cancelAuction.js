...
export const FN_SELECTOR = "0x96b5a755";
const FN_INPUTS = [
    {
        type: "uint256",
        name: "_auctionId",
 ...
 * ```
 */
export function isCancelAuctionSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function encodeCancelAuctionParams(options) {
 ...
 * ```
 */
export function encodeCancelAuction(options) {
 ...
 * ```
 */
export function cancelAuction(options) {
