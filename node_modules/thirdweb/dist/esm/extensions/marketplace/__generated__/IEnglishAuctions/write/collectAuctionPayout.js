...
export const FN_SELECTOR = "0xebf05a62";
const FN_INPUTS = [
    {
        type: "uint256",
        name: "_auctionId",
 ...
 * ```
 */
export function isCollectAuctionPayoutSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function encodeCollectAuctionPayoutParams(options) {
 ...
 * ```
 */
export function encodeCollectAuctionPayout(options) {
 ...
 * ```
 */
export function collectAuctionPayout(options) {
