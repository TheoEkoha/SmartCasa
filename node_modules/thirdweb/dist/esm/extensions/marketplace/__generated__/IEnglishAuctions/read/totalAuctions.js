...
export const FN_SELECTOR = "0x16002f4a";
const FN_INPUTS = [];
const FN_OUTPUTS = [
    {
        type: "uint256",
 ...
 * ```
 */
export function isTotalAuctionsSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function decodeTotalAuctionsResult(result) {
 ...
 * ```
 */
export async function totalAuctions(options) {
    return readContract({
