...
export const FN_SELECTOR = "0x1389b117";
const FN_INPUTS = [
    {
        type: "uint256",
        name: "_auctionId",
 ...
 * ```
 */
export function isIsAuctionExpiredSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function encodeIsAuctionExpiredParams(options) {
 ...
 * ```
 */
export function encodeIsAuctionExpired(options) {
 ...
 * ```
 */
export function decodeIsAuctionExpiredResult(result) {
 ...
 * ```
 */
export async function isAuctionExpired(options) {
    return readContract({
