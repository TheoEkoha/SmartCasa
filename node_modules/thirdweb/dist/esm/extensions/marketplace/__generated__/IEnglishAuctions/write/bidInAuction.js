...
export const FN_SELECTOR = "0x0858e5ad";
const FN_INPUTS = [
    {
        type: "uint256",
        name: "_auctionId",
 ...
 * ```
 */
export function isBidInAuctionSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function encodeBidInAuctionParams(options) {
 ...
 * ```
 */
export function encodeBidInAuction(options) {
 ...
 * ```
 */
export function bidInAuction(options) {
