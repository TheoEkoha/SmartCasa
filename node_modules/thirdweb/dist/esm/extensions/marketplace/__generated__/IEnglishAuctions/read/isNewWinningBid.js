...
export const FN_SELECTOR = "0x2eb566bd";
const FN_INPUTS = [
    {
        type: "uint256",
        name: "_auctionId",
 ...
 * ```
 */
export function isIsNewWinningBidSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function encodeIsNewWinningBidParams(options) {
 ...
 * ```
 */
export function encodeIsNewWinningBid(options) {
    // we do a "manual" concat here to avoid the overhead of the "concatHex" function
    // we can do this because we know the specific formats of the values
    return (FN_SELECTOR +
        encodeIsNewWinningBidParams(options).slice(2));
}
/**
 ...
 * ```
 */
export function decodeIsNewWinningBidResult(result) {
 ...
 * ```
 */
export async function isNewWinningBid(options) {
    return readContract({
