...
export const FN_SELECTOR = "0xc291537c";
const FN_INPUTS = [
    {
        type: "uint256",
        name: "_startId",
 ...
 * ```
 */
export function isGetAllAuctionsSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function encodeGetAllAuctionsParams(options) {
 ...
 * ```
 */
export function encodeGetAllAuctions(options) {
 ...
 * ```
 */
export function decodeGetAllAuctionsResult(result) {
 ...
 * ```
 */
export async function getAllAuctions(options) {
    return readContract({
