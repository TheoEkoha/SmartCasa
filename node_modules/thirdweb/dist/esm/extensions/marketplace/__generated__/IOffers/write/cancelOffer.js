...
export const FN_SELECTOR = "0xef706adf";
const FN_INPUTS = [
    {
        type: "uint256",
        name: "_offerId",
 ...
 * ```
 */
export function isCancelOfferSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function encodeCancelOfferParams(options) {
 ...
 * ```
 */
export function encodeCancelOffer(options) {
    // we do a "manual" concat here to avoid the overhead of the "concatHex" function
    // we can do this because we know the specific formats of the values
    return (FN_SELECTOR +
        encodeCancelOfferParams(options).slice(2));
}
/**
 ...
 * ```
 */
export function cancelOffer(options) {
