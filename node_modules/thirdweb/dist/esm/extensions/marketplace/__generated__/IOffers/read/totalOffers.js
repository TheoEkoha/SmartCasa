...
export const FN_SELECTOR = "0xa9fd8ed1";
const FN_INPUTS = [];
const FN_OUTPUTS = [
    {
        type: "uint256",
 ...
 * ```
 */
export function isTotalOffersSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function decodeTotalOffersResult(result) {
 ...
 * ```
 */
export async function totalOffers(options) {
    return readContract({
