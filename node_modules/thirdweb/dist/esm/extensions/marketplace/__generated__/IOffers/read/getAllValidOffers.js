...
export const FN_SELECTOR = "0x91940b3e";
const FN_INPUTS = [
    {
        type: "uint256",
        name: "_startId",
 ...
 * ```
 */
export function isGetAllValidOffersSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function encodeGetAllValidOffersParams(options) {
 ...
 * ```
 */
export function encodeGetAllValidOffers(options) {
 ...
 * ```
 */
export function decodeGetAllValidOffersResult(result) {
 ...
 * ```
 */
export async function getAllValidOffers(options) {
    return readContract({
