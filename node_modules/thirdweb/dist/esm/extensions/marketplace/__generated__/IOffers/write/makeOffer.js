...
export const FN_SELECTOR = "0x016767fa";
const FN_INPUTS = [
    {
        type: "tuple",
        name: "_params",
 ...
 * ```
 */
export function isMakeOfferSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function encodeMakeOfferParams(options) {
 ...
 * ```
 */
export function encodeMakeOffer(options) {
