...
export const FN_SELECTOR = "0xc1edcfbe";
const FN_INPUTS = [
    {
        type: "uint256",
        name: "_startId",
 ...
 * ```
 */
export function isGetAllOffersSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function encodeGetAllOffersParams(options) {
 ...
 * ```
 */
export function encodeGetAllOffers(options) {
 ...
 * ```
 */
export function decodeGetAllOffersResult(result) {
