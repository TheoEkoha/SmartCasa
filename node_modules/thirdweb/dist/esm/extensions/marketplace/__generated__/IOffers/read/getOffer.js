...
export const FN_SELECTOR = "0x4579268a";
const FN_INPUTS = [
    {
        type: "uint256",
        name: "_offerId",
 ...
 * ```
 */
export function isGetOfferSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function encodeGetOfferParams(options) {
 ...
 * ```
 */
export function encodeGetOffer(options) {
    // we do a "manual" concat here to avoid the overhead of the "concatHex" function
    // we can do this because we know the specific formats of the values
    return (FN_SELECTOR +
        encodeGetOfferParams(options).slice(2));
}
/**
 ...
 * ```
 */
export function decodeGetOfferResult(result) {
