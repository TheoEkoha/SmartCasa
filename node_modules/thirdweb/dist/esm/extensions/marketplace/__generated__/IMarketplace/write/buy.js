...
export const FN_SELECTOR = "0x7687ab02";
const FN_INPUTS = [
    {
        type: "uint256",
        name: "_listingId",
 ...
 * ```
 */
export function isBuySupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function encodeBuyParams(options) {
 ...
 * ```
 */
export function encodeBuy(options) {
