...
export const FN_SELECTOR = "0x6bab66ae";
const FN_INPUTS = [
    {
        type: "uint256",
        name: "_listingId",
 ...
 * ```
 */
export function isCloseAuctionSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function encodeCloseAuctionParams(options) {
 ...
 * ```
 */
export function encodeCloseAuction(options) {
 ...
 * ```
 */
export function closeAuction(options) {
