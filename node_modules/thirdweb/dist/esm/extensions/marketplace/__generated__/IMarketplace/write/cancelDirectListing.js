...
export const FN_SELECTOR = "0x7506c84a";
const FN_INPUTS = [
    {
        type: "uint256",
        name: "_listingId",
 ...
 * ```
 */
export function isCancelDirectListingSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function encodeCancelDirectListingParams(options) {
 ...
 * ```
 */
export function encodeCancelDirectListing(options) {
 ...
 * ```
 */
export function cancelDirectListing(options) {
