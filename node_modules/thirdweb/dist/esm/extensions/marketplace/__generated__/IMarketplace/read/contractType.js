...
export const FN_SELECTOR = "0xcb2ef6f7";
const FN_INPUTS = [];
const FN_OUTPUTS = [
    {
        type: "bytes32",
 ...
 * @example
 * ```ts
 * import { isContractTypeSupported } from "thirdweb/extensions/marketplace";
 *
 * const supported = isContractTypeSupported(["0x..."]);
 * ```
 */
export function isContractTypeSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function decodeContractTypeResult(result) {
 ...
 * ```
 */
export async function contractType(options) {
    return readContract({
