...
export const FN_SELECTOR = "0xa0a8e460";
const FN_INPUTS = [];
const FN_OUTPUTS = [
    {
        type: "uint8",
 ...
 * ```
 */
export function isContractVersionSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function decodeContractVersionResult(result) {
 ...
 * ```
 */
export async function contractVersion(options) {
    return readContract({
