...
export const FN_SELECTOR = "0xd45573f6";
const FN_INPUTS = [];
const FN_OUTPUTS = [
    {
        type: "address",
 ...
 * ```
 */
export function isGetPlatformFeeInfoSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function decodeGetPlatformFeeInfoResult(result) {
 ...
 * ```
 */
export async function getPlatformFeeInfo(options) {
    return readContract({
