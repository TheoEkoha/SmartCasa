...
export const FN_SELECTOR = "0xc01f9e37";
const FN_INPUTS = [
    {
        type: "uint256",
        name: "proposalId",
 ...
 * ```
 */
export function isProposalDeadlineSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function encodeProposalDeadlineParams(options) {
 ...
 * ```
 */
export function encodeProposalDeadline(options) {
 ...
 * ```
 */
export function decodeProposalDeadlineResult(result) {
 ...
 * ```
 */
export async function proposalDeadline(options) {
    return readContract({
