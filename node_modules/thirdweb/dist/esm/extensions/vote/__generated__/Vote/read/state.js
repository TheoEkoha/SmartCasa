...
export const FN_SELECTOR = "0x3e4f49e6";
const FN_INPUTS = [
    {
        type: "uint256",
        name: "proposalId",
 ...
 * ```
 */
export function isStateSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function encodeStateParams(options) {
 ...
 * ```
 */
export function decodeStateResult(result) {
