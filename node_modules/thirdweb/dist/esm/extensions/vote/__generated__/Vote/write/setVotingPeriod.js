...
export const FN_SELECTOR = "0xea0217cf";
const FN_INPUTS = [
    {
        type: "uint256",
 ...
 * ```
 */
export function isSetVotingPeriodSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function encodeSetVotingPeriodParams(options) {
 ...
 * ```
 */
export function encodeSetVotingPeriod(options) {
 ...
 * ```
 */
export function setVotingPeriod(options) {
