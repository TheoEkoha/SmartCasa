...
export const FN_SELECTOR = "0x56781388";
const FN_INPUTS = [
    {
        type: "uint256",
        name: "proposalId",
 ...
 * ```
 */
export function isCastVoteSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function encodeCastVoteParams(options) {
 ...
 * ```
 */
export function encodeCastVote(options) {
 ...
 * ```
 */
export function castVote(options) {
