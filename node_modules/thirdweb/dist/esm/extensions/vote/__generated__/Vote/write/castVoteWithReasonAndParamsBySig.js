...
export const FN_SELECTOR = "0x03420181";
const FN_INPUTS = [
    {
        type: "uint256",
        name: "proposalId",
 ...
 * ```
 */
export function isCastVoteWithReasonAndParamsBySigSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function encodeCastVoteWithReasonAndParamsBySigParams(options) {
 ...
 * ```
 */
export function encodeCastVoteWithReasonAndParamsBySig(options) {
 ...
 * ```
 */
export function castVoteWithReasonAndParamsBySig(options) {
