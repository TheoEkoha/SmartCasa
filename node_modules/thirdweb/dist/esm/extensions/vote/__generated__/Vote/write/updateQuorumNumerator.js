...
export const FN_SELECTOR = "0x06f3f9e6";
const FN_INPUTS = [
    {
        type: "uint256",
 ...
 * ```
 */
export function isUpdateQuorumNumeratorSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function encodeUpdateQuorumNumeratorParams(options) {
 ...
 * ```
 */
export function encodeUpdateQuorumNumerator(options) {
 ...
 * ```
 */
export function updateQuorumNumerator(options) {
