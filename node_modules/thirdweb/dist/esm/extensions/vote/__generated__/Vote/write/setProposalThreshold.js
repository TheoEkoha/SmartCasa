...
export const FN_SELECTOR = "0xece40cc1";
const FN_INPUTS = [
    {
        type: "uint256",
 ...
 * ```
 */
export function isSetProposalThresholdSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function encodeSetProposalThresholdParams(options) {
 ...
 * ```
 */
export function encodeSetProposalThreshold(options) {
 ...
 * ```
 */
export function setProposalThreshold(options) {
