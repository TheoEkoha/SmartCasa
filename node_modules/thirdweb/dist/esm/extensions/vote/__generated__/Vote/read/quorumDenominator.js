...
export const FN_SELECTOR = "0x97c3d334";
const FN_INPUTS = [];
const FN_OUTPUTS = [
    {
        type: "uint256",
 ...
 * ```
 */
export function isQuorumDenominatorSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function decodeQuorumDenominatorResult(result) {
 ...
 * ```
 */
export async function quorumDenominator(options) {
    return readContract({
