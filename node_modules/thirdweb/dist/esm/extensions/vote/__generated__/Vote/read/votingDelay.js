...
export const FN_SELECTOR = "0x3932abb1";
const FN_INPUTS = [];
const FN_OUTPUTS = [
    {
        type: "uint256",
 ...
 * ```
 */
export function isVotingDelaySupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function decodeVotingDelayResult(result) {
 ...
 * ```
 */
export async function votingDelay(options) {
    return readContract({
