...
export const FN_SELECTOR = "0x013cf08b";
const FN_INPUTS = [
    {
        type: "uint256",
        name: "key",
 ...
 * ```
 */
export function isProposalsSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function encodeProposalsParams(options) {
 ...
 * ```
 */
export function encodeProposals(options) {
 ...
 * ```
 */
export function decodeProposalsResult(result) {
