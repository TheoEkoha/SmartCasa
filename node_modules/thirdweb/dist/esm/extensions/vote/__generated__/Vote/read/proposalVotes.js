...
export const FN_SELECTOR = "0x544ffc9c";
const FN_INPUTS = [
    {
        type: "uint256",
        name: "proposalId",
 ...
 * ```
 */
export function isProposalVotesSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function encodeProposalVotesParams(options) {
 ...
 * ```
 */
export function encodeProposalVotes(options) {
 ...
 * ```
 */
export function decodeProposalVotesResult(result) {
 ...
 * ```
 */
export async function proposalVotes(options) {
    return readContract({
