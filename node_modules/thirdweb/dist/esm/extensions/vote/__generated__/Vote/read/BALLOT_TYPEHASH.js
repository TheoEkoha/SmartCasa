...
export const FN_SELECTOR = "0xdeaaa7cc";
const FN_INPUTS = [];
const FN_OUTPUTS = [
    {
        type: "bytes32",
 ...
 * ```
 */
export function isBALLOT_TYPEHASHSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function decodeBALLOT_TYPEHASHResult(result) {
 ...
 * ```
 */
export async function BALLOT_TYPEHASH(options) {
    return readContract({
