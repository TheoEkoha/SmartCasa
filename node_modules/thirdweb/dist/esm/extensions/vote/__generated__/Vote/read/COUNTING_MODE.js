...
export const FN_SELECTOR = "0xdd4e2ba5";
const FN_INPUTS = [];
const FN_OUTPUTS = [
    {
        type: "string",
 ...
 * ```
 */
export function isCOUNTING_MODESupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function decodeCOUNTING_MODEResult(result) {
 ...
 * ```
 */
export async function COUNTING_MODE(options) {
    return readContract({
