...
export const FN_SELECTOR = "0x43859632";
const FN_INPUTS = [
    {
        type: "uint256",
        name: "proposalId",
 ...
 * ```
 */
export function isHasVotedSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function encodeHasVotedParams(options) {
 ...
 * ```
 */
export function encodeHasVoted(options) {
 ...
 * ```
 */
export function decodeHasVotedResult(result) {
 ...
 * ```
 */
export async function hasVoted(options) {
    return readContract({
