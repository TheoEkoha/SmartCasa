...
export const FN_SELECTOR = "0x02a251a3";
const FN_INPUTS = [];
const FN_OUTPUTS = [
    {
        type: "uint256",
 ...
 * ```
 */
export function isVotingPeriodSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function decodeVotingPeriodResult(result) {
 ...
 * ```
 */
export async function votingPeriod(options) {
    return readContract({
