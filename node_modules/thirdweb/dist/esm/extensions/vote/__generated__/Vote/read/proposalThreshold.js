...
export const FN_SELECTOR = "0xb58131b0";
const FN_INPUTS = [];
const FN_OUTPUTS = [
    {
        type: "uint256",
 ...
 * ```
 */
export function isProposalThresholdSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function decodeProposalThresholdResult(result) {
 ...
 * ```
 */
export async function proposalThreshold(options) {
    return readContract({
