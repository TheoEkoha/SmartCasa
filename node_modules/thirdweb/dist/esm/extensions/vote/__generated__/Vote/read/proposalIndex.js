...
export const FN_SELECTOR = "0x5977e0f2";
const FN_INPUTS = [];
const FN_OUTPUTS = [
    {
        type: "uint256",
 ...
 * ```
 */
export function isProposalIndexSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function decodeProposalIndexResult(result) {
 ...
 * ```
 */
export async function proposalIndex(options) {
    return readContract({
