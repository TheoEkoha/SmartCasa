...
export const FN_SELECTOR = "0x3bccf4fd";
const FN_INPUTS = [
    {
        type: "uint256",
        name: "proposalId",
 ...
 * ```
 */
export function isCastVoteBySigSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function encodeCastVoteBySigParams(options) {
 ...
 * ```
 */
export function encodeCastVoteBySig(options) {
 ...
 * ```
 */
export function castVoteBySig(options) {
