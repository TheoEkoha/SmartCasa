...
export const FN_SELECTOR = "0x7b3c71d3";
const FN_INPUTS = [
    {
        type: "uint256",
        name: "proposalId",
 ...
 * ```
 */
export function isCastVoteWithReasonSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function encodeCastVoteWithReasonParams(options) {
 ...
 * ```
 */
export function encodeCastVoteWithReason(options) {
 ...
 * ```
 */
export function castVoteWithReason(options) {
