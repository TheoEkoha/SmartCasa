...
export const FN_SELECTOR = "0x2d63f693";
const FN_INPUTS = [
    {
        type: "uint256",
        name: "proposalId",
 ...
 * ```
 */
export function isProposalSnapshotSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function encodeProposalSnapshotParams(options) {
 ...
 * ```
 */
export function encodeProposalSnapshot(options) {
 ...
 * ```
 */
export function decodeProposalSnapshotResult(result) {
 ...
 * ```
 */
export async function proposalSnapshot(options) {
    return readContract({
