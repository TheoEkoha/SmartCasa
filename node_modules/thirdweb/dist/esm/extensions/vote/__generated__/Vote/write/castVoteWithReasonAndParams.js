...
export const FN_SELECTOR = "0x5f398a14";
const FN_INPUTS = [
    {
        type: "uint256",
        name: "proposalId",
 ...
 * ```
 */
export function isCastVoteWithReasonAndParamsSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function encodeCastVoteWithReasonAndParamsParams(options) {
 ...
 * ```
 */
export function encodeCastVoteWithReasonAndParams(options) {
 ...
 * ```
 */
export function castVoteWithReasonAndParams(options) {
