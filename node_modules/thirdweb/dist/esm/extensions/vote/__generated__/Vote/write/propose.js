...
export const FN_SELECTOR = "0x7d5e81e2";
const FN_INPUTS = [
    {
        type: "address[]",
        name: "targets",
 ...
 * ```
 */
export function isProposeSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function encodeProposeParams(options) {
 ...
 * ```
 */
export function encodePropose(options) {
