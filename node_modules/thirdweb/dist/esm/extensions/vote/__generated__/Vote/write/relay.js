...
export const FN_SELECTOR = "0xc28bc2fa";
const FN_INPUTS = [
    {
        type: "address",
        name: "target",
 ...
 * ```
 */
export function isRelaySupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function encodeRelayParams(options) {
 ...
 * ```
 */
export function encodeRelay(options) {
