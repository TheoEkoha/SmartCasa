...
export const FN_SELECTOR = "0x9a802a6d";
const FN_INPUTS = [
    {
        type: "address",
        name: "account",
 ...
 * ```
 */
export function isGetVotesWithParamsSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function encodeGetVotesWithParamsParams(options) {
 ...
 * ```
 */
export function encodeGetVotesWithParams(options) {
 ...
 * ```
 */
export function decodeGetVotesWithParamsResult(result) {
 ...
 * ```
 */
export async function getVotesWithParams(options) {
    return readContract({
