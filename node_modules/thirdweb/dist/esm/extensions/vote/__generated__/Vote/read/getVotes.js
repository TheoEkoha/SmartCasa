...
export const FN_SELECTOR = "0xeb9019d4";
const FN_INPUTS = [
    {
        type: "address",
        name: "account",
 ...
 * ```
 */
export function isGetVotesSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function encodeGetVotesParams(options) {
 ...
 * ```
 */
export function encodeGetVotes(options) {
 ...
 * ```
 */
export function decodeGetVotesResult(result) {
