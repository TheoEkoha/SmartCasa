...
export const FN_SELECTOR = "0xf8ce560a";
const FN_INPUTS = [
    {
        type: "uint256",
        name: "blockNumber",
 ...
 * ```
 */
export function isQuorumSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function encodeQuorumParams(options) {
 ...
 * ```
 */
export function encodeQuorum(options) {
 ...
 * ```
 */
export function decodeQuorumResult(result) {
 ...
 * ```
 */
export async function quorum(options) {
    return readContract({
