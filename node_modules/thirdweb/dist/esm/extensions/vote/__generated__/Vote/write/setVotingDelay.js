...
export const FN_SELECTOR = "0x70b0f660";
const FN_INPUTS = [
    {
        type: "uint256",
        name: "newVotingDelay",
 ...
 * ```
 */
export function isSetVotingDelaySupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function encodeSetVotingDelayParams(options) {
 ...
 * ```
 */
export function encodeSetVotingDelay(options) {
 ...
 * ```
 */
export function setVotingDelay(options) {
