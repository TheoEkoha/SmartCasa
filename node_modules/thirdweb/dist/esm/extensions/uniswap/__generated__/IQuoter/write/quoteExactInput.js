...
export const FN_SELECTOR = "0xcdca1753";
const FN_INPUTS = [
    {
        type: "bytes",
        name: "path",
 ...
 * ```
 */
export function isQuoteExactInputSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function encodeQuoteExactInputParams(options) {
 ...
 * ```
 */
export function encodeQuoteExactInput(options) {
 ...
 * ```
 */
export function quoteExactInput(options) {
