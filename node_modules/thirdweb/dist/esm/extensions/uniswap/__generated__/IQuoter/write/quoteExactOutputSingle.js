...
export const FN_SELECTOR = "0x30d07f21";
const FN_INPUTS = [
    {
        type: "address",
        name: "tokenIn",
 ...
 * ```
 */
export function isQuoteExactOutputSingleSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function encodeQuoteExactOutputSingle(options) {
