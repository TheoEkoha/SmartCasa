...
export const FN_SELECTOR = "0xf7729d43";
const FN_INPUTS = [
    {
        type: "address",
        name: "tokenIn",
 ...
 * ```
 */
export function isQuoteExactInputSingleSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function encodeQuoteExactInputSingleParams(options) {
 ...
 * ```
 */
export function encodeQuoteExactInputSingle(options) {
 ...
 * ```
 */
export function quoteExactInputSingle(options) {
