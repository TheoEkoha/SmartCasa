...
export const FN_SELECTOR = "0x2f80bb1d";
const FN_INPUTS = [
    {
        type: "bytes",
        name: "path",
 ...
 * ```
 */
export function isQuoteExactOutputSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function encodeQuoteExactOutputParams(options) {
 ...
 * ```
 */
export function encodeQuoteExactOutput(options) {
 ...
 * ```
 */
export function quoteExactOutput(options) {
