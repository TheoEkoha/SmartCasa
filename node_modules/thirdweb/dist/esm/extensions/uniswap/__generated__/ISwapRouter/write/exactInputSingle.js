...
export const FN_SELECTOR = "0x414bf389";
const FN_INPUTS = [
    {
        type: "tuple",
        name: "params",
 ...
 * ```
 */
export function isExactInputSingleSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function encodeExactInputSingleParams(options) {
 ...
 * ```
 */
export function encodeExactInputSingle(options) {
 ...
 * ```
 */
export function exactInputSingle(options) {
