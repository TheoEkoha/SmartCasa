...
export const FN_SELECTOR = "0xdb3e2198";
const FN_INPUTS = [
    {
        type: "tuple",
        name: "params",
 ...
 * ```
 */
export function isExactOutputSingleSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function encodeExactOutputSingleParams(options) {
 ...
 * ```
 */
export function encodeExactOutputSingle(options) {
 ...
 * ```
 */
export function exactOutputSingle(options) {
