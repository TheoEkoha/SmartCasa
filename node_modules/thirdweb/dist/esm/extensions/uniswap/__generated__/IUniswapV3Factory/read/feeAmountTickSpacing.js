...
export const FN_SELECTOR = "0x22afcccb";
const FN_INPUTS = [
    {
        type: "uint24",
        name: "fee",
 ...
 * ```
 */
export function isFeeAmountTickSpacingSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function encodeFeeAmountTickSpacing(options) {
