...
export const FN_SELECTOR = "0x1698ee82";
const FN_INPUTS = [
    {
        type: "address",
        name: "tokenA",
 ...
 * ```
 */
export function isGetPoolSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function encodeGetPoolParams(options) {
 ...
 * ```
 */
export function encodeGetPool(options) {
    // we do a "manual" concat here to avoid the overhead of the "concatHex" function
    // we can do this because we know the specific formats of the values
    return (FN_SELECTOR +
        encodeGetPoolParams(options).slice(2));
}
/**
 ...
 * ```
 */
export function decodeGetPoolResult(result) {
