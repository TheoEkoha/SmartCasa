...
export const FN_SELECTOR = "0x80251dac";
const FN_INPUTS = [
    {
        type: "address",
        name: "publisher",
 ...
 * ```
 */
export function isGetPublishedContractVersionsSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function encodeGetPublishedContractVersionsParams(options) {
 ...
 * ```
 */
export function encodeGetPublishedContractVersions(options) {
 ...
 * ```
 */
export function decodeGetPublishedContractVersionsResult(result) {
 ...
 * ```
 */
export async function getPublishedContractVersions(options) {
    return readContract({
