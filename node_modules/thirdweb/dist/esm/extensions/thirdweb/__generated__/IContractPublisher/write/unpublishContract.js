...
export const FN_SELECTOR = "0x06eb56cc";
const FN_INPUTS = [
    {
        type: "address",
        name: "publisher",
 ...
 * ```
 */
export function isUnpublishContractSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function encodeUnpublishContractParams(options) {
 ...
 * ```
 */
export function encodeUnpublishContract(options) {
 ...
 * ```
 */
export function unpublishContract(options) {
