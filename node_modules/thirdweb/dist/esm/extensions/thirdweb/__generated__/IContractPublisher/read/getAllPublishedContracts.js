...
export const FN_SELECTOR = "0xaf8db690";
const FN_INPUTS = [
    {
        type: "address",
        name: "publisher",
 ...
 * ```
 */
export function isGetAllPublishedContractsSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function encodeGetAllPublishedContractsParams(options) {
 ...
 * ```
 */
export function encodeGetAllPublishedContracts(options) {
    // we do a "manual" concat here to avoid the overhead of the "concatHex" function
    // we can do this because we know the specific formats of the values
    return (FN_SELECTOR +
        encodeGetAllPublishedContractsParams(options).slice(2));
}
/**
 ...
 * ```
 */
export function decodeGetAllPublishedContractsResult(result) {
 ...
 * ```
 */
export async function getAllPublishedContracts(options) {
    return readContract({
