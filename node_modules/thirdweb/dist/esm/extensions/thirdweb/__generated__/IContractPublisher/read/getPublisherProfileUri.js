...
export const FN_SELECTOR = "0x4f781675";
const FN_INPUTS = [
    {
        type: "address",
        name: "publisher",
 ...
 * ```
 */
export function isGetPublisherProfileUriSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function encodeGetPublisherProfileUriParams(options) {
 ...
 * ```
 */
export function encodeGetPublisherProfileUri(options) {
 ...
 * ```
 */
export function decodeGetPublisherProfileUriResult(result) {
 ...
 * ```
 */
export async function getPublisherProfileUri(options) {
    return readContract({
