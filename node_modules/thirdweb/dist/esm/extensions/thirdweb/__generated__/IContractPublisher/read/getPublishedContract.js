...
export const FN_SELECTOR = "0x7ec047fa";
const FN_INPUTS = [
    {
        type: "address",
        name: "publisher",
 ...
 * ```
 */
export function isGetPublishedContractSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function encodeGetPublishedContract(options) {
