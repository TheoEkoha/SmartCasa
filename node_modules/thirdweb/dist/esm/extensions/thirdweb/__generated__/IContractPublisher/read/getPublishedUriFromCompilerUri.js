...
export const FN_SELECTOR = "0x819e992f";
const FN_INPUTS = [
    {
        type: "string",
 ...
 * ```
 */
export function isGetPublishedUriFromCompilerUriSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function encodeGetPublishedUriFromCompilerUriParams(options) {
 ...
 * ```
 */
export function encodeGetPublishedUriFromCompilerUri(options) {
 ...
 * ```
 */
export function decodeGetPublishedUriFromCompilerUriResult(result) {
 ...
 * ```
 */
export async function getPublishedUriFromCompilerUri(options) {
    return readContract({
