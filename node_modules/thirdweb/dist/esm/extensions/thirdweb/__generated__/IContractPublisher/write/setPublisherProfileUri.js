...
export const FN_SELECTOR = "0x6e578e54";
const FN_INPUTS = [
    {
        type: "address",
        name: "publisher",
 ...
 * ```
 */
export function isSetPublisherProfileUriSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function encodeSetPublisherProfileUriParams(options) {
 ...
 * ```
 */
export function encodeSetPublisherProfileUri(options) {
 ...
 * ```
 */
export function setPublisherProfileUri(options) {
