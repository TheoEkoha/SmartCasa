...
export const FN_SELECTOR = "0x11b804ab";
const FN_INPUTS = [
    {
        type: "address",
        name: "implementation",
 ...
 * ```
 */
export function isDeployProxyByImplementationSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function encodeDeployProxyByImplementation(options) {
