...
export const FN_SELECTOR = "0x1022a25e";
const FN_INPUTS = [
    {
        type: "tuple",
        name: "rule",
 ...
 * ```
 */
export function isCreateRuleThresholdSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function encodeCreateRuleThresholdParams(options) {
 ...
 * ```
 */
export function encodeCreateRuleThreshold(options) {
 ...
 * ```
 */
export function createRuleThreshold(options) {
