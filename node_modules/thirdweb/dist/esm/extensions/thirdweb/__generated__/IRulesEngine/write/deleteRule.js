...
export const FN_SELECTOR = "0x9d907761";
const FN_INPUTS = [
    {
        type: "bytes32",
        name: "ruleId",
 ...
 * ```
 */
export function isDeleteRuleSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function encodeDeleteRuleParams(options) {
 ...
 * ```
 */
export function encodeDeleteRule(options) {
