...
export const FN_SELECTOR = "0x0eb0adb6";
const FN_INPUTS = [
    {
        type: "address",
 ...
 * ```
 */
export function isSetRulesEngineOverrideSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function encodeSetRulesEngineOverrideParams(options) {
 ...
 * ```
 */
export function encodeSetRulesEngineOverride(options) {
 ...
 * ```
 */
export function setRulesEngineOverride(options) {
