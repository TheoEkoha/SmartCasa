...
export const FN_SELECTOR = "0x1e2e9cb5";
const FN_INPUTS = [
    {
        type: "tuple",
        name: "rule",
 ...
 * ```
 */
export function isCreateRuleMultiplicativeSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function encodeCreateRuleMultiplicativeParams(options) {
 ...
 * ```
 */
export function encodeCreateRuleMultiplicative(options) {
 ...
 * ```
 */
export function createRuleMultiplicative(options) {
