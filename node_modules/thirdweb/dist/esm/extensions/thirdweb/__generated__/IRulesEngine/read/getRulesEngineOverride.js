...
export const FN_SELECTOR = "0xa7145eb4";
const FN_INPUTS = [];
const FN_OUTPUTS = [
    {
        type: "address",
 ...
 * ```
 */
export function isGetRulesEngineOverrideSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function decodeGetRulesEngineOverrideResult(result) {
 ...
 * ```
 */
export async function getRulesEngineOverride(options) {
    return readContract({
