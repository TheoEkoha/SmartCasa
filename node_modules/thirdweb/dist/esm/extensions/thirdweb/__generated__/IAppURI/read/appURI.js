...
export const FN_SELECTOR = "0x094ec830";
const FN_INPUTS = [];
const FN_OUTPUTS = [
    {
        type: "string",
 ...
 * ```
 */
export function isAppURISupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function decodeAppURIResult(result) {
 ...
 * ```
 */
export async function appURI(options) {
    return readContract({
