...
export const FN_SELECTOR = "0xfea18082";
const FN_INPUTS = [
    {
        type: "string",
        name: "_uri",
 ...
 * ```
 */
export function isSetAppURISupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function encodeSetAppURIParams(options) {
 ...
 * ```
 */
export function encodeSetAppURI(options) {
 ...
 * ```
 */
export function setAppURI(options) {
