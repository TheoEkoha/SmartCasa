...
export const FN_SELECTOR = "0x05d85eda";
const FN_INPUTS = [
    {
        type: "address",
        name: "_deployer",
 ...
 * ```
 */
export function isCountSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function encodeCountParams(options) {
 ...
 * ```
 */
export function encodeCount(options) {
 ...
 * ```
 */
export function decodeCountResult(result) {
