...
export const FN_SELECTOR = "0xf4c2012d";
const FN_INPUTS = [
    {
        type: "uint256",
        name: "_chainId",
 ...
 * ```
 */
export function isGetMetadataUriSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function encodeGetMetadataUriParams(options) {
 ...
 * ```
 */
export function encodeGetMetadataUri(options) {
    // we do a "manual" concat here to avoid the overhead of the "concatHex" function
    // we can do this because we know the specific formats of the values
    return (FN_SELECTOR +
        encodeGetMetadataUriParams(options).slice(2));
}
/**
 ...
 * ```
 */
export function decodeGetMetadataUriResult(result) {
 ...
 * ```
 */
export async function getMetadataUri(options) {
    return readContract({
