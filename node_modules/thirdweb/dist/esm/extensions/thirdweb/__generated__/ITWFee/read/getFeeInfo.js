...
export const FN_SELECTOR = "0x85b49ad0";
const FN_INPUTS = [
    {
        type: "address",
        name: "_proxy",
 ...
 * ```
 */
export function isGetFeeInfoSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function encodeGetFeeInfoParams(options) {
 ...
 * ```
 */
export function encodeGetFeeInfo(options) {
 ...
 * ```
 */
export function decodeGetFeeInfoResult(result) {
 ...
 * ```
 */
export async function getFeeInfo(options) {
    return readContract({
