...
export const FN_SELECTOR = "0x19165587";
const FN_INPUTS = [
    {
        type: "address",
        name: "account",
 ...
 * ```
 */
export function isReleaseSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function encodeReleaseParams(options) {
 ...
 * ```
 */
export function encodeRelease(options) {
