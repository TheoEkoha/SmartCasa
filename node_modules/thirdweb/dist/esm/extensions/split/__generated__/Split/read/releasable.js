...
export const FN_SELECTOR = "0xa3f8eace";
const FN_INPUTS = [
    {
        type: "address",
        name: "account",
 ...
 * ```
 */
export function isReleasableSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function encodeReleasableParams(options) {
 ...
 * ```
 */
export function encodeReleasable(options) {
 ...
 * ```
 */
export function decodeReleasableResult(result) {
 ...
 * ```
 */
export async function releasable(options) {
    return readContract({
