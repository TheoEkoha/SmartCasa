...
export const FN_SELECTOR = "0x8b83209b";
const FN_INPUTS = [
    {
        type: "uint256",
        name: "index",
 ...
 * ```
 */
export function isPayeeSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function encodePayeeParams(options) {
 ...
 * ```
 */
export function encodePayee(options) {
 ...
 * ```
 */
export function decodePayeeResult(result) {
 ...
 * ```
 */
export async function payee(options) {
    return readContract({
