...
export const FN_SELECTOR = "0xce7c2ac2";
const FN_INPUTS = [
    {
        type: "address",
        name: "account",
 ...
 * ```
 */
export function isSharesSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function encodeSharesParams(options) {
 ...
 * ```
 */
export function encodeShares(options) {
 ...
 * ```
 */
export function decodeSharesResult(result) {
