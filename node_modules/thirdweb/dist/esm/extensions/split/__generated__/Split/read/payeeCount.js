...
export const FN_SELECTOR = "0x00dbe109";
const FN_INPUTS = [];
const FN_OUTPUTS = [
    {
        type: "uint256",
 ...
 * ```
 */
export function isPayeeCountSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function decodePayeeCountResult(result) {
 ...
 * ```
 */
export async function payeeCount(options) {
    return readContract({
