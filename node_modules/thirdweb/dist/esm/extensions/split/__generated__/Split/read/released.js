...
export const FN_SELECTOR = "0x9852595c";
const FN_INPUTS = [
    {
        type: "address",
        name: "account",
 ...
 * ```
 */
export function isReleasedSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function encodeReleasedParams(options) {
 ...
 * ```
 */
export function encodeReleased(options) {
 ...
 * ```
 */
export function decodeReleasedResult(result) {
 ...
 * ```
 */
export async function released(options) {
    return readContract({
