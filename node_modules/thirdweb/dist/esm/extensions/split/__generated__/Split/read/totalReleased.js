...
export const FN_SELECTOR = "0xe33b7de3";
const FN_INPUTS = [];
const FN_OUTPUTS = [
    {
        type: "uint256",
 ...
 * ```
 */
export function isTotalReleasedSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function decodeTotalReleasedResult(result) {
 ...
 * ```
 */
export async function totalReleased(options) {
    return readContract({
