...
export const FN_SELECTOR = "0x8f0fefbb";
const FN_INPUTS = [
    {
        type: "tuple",
        name: "payload",
 ...
 * ```
 */
export function isMintWithSignatureSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function encodeMintWithSignatureParams(options) {
 ...
 * ```
 */
export function encodeMintWithSignature(options) {
