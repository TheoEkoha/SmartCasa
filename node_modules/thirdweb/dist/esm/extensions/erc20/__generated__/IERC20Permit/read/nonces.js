...
export const FN_SELECTOR = "0x7ecebe00";
const FN_INPUTS = [
    {
        type: "address",
        name: "owner",
 ...
 * ```
 */
export function isNoncesSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function encodeNoncesParams(options) {
 ...
 * ```
 */
export function encodeNonces(options) {
 ...
 * ```
 */
export function decodeNoncesResult(result) {
