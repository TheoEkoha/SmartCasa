...
export const FN_SELECTOR = "0x79cc6790";
const FN_INPUTS = [
    {
        type: "address",
        name: "account",
 ...
 * ```
 */
export function isBurnFromSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function encodeBurnFromParams(options) {
 ...
 * ```
 */
export function encodeBurnFrom(options) {
 ...
 * ```
 */
export function burnFrom(options) {
