...
export const FN_SELECTOR = "0x8e539e8c";
const FN_INPUTS = [
    {
        type: "uint256",
        name: "blockNumber",
 ...
 * ```
 */
export function isGetPastTotalSupplySupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function encodeGetPastTotalSupplyParams(options) {
 ...
 * ```
 */
export function encodeGetPastTotalSupply(options) {
 ...
 * ```
 */
export function decodeGetPastTotalSupplyResult(result) {
 ...
 * ```
 */
export async function getPastTotalSupply(options) {
    return readContract({
