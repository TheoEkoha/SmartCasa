...
export const FN_SELECTOR = "0x5c19a95c";
const FN_INPUTS = [
    {
        type: "address",
        name: "delegatee",
 ...
 * ```
 */
export function isDelegateSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function encodeDelegateParams(options) {
 ...
 * ```
 */
export function encodeDelegate(options) {
