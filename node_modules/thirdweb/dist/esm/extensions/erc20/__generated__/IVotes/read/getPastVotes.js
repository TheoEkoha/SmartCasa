...
export const FN_SELECTOR = "0x3a46b1a8";
const FN_INPUTS = [
    {
        type: "address",
        name: "account",
 ...
 * ```
 */
export function isGetPastVotesSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function encodeGetPastVotesParams(options) {
 ...
 * ```
 */
export function encodeGetPastVotes(options) {
 ...
 * ```
 */
export function decodeGetPastVotesResult(result) {
 ...
 * ```
 */
export async function getPastVotes(options) {
    return readContract({
