...
export const FN_SELECTOR = "0xc3cda520";
const FN_INPUTS = [
    {
        type: "address",
        name: "delegatee",
 ...
 * ```
 */
export function isDelegateBySigSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function encodeDelegateBySigParams(options) {
 ...
 * ```
 */
export function encodeDelegateBySig(options) {
    // we do a "manual" concat here to avoid the overhead of the "concatHex" function
    // we can do this because we know the specific formats of the values
    return (FN_SELECTOR +
        encodeDelegateBySigParams(options).slice(2));
}
/**
 ...
 * ```
 */
export function delegateBySig(options) {
