...
export const FN_SELECTOR = "0x587cde1e";
const FN_INPUTS = [
    {
        type: "address",
        name: "account",
 ...
 * ```
 */
export function isDelegatesSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function encodeDelegatesParams(options) {
 ...
 * ```
 */
export function encodeDelegates(options) {
 ...
 * ```
 */
export function decodeDelegatesResult(result) {
 ...
 * ```
 */
export async function delegates(options) {
    return readContract({
