...
export const FN_SELECTOR = "0xd42f2f35";
const FN_INPUTS = [];
const FN_OUTPUTS = [
    {
        type: "tuple[]",
 ...
 * ```
 */
export function isGetAllSignersSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function decodeGetAllSignersResult(result) {
 ...
 * ```
 */
export async function getAllSigners(options) {
    return readContract({
