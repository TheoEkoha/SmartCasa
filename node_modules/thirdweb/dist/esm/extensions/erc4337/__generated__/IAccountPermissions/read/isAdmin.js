...
export const FN_SELECTOR = "0x24d7806c";
const FN_INPUTS = [
    {
        type: "address",
        name: "signer",
 ...
 * ```
 */
export function isIsAdminSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function encodeIsAdminParams(options) {
 ...
 * ```
 */
export function encodeIsAdmin(options) {
 ...
 * ```
 */
export function decodeIsAdminResult(result) {
