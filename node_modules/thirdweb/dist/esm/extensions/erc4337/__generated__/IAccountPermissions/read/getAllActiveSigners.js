...
export const FN_SELECTOR = "0x8b52d723";
const FN_INPUTS = [];
const FN_OUTPUTS = [
    {
        type: "tuple[]",
 ...
 * ```
 */
export function isGetAllActiveSignersSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function decodeGetAllActiveSignersResult(result) {
 ...
 * ```
 */
export async function getAllActiveSigners(options) {
    return readContract({
