...
export const FN_SELECTOR = "0x7dff5a79";
const FN_INPUTS = [
    {
        type: "address",
        name: "signer",
 ...
 * ```
 */
export function isIsActiveSignerSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function encodeIsActiveSignerParams(options) {
 ...
 * ```
 */
export function encodeIsActiveSigner(options) {
    // we do a "manual" concat here to avoid the overhead of the "concatHex" function
    // we can do this because we know the specific formats of the values
    return (FN_SELECTOR +
        encodeIsActiveSignerParams(options).slice(2));
}
/**
 ...
 * ```
 */
export function decodeIsActiveSignerResult(result) {
 ...
 * ```
 */
export async function isActiveSigner(options) {
    return readContract({
