...
export const FN_SELECTOR = "0xa9082d84";
const FN_INPUTS = [
    {
        type: "tuple",
        name: "req",
 ...
 * ```
 */
export function isVerifySignerPermissionRequestSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function encodeVerifySignerPermissionRequestParams(options) {
 ...
 * ```
 */
export function encodeVerifySignerPermissionRequest(options) {
    // we do a "manual" concat here to avoid the overhead of the "concatHex" function
    // we can do this because we know the specific formats of the values
    return (FN_SELECTOR +
        encodeVerifySignerPermissionRequestParams(options).slice(2));
}
/**
 ...
 * ```
 */
export function decodeVerifySignerPermissionRequestResult(result) {
 ...
 * ```
 */
export async function verifySignerPermissionRequest(options) {
    return readContract({
