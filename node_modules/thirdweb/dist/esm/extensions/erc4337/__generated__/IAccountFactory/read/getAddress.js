...
export const FN_SELECTOR = "0x8878ed33";
const FN_INPUTS = [
    {
        type: "address",
        name: "adminSigner",
 ...
 * ```
 */
export function isGetAddressSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function encodeGetAddressParams(options) {
 ...
 * ```
 */
export function encodeGetAddress(options) {
 ...
 * ```
 */
export function decodeGetAddressResult(result) {
