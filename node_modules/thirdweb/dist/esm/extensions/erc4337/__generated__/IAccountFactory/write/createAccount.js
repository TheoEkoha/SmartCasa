...
export const FN_SELECTOR = "0xd8fd8f44";
const FN_INPUTS = [
    {
        type: "address",
        name: "admin",
 ...
 * ```
 */
export function isCreateAccountSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function encodeCreateAccountParams(options) {
 ...
 * ```
 */
export function encodeCreateAccount(options) {
