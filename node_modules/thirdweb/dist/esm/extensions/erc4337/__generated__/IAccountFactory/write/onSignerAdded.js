...
export const FN_SELECTOR = "0x9ddbb9d8";
const FN_INPUTS = [
    {
        type: "address",
        name: "signer",
 ...
 * ```
 */
export function isOnSignerAddedSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function encodeOnSignerAddedParams(options) {
 ...
 * ```
 */
export function encodeOnSignerAdded(options) {
    // we do a "manual" concat here to avoid the overhead of the "concatHex" function
    // we can do this because we know the specific formats of the values
    return (FN_SELECTOR +
        encodeOnSignerAddedParams(options).slice(2));
}
/**
 ...
 * ```
 */
export function onSignerAdded(options) {
