...
export const FN_SELECTOR = "0x0e6254fd";
const FN_INPUTS = [
    {
        type: "address",
        name: "signer",
 ...
 * ```
 */
export function isGetAccountsOfSignerSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function encodeGetAccountsOfSignerParams(options) {
 ...
 * ```
 */
export function encodeGetAccountsOfSigner(options) {
 ...
 * ```
 */
export function decodeGetAccountsOfSignerResult(result) {
 ...
 * ```
 */
export async function getAccountsOfSigner(options) {
    return readContract({
