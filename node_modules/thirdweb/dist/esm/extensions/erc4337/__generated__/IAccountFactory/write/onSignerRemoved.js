...
export const FN_SELECTOR = "0x0db33003";
const FN_INPUTS = [
    {
        type: "address",
        name: "signer",
 ...
 * ```
 */
export function isOnSignerRemovedSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function encodeOnSignerRemovedParams(options) {
 ...
 * ```
 */
export function encodeOnSignerRemoved(options) {
 ...
 * ```
 */
export function onSignerRemoved(options) {
