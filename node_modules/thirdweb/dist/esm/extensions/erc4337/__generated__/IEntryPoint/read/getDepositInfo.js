...
export const FN_SELECTOR = "0x5287ce12";
const FN_INPUTS = [
    {
        type: "address",
        name: "account",
 ...
 * ```
 */
export function isGetDepositInfoSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function encodeGetDepositInfoParams(options) {
 ...
 * ```
 */
export function encodeGetDepositInfo(options) {
 ...
 * ```
 */
export function decodeGetDepositInfoResult(result) {
 ...
 * ```
 */
export async function getDepositInfo(options) {
    return readContract({
