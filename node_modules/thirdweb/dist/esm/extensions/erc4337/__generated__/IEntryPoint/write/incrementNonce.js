...
export const FN_SELECTOR = "0x0bd28e3b";
const FN_INPUTS = [
    {
        type: "uint192",
        name: "key",
 ...
 * ```
 */
export function isIncrementNonceSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function encodeIncrementNonceParams(options) {
 ...
 * ```
 */
export function encodeIncrementNonce(options) {
 ...
 * ```
 */
export function incrementNonce(options) {
