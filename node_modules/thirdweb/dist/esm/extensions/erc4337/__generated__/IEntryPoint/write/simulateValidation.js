...
export const FN_SELECTOR = "0xee219423";
const FN_INPUTS = [
    {
        type: "tuple",
        name: "userOp",
 ...
 * ```
 */
export function isSimulateValidationSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function encodeSimulateValidationParams(options) {
 ...
 * ```
 */
export function encodeSimulateValidation(options) {
 ...
 * ```
 */
export function simulateValidation(options) {
