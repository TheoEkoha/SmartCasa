...
export const FN_SELECTOR = "0xd6383f94";
const FN_INPUTS = [
    {
        type: "tuple",
        name: "op",
 ...
 * ```
 */
export function isSimulateHandleOpSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function encodeSimulateHandleOpParams(options) {
 ...
 * ```
 */
export function encodeSimulateHandleOp(options) {
 ...
 * ```
 */
export function simulateHandleOp(options) {
