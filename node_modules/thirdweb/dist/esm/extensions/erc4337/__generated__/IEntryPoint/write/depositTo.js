...
export const FN_SELECTOR = "0xb760faf9";
const FN_INPUTS = [
    {
        type: "address",
        name: "account",
 ...
 * ```
 */
export function isDepositToSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function encodeDepositToParams(options) {
 ...
 * ```
 */
export function encodeDepositTo(options) {
    // we do a "manual" concat here to avoid the overhead of the "concatHex" function
    // we can do this because we know the specific formats of the values
    return (FN_SELECTOR +
        encodeDepositToParams(options).slice(2));
}
/**
 ...
 * ```
 */
export function depositTo(options) {
