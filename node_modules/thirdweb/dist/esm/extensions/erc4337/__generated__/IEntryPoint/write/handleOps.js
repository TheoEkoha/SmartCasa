...
export const FN_SELECTOR = "0x1fad948c";
const FN_INPUTS = [
    {
        type: "tuple[]",
        name: "ops",
 ...
 * ```
 */
export function isHandleOpsSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function encodeHandleOpsParams(options) {
 ...
 * ```
 */
export function encodeHandleOps(options) {
    // we do a "manual" concat here to avoid the overhead of the "concatHex" function
    // we can do this because we know the specific formats of the values
    return (FN_SELECTOR +
        encodeHandleOpsParams(options).slice(2));
}
/**
 ...
 * ```
 */
export function handleOps(options) {
    ...
    return prepareContractCall({
        ...
        params: async () => {
            ...
            return [resolvedOptions.ops, resolvedOptions.beneficiary];
        },
