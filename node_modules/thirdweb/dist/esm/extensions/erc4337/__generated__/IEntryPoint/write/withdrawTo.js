...
export const FN_SELECTOR = "0x205c2878";
const FN_INPUTS = [
    {
        type: "address",
 ...
 * ```
 */
export function isWithdrawToSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function encodeWithdrawToParams(options) {
 ...
 * ```
 */
export function encodeWithdrawTo(options) {
    // we do a "manual" concat here to avoid the overhead of the "concatHex" function
    // we can do this because we know the specific formats of the values
    return (FN_SELECTOR +
        encodeWithdrawToParams(options).slice(2));
}
/**
 ...
 * ```
 */
export function withdrawTo(options) {
