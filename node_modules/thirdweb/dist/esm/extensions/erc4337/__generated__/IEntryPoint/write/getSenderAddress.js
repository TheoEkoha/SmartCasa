...
export const FN_SELECTOR = "0x9b249f69";
const FN_INPUTS = [
    {
        type: "bytes",
        name: "initCode",
 ...
 * ```
 */
export function isGetSenderAddressSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function encodeGetSenderAddressParams(options) {
 ...
 * ```
 */
export function encodeGetSenderAddress(options) {
 ...
 * ```
 */
export function getSenderAddress(options) {
