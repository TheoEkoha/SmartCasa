...
export const FN_SELECTOR = "0x4b1d7cf5";
const FN_INPUTS = [
    {
        type: "tuple[]",
 ...
 * ```
 */
export function isHandleAggregatedOpsSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function encodeHandleAggregatedOpsParams(options) {
 ...
 * ```
 */
export function encodeHandleAggregatedOps(options) {
 ...
 * ```
 */
export function handleAggregatedOps(options) {
