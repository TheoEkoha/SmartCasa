...
export const FN_SELECTOR = "0xf465c77e";
const FN_INPUTS = [
    {
        type: "tuple",
        name: "userOp",
 ...
 * ```
 */
export function isValidatePaymasterUserOpSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function encodeValidatePaymasterUserOp(options) {
