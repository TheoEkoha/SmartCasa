...
export const FN_SELECTOR = "0xbd85b039";
const FN_INPUTS = [
    {
        type: "uint256",
        name: "id",
 ...
 * ```
 */
export function isTotalSupplySupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function encodeTotalSupplyParams(options) {
 ...
 * ```
 */
export function encodeTotalSupply(options) {
 ...
 * ```
 */
export function decodeTotalSupplyResult(result) {
