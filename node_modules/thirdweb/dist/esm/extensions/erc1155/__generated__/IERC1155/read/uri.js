...
export const FN_SELECTOR = "0x0e89341c";
const FN_INPUTS = [
    {
        type: "uint256",
        name: "tokenId",
 ...
 * ```
 */
export function isUriSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function encodeUriParams(options) {
 ...
 * ```
 */
export function encodeUri(options) {
 ...
 * ```
 */
export function decodeUriResult(result) {
 ...
 * ```
 */
export async function uri(options) {
    return readContract({
