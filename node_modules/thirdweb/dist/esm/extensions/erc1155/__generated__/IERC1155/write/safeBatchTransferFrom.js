...
export const FN_SELECTOR = "0x2eb2c2d6";
const FN_INPUTS = [
    {
        type: "address",
        name: "_from",
 ...
 * ```
 */
export function isSafeBatchTransferFromSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function encodeSafeBatchTransferFromParams(options) {
 ...
 * ```
 */
export function encodeSafeBatchTransferFrom(options) {
 ...
 * ```
 */
export function safeBatchTransferFrom(options) {
