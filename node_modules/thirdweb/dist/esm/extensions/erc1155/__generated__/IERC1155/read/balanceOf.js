...
export const FN_SELECTOR = "0x00fdd58e";
const FN_INPUTS = [
    {
        type: "address",
        name: "_owner",
 ...
 * ```
 */
export function isBalanceOfSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function encodeBalanceOfParams(options) {
 ...
 * @example
 * ```ts
 * import { encodeBalanceOf } "thirdweb/extensions/erc1155";
 ...
 * ```
 */
export function encodeBalanceOf(options) {
 ...
 * ```
 */
export function decodeBalanceOfResult(result) {
