...
export const FN_SELECTOR = "0xac296b3f";
const FN_INPUTS = [
    {
        type: "uint256",
        name: "_packId",
 ...
 * ```
 */
export function isOpenPackAndClaimRewardsSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function encodeOpenPackAndClaimRewardsParams(options) {
 ...
 * ```
 */
export function encodeOpenPackAndClaimRewards(options) {
 ...
 * ```
 */
export function openPackAndClaimRewards(options) {
