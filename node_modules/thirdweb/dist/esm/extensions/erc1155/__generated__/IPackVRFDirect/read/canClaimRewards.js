...
export const FN_SELECTOR = "0xa9b47a66";
const FN_INPUTS = [
    {
        type: "address",
        name: "_opener",
 ...
 * ```
 */
export function isCanClaimRewardsSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function encodeCanClaimRewardsParams(options) {
 ...
 * ```
 */
export function encodeCanClaimRewards(options) {
    // we do a "manual" concat here to avoid the overhead of the "concatHex" function
    // we can do this because we know the specific formats of the values
    return (FN_SELECTOR +
        encodeCanClaimRewardsParams(options).slice(2));
}
/**
 ...
 * ```
 */
export function decodeCanClaimRewardsResult(result) {
 ...
 * ```
 */
export async function canClaimRewards(options) {
    return readContract({
