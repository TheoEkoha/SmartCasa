...
export const FN_SELECTOR = "0x63b45e2d";
const FN_INPUTS = [];
const FN_OUTPUTS = [
    {
        type: "uint256",
 ...
 * ```
 */
export function isGetBaseURICountSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function decodeGetBaseURICountResult(result) {
 ...
 * ```
 */
export async function getBaseURICount(options) {
    return readContract({
