...
export const FN_SELECTOR = "0x29c49b9b";
const FN_INPUTS = [
    {
        type: "uint256",
        name: "_tokenId",
 ...
 * ```
 */
export function isSetSaleRecipientForTokenSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function encodeSetSaleRecipientForTokenParams(options) {
 ...
 * ```
 */
export function encodeSetSaleRecipientForToken(options) {
 ...
 * ```
 */
export function setSaleRecipientForToken(options) {
