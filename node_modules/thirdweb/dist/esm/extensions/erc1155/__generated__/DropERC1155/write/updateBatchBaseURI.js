...
export const FN_SELECTOR = "0xde903ddd";
const FN_INPUTS = [
    {
        type: "uint256",
        name: "_index",
 ...
 * ```
 */
export function isUpdateBatchBaseURISupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function encodeUpdateBatchBaseURIParams(options) {
 ...
 * ```
 */
export function encodeUpdateBatchBaseURI(options) {
 ...
 * ```
 */
export function updateBatchBaseURI(options) {
