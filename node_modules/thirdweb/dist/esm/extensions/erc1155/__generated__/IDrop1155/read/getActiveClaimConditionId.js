...
export const FN_SELECTOR = "0x5ab063e8";
const FN_INPUTS = [
    {
        type: "uint256",
        name: "_tokenId",
 ...
 * ```
 */
export function isGetActiveClaimConditionIdSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function encodeGetActiveClaimConditionIdParams(options) {
 ...
 * ```
 */
export function encodeGetActiveClaimConditionId(options) {
 ...
 * ```
 */
export function decodeGetActiveClaimConditionIdResult(result) {
 ...
 * ```
 */
export async function getActiveClaimConditionId(options) {
    return readContract({
