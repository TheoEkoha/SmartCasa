...
export const FN_SELECTOR = "0x6b20c454";
const FN_INPUTS = [
    {
        type: "address",
        name: "account",
 ...
 * ```
 */
export function isBurnBatchSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function encodeBurnBatchParams(options) {
 ...
 * ```
 */
export function encodeBurnBatch(options) {
    // we do a "manual" concat here to avoid the overhead of the "concatHex" function
    // we can do this because we know the specific formats of the values
    return (FN_SELECTOR +
        encodeBurnBatchParams(options).slice(2));
}
/**
 ...
 * ```
 */
export function burnBatch(options) {
