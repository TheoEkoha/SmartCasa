...
export const FN_SELECTOR = "0x168fb5c5";
const FN_INPUTS = [
    {
        type: "uint256",
        name: "tokenId",
 ...
 * ```
 */
export function isGetStakeInfoForTokenSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function encodeGetStakeInfoForTokenParams(options) {
 ...
 * ```
 */
export function encodeGetStakeInfoForToken(options) {
 ...
 * ```
 */
export function decodeGetStakeInfoForTokenResult(result) {
 ...
 * ```
 */
export async function getStakeInfoForToken(options) {
    return readContract({
