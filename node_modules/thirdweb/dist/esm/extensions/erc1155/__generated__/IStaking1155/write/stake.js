...
export const FN_SELECTOR = "0x952e68cf";
const FN_INPUTS = [
    {
        type: "uint256",
        name: "tokenId",
 ...
 * ```
 */
export function isStakeSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function encodeStakeParams(options) {
 ...
 * ```
 */
export function encodeStake(options) {
