...
export const FN_SELECTOR = "0xc434dcfe";
const FN_INPUTS = [
    {
        type: "uint256",
        name: "tokenId",
 ...
 * ```
 */
export function isWithdrawSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function encodeWithdrawParams(options) {
 ...
 * ```
 */
export function encodeWithdraw(options) {
