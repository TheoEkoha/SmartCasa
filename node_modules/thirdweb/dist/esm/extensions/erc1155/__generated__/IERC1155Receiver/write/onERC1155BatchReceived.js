...
export const FN_SELECTOR = "0xbc197c81";
const FN_INPUTS = [
    {
        type: "address",
        name: "operator",
 ...
 * ```
 */
export function isOnERC1155BatchReceivedSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function encodeOnERC1155BatchReceivedParams(options) {
 ...
 * ```
 */
export function encodeOnERC1155BatchReceived(options) {
 ...
 * ```
 */
export function onERC1155BatchReceived(options) {
