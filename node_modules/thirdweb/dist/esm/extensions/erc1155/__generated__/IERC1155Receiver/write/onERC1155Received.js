...
export const FN_SELECTOR = "0xf23a6e61";
const FN_INPUTS = [
    {
        type: "address",
        name: "operator",
 ...
 * ```
 */
export function isOnERC1155ReceivedSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function encodeOnERC1155ReceivedParams(options) {
 ...
 * ```
 */
export function encodeOnERC1155Received(options) {
 ...
 * ```
 */
export function onERC1155Received(options) {
