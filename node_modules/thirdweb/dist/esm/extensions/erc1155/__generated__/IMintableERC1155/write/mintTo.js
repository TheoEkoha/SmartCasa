...
export const FN_SELECTOR = "0xb03f4528";
const FN_INPUTS = [
    {
        type: "address",
        name: "to",
 ...
 * ```
 */
export function isMintToSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function encodeMintToParams(options) {
 ...
 * @example
 * ```ts
 * import { encodeMintTo } "thirdweb/extensions/erc1155";
 ...
 * ```
 */
export function encodeMintTo(options) {
