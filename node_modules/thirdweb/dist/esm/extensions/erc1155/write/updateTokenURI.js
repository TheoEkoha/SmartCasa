...
import { setTokenURI, } from "../../erc1155/__generated__/INFTMetadata/write/setTokenURI.js";
/**
 ...
 * ```
 */
export function updateTokenURI(options) {
...
export async function getUpdateTokenParams(options) {
