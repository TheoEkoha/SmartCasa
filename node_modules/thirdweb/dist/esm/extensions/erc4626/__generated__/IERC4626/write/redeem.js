...
export const FN_SELECTOR = "0xba087652";
const FN_INPUTS = [
    {
        name: "shares",
        type: "uint256",
 ...
 * ```
 */
export function isRedeemSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function encodeRedeemParams(options) {
 ...
 * ```
 */
export function encodeRedeem(options) {
