...
export const FN_SELECTOR = "0xef8b30f7";
const FN_INPUTS = [
    {
        name: "assets",
        type: "uint256",
 ...
 * ```
 */
export function isPreviewDepositSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function encodePreviewDepositParams(options) {
 ...
 * ```
 */
export function encodePreviewDeposit(options) {
 ...
 * ```
 */
export function decodePreviewDepositResult(result) {
 ...
 * ```
 */
export async function previewDeposit(options) {
    return readContract({
