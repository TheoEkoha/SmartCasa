...
export const FN_SELECTOR = "0x07a2d13a";
const FN_INPUTS = [
    {
        name: "shares",
        type: "uint256",
 ...
 * ```
 */
export function isConvertToAssetsSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function encodeConvertToAssetsParams(options) {
 ...
 * ```
 */
export function encodeConvertToAssets(options) {
 ...
 * ```
 */
export function decodeConvertToAssetsResult(result) {
 ...
 * ```
 */
export async function convertToAssets(options) {
    return readContract({
