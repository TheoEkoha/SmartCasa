...
export const FN_SELECTOR = "0x38d52e0f";
const FN_INPUTS = [];
const FN_OUTPUTS = [
    {
 ...
 * ```
 */
export function isAssetSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function decodeAssetResult(result) {
 ...
 * ```
 */
export async function asset(options) {
    return readContract({
