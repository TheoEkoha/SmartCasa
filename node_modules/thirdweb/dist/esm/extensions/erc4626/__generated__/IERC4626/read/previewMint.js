...
export const FN_SELECTOR = "0xb3d7f6b9";
const FN_INPUTS = [
    {
        name: "shares",
        type: "uint256",
 ...
 * ```
 */
export function isPreviewMintSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function encodePreviewMintParams(options) {
 ...
 * ```
 */
export function encodePreviewMint(options) {
    // we do a "manual" concat here to avoid the overhead of the "concatHex" function
    // we can do this because we know the specific formats of the values
    return (FN_SELECTOR +
        encodePreviewMintParams(options).slice(2));
}
/**
 ...
 * ```
 */
export function decodePreviewMintResult(result) {
 ...
 * ```
 */
export async function previewMint(options) {
    return readContract({
