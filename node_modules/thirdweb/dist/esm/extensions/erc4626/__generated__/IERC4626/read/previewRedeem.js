...
export const FN_SELECTOR = "0x4cdad506";
const FN_INPUTS = [
    {
        name: "shares",
        type: "uint256",
 ...
 * ```
 */
export function isPreviewRedeemSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function encodePreviewRedeemParams(options) {
 ...
 * ```
 */
export function encodePreviewRedeem(options) {
 ...
 * ```
 */
export function decodePreviewRedeemResult(result) {
 ...
 * ```
 */
export async function previewRedeem(options) {
    return readContract({
