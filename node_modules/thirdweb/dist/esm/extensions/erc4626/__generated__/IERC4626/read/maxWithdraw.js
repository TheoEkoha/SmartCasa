...
export const FN_SELECTOR = "0xce96cb77";
const FN_INPUTS = [
    {
        name: "owner",
        type: "address",
 ...
 * ```
 */
export function isMaxWithdrawSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function encodeMaxWithdrawParams(options) {
 ...
 * ```
 */
export function encodeMaxWithdraw(options) {
 ...
 * ```
 */
export function decodeMaxWithdrawResult(result) {
 ...
 * ```
 */
export async function maxWithdraw(options) {
    return readContract({
