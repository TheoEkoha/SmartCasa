...
export const FN_SELECTOR = "0xc63d75b6";
const FN_INPUTS = [
    {
        name: "receiver",
        type: "address",
 ...
 * ```
 */
export function isMaxMintSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function encodeMaxMintParams(options) {
 ...
 * ```
 */
export function encodeMaxMint(options) {
 ...
 * ```
 */
export function decodeMaxMintResult(result) {
 ...
 * ```
 */
export async function maxMint(options) {
    return readContract({
