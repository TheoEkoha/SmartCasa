...
export const FN_SELECTOR = "0x402d267d";
const FN_INPUTS = [
    {
        name: "receiver",
        type: "address",
 ...
 * ```
 */
export function isMaxDepositSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function encodeMaxDepositParams(options) {
 ...
 * ```
 */
export function encodeMaxDeposit(options) {
 ...
 * ```
 */
export function decodeMaxDepositResult(result) {
 ...
 * ```
 */
export async function maxDeposit(options) {
    return readContract({
