...
export const FN_SELECTOR = "0x0a28a477";
const FN_INPUTS = [
    {
        name: "assets",
        type: "uint256",
 ...
 * ```
 */
export function isPreviewWithdrawSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function encodePreviewWithdrawParams(options) {
 ...
 * ```
 */
export function encodePreviewWithdraw(options) {
 ...
 * ```
 */
export function decodePreviewWithdrawResult(result) {
 ...
 * ```
 */
export async function previewWithdraw(options) {
    return readContract({
