...
export const FN_SELECTOR = "0x01e1d114";
const FN_INPUTS = [];
const FN_OUTPUTS = [
    {
 ...
 * ```
 */
export function isTotalAssetsSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function decodeTotalAssetsResult(result) {
 ...
 * ```
 */
export async function totalAssets(options) {
    return readContract({
