...
export const FN_SELECTOR = "0xc8690233";
const FN_INPUTS = [
    {
        type: "bytes32",
        name: "name",
 ...
 * ```
 */
export function isPubkeySupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function encodePubkeyParams(options) {
 ...
 * ```
 */
export function encodePubkey(options) {
 ...
 * ```
 */
export function decodePubkeyResult(result) {
 ...
 * ```
 */
export async function pubkey(options) {
    return readContract({
