...
export const FN_SELECTOR = "0xbc1c58d1";
const FN_INPUTS = [
    {
        type: "bytes32",
        name: "name",
 ...
 * ```
 */
export function isContenthashSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function encodeContenthashParams(options) {
 ...
 * ```
 */
export function encodeContenthash(options) {
    // we do a "manual" concat here to avoid the overhead of the "concatHex" function
    // we can do this because we know the specific formats of the values
    return (FN_SELECTOR +
        encodeContenthashParams(options).slice(2));
}
/**
 ...
 * ```
 */
export function decodeContenthashResult(result) {
 ...
 * ```
 */
export async function contenthash(options) {
    return readContract({
