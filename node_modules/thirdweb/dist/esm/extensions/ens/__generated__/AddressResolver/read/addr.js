...
export const FN_SELECTOR = "0x3b3b57de";
const FN_INPUTS = [
    {
        type: "bytes32",
        name: "name",
 ...
 * ```
 */
export function isAddrSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function encodeAddrParams(options) {
 ...
 * ```
 */
export function encodeAddr(options) {
    // we do a "manual" concat here to avoid the overhead of the "concatHex" function
    // we can do this because we know the specific formats of the values
    return (FN_SELECTOR +
        encodeAddrParams(options).slice(2));
}
/**
 ...
 * ```
 */
export function decodeAddrResult(result) {
 ...
 * ```
 */
export async function addr(options) {
    return readContract({
