...
export const FN_SELECTOR = "0x6352211e";
const FN_INPUTS = [
    {
        type: "uint256",
        name: "tokenId",
 ...
 * ```
 */
export function isOwnerOfSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function encodeOwnerOfParams(options) {
 ...
 * ```
 */
export function encodeOwnerOf(options) {
 ...
 * ```
 */
export async function ownerOf(options) {
    return readContract({
