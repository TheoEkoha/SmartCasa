...
export const FN_SELECTOR = "0xe6798baa";
const FN_INPUTS = [];
const FN_OUTPUTS = [
    {
        type: "uint256",
 ...
 * ```
 */
export function isStartTokenIdSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function decodeStartTokenIdResult(result) {
 ...
 * ```
 */
export async function startTokenId(options) {
    return readContract({
