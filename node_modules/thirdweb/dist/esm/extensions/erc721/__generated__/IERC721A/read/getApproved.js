...
export const FN_SELECTOR = "0x081812fc";
const FN_INPUTS = [
    {
        type: "uint256",
        name: "tokenId",
 ...
 * ```
 */
export function isGetApprovedSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function encodeGetApprovedParams(options) {
 ...
 * ```
 */
export function encodeGetApproved(options) {
 ...
 * ```
 */
export function decodeGetApprovedResult(result) {
