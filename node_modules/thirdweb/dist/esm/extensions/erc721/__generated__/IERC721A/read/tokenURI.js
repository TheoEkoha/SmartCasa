...
export const FN_SELECTOR = "0xc87b56dd";
const FN_INPUTS = [
    {
        type: "uint256",
        name: "_tokenId",
 ...
 * ```
 */
export function isTokenURISupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function encodeTokenURIParams(options) {
 ...
 * ```
 */
export function encodeTokenURI(options) {
    // we do a "manual" concat here to avoid the overhead of the "concatHex" function
    // we can do this because we know the specific formats of the values
    return (FN_SELECTOR +
        encodeTokenURIParams(options).slice(2));
}
/**
 ...
 * ```
 */
export function decodeTokenURIResult(result) {
 ...
 * ```
 */
export async function tokenURI(options) {
    return readContract({
