...
export const FN_SELECTOR = "0xacd083f8";
const FN_INPUTS = [];
const FN_OUTPUTS = [
    {
        type: "uint256",
 ...
 * ```
 */
export function isNextTokenIdToClaimSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function decodeNextTokenIdToClaimResult(result) {
 ...
 * ```
 */
export async function nextTokenIdToClaim(options) {
    return readContract({
