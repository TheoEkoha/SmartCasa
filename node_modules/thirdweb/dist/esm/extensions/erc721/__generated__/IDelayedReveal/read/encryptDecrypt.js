...
export const FN_SELECTOR = "0xe7150322";
const FN_INPUTS = [
    {
        type: "bytes",
        name: "data",
 ...
 * ```
 */
export function isEncryptDecryptSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function encodeEncryptDecryptParams(options) {
 ...
 * ```
 */
export function encodeEncryptDecrypt(options) {
 ...
 * ```
 */
export function decodeEncryptDecryptResult(result) {
 ...
 * ```
 */
export async function encryptDecrypt(options) {
    return readContract({
