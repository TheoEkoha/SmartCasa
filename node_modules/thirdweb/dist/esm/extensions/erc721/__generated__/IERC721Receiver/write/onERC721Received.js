...
export const FN_SELECTOR = "0x150b7a02";
const FN_INPUTS = [
    {
        type: "address",
        name: "operator",
 ...
 * ```
 */
export function isOnERC721ReceivedSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function encodeOnERC721ReceivedParams(options) {
 ...
 * ```
 */
export function encodeOnERC721Received(options) {
 ...
 * ```
 */
export function onERC721Received(options) {
