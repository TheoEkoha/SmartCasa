...
export const FN_SELECTOR = "0x4f6ccce7";
const FN_INPUTS = [
    {
        type: "uint256",
        name: "_index",
 ...
 * ```
 */
export function isTokenByIndexSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function encodeTokenByIndexParams(options) {
 ...
 * ```
 */
export function encodeTokenByIndex(options) {
 ...
 * ```
 */
export function decodeTokenByIndexResult(result) {
 ...
 * ```
 */
export async function tokenByIndex(options) {
    return readContract({
