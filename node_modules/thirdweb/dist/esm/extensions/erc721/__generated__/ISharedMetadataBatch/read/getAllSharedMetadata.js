...
export const FN_SELECTOR = "0xfc3c2a73";
const FN_INPUTS = [];
const FN_OUTPUTS = [
    {
        type: "tuple[]",
 ...
 * ```
 */
export function isGetAllSharedMetadataSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function decodeGetAllSharedMetadataResult(result) {
 ...
 * ```
 */
export async function getAllSharedMetadata(options) {
    return readContract({
