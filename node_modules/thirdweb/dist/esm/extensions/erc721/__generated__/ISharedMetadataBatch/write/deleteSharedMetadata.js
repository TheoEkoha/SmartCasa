...
export const FN_SELECTOR = "0x1ebb2422";
const FN_INPUTS = [
    {
        type: "bytes32",
        name: "id",
 ...
 * ```
 */
export function isDeleteSharedMetadataSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function encodeDeleteSharedMetadataParams(options) {
 ...
 * ```
 */
export function encodeDeleteSharedMetadata(options) {
 ...
 * ```
 */
export function deleteSharedMetadata(options) {
