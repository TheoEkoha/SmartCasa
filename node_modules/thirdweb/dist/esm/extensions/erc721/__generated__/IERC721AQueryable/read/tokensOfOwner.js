...
export const FN_SELECTOR = "0x8462151c";
const FN_INPUTS = [
    {
        type: "address",
        name: "owner",
 ...
 * ```
 */
export function isTokensOfOwnerSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function encodeTokensOfOwnerParams(options) {
 ...
 * ```
 */
export function encodeTokensOfOwner(options) {
 ...
 * ```
 */
export function decodeTokensOfOwnerResult(result) {
 ...
 * ```
 */
export async function tokensOfOwner(options) {
    return readContract({
