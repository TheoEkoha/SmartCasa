...
export const FN_SELECTOR = "0x16c621e0";
const FN_INPUTS = [
    {
        type: "uint256",
        name: "_amount",
 ...
 * ```
 */
export function isDepositRewardTokensSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function encodeDepositRewardTokensParams(options) {
 ...
 * ```
 */
export function encodeDepositRewardTokens(options) {
 ...
 * ```
 */
export function depositRewardTokens(options) {
