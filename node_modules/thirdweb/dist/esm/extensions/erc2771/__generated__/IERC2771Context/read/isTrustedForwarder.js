...
export const FN_SELECTOR = "0x572b6c05";
const FN_INPUTS = [
    {
        type: "address",
        name: "forwarder",
 ...
 * ```
 */
export function isIsTrustedForwarderSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function encodeIsTrustedForwarderParams(options) {
 ...
 * ```
 */
export function encodeIsTrustedForwarder(options) {
    // we do a "manual" concat here to avoid the overhead of the "concatHex" function
    // we can do this because we know the specific formats of the values
    return (FN_SELECTOR +
        encodeIsTrustedForwarderParams(options).slice(2));
}
/**
 ...
 * ```
 */
export function decodeIsTrustedForwarderResult(result) {
 ...
 * ```
 */
export async function isTrustedForwarder(options) {
    return readContract({
