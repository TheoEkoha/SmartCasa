...
export const FN_SELECTOR = "0x52d1902d";
const FN_INPUTS = [];
const FN_OUTPUTS = [
    {
        type: "bytes32",
 ...
 * ```
 */
export function isProxiableUUIDSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function decodeProxiableUUIDResult(result) {
 ...
 * ```
 */
export async function proxiableUUID(options) {
    return readContract({
