...
export const FN_SELECTOR = "0x514e62fc";
const FN_INPUTS = [
    {
        name: "user",
        type: "address",
 ...
 * ```
 */
export function isHasAnyRoleSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function encodeHasAnyRoleParams(options) {
 ...
 * ```
 */
export function encodeHasAnyRole(options) {
 ...
 * ```
 */
export function decodeHasAnyRoleResult(result) {
