...
export const FN_SELECTOR = "0xcea943ee";
const FN_INPUTS = [];
const FN_OUTPUTS = [
    {
 ...
 * ```
 */
export function isGetSaleConfigSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function decodeGetSaleConfigResult(result) {
 ...
 * ```
 */
export async function getSaleConfig(options) {
    return readContract({
