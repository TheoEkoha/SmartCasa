...
export const FN_SELECTOR = "0x8da5cb5b";
const FN_INPUTS = [];
const FN_OUTPUTS = [
    {
        name: "result",
 ...
 * ```
 */
export function isOwnerSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function decodeOwnerResult(result) {
 ...
 * ```
 */
export async function owner(options) {
    return readContract({
