...
export const FN_SELECTOR = "0x7ce7cf07";
const FN_INPUTS = [
    {
        name: "_to",
        type: "address",
 ...
 * ```
 */
export function isBeforeMintERC20Supported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function encodeBeforeMintERC20Params(options) {
 ...
 * ```
 */
export function encodeBeforeMintERC20(options) {
