...
export const FN_SELECTOR = "0xe6c23512";
const FN_INPUTS = [];
const FN_OUTPUTS = [
    {
        name: "",
 ...
 * ```
 */
export function isGetAllMetadataBatchesSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function decodeGetAllMetadataBatchesResult(result) {
 ...
 * ```
 */
export async function getAllMetadataBatches(options) {
    return readContract({
