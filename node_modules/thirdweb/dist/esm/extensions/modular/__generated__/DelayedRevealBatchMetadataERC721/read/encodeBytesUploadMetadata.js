...
export const FN_SELECTOR = "0x479eac8a";
const FN_INPUTS = [
    {
        name: "encryptedURI",
        type: "bytes",
 ...
 * ```
 */
export function isEncodeBytesUploadMetadataSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function encodeEncodeBytesUploadMetadataParams(options) {
 ...
 * ```
 */
export function encodeEncodeBytesUploadMetadata(options) {
 ...
 * ```
 */
export function decodeEncodeBytesUploadMetadataResult(result) {
 ...
 * ```
 */
export async function encodeBytesUploadMetadata(options) {
    return readContract({
