...
export const FN_SELECTOR = "0xce805642";
const FN_INPUTS = [
    {
        name: "_index",
        type: "uint256",
 ...
 * ```
 */
export function isRevealSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function encodeRevealParams(options) {
 ...
 * ```
 */
export function encodeReveal(options) {
