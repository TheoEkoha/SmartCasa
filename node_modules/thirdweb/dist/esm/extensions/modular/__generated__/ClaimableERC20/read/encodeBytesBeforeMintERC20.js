...
export const FN_SELECTOR = "0xe951ff30";
const FN_INPUTS = [
    {
        name: "params",
        type: "tuple",
 ...
 * ```
 */
export function isEncodeBytesBeforeMintERC20Supported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function encodeEncodeBytesBeforeMintERC20Params(options) {
 ...
 * ```
 */
export function encodeEncodeBytesBeforeMintERC20(options) {
 ...
 * ```
 */
export function decodeEncodeBytesBeforeMintERC20Result(result) {
