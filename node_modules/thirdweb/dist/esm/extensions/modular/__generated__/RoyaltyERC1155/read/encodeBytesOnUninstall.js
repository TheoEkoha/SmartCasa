...
export const FN_SELECTOR = "0xf5b75d2a";
const FN_INPUTS = [];
const FN_OUTPUTS = [
    {
        name: "",
 ...
 * ```
 */
export function isEncodeBytesOnUninstallSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function decodeEncodeBytesOnUninstallResult(result) {
