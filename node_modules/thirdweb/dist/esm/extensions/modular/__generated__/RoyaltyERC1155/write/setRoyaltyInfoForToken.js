...
export const FN_SELECTOR = "0x9bcf7a15";
const FN_INPUTS = [
    {
        name: "_tokenId",
        type: "uint256",
 ...
 * ```
 */
export function isSetRoyaltyInfoForTokenSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function encodeSetRoyaltyInfoForToken(options) {
