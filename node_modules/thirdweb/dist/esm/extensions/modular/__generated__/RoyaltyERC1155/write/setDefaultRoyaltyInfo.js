...
export const FN_SELECTOR = "0x600dd5ea";
const FN_INPUTS = [
    {
 ...
 * ```
 */
export function isSetDefaultRoyaltyInfoSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function encodeSetDefaultRoyaltyInfo(options) {
