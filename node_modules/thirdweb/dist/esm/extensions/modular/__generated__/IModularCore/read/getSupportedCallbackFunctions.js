...
export const FN_SELECTOR = "0xf147db8a";
const FN_INPUTS = [];
const FN_OUTPUTS = [
    {
        name: "",
 ...
 * ```
 */
export function isGetSupportedCallbackFunctionsSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function decodeGetSupportedCallbackFunctionsResult(result) {
