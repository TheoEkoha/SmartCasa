...
export const FN_SELECTOR = "0x4cc157df";
const FN_INPUTS = [
    {
        name: "_tokenId",
        type: "uint256",
 ...
 * ```
 */
export function isGetRoyaltyInfoForTokenSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function encodeGetRoyaltyInfoForTokenParams(options) {
 ...
 * ```
 */
export function encodeGetRoyaltyInfoForToken(options) {
    // we do a "manual" concat here to avoid the overhead of the "concatHex" function
    // we can do this because we know the specific formats of the values
    return (FN_SELECTOR +
        encodeGetRoyaltyInfoForTokenParams(options).slice(2));
}
/**
 ...
 * ```
 */
export function decodeGetRoyaltyInfoForTokenResult(result) {
 ...
 * ```
 */
export async function getRoyaltyInfoForToken(options) {
    return readContract({
