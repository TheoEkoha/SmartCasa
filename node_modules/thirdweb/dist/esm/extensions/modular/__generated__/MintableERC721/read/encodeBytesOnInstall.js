...
export const FN_SELECTOR = "0x5d4c0b89";
const FN_INPUTS = [
    {
 ...
 * ```
 */
export function isEncodeBytesOnInstallSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function encodeEncodeBytesOnInstallParams(options) {
 ...
 * ```
 */
export function encodeEncodeBytesOnInstall(options) {
 ...
 * ```
 */
export function decodeEncodeBytesOnInstallResult(result) {
