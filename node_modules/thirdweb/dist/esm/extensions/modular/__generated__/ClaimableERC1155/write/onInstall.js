...
export const FN_SELECTOR = "0x6d61fe70";
const FN_INPUTS = [
    {
        name: "data",
        type: "bytes",
 ...
 * ```
 */
export function isOnInstallSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function encodeOnInstallParams(options) {
 ...
 * ```
 */
export function encodeOnInstall(options) {
