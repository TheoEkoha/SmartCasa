...
export const FN_SELECTOR = "0xf04e283e";
const FN_INPUTS = [
    {
        name: "pendingOwner",
        type: "address",
 ...
 * ```
 */
export function isCompleteOwnershipHandoverSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function encodeCompleteOwnershipHandoverParams(options) {
 ...
 * ```
 */
export function encodeCompleteOwnershipHandover(options) {
