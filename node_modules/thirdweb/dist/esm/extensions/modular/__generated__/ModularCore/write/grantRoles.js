...
export const FN_SELECTOR = "0x1c10893f";
const FN_INPUTS = [
    {
        name: "user",
        type: "address",
 ...
 * ```
 */
export function isGrantRolesSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function encodeGrantRolesParams(options) {
 ...
 * ```
 */
export function encodeGrantRoles(options) {
