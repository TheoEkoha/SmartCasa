...
export const FN_SELECTOR = "0x183a4f6e";
const FN_INPUTS = [
    {
        name: "roles",
        type: "uint256",
 ...
 * ```
 */
export function isRenounceRolesSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function encodeRenounceRolesParams(options) {
 ...
 * ```
 */
export function encodeRenounceRoles(options) {
