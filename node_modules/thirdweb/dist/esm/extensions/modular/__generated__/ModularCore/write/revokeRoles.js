...
export const FN_SELECTOR = "0x4a4ee7b1";
const FN_INPUTS = [
    {
        name: "user",
        type: "address",
 ...
 * ```
 */
export function isRevokeRolesSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function encodeRevokeRolesParams(options) {
 ...
 * ```
 */
export function encodeRevokeRoles(options) {
