...
export const FN_SELECTOR = "0x1cd64df4";
const FN_INPUTS = [
    {
        name: "user",
        type: "address",
 ...
 * ```
 */
export function isHasAllRolesSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function encodeHasAllRolesParams(options) {
 ...
 * ```
 */
export function encodeHasAllRoles(options) {
 ...
 * ```
 */
export function decodeHasAllRolesResult(result) {
