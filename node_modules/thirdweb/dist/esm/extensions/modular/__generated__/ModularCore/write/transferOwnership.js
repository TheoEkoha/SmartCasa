...
export const FN_SELECTOR = "0xf2fde38b";
const FN_INPUTS = [
    {
        name: "newOwner",
        type: "address",
 ...
 * ```
 */
export function isTransferOwnershipSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function encodeTransferOwnershipParams(options) {
 ...
 * ```
 */
export function encodeTransferOwnership(options) {
