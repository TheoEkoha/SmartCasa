...
export const FN_SELECTOR = "0xfee81cf4";
const FN_INPUTS = [
    {
        name: "pendingOwner",
        type: "address",
 ...
 * ```
 */
export function isOwnershipHandoverExpiresAtSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function encodeOwnershipHandoverExpiresAtParams(options) {
 ...
 * ```
 */
export function encodeOwnershipHandoverExpiresAt(options) {
 ...
 * ```
 */
export function decodeOwnershipHandoverExpiresAtResult(result) {
