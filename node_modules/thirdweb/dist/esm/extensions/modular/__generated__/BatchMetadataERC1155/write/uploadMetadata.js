...
export const FN_SELECTOR = "0xbfa2f36e";
const FN_INPUTS = [
    {
        name: "_amount",
        type: "uint256",
 ...
 * ```
 */
export function isUploadMetadataSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function encodeUploadMetadataParams(options) {
 ...
 * ```
 */
export function encodeUploadMetadata(options) {
