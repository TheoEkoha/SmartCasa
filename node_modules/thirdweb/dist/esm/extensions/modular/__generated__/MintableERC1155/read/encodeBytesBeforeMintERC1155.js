...
export const FN_SELECTOR = "0xa4c6930f";
const FN_INPUTS = [
    {
        name: "params",
        type: "tuple",
 ...
 * ```
 */
export function isEncodeBytesBeforeMintERC1155Supported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function encodeEncodeBytesBeforeMintERC1155Params(options) {
 ...
 * ```
 */
export function encodeEncodeBytesBeforeMintERC1155(options) {
 ...
 * ```
 */
export function decodeEncodeBytesBeforeMintERC1155Result(result) {
 ...
 * ```
 */
export async function encodeBytesBeforeMintERC1155(options) {
    return readContract({
