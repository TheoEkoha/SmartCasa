...
export const FN_SELECTOR = "0x1e1dcb18";
const FN_INPUTS = [
    {
        name: "_to",
        type: "address",
 ...
 * ```
 */
export function isBeforeMintERC1155Supported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function encodeBeforeMintERC1155Params(options) {
 ...
 * ```
 */
export function encodeBeforeMintERC1155(options) {
 ...
 * ```
 */
export function beforeMintERC1155(options) {
