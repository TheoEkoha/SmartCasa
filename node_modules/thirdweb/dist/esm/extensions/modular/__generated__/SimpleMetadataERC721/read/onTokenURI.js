...
export const FN_SELECTOR = "0xcfc0cb96";
const FN_INPUTS = [
    {
        name: "_id",
        type: "uint256",
 ...
 * ```
 */
export function isOnTokenURISupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function encodeOnTokenURIParams(options) {
 ...
 * ```
 */
export function encodeOnTokenURI(options) {
 ...
 * ```
 */
export function decodeOnTokenURIResult(result) {
 ...
 * ```
 */
export async function onTokenURI(options) {
    return readContract({
