...
export const FN_SELECTOR = "0x95f5c120";
const FN_INPUTS = [
    {
        type: "address",
        name: "tokenAddress",
 ...
 * ```
 */
export function isTokenMerkleRootSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function encodeTokenMerkleRootParams(options) {
 ...
 * ```
 */
export function encodeTokenMerkleRoot(options) {
 ...
 * ```
 */
export function decodeTokenMerkleRootResult(result) {
 ...
 * ```
 */
export async function tokenMerkleRoot(options) {
    return readContract({
