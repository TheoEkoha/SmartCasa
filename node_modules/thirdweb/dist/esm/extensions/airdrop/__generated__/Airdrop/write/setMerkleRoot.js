...
export const FN_SELECTOR = "0x8259a87b";
const FN_INPUTS = [
    {
        name: "_token",
        type: "address",
 ...
 * ```
 */
export function isSetMerkleRootSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function encodeSetMerkleRootParams(options) {
 ...
 * ```
 */
export function encodeSetMerkleRoot(options) {
 ...
 * ```
 */
export function setMerkleRoot(options) {
