...
export const FN_SELECTOR = "0x3dc28d49";
const FN_INPUTS = [
    {
        type: "address",
        name: "tokenAddress",
 ...
 * ```
 */
export function isTokenConditionIdSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function encodeTokenConditionIdParams(options) {
 ...
 * ```
 */
export function encodeTokenConditionId(options) {
 ...
 * ```
 */
export function decodeTokenConditionIdResult(result) {
 ...
 * ```
 */
export async function tokenConditionId(options) {
    return readContract({
