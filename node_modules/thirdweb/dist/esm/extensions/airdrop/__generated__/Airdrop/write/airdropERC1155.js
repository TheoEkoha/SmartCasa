...
export const FN_SELECTOR = "0x2d89e38b";
const FN_INPUTS = [
    {
        name: "_tokenAddress",
        type: "address",
 ...
 * ```
 */
export function isAirdropERC1155Supported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function encodeAirdropERC1155Params(options) {
 ...
 * ```
 */
export function encodeAirdropERC1155(options) {
 ...
 * ```
 */
export function airdropERC1155(options) {
