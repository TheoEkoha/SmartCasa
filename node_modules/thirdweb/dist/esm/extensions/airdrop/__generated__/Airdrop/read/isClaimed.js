...
export const FN_SELECTOR = "0xd12acf73";
const FN_INPUTS = [
    {
        name: "_receiver",
        type: "address",
 ...
 * ```
 */
export function isIsClaimedSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function encodeIsClaimedParams(options) {
 ...
 * ```
 */
export function encodeIsClaimed(options) {
 ...
 * ```
 */
export function decodeIsClaimedResult(result) {
 ...
 * ```
 */
export async function isClaimed(options) {
    return readContract({
