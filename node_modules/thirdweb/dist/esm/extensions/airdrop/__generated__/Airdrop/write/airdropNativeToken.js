...
export const FN_SELECTOR = "0x0d5818f7";
const FN_INPUTS = [
    {
        name: "_contents",
        type: "tuple[]",
 ...
 * ```
 */
export function isAirdropNativeTokenSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function encodeAirdropNativeTokenParams(options) {
 ...
 * ```
 */
export function encodeAirdropNativeToken(options) {
 ...
 * ```
 */
export function airdropNativeToken(options) {
