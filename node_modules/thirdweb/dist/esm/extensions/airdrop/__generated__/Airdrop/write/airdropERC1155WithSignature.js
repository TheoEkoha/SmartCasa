...
export const FN_SELECTOR = "0xd0d4afd6";
const FN_INPUTS = [
    {
        name: "req",
        type: "tuple",
 ...
 * ```
 */
export function isAirdropERC1155WithSignatureSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function encodeAirdropERC1155WithSignatureParams(options) {
 ...
 * ```
 */
export function encodeAirdropERC1155WithSignature(options) {
 ...
 * ```
 */
export function airdropERC1155WithSignature(options) {
