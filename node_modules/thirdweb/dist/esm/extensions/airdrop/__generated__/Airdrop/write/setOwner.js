...
export const FN_SELECTOR = "0x13af4035";
const FN_INPUTS = [
    {
        name: "_newOwner",
        type: "address",
 ...
 * ```
 */
export function isSetOwnerSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function encodeSetOwnerParams(options) {
 ...
 * ```
 */
export function encodeSetOwner(options) {
 ...
 * ```
 */
export function setOwner(options) {
