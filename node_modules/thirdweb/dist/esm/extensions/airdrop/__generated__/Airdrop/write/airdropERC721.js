...
export const FN_SELECTOR = "0x6d582ebe";
const FN_INPUTS = [
    {
        name: "_tokenAddress",
        type: "address",
 ...
 * ```
 */
export function isAirdropERC721Supported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function encodeAirdropERC721Params(options) {
 ...
 * ```
 */
export function encodeAirdropERC721(options) {
 ...
 * ```
 */
export function airdropERC721(options) {
