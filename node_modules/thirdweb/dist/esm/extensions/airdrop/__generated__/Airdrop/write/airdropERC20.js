...
export const FN_SELECTOR = "0x56b0b449";
const FN_INPUTS = [
    {
        name: "_tokenAddress",
        type: "address",
 ...
 * ```
 */
export function isAirdropERC20Supported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function encodeAirdropERC20Params(options) {
 ...
 * ```
 */
export function encodeAirdropERC20(options) {
 ...
 * ```
 */
export function airdropERC20(options) {
