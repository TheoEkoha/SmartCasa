...
export const FN_SELECTOR = "0x1290be10";
const FN_INPUTS = [
    {
        name: "_token",
        type: "address",
 ...
 * ```
 */
export function isClaimERC721Supported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function encodeClaimERC721Params(options) {
 ...
 * ```
 */
export function encodeClaimERC721(options) {
