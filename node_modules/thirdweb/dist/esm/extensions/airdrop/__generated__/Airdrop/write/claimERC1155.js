...
export const FN_SELECTOR = "0xc6fa26ab";
const FN_INPUTS = [
    {
        name: "_token",
        type: "address",
 ...
 * ```
 */
export function isClaimERC1155Supported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function encodeClaimERC1155Params(options) {
 ...
 * ```
 */
export function encodeClaimERC1155(options) {
 ...
 * ```
 */
export function claimERC1155(options) {
