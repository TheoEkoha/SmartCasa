...
export const FN_SELECTOR = "0xb654a6f3";
const FN_INPUTS = [
    {
        name: "req",
        type: "tuple",
 ...
 * ```
 */
export function isAirdropERC721WithSignatureSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function encodeAirdropERC721WithSignatureParams(options) {
 ...
 * ```
 */
export function encodeAirdropERC721WithSignature(options) {
 ...
 * ```
 */
export function airdropERC721WithSignature(options) {
