...
export const FN_SELECTOR = "0xecf3d3d4";
const FN_INPUTS = [
    {
        name: "_token",
        type: "address",
 ...
 * ```
 */
export function isClaimERC20Supported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function encodeClaimERC20Params(options) {
 ...
 * ```
 */
export function encodeClaimERC20(options) {
 ...
 * ```
 */
export function claimERC20(options) {
