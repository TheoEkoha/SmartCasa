 ...
 * ```
 */
export function isGetRoleMemberSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function encodeGetRoleMemberParams(options) {
 ...
 * ```
 */
export function encodeGetRoleMember(options) {
    // we do a "manual" concat here to avoid the overhead of the "concatHex" function
    // we can do this because we know the specific formats of the values
    return (FN_SELECTOR +
        encodeGetRoleMemberParams(options).slice(2));
}
/**
 ...
 * ```
 */
export function decodeGetRoleMemberResult(result) {
 ...
 * ```
 */
export async function getRoleMember(options) {
    return readContract({
