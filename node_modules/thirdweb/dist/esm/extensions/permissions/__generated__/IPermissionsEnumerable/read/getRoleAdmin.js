...
export const FN_SELECTOR = "0x248a9ca3";
const FN_INPUTS = [
    {
        type: "bytes32",
        name: "role",
 ...
 * ```
 */
export function isGetRoleAdminSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function encodeGetRoleAdminParams(options) {
 ...
 * ```
 */
export function encodeGetRoleAdmin(options) {
 ...
 * ```
 */
export function decodeGetRoleAdminResult(result) {
 ...
 * ```
 */
export async function getRoleAdmin(options) {
    return readContract({
