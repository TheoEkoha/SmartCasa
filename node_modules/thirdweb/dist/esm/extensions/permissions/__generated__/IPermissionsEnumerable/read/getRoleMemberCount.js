...
export const FN_SELECTOR = "0xca15c873";
const FN_INPUTS = [
    {
        type: "bytes32",
        name: "role",
 ...
 * ```
 */
export function isGetRoleMemberCountSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function encodeGetRoleMemberCountParams(options) {
 ...
 * ```
 */
export function encodeGetRoleMemberCount(options) {
 ...
 * ```
 */
export function decodeGetRoleMemberCountResult(result) {
 ...
 * ```
 */
export async function getRoleMemberCount(options) {
    return readContract({
