...
export const FN_SELECTOR = "0x36568abe";
const FN_INPUTS = [
    {
        type: "bytes32",
        name: "role",
 ...
 * ```
 */
export function isRenounceRoleSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function encodeRenounceRoleParams(options) {
 ...
 * ```
 */
export function encodeRenounceRole(options) {
 ...
 * ```
 */
export function renounceRole(options) {
