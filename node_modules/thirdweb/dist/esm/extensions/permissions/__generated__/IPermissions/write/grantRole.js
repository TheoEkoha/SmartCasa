...
export const FN_SELECTOR = "0x2f2ff15d";
const FN_INPUTS = [
    {
        type: "bytes32",
        name: "role",
 ...
 * ```
 */
export function isGrantRoleSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function encodeGrantRoleParams(options) {
 ...
 * ```
 */
export function encodeGrantRole(options) {
