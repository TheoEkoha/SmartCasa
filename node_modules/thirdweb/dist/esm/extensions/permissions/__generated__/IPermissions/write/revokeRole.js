...
export const FN_SELECTOR = "0xd547741f";
const FN_INPUTS = [
    {
        type: "bytes32",
        name: "role",
 ...
 * ```
 */
export function isRevokeRoleSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function encodeRevokeRoleParams(options) {
 ...
 * ```
 */
export function encodeRevokeRole(options) {
