...
export const FN_SELECTOR = "0xf533b802";
const FN_INPUTS = [
    {
        type: "address",
        name: "tokenAddress",
 ...
 * ```
 */
export function isGetRoyaltySupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function encodeGetRoyaltyParams(options) {
 ...
 * ```
 */
export function encodeGetRoyalty(options) {
 ...
 * ```
 */
export function getRoyalty(options) {
