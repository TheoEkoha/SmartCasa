...
export const FN_SELECTOR = "0x21ede032";
const FN_INPUTS = [
    {
        type: "address",
 ...
 * ```
 */
export function isSetRoyaltyEngineSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function encodeSetRoyaltyEngineParams(options) {
 ...
 * ```
 */
export function encodeSetRoyaltyEngine(options) {
 ...
 * ```
 */
export function setRoyaltyEngine(options) {
