...
export const FN_SELECTOR = "0xe8a3d485";
const FN_INPUTS = [];
const FN_OUTPUTS = [
    {
        type: "string",
 ...
 * ```
 */
export function isContractURISupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function decodeContractURIResult(result) {
 ...
 * ```
 */
export async function contractURI(options) {
    return readContract({
