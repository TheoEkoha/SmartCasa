...
export const FN_SELECTOR = "0x6f4f2837";
const FN_INPUTS = [
    {
        type: "address",
        name: "_saleRecipient",
 ...
 * ```
 */
export function isSetPrimarySaleRecipientSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function encodeSetPrimarySaleRecipientParams(options) {
 ...
 * ```
 */
export function encodeSetPrimarySaleRecipient(options) {
 ...
 * ```
 */
export function setPrimarySaleRecipient(options) {
