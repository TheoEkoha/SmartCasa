...
export const FN_SELECTOR = "0x079fe40e";
const FN_INPUTS = [];
const FN_OUTPUTS = [
    {
        type: "address",
 ...
 * ```
 */
export function isPrimarySaleRecipientSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function decodePrimarySaleRecipientResult(result) {
 ...
 * ```
 */
export async function primarySaleRecipient(options) {
    return readContract({
