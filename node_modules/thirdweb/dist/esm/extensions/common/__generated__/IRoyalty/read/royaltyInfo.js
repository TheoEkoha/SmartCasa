...
export const FN_SELECTOR = "0x2a55205a";
const FN_INPUTS = [
    {
        type: "uint256",
        name: "tokenId",
 ...
 * ```
 */
export function isRoyaltyInfoSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function encodeRoyaltyInfoParams(options) {
 ...
 * ```
 */
export function encodeRoyaltyInfo(options) {
 ...
 * ```
 */
export function decodeRoyaltyInfoResult(result) {
 ...
 * ```
 */
export async function royaltyInfo(options) {
    return readContract({
