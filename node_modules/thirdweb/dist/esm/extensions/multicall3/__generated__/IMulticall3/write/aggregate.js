...
export const FN_SELECTOR = "0x252dba42";
const FN_INPUTS = [
    {
        components: [
            {
 ...
 * ```
 */
export function isAggregateSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function encodeAggregateParams(options) {
 ...
 * ```
 */
export function encodeAggregate(options) {
