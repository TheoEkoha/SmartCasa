...
export const FN_SELECTOR = "0x82ad56cb";
const FN_INPUTS = [
    {
        components: [
            {
 ...
 * ```
 */
export function isAggregate3Supported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function encodeAggregate3Params(options) {
 ...
 * ```
 */
export function encodeAggregate3(options) {
 ...
 * ```
 */
export function aggregate3(options) {
