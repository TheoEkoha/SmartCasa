...
export const FN_SELECTOR = "0x3408e470";
const FN_INPUTS = [];
const FN_OUTPUTS = [
    {
 ...
 * ```
 */
export function isGetChainIdSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function decodeGetChainIdResult(result) {
 ...
 * ```
 */
export async function getChainId(options) {
    return readContract({
