...
export const FN_SELECTOR = "0x174dea71";
const FN_INPUTS = [
    {
        components: [
            {
 ...
 * ```
 */
export function isAggregate3ValueSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function encodeAggregate3ValueParams(options) {
 ...
 * ```
 */
export function encodeAggregate3Value(options) {
 ...
 * ```
 */
export function aggregate3Value(options) {
