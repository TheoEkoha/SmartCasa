...
export const FN_SELECTOR = "0x0f28c97d";
const FN_INPUTS = [];
const FN_OUTPUTS = [
    {
 ...
 * ```
 */
export function isGetCurrentBlockTimestampSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function decodeGetCurrentBlockTimestampResult(result) {
 ...
 * ```
 */
export async function getCurrentBlockTimestamp(options) {
    return readContract({
