...
export const FN_SELECTOR = "0x72425d9d";
const FN_INPUTS = [];
const FN_OUTPUTS = [
    {
 ...
 * ```
 */
export function isGetCurrentBlockDifficultySupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function decodeGetCurrentBlockDifficultyResult(result) {
 ...
 * ```
 */
export async function getCurrentBlockDifficulty(options) {
    return readContract({
