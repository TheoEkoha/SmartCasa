...
export const FN_SELECTOR = "0xc3077fa9";
const FN_INPUTS = [
    {
        components: [
            {
 ...
 * ```
 */
export function isBlockAndAggregateSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function encodeBlockAndAggregateParams(options) {
 ...
 * ```
 */
export function encodeBlockAndAggregate(options) {
 ...
 * ```
 */
export function blockAndAggregate(options) {
