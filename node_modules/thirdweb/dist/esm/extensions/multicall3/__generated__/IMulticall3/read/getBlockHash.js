...
export const FN_SELECTOR = "0xee82ac5e";
const FN_INPUTS = [
    {
 ...
 * ```
 */
export function isGetBlockHashSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function encodeGetBlockHashParams(options) {
 ...
 * ```
 */
export function encodeGetBlockHash(options) {
 ...
 * ```
 */
export function decodeGetBlockHashResult(result) {
 ...
 * ```
 */
export async function getBlockHash(options) {
    return readContract({
