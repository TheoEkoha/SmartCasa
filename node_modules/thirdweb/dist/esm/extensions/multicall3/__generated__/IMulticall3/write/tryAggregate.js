...
export const FN_SELECTOR = "0xbce38bd7";
const FN_INPUTS = [
    {
        internalType: "bool",
        name: "requireSuccess",
 ...
 * ```
 */
export function isTryAggregateSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function encodeTryAggregateParams(options) {
 ...
 * ```
 */
export function encodeTryAggregate(options) {
 ...
 * ```
 */
export function tryAggregate(options) {
