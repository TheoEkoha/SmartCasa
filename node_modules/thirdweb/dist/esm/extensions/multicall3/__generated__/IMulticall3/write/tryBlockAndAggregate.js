...
export const FN_SELECTOR = "0x399542e9";
const FN_INPUTS = [
    {
        internalType: "bool",
        name: "requireSuccess",
 ...
 * ```
 */
export function isTryBlockAndAggregateSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function encodeTryBlockAndAggregateParams(options) {
 ...
 * ```
 */
export function encodeTryBlockAndAggregate(options) {
 ...
 * ```
 */
export function tryBlockAndAggregate(options) {
