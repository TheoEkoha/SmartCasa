...
export const FN_SELECTOR = "0x3e64a696";
const FN_INPUTS = [];
const FN_OUTPUTS = [
    {
 ...
 * ```
 */
export function isGetBasefeeSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function decodeGetBasefeeResult(result) {
 ...
 * ```
 */
export async function getBasefee(options) {
    return readContract({
