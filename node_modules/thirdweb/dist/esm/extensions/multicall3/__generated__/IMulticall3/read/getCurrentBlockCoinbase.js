...
export const FN_SELECTOR = "0xa8b0574e";
const FN_INPUTS = [];
const FN_OUTPUTS = [
    {
 ...
 * ```
 */
export function isGetCurrentBlockCoinbaseSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function decodeGetCurrentBlockCoinbaseResult(result) {
 ...
 * ```
 */
export async function getCurrentBlockCoinbase(options) {
    return readContract({
