...
export const FN_SELECTOR = "0x27e86d6e";
const FN_INPUTS = [];
const FN_OUTPUTS = [
    {
 ...
 * ```
 */
export function isGetLastBlockHashSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function decodeGetLastBlockHashResult(result) {
 ...
 * ```
 */
export async function getLastBlockHash(options) {
    return readContract({
