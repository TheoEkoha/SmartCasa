...
export const FN_SELECTOR = "0x42cbb15c";
const FN_INPUTS = [];
const FN_OUTPUTS = [
    {
 ...
 * ```
 */
export function isGetBlockNumberSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function decodeGetBlockNumberResult(result) {
 ...
 * ```
 */
export async function getBlockNumber(options) {
    return readContract({
