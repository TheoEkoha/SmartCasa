...
export const FN_SELECTOR = "0x4d2301cc";
const FN_INPUTS = [
    {
 ...
 * ```
 */
export function isGetEthBalanceSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function encodeGetEthBalanceParams(options) {
 ...
 * ```
 */
export function encodeGetEthBalance(options) {
 ...
 * ```
 */
export function decodeGetEthBalanceResult(result) {
 ...
 * ```
 */
export async function getEthBalance(options) {
    return readContract({
