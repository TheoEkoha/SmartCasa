...
export const FN_SELECTOR = "0x86d516e8";
const FN_INPUTS = [];
const FN_OUTPUTS = [
    {
 ...
 * ```
 */
export function isGetCurrentBlockGasLimitSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function decodeGetCurrentBlockGasLimitResult(result) {
 ...
 * ```
 */
export async function getCurrentBlockGasLimit(options) {
    return readContract({
