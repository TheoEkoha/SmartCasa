...
export const FN_SELECTOR = "0xf21b24d7";
const FN_INPUTS = [
    {
        type: "address",
 ...
 * ```
 */
export function isIsErc20CurrencyRegisteredSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function encodeIsErc20CurrencyRegisteredParams(options) {
 ...
 * ```
 */
export function encodeIsErc20CurrencyRegistered(options) {
 ...
 * ```
 */
export function decodeIsErc20CurrencyRegisteredResult(result) {
 ...
 * ```
 */
export async function isErc20CurrencyRegistered(options) {
    return readContract({
