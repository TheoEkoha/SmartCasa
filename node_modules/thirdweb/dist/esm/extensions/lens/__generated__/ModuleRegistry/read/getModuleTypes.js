...
export const FN_SELECTOR = "0xc5dcd896";
const FN_INPUTS = [
    {
        type: "address",
        name: "moduleAddress",
 ...
 * ```
 */
export function isGetModuleTypesSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function encodeGetModuleTypesParams(options) {
 ...
 * ```
 */
export function encodeGetModuleTypes(options) {
 ...
 * ```
 */
export function decodeGetModuleTypesResult(result) {
 ...
 * ```
 */
export async function getModuleTypes(options) {
    return readContract({
