...
export const FN_SELECTOR = "0xc2b62fdd";
const FN_INPUTS = [
    {
        type: "address",
        name: "moduleAddress",
 ...
 * ```
 */
export function isIsModuleRegisteredAsSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function encodeIsModuleRegisteredAsParams(options) {
 ...
 * ```
 */
export function encodeIsModuleRegisteredAs(options) {
 ...
 * ```
 */
export function decodeIsModuleRegisteredAsResult(result) {
 ...
 * ```
 */
export async function isModuleRegisteredAs(options) {
    return readContract({
