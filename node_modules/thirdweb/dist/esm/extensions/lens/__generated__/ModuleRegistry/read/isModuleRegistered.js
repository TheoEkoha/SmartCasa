...
export const FN_SELECTOR = "0x1c5ebe2f";
const FN_INPUTS = [
    {
        type: "address",
        name: "moduleAddress",
 ...
 * ```
 */
export function isIsModuleRegisteredSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function encodeIsModuleRegisteredParams(options) {
 ...
 * ```
 */
export function encodeIsModuleRegistered(options) {
 ...
 * ```
 */
export function decodeIsModuleRegisteredResult(result) {
 ...
 * ```
 */
export async function isModuleRegistered(options) {
    return readContract({
