...
export const FN_SELECTOR = "0x1e7663bc";
const FN_INPUTS = [
    {
        type: "string",
        name: "localName",
 ...
 * ```
 */
export function isGetTokenIdSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function encodeGetTokenIdParams(options) {
 ...
 * ```
 */
export function encodeGetTokenId(options) {
 ...
 * ```
 */
export function decodeGetTokenIdResult(result) {
 ...
 * ```
 */
export async function getTokenId(options) {
    return readContract({
