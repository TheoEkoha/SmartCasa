...
export const FN_SELECTOR = "0x35eb3cb9";
const FN_INPUTS = [];
const FN_OUTPUTS = [
    {
        type: "address",
 ...
 * ```
 */
export function isGetHandleTokenURIContractSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function decodeGetHandleTokenURIContractResult(result) {
 ...
 * ```
 */
export async function getHandleTokenURIContract(options) {
    return readContract({
