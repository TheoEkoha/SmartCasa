...
export const FN_SELECTOR = "0xec81d194";
const FN_INPUTS = [
    {
        type: "uint256",
        name: "tokenId",
 ...
 * ```
 */
export function isGetHandleSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function encodeGetHandleParams(options) {
 ...
 * ```
 */
export function encodeGetHandle(options) {
 ...
 * ```
 */
export function decodeGetHandleResult(result) {
 ...
 * ```
 */
export async function getHandle(options) {
    return readContract({
