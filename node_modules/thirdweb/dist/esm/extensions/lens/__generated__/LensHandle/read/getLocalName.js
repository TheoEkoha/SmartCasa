...
export const FN_SELECTOR = "0x4985e504";
const FN_INPUTS = [
    {
        type: "uint256",
        name: "tokenId",
 ...
 * ```
 */
export function isGetLocalNameSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function encodeGetLocalNameParams(options) {
 ...
 * ```
 */
export function encodeGetLocalName(options) {
 ...
 * ```
 */
export function decodeGetLocalNameResult(result) {
 ...
 * ```
 */
export async function getLocalName(options) {
    return readContract({
