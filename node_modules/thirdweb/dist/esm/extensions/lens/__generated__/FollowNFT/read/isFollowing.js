...
export const FN_SELECTOR = "0x4d71688d";
const FN_INPUTS = [
    {
        type: "uint256",
 ...
 * ```
 */
export function isIsFollowingSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function encodeIsFollowingParams(options) {
 ...
 * ```
 */
export function encodeIsFollowing(options) {
 ...
 * ```
 */
export function decodeIsFollowingResult(result) {
 ...
 * ```
 */
export async function isFollowing(options) {
    return readContract({
