...
export const FN_SELECTOR = "0x11c763d6";
const FN_INPUTS = [
    {
        type: "uint256",
 ...
 * ```
 */
export function isGetFollowTokenIdSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function encodeGetFollowTokenIdParams(options) {
 ...
 * ```
 */
export function encodeGetFollowTokenId(options) {
 ...
 * ```
 */
export function decodeGetFollowTokenIdResult(result) {
 ...
 * ```
 */
export async function getFollowTokenId(options) {
    return readContract({
