...
export const FN_SELECTOR = "0x3543a277";
const FN_INPUTS = [
    {
        type: "uint256",
        name: "followTokenId",
 ...
 * ```
 */
export function isGetFollowTimestampSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function encodeGetFollowTimestampParams(options) {
 ...
 * ```
 */
export function encodeGetFollowTimestamp(options) {
 ...
 * ```
 */
export function decodeGetFollowTimestampResult(result) {
 ...
 * ```
 */
export async function getFollowTimestamp(options) {
    return readContract({
