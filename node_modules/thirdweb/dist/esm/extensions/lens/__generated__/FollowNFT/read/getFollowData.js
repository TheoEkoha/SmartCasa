...
export const FN_SELECTOR = "0xd6cbec5d";
const FN_INPUTS = [
    {
        type: "uint256",
        name: "followTokenId",
 ...
 * ```
 */
export function isGetFollowDataSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function encodeGetFollowDataParams(options) {
 ...
 * ```
 */
export function encodeGetFollowData(options) {
 ...
 * ```
 */
export function decodeGetFollowDataResult(result) {
 ...
 * ```
 */
export async function getFollowData(options) {
    return readContract({
