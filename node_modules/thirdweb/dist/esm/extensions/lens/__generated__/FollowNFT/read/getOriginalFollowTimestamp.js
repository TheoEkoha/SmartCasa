...
export const FN_SELECTOR = "0xd1b34934";
const FN_INPUTS = [
    {
        type: "uint256",
        name: "followTokenId",
 ...
 * ```
 */
export function isGetOriginalFollowTimestampSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function encodeGetOriginalFollowTimestampParams(options) {
 ...
 * ```
 */
export function encodeGetOriginalFollowTimestamp(options) {
 ...
 * ```
 */
export function decodeGetOriginalFollowTimestampResult(result) {
 ...
 * ```
 */
export async function getOriginalFollowTimestamp(options) {
    return readContract({
