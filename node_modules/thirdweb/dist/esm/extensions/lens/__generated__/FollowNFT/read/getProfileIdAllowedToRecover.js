...
export const FN_SELECTOR = "0x2af1544f";
const FN_INPUTS = [
    {
        type: "uint256",
        name: "followTokenId",
 ...
 * ```
 */
export function isGetProfileIdAllowedToRecoverSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function encodeGetProfileIdAllowedToRecoverParams(options) {
 ...
 * ```
 */
export function encodeGetProfileIdAllowedToRecover(options) {
 ...
 * ```
 */
export function decodeGetProfileIdAllowedToRecoverResult(result) {
 ...
 * ```
 */
export async function getProfileIdAllowedToRecover(options) {
    return readContract({
