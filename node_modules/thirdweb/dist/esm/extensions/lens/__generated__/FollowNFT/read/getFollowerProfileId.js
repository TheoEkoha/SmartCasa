...
export const FN_SELECTOR = "0x886a65c3";
const FN_INPUTS = [
    {
        type: "uint256",
        name: "followTokenId",
 ...
 * ```
 */
export function isGetFollowerProfileIdSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function encodeGetFollowerProfileIdParams(options) {
 ...
 * ```
 */
export function encodeGetFollowerProfileId(options) {
 ...
 * ```
 */
export function decodeGetFollowerProfileIdResult(result) {
 ...
 * ```
 */
export async function getFollowerProfileId(options) {
    return readContract({
