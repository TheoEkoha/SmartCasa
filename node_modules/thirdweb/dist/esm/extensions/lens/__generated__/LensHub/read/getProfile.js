...
export const FN_SELECTOR = "0xf08f4f64";
const FN_INPUTS = [
    {
        type: "uint256",
        name: "profileId",
 ...
 * ```
 */
export function isGetProfileSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function encodeGetProfileParams(options) {
 ...
 * ```
 */
export function encodeGetProfile(options) {
 ...
 * ```
 */
export function decodeGetProfileResult(result) {
