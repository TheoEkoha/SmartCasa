...
export const FN_SELECTOR = "0x50ddf35c";
const FN_INPUTS = [
    {
        type: "uint256",
        name: "tokenId",
 ...
 * ```
 */
export function isMintTimestampOfSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function encodeMintTimestampOfParams(options) {
 ...
 * ```
 */
export function encodeMintTimestampOf(options) {
 ...
 * ```
 */
export function decodeMintTimestampOfResult(result) {
 ...
 * ```
 */
export async function mintTimestampOf(options) {
    return readContract({
