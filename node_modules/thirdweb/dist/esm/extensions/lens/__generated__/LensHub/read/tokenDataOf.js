...
export const FN_SELECTOR = "0xc0da9bcd";
const FN_INPUTS = [
    {
        type: "uint256",
        name: "tokenId",
 ...
 * ```
 */
export function isTokenDataOfSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function encodeTokenDataOfParams(options) {
 ...
 * ```
 */
export function encodeTokenDataOf(options) {
 ...
 * ```
 */
export function decodeTokenDataOfResult(result) {
 ...
 * ```
 */
export async function tokenDataOf(options) {
    return readContract({
