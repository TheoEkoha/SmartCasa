...
export const FN_SELECTOR = "0xb5a31496";
const FN_INPUTS = [
    {
        type: "uint256",
        name: "profileId",
 ...
 * ```
 */
export function isGetContentURISupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function encodeGetContentURIParams(options) {
 ...
 * ```
 */
export function encodeGetContentURI(options) {
 ...
 * ```
 */
export function decodeGetContentURIResult(result) {
 ...
 * ```
 */
export async function getContentURI(options) {
    return readContract({
