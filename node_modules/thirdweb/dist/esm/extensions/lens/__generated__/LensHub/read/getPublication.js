...
export const FN_SELECTOR = "0x7385ebc9";
const FN_INPUTS = [
    {
        type: "uint256",
        name: "profileId",
 ...
 * ```
 */
export function isGetPublicationSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function encodeGetPublicationParams(options) {
 ...
 * ```
 */
export function encodeGetPublication(options) {
 ...
 * ```
 */
export function decodeGetPublicationResult(result) {
 ...
 * ```
 */
export async function getPublication(options) {
    return readContract({
