...
export const FN_SELECTOR = "0x19e14070";
const FN_INPUTS = [
    {
        type: "bytes32",
        name: "handleHash",
 ...
 * ```
 */
export function isGetProfileIdByHandleHashSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function encodeGetProfileIdByHandleHashParams(options) {
 ...
 * ```
 */
export function encodeGetProfileIdByHandleHash(options) {
 ...
 * ```
 */
export function decodeGetProfileIdByHandleHashResult(result) {
 ...
 * ```
 */
export async function getProfileIdByHandleHash(options) {
    return readContract({
