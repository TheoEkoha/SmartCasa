...
export const FN_SELECTOR = "0xe524488d";
const FN_INPUTS = [
    {
        type: "uint256",
        name: "profileId",
 ...
 * ```
 */
export function isGetDefaultHandleSupported(availableSelectors) {
    return detectMethod({
        availableSelectors,
 ...
 * ```
 */
export function encodeGetDefaultHandleParams(options) {
 ...
 * ```
 */
export function encodeGetDefaultHandle(options) {
 ...
 * ```
 */
export function decodeGetDefaultHandleResult(result) {
 ...
 * ```
 */
export async function getDefaultHandle(options) {
    return readContract({
