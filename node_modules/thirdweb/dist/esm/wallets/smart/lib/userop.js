...
import { DUMMY_SIGNATURE, ENTRYPOINT_ADDRESS_v0_6, ENTRYPOINT_ADDRESS_v0_7, getDefaultBundlerUrl, getEntryPointVersion, } from "./constants.js";
...
async function getGasFees(args) {
    ...
    const bundlerUrl = bundlerOptions?.bundlerUrl ?? getDefaultBundlerUrl(chain, bundlerVersion);
...
async function populateUserOp_v0_7(args) {
    ...
    const factoryData = isDeployed
        ? "0x"
        : await encode(prepareCreateAccount({
