 ...
 * ```
 */
export declare function isDelegatesSupported(availableSelectors: string[]): boolean;
/**
 ...
 * ```
 */
export declare function encodeDelegates(options: DelegatesParams): `${typeof FN_SELECTOR}${string}`;
/**
