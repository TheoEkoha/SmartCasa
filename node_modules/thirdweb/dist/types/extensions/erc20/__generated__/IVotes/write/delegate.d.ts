 ...
 * ```
 */
export declare function isDelegateSupported(availableSelectors: string[]): boolean;
/**
 ...
 * ```
 */
export declare function encodeDelegate(options: DelegateParams): `${typeof FN_SELECTOR}${string}`;
/**
