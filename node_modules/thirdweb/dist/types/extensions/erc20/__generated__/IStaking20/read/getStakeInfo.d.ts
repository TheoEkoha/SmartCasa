 ...
 * ```
 */
export declare function decodeGetStakeInfoResult(result: Hex): readonly [bigint, bigint];
/**
 ...
 * ```
 */
export declare function getStakeInfo(options: BaseTransactionOptions<GetStakeInfoParams>): Promise<readonly [bigint, bigint]>;
