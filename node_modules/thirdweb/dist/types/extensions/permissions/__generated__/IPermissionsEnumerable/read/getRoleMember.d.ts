...
export declare const FN_SELECTOR: "0x9010d07c";
/**
 ...
 * ```
 */
export declare function isGetRoleMemberSupported(availableSelectors: string[]): boolean;
/**
 ...
 * ```
 */
export declare function encodeGetRoleMember(options: GetRoleMemberParams): `${typeof FN_SELECTOR}${string}`;
/**
