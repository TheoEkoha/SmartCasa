...
export declare const FN_SELECTOR: "0x85b49ad0";
/**
 ...
 * ```
 */
export declare function isGetFeeInfoSupported(availableSelectors: string[]): boolean;
/**
 ...
 * ```
 */
export declare function encodeGetFeeInfo(options: GetFeeInfoParams): `${typeof FN_SELECTOR}${string}`;
/**
