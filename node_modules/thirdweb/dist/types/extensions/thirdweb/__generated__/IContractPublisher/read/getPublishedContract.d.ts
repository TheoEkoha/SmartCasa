...
export declare const FN_SELECTOR: "0x7ec047fa";
/**
 ...
 * ```
 */
export declare function isGetPublishedContractSupported(availableSelectors: string[]): boolean;
/**
 ...
 * ```
 */
export declare function encodeGetPublishedContract(options: GetPublishedContractParams): `${typeof FN_SELECTOR}${string}`;
/**
