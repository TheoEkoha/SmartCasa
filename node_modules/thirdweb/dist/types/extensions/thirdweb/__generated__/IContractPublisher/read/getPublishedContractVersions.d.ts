 ...
 * ```
 */
export declare function isGetPublishedContractVersionsSupported(availableSelectors: string[]): boolean;
/**
 ...
 * ```
 */
export declare function encodeGetPublishedContractVersions(options: GetPublishedContractVersionsParams): `${typeof FN_SELECTOR}${string}`;
/**
