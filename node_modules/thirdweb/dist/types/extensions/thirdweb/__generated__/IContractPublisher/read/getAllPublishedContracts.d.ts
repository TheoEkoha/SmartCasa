 ...
 * ```
 */
export declare function isGetAllPublishedContractsSupported(availableSelectors: string[]): boolean;
/**
 ...
 * ```
 */
export declare function encodeGetAllPublishedContracts(options: GetAllPublishedContractsParams): `${typeof FN_SELECTOR}${string}`;
/**
