 ...
 * ```
 */
export declare function isGetAllSupported(availableSelectors: string[]): boolean;
/**
 ...
 * ```
 */
export declare function encodeGetAll(options: GetAllParams): `${typeof FN_SELECTOR}${string}`;
/**
