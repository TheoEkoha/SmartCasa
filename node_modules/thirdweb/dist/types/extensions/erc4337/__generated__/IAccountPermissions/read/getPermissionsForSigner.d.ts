...
export declare const FN_SELECTOR: "0xf15d424e";
/**
 ...
 * ```
 */
export declare function isGetPermissionsForSignerSupported(availableSelectors: string[]): boolean;
/**
 ...
 * ```
 */
export declare function encodeGetPermissionsForSigner(options: GetPermissionsForSignerParams): `${typeof FN_SELECTOR}${string}`;
/**
