...
export declare const FN_SELECTOR: "0xa9082d84";
/**
 ...
 * ```
 */
export declare function isVerifySignerPermissionRequestSupported(availableSelectors: string[]): boolean;
/**
 ...
 * ```
 */
export declare function encodeVerifySignerPermissionRequest(options: VerifySignerPermissionRequestParams): `${typeof FN_SELECTOR}${string}`;
/**
