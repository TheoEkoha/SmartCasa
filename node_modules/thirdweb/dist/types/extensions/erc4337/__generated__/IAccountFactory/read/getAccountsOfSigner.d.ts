 ...
 * ```
 */
export declare function isGetAccountsOfSignerSupported(availableSelectors: string[]): boolean;
/**
 ...
 * ```
 */
export declare function encodeGetAccountsOfSigner(options: GetAccountsOfSignerParams): `${typeof FN_SELECTOR}${string}`;
/**
