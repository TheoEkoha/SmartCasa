...
export declare const FN_SELECTOR: "0x11464fbe";
/**
 ...
 * ```
 */
export declare function isAccountImplementationSupported(availableSelectors: string[]): boolean;
/**
 ...
 * ```
 */
export declare function decodeAccountImplementationResult(result: Hex): string;
/**
...
//# sourceMappingURL=accountImplementation.d.ts.map