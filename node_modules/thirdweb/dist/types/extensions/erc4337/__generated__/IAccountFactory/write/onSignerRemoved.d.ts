 ...
 * ```
 */
export declare function isOnSignerRemovedSupported(availableSelectors: string[]): boolean;
/**
 ...
 * ```
 */
export declare function encodeOnSignerRemoved(options: OnSignerRemovedParams): `${typeof FN_SELECTOR}${string}`;
/**
