...
export declare const FN_SELECTOR: "0x38d52e0f";
/**
 ...
 * ```
 */
export declare function isAssetSupported(availableSelectors: string[]): boolean;
/**
 ...
 * ```
 */
export declare function decodeAssetResult(result: Hex): string;
/**
 ...
 * ```
 */
export declare function asset(options: BaseTransactionOptions): Promise<string>;
