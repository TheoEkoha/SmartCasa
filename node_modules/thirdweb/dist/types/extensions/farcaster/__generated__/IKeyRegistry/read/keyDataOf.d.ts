 ...
 * ```
 */
export declare function isKeyDataOfSupported(availableSelectors: string[]): boolean;
/**
 ...
 * ```
 */
export declare function encodeKeyDataOf(options: KeyDataOfParams): `${typeof FN_SELECTOR}${string}`;
/**
