 ...
 * ```
 */
export declare function isCustodyOfSupported(availableSelectors: string[]): boolean;
/**
 ...
 * ```
 */
export declare function encodeCustodyOf(options: CustodyOfParams): `${typeof FN_SELECTOR}${string}`;
/**
