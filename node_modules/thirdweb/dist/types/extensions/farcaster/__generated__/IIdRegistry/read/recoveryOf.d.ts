...
export declare const FN_SELECTOR: "0xfa1a1b25";
/**
 ...
 * ```
 */
export declare function isRecoveryOfSupported(availableSelectors: string[]): boolean;
/**
 ...
 * ```
 */
export declare function encodeRecoveryOf(options: RecoveryOfParams): `${typeof FN_SELECTOR}${string}`;
/**
