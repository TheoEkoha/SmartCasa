...
export declare const FN_SELECTOR: "0x6352211e";
/**
 ...
 * ```
 */
export declare function isOwnerOfSupported(availableSelectors: string[]): boolean;
/**
 ...
 * ```
 */
export declare function encodeOwnerOf(options: OwnerOfParams): `${typeof FN_SELECTOR}${string}`;
/**
