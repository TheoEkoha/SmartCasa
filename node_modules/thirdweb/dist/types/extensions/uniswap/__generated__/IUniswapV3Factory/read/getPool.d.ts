 ...
 * ```
 */
export declare function isGetPoolSupported(availableSelectors: string[]): boolean;
/**
 ...
 * ```
 */
export declare function encodeGetPool(options: GetPoolParams): `${typeof FN_SELECTOR}${string}`;
/**
