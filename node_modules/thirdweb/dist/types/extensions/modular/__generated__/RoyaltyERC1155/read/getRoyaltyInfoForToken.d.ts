 ...
 * ```
 */
export declare function isGetRoyaltyInfoForTokenSupported(availableSelectors: string[]): boolean;
/**
 ...
 * ```
 */
export declare function encodeGetRoyaltyInfoForToken(options: GetRoyaltyInfoForTokenParams): `${typeof FN_SELECTOR}${string}`;
/**
