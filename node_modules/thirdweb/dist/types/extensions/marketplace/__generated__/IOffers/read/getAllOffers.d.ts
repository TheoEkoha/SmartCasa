...
export declare const FN_SELECTOR: "0xc1edcfbe";
/**
 ...
 * ```
 */
export declare function isGetAllOffersSupported(availableSelectors: string[]): boolean;
/**
 ...
 * ```
 */
export declare function encodeGetAllOffers(options: GetAllOffersParams): `${typeof FN_SELECTOR}${string}`;
/**
