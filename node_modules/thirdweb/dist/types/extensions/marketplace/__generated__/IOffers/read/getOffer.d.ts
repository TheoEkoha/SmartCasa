 ...
 * ```
 */
export declare function isGetOfferSupported(availableSelectors: string[]): boolean;
/**
 ...
 * ```
 */
export declare function encodeGetOffer(options: GetOfferParams): `${typeof FN_SELECTOR}${string}`;
/**
