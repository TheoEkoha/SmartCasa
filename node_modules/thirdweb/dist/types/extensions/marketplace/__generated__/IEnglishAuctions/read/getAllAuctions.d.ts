 ...
 * ```
 */
export declare function isGetAllAuctionsSupported(availableSelectors: string[]): boolean;
/**
 ...
 * ```
 */
export declare function encodeGetAllAuctions(options: GetAllAuctionsParams): `${typeof FN_SELECTOR}${string}`;
/**
