 ...
 * ```
 */
export declare function isGetWinningBidSupported(availableSelectors: string[]): boolean;
/**
 ...
 * ```
 */
export declare function encodeGetWinningBid(options: GetWinningBidParams): `${typeof FN_SELECTOR}${string}`;
/**
