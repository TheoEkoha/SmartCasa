...
export declare const FN_SELECTOR: "0x7b063801";
/**
 ...
 * ```
 */
export declare function isGetAllValidAuctionsSupported(availableSelectors: string[]): boolean;
/**
 ...
 * ```
 */
export declare function encodeGetAllValidAuctionsParams(options: GetAllValidAuctionsParams): `0x${string}`;
/**
 ...
 * ```
 */
export declare function encodeGetAllValidAuctions(options: GetAllValidAuctionsParams): `${typeof FN_SELECTOR}${string}`;
/**
 ...
 * ```
 */
export declare function decodeGetAllValidAuctionsResult(result: Hex): readonly {
    auctionId: bigint;
    tokenId: bigint;
    quantity: bigint;
 ...
 * ```
 */
export declare function getAllValidAuctions(options: BaseTransactionOptions<GetAllValidAuctionsParams>): Promise<readonly {
    auctionId: bigint;
    tokenId: bigint;
    quantity: bigint;
    minimumBidAmount: bigint;
