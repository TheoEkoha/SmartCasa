...
export declare const FN_SELECTOR: "0x704232dc";
/**
 ...
 * ```
 */
export declare function encodeBuyFromListingParams(options: BuyFromListingParams): `0x${string}`;
/**
 ...
 * ```
 */
export declare function encodeBuyFromListing(options: BuyFromListingParams): `${typeof FN_SELECTOR}${string}`;
/**
 ...
 * ```
 */
export declare function buyFromListing(options: BaseTransactionOptions<BuyFromListingParams | {
