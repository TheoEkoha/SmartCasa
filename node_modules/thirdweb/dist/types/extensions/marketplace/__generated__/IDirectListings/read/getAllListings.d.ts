...
export declare const FN_SELECTOR: "0xc5275fb0";
/**
 ...
 * ```
 */
export declare function isGetAllListingsSupported(availableSelectors: string[]): boolean;
/**
 ...
 * ```
 */
export declare function encodeGetAllListingsParams(options: GetAllListingsParams): `0x${string}`;
/**
 ...
 * ```
 */
export declare function encodeGetAllListings(options: GetAllListingsParams): `${typeof FN_SELECTOR}${string}`;
/**
 ...
 * ```
 */
export declare function decodeGetAllListingsResult(result: Hex): readonly {
    listingId: bigint;
    tokenId: bigint;
    quantity: bigint;
 ...
 * ```
 */
export declare function getAllListings(options: BaseTransactionOptions<GetAllListingsParams>): Promise<readonly {
    listingId: bigint;
    tokenId: bigint;
    quantity: bigint;
    pricePerToken: bigint;
