...
export declare const FN_SELECTOR: "0x31654b4d";
/**
 ...
 * ```
 */
export declare function isGetAllValidListingsSupported(availableSelectors: string[]): boolean;
/**
 ...
 * ```
 */
export declare function encodeGetAllValidListings(options: GetAllValidListingsParams): `${typeof FN_SELECTOR}${string}`;
/**
