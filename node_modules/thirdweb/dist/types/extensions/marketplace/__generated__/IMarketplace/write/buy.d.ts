...
export declare const FN_SELECTOR: "0x7687ab02";
/**
 ...
 * ```
 */
export declare function isBuySupported(availableSelectors: string[]): boolean;
/**
 ...
 * ```
 */
export declare function encodeBuy(options: BuyParams): `${typeof FN_SELECTOR}${string}`;
/**
