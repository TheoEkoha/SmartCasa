...
export declare const FN_SELECTOR: "0x3b3b57de";
/**
 ...
 * ```
 */
export declare function isAddrSupported(availableSelectors: string[]): boolean;
/**
 ...
 * ```
 */
export declare function encodeAddr(options: AddrParams): `${typeof FN_SELECTOR}${string}`;
/**
