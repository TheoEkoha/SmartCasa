 ...
 * ```
 */
export declare function isTokenSupported(availableSelectors: string[]): boolean;
/**
 ...
 * ```
 */
export declare function decodeTokenResult(result: Hex): string;
/**
 ...
 * ```
 */
export declare function token(options: BaseTransactionOptions): Promise<string>;
