...
function InAppWalletUI(props) {
    ...
    return ((0, jsx_runtime_1.jsxs)(react_native_1.View, { style: styles.container, children: [(0, jsx_runtime_1.jsx)(react_native_1.View, { style: styles.row, children: socialLogins.map((auth) => ((0, jsx_runtime_1.jsx)(SocialLogin, { auth: auth, ...props }, auth))) }), authOptions.includes("email") ? (inputMode === "email" ? ((0, jsx_runtime_1.jsx)(PreOtpLogin, { auth: "email", ...props })) : ((0, jsx_runtime_1.jsx)(button_js_1.ThemedButtonWithIcon, { theme: theme, title: "Email address", icon: (0, walletIcon_js_1.getWalletIcon)("email"), onPress: () => setInputMode("email") }))) : null, authOptions.includes("phone") ? (inputMode === "phone" ? ((0, jsx_runtime_1.jsx)(PreOtpLogin, { auth: "phone", ...props })) : ((0, jsx_runtime_1.jsx)(button_js_1.ThemedButtonWithIcon, { theme: theme, title: "Phone number", icon: (0, walletIcon_js_1.getWalletIcon)("phone"), onPress: () => setInputMode("phone") }))) : null, authOptions.includes("passkey") ? ((0, jsx_runtime_1.jsx)(button_js_1.ThemedButtonWithIcon, { theme: theme, title: "Passkey", icon: (0, walletIcon_js_1.getWalletIcon)("passkey"), onPress: () => {
...
function PasskeyView(props) {
    ...
    return (wallet && ((0, jsx_runtime_1.jsxs)(react_native_1.View, { style: {
        ...
        }, children: [(0, jsx_runtime_1.jsx)(RNImage_js_1.RNImage, { theme: theme, size: 90, data: (0, walletIcon_js_1.getWalletIcon)("passkey") }), (0, jsx_runtime_1.jsx)(spacer_js_1.Spacer, { size: "xxl" }), (0, jsx_runtime_1.jsx)(button_js_1.ThemedButton, { theme: theme, variant: "accent", style: { width: "100%" }, onPress: async () => {
                    setScreen("signup");
