...
const ConnectedWalletDetails = (props) => {
    ...
    const { ensAvatarQuery, addressOrENS, balanceQuery } = (0, wallet_js_1.useConnectedWalletDetails)(client, walletChain, activeAccount, props.detailsButton?.displayBalanceToken);
    function closeModal() {
        setRootEl(null);
    }
    function openModal() {
        setRootEl((0, jsx_runtime_1.jsx)(DetailsModal, { client: client, locale: locale, detailsModal: props.detailsModal, theme: props.theme, supportedTokens: props.supportedTokens, supportedNFTs: props.supportedNFTs, closeModal: closeModal, onDisconnect: props.onDisconnect, chains: props.chains, displayBalanceToken: props.detailsButton?.displayBalanceToken, connectOptions: props.connectOptions }));
    }
    ...
    const avatarSrc = props.detailsButton?.connectedAccountAvatarUrl ?? ensAvatarQuery.data;
    return ((0, jsx_runtime_1.jsxs)(WalletInfoButton, { type: "button", className: `${TW_CONNECTED_WALLET} ${props.detailsButton?.className || ""}`, style: props.detailsButton?.style, "data-test": "connected-wallet-details", onClick: openModal, children: [(0, jsx_runtime_1.jsx)(basic_js_1.Container, { style: {
                    borderRadius: "100%",
                    overflow: "hidden",
                    width: "35px",
                    height: "35px",
...
function DetailsModal(props) {
    ...
    const walletChain = (0, useActiveWalletChain_js_1.useActiveWalletChain)();
    const activeAccount = (0, useActiveAccount_js_1.useActiveAccount)();
    const { ensAvatarQuery, addressOrENS, balanceQuery } = (0, wallet_js_1.useConnectedWalletDetails)(client, walletChain, activeAccount, props.displayBalanceToken);
    ...
    let content = ((0, jsx_runtime_1.jsxs)("div", { children: [(0, jsx_runtime_1.jsx)(Spacer_js_1.Spacer, { y: "xs" }), (0, jsx_runtime_1.jsxs)(basic_js_1.Container, { p: "lg", gap: "sm", flex: "row", center: "y", children: [props.detailsModal?.hideSwitchWallet ? (avatarContent) : ((0, jsx_runtime_1.jsx)(Tooltip_js_1.ToolTip, { tip: "Switch wallet", children: (0, jsx_runtime_1.jsx)("div", { style: {
                                cursor: "pointer",
                            }, onKeyDown: (e) => {
                                if (e.key === "w") {
                        ...
                        gap: index_js_1.spacing.xs,
                            ...
                            gap: "1px",
                                    ...
                                    fontSize: index_js_1.fontSize.sm,
                                }, children: [(0, jsx_runtime_1.jsx)(react_icons_1.TextAlignJustifyIcon, { width: index_js_1.iconSize.md, height: index_js_1.iconSize.md }), (0, jsx_runtime_1.jsx)(basic_js_1.Container, { flex: "row", gap: "xs", center: "y", children: (0, jsx_runtime_1.jsx)(text_js_1.Text, { color: "primaryText", children: locale.transactions }) })] }), (0, jsx_runtime_1.jsxs)(MenuButton_js_1.MenuButton, { onClick: () => {
    ...
    if (screen === "network-switcher") {
        ...
        if (props.supportedNFTs) {
            content = ((0, jsx_runtime_1.jsx)(ViewAssets_js_1.ViewAssets, { supportedTokens: props.supportedTokens, supportedNFTs: props.supportedNFTs, onBack: () => {
                    setScreen("main");
                }, theme: props.theme, setScreen: setScreen, client: client, connectLocale: locale }));
        }
        else {
...
function InAppWalletUserInfo(props) {
    ...
    if (userInfoQuery.data || walletInfo) {
        return ((0, jsx_runtime_1.jsx)(text_js_1.Text, { size: "xs", weight: 400, children: userInfoQuery.data || walletInfo?.name }));
    }
