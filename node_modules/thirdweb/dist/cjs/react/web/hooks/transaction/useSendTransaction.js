...
function useSendTransaction(config = {}) {
    ...
    const showPayModal = (data) => {
        if (payModal === false)
            return;
        setRootEl((0, jsx_runtime_1.jsx)(TransactionModal_js_1.TransactionModal, { title: payModal?.metadata?.name || "Transaction", tx: data.tx, onComplete: data.sendTx, onClose: () => {
                setRootEl(null);
