...
async function getClaimParams(options) {
    const cc = await (async () => {
        ...
        // lazy-load the getActiveClaimCondition function
        const { getActiveClaimCondition } = await Promise.resolve().then(() => require("../../../extensions/erc20/drops/read/getActiveClaimCondition.js"));
        return await getActiveClaimCondition({
            contract: options.contract,
        });
    })();
    ...
    const value = (0, addresses_js_1.isNativeTokenAddress)(currency) ? totalPrice : 0n;
    const erc20Value = !(0, addresses_js_1.isNativeTokenAddress)(currency) && pricePerToken > 0n
        ? {
