...
exports.isTotalListingsSupported = isTotalListingsSupported;
exports.decodeTotalListingsResult = decodeTotalListingsResult;
exports.totalListings = totalListings;
const read_contract_js_1 = require("../../../../../transaction/read-contract.js");
const viem_1 = require("viem");
const detectExtension_js_1 = require("../../../../../utils/bytecode/detectExtension.js");
exports.FN_SELECTOR = "0xc78b616c";
const FN_INPUTS = [];
const FN_OUTPUTS = [
    {
        type: "uint256",
 ...
 * ```
 */
function isTotalListingsSupported(availableSelectors) {
 ...
 * ```
 */
function decodeTotalListingsResult(result) {
 ...
 * ```
 */
async function totalListings(options) {
...
//# sourceMappingURL=totalListings.js.map