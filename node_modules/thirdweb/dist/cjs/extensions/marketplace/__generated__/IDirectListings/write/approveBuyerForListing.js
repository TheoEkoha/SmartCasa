...
exports.isApproveBuyerForListingSupported = isApproveBuyerForListingSupported;
exports.encodeApproveBuyerForListingParams = encodeApproveBuyerForListingParams;
exports.encodeApproveBuyerForListing = encodeApproveBuyerForListing;
exports.approveBuyerForListing = approveBuyerForListing;
const prepare_contract_call_js_1 = require("../../../../../transaction/prepare-contract-call.js");
const encodeAbiParameters_js_1 = require("../../../../../utils/abi/encodeAbiParameters.js");
const once_js_1 = require("../../../../../utils/promise/once.js");
const detectExtension_js_1 = require("../../../../../utils/bytecode/detectExtension.js");
exports.FN_SELECTOR = "0x48dd77df";
const FN_INPUTS = [
    {
        type: "uint256",
        name: "_listingId",
 ...
 * ```
 */
function isApproveBuyerForListingSupported(availableSelectors) {
 ...
 * ```
 */
function encodeApproveBuyerForListingParams(options) {
 ...
 * ```
 */
function encodeApproveBuyerForListing(options) {
    // we do a "manual" concat here to avoid the overhead of the "concatHex" function
    // we can do this because we know the specific formats of the values
    return (exports.FN_SELECTOR +
        encodeApproveBuyerForListingParams(options).slice(2));
}
/**
 ...
 * ```
 */
function approveBuyerForListing(options) {
