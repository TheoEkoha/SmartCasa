...
exports.isGetOfferSupported = isGetOfferSupported;
exports.encodeGetOfferParams = encodeGetOfferParams;
exports.encodeGetOffer = encodeGetOffer;
...
exports.FN_SELECTOR = "0x4579268a";
const FN_INPUTS = [
    {
        type: "uint256",
        name: "_offerId",
 ...
 * ```
 */
function isGetOfferSupported(availableSelectors) {
 ...
 * ```
 */
function encodeGetOffer(options) {
