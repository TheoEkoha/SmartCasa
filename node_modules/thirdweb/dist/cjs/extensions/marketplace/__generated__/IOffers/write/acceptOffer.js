...
exports.isAcceptOfferSupported = isAcceptOfferSupported;
exports.encodeAcceptOfferParams = encodeAcceptOfferParams;
exports.encodeAcceptOffer = encodeAcceptOffer;
exports.acceptOffer = acceptOffer;
const prepare_contract_call_js_1 = require("../../../../../transaction/prepare-contract-call.js");
const encodeAbiParameters_js_1 = require("../../../../../utils/abi/encodeAbiParameters.js");
const once_js_1 = require("../../../../../utils/promise/once.js");
const detectExtension_js_1 = require("../../../../../utils/bytecode/detectExtension.js");
exports.FN_SELECTOR = "0xc815729d";
const FN_INPUTS = [
    {
        type: "uint256",
        name: "_offerId",
 ...
 * ```
 */
function isAcceptOfferSupported(availableSelectors) {
 ...
 * ```
 */
function encodeAcceptOfferParams(options) {
 ...
 * ```
 */
function encodeAcceptOffer(options) {
    // we do a "manual" concat here to avoid the overhead of the "concatHex" function
    // we can do this because we know the specific formats of the values
    return (exports.FN_SELECTOR +
        encodeAcceptOfferParams(options).slice(2));
}
/**
...
function acceptOffer(options) {
    ...
    return (0, prepare_contract_call_js_1.prepareContractCall)({
        ...
        params: async () => {
            ...
            return [resolvedOptions.offerId];
        },
