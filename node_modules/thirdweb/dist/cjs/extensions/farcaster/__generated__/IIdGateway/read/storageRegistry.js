...
exports.isStorageRegistrySupported = isStorageRegistrySupported;
exports.decodeStorageRegistryResult = decodeStorageRegistryResult;
exports.storageRegistry = storageRegistry;
const read_contract_js_1 = require("../../../../../transaction/read-contract.js");
const viem_1 = require("viem");
const detectExtension_js_1 = require("../../../../../utils/bytecode/detectExtension.js");
exports.FN_SELECTOR = "0x4ec77b45";
const FN_INPUTS = [];
const FN_OUTPUTS = [
    {
        type: "address",
 ...
 * ```
 */
function isStorageRegistrySupported(availableSelectors) {
 ...
 * ```
 */
function decodeStorageRegistryResult(result) {
 ...
 * ```
 */
async function storageRegistry(options) {
