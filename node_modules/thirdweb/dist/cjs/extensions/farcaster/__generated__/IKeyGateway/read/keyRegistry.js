...
exports.isKeyRegistrySupported = isKeyRegistrySupported;
exports.decodeKeyRegistryResult = decodeKeyRegistryResult;
exports.keyRegistry = keyRegistry;
const read_contract_js_1 = require("../../../../../transaction/read-contract.js");
const viem_1 = require("viem");
const detectExtension_js_1 = require("../../../../../utils/bytecode/detectExtension.js");
exports.FN_SELECTOR = "0x086b5198";
const FN_INPUTS = [];
const FN_OUTPUTS = [
    {
        type: "address",
 ...
 * ```
 */
function isKeyRegistrySupported(availableSelectors) {
 ...
 * ```
 */
function decodeKeyRegistryResult(result) {
 ...
 * ```
 */
async function keyRegistry(options) {
