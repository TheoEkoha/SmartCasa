...
exports.isMaxUnitsSupported = isMaxUnitsSupported;
exports.decodeMaxUnitsResult = decodeMaxUnitsResult;
exports.maxUnits = maxUnits;
const read_contract_js_1 = require("../../../../../transaction/read-contract.js");
const viem_1 = require("viem");
const detectExtension_js_1 = require("../../../../../utils/bytecode/detectExtension.js");
exports.FN_SELECTOR = "0x06517a29";
const FN_INPUTS = [];
const FN_OUTPUTS = [
    {
        type: "uint256",
 ...
 * ```
 */
function isMaxUnitsSupported(availableSelectors) {
 ...
 * ```
 */
function decodeMaxUnitsResult(result) {
 ...
 * ```
 */
async function maxUnits(options) {
...
//# sourceMappingURL=maxUnits.js.map