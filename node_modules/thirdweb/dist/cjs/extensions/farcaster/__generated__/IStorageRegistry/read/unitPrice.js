...
exports.isUnitPriceSupported = isUnitPriceSupported;
exports.decodeUnitPriceResult = decodeUnitPriceResult;
exports.unitPrice = unitPrice;
const read_contract_js_1 = require("../../../../../transaction/read-contract.js");
const viem_1 = require("viem");
const detectExtension_js_1 = require("../../../../../utils/bytecode/detectExtension.js");
exports.FN_SELECTOR = "0xe73faa2d";
const FN_INPUTS = [];
const FN_OUTPUTS = [
    {
        type: "uint256",
 ...
 * ```
 */
function isUnitPriceSupported(availableSelectors) {
 ...
 * ```
 */
function decodeUnitPriceResult(result) {
 ...
 * ```
 */
async function unitPrice(options) {
