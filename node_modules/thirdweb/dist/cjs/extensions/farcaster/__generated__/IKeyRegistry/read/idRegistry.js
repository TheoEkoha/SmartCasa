...
exports.isIdRegistrySupported = isIdRegistrySupported;
exports.decodeIdRegistryResult = decodeIdRegistryResult;
exports.idRegistry = idRegistry;
const read_contract_js_1 = require("../../../../../transaction/read-contract.js");
const viem_1 = require("viem");
const detectExtension_js_1 = require("../../../../../utils/bytecode/detectExtension.js");
exports.FN_SELECTOR = "0x0aa13b8c";
const FN_INPUTS = [];
const FN_OUTPUTS = [
    {
        type: "address",
 ...
 * ```
 */
function isIdRegistrySupported(availableSelectors) {
 ...
 * ```
 */
function decodeIdRegistryResult(result) {
 ...
 * ```
 */
async function idRegistry(options) {
