...
exports.isIdGatewaySupported = isIdGatewaySupported;
exports.decodeIdGatewayResult = decodeIdGatewayResult;
exports.idGateway = idGateway;
const read_contract_js_1 = require("../../../../../transaction/read-contract.js");
const viem_1 = require("viem");
const detectExtension_js_1 = require("../../../../../utils/bytecode/detectExtension.js");
exports.FN_SELECTOR = "0x4b57a600";
const FN_INPUTS = [];
const FN_OUTPUTS = [
    {
        type: "address",
 ...
 * ```
 */
function isIdGatewaySupported(availableSelectors) {
 ...
 * ```
 */
function decodeIdGatewayResult(result) {
 ...
 * ```
 */
async function idGateway(options) {
