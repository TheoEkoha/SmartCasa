...
exports.isChangeRecoveryAddressSupported = isChangeRecoveryAddressSupported;
exports.encodeChangeRecoveryAddressParams = encodeChangeRecoveryAddressParams;
exports.encodeChangeRecoveryAddress = encodeChangeRecoveryAddress;
exports.changeRecoveryAddress = changeRecoveryAddress;
const prepare_contract_call_js_1 = require("../../../../../transaction/prepare-contract-call.js");
const encodeAbiParameters_js_1 = require("../../../../../utils/abi/encodeAbiParameters.js");
const once_js_1 = require("../../../../../utils/promise/once.js");
const detectExtension_js_1 = require("../../../../../utils/bytecode/detectExtension.js");
exports.FN_SELECTOR = "0xf1f0b224";
const FN_INPUTS = [
    {
        type: "address",
        name: "recovery",
 ...
 * ```
 */
function isChangeRecoveryAddressSupported(availableSelectors) {
 ...
 * ```
 */
function encodeChangeRecoveryAddressParams(options) {
    return (0, encodeAbiParameters_js_1.encodeAbiParameters)(FN_INPUTS, [options.recovery]);
}
/**
 ...
 * ```
 */
function encodeChangeRecoveryAddress(options) {
    // we do a "manual" concat here to avoid the overhead of the "concatHex" function
    // we can do this because we know the specific formats of the values
    return (exports.FN_SELECTOR +
        encodeChangeRecoveryAddressParams(options).slice(2));
}
/**
 ...
 * ```
 */
function changeRecoveryAddress(options) {
    ...
    return (0, prepare_contract_call_js_1.prepareContractCall)({
        ...
        params: async () => {
            ...
            return [resolvedOptions.recovery];
        },
