...
exports.encodeDepositParams = encodeDepositParams;
...
exports.FN_SELECTOR = "0x6e553f65";
const FN_INPUTS = [
    {
        name: "assets",
        type: "uint256",
 ...
 * ```
 */
function isDepositSupported(availableSelectors) {
 ...
 * ```
 */
function encodeDepositParams(options) {
    return (0, encodeAbiParameters_js_1.encodeAbiParameters)(FN_INPUTS, [options.assets, options.receiver]);
}
/**
 ...
 * ```
 */
function encodeDeposit(options) {
    // we do a "manual" concat here to avoid the overhead of the "concatHex" function
    // we can do this because we know the specific formats of the values
    return (exports.FN_SELECTOR +
        encodeDepositParams(options).slice(2));
}
/**
...
function deposit(options) {
    ...
    return (0, prepare_contract_call_js_1.prepareContractCall)({
        ...
        params: async () => {
            ...
            return [resolvedOptions.assets, resolvedOptions.receiver];
        },
