...
exports.isConvertToSharesSupported = isConvertToSharesSupported;
exports.encodeConvertToSharesParams = encodeConvertToSharesParams;
exports.encodeConvertToShares = encodeConvertToShares;
exports.decodeConvertToSharesResult = decodeConvertToSharesResult;
exports.convertToShares = convertToShares;
const read_contract_js_1 = require("../../../../../transaction/read-contract.js");
const encodeAbiParameters_js_1 = require("../../../../../utils/abi/encodeAbiParameters.js");
const viem_1 = require("viem");
const detectExtension_js_1 = require("../../../../../utils/bytecode/detectExtension.js");
exports.FN_SELECTOR = "0xc6e6f592";
const FN_INPUTS = [
    {
        name: "assets",
        type: "uint256",
 ...
 * ```
 */
function isConvertToSharesSupported(availableSelectors) {
 ...
 * ```
 */
function encodeConvertToSharesParams(options) {
 ...
 * ```
 */
function encodeConvertToShares(options) {
    // we do a "manual" concat here to avoid the overhead of the "concatHex" function
    // we can do this because we know the specific formats of the values
    return (exports.FN_SELECTOR +
        encodeConvertToSharesParams(options).slice(2));
}
/**
 ...
 * ```
 */
function decodeConvertToSharesResult(result) {
 ...
 * ```
 */
async function convertToShares(options) {
