...
exports.isWithdrawSupported = isWithdrawSupported;
exports.encodeWithdrawParams = encodeWithdrawParams;
...
exports.FN_SELECTOR = "0xc434dcfe";
const FN_INPUTS = [
    {
        type: "uint256",
        name: "tokenId",
 ...
 * ```
 */
function isWithdrawSupported(availableSelectors) {
 ...
 * ```
 */
function encodeWithdrawParams(options) {
 ...
 * ```
 */
function encodeWithdraw(options) {
    // we do a "manual" concat here to avoid the overhead of the "concatHex" function
    // we can do this because we know the specific formats of the values
    return (exports.FN_SELECTOR +
        encodeWithdrawParams(options).slice(2));
}
/**
