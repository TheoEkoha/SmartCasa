...
exports.isStakeSupported = isStakeSupported;
exports.encodeStakeParams = encodeStakeParams;
exports.encodeStake = encodeStake;
exports.stake = stake;
const prepare_contract_call_js_1 = require("../../../../../transaction/prepare-contract-call.js");
const encodeAbiParameters_js_1 = require("../../../../../utils/abi/encodeAbiParameters.js");
const once_js_1 = require("../../../../../utils/promise/once.js");
const detectExtension_js_1 = require("../../../../../utils/bytecode/detectExtension.js");
exports.FN_SELECTOR = "0x952e68cf";
const FN_INPUTS = [
    {
        type: "uint256",
        name: "tokenId",
 ...
 * ```
 */
function isStakeSupported(availableSelectors) {
 ...
 * ```
 */
function encodeStakeParams(options) {
    return (0, encodeAbiParameters_js_1.encodeAbiParameters)(FN_INPUTS, [options.tokenId, options.amount]);
}
/**
 ...
 * ```
 */
function encodeStake(options) {
    // we do a "manual" concat here to avoid the overhead of the "concatHex" function
    // we can do this because we know the specific formats of the values
    return (exports.FN_SELECTOR +
        encodeStakeParams(options).slice(2));
}
/**
...
function stake(options) {
    ...
    return (0, prepare_contract_call_js_1.prepareContractCall)({
        ...
        params: async () => {
            ...
            return [resolvedOptions.tokenId, resolvedOptions.amount];
        },
