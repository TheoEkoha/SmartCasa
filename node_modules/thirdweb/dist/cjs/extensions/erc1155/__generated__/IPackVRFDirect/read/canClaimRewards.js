...
exports.isCanClaimRewardsSupported = isCanClaimRewardsSupported;
exports.encodeCanClaimRewardsParams = encodeCanClaimRewardsParams;
exports.encodeCanClaimRewards = encodeCanClaimRewards;
...
exports.FN_SELECTOR = "0xa9b47a66";
const FN_INPUTS = [
    {
        type: "address",
        name: "_opener",
 ...
 * ```
 */
function isCanClaimRewardsSupported(availableSelectors) {
 ...
 * ```
 */
function encodeCanClaimRewards(options) {
