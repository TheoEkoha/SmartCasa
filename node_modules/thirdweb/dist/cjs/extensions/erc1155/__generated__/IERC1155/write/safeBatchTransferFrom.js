...
exports.isSafeBatchTransferFromSupported = isSafeBatchTransferFromSupported;
exports.encodeSafeBatchTransferFromParams = encodeSafeBatchTransferFromParams;
exports.encodeSafeBatchTransferFrom = encodeSafeBatchTransferFrom;
exports.safeBatchTransferFrom = safeBatchTransferFrom;
const prepare_contract_call_js_1 = require("../../../../../transaction/prepare-contract-call.js");
const encodeAbiParameters_js_1 = require("../../../../../utils/abi/encodeAbiParameters.js");
const once_js_1 = require("../../../../../utils/promise/once.js");
const detectExtension_js_1 = require("../../../../../utils/bytecode/detectExtension.js");
exports.FN_SELECTOR = "0x2eb2c2d6";
const FN_INPUTS = [
    {
        type: "address",
        name: "_from",
 ...
 * ```
 */
function isSafeBatchTransferFromSupported(availableSelectors) {
 ...
 * ```
 */
function encodeSafeBatchTransferFromParams(options) {
 ...
 * ```
 */
function encodeSafeBatchTransferFrom(options) {
    // we do a "manual" concat here to avoid the overhead of the "concatHex" function
    // we can do this because we know the specific formats of the values
    return (exports.FN_SELECTOR +
        encodeSafeBatchTransferFromParams(options).slice(2));
}
/**
 ...
 * ```
 */
function safeBatchTransferFrom(options) {
...
//# sourceMappingURL=safeBatchTransferFrom.js.map