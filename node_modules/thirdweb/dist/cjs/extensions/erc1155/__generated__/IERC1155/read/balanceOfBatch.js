...
exports.isBalanceOfBatchSupported = isBalanceOfBatchSupported;
exports.encodeBalanceOfBatchParams = encodeBalanceOfBatchParams;
exports.encodeBalanceOfBatch = encodeBalanceOfBatch;
exports.decodeBalanceOfBatchResult = decodeBalanceOfBatchResult;
exports.balanceOfBatch = balanceOfBatch;
const read_contract_js_1 = require("../../../../../transaction/read-contract.js");
const encodeAbiParameters_js_1 = require("../../../../../utils/abi/encodeAbiParameters.js");
const viem_1 = require("viem");
const detectExtension_js_1 = require("../../../../../utils/bytecode/detectExtension.js");
exports.FN_SELECTOR = "0x4e1273f4";
const FN_INPUTS = [
    {
        type: "address[]",
        name: "_owners",
...
function encodeBalanceOfBatchParams(options) {
    return (0, encodeAbiParameters_js_1.encodeAbiParameters)(FN_INPUTS, [options.owners, options.tokenIds]);
}
/**
...
function encodeBalanceOfBatch(options) {
    ...
    return (exports.FN_SELECTOR +
        encodeBalanceOfBatchParams(options).slice(2));
}
/**
