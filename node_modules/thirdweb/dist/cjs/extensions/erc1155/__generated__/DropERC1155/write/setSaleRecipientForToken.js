...
exports.isSetSaleRecipientForTokenSupported = isSetSaleRecipientForTokenSupported;
exports.encodeSetSaleRecipientForTokenParams = encodeSetSaleRecipientForTokenParams;
exports.encodeSetSaleRecipientForToken = encodeSetSaleRecipientForToken;
exports.setSaleRecipientForToken = setSaleRecipientForToken;
const prepare_contract_call_js_1 = require("../../../../../transaction/prepare-contract-call.js");
const encodeAbiParameters_js_1 = require("../../../../../utils/abi/encodeAbiParameters.js");
const once_js_1 = require("../../../../../utils/promise/once.js");
const detectExtension_js_1 = require("../../../../../utils/bytecode/detectExtension.js");
exports.FN_SELECTOR = "0x29c49b9b";
const FN_INPUTS = [
    {
        type: "uint256",
        name: "_tokenId",
 ...
 * ```
 */
function isSetSaleRecipientForTokenSupported(availableSelectors) {
 ...
 * ```
 */
function encodeSetSaleRecipientForTokenParams(options) {
 ...
 * ```
 */
function encodeSetSaleRecipientForToken(options) {
    // we do a "manual" concat here to avoid the overhead of the "concatHex" function
    // we can do this because we know the specific formats of the values
    return (exports.FN_SELECTOR +
        encodeSetSaleRecipientForTokenParams(options).slice(2));
}
/**
 ...
 * ```
 */
function setSaleRecipientForToken(options) {
    ...
    return (0, prepare_contract_call_js_1.prepareContractCall)({
        ...
        params: async () => {
            ...
            return [resolvedOptions.tokenId, resolvedOptions.saleRecipient];
        },
...
//# sourceMappingURL=setSaleRecipientForToken.js.map