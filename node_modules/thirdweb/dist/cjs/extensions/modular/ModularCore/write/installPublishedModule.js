...
const installModule_js_1 = require("../../__generated__/ModularCore/write/installModule.js");
/**
...
function installPublishedModule(options) {
    const { client, chain, account, contract, moduleName, constructorParams, publisherAddress, moduleData, } = options;
    return (0, installModule_js_1.installModule)({
        ...
        asyncParams: async () => {
            ...
            return {
                module: deployedModule.implementationContract.address,
                data: moduleData || "0x",
            };
        },
    });
