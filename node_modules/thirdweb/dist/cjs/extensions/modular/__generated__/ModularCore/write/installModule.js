...
exports.isInstallModuleSupported = isInstallModuleSupported;
exports.encodeInstallModuleParams = encodeInstallModuleParams;
...
exports.FN_SELECTOR = "0x8da798da";
const FN_INPUTS = [
    {
        name: "_module",
        type: "address",
 ...
 * ```
 */
function isInstallModuleSupported(availableSelectors) {
 ...
 * ```
 */
function encodeInstallModuleParams(options) {
    return (0, encodeAbiParameters_js_1.encodeAbiParameters)(FN_INPUTS, [options.module, options.data]);
}
/**
 ...
 * ```
 */
function encodeInstallModule(options) {
...
function installModule(options) {
    ...
    return (0, prepare_contract_call_js_1.prepareContractCall)({
        ...
        params: async () => {
            ...
            return [resolvedOptions.module, resolvedOptions.data];
        },
