...
exports.isCompleteOwnershipHandoverSupported = isCompleteOwnershipHandoverSupported;
exports.encodeCompleteOwnershipHandoverParams = encodeCompleteOwnershipHandoverParams;
exports.encodeCompleteOwnershipHandover = encodeCompleteOwnershipHandover;
exports.completeOwnershipHandover = completeOwnershipHandover;
const prepare_contract_call_js_1 = require("../../../../../transaction/prepare-contract-call.js");
const encodeAbiParameters_js_1 = require("../../../../../utils/abi/encodeAbiParameters.js");
const once_js_1 = require("../../../../../utils/promise/once.js");
const detectExtension_js_1 = require("../../../../../utils/bytecode/detectExtension.js");
exports.FN_SELECTOR = "0xf04e283e";
const FN_INPUTS = [
    {
        name: "pendingOwner",
        type: "address",
 ...
 * ```
 */
function isCompleteOwnershipHandoverSupported(availableSelectors) {
 ...
 * ```
 */
function encodeCompleteOwnershipHandoverParams(options) {
 ...
 * ```
 */
function encodeCompleteOwnershipHandover(options) {
    // we do a "manual" concat here to avoid the overhead of the "concatHex" function
    // we can do this because we know the specific formats of the values
    return (exports.FN_SELECTOR +
        encodeCompleteOwnershipHandoverParams(options).slice(2));
}
/**
 ...
 * ```
 */
function completeOwnershipHandover(options) {
    ...
    return (0, prepare_contract_call_js_1.prepareContractCall)({
        ...
        params: async () => {
            ...
            return [resolvedOptions.pendingOwner];
        },
...
//# sourceMappingURL=completeOwnershipHandover.js.map