...
exports.isGrantRolesSupported = isGrantRolesSupported;
exports.encodeGrantRolesParams = encodeGrantRolesParams;
exports.encodeGrantRoles = encodeGrantRoles;
exports.grantRoles = grantRoles;
const prepare_contract_call_js_1 = require("../../../../../transaction/prepare-contract-call.js");
const encodeAbiParameters_js_1 = require("../../../../../utils/abi/encodeAbiParameters.js");
const once_js_1 = require("../../../../../utils/promise/once.js");
const detectExtension_js_1 = require("../../../../../utils/bytecode/detectExtension.js");
exports.FN_SELECTOR = "0x1c10893f";
const FN_INPUTS = [
    {
        name: "user",
        type: "address",
 ...
 * ```
 */
function isGrantRolesSupported(availableSelectors) {
 ...
 * ```
 */
function encodeGrantRolesParams(options) {
 ...
 * ```
 */
function encodeGrantRoles(options) {
    // we do a "manual" concat here to avoid the overhead of the "concatHex" function
    // we can do this because we know the specific formats of the values
    return (exports.FN_SELECTOR +
        encodeGrantRolesParams(options).slice(2));
}
/**
...
//# sourceMappingURL=grantRoles.js.map