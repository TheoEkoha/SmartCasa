...
function encodeSetTokenURIParams(options) {
    return (0, encodeAbiParameters_js_1.encodeAbiParameters)(FN_INPUTS, [options.tokenId, options.tokenURI]);
}
/**
 ...
 * ```
 */
function encodeSetTokenURI(options) {
