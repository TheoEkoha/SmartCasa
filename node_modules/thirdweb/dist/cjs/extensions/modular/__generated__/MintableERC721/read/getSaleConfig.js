...
exports.isGetSaleConfigSupported = isGetSaleConfigSupported;
exports.decodeGetSaleConfigResult = decodeGetSaleConfigResult;
exports.getSaleConfig = getSaleConfig;
const read_contract_js_1 = require("../../../../../transaction/read-contract.js");
const viem_1 = require("viem");
const detectExtension_js_1 = require("../../../../../utils/bytecode/detectExtension.js");
exports.FN_SELECTOR = "0xcea943ee";
const FN_INPUTS = [];
const FN_OUTPUTS = [
    {
 ...
 * ```
 */
function isGetSaleConfigSupported(availableSelectors) {
 ...
 * ```
 */
function decodeGetSaleConfigResult(result) {
 ...
 * ```
 */
async function getSaleConfig(options) {
...
//# sourceMappingURL=getSaleConfig.js.map