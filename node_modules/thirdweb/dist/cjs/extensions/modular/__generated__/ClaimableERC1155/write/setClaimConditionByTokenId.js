...
exports.FN_SELECTOR = "0xb7720475";
const FN_INPUTS = [
    {
        name: "_id",
        type: "uint256",
...
function encodeSetClaimConditionByTokenIdParams(options) {
    return (0, encodeAbiParameters_js_1.encodeAbiParameters)(FN_INPUTS, [options.id, options.claimCondition]);
}
/**
...
function setClaimConditionByTokenId(options) {
    ...
    return (0, prepare_contract_call_js_1.prepareContractCall)({
        ...
        params: async () => {
            ...
            return [resolvedOptions.id, resolvedOptions.claimCondition];
        },
