...
exports.isEncodeBytesOnUninstallSupported = isEncodeBytesOnUninstallSupported;
exports.decodeEncodeBytesOnUninstallResult = decodeEncodeBytesOnUninstallResult;
exports.encodeBytesOnUninstall = encodeBytesOnUninstall;
const read_contract_js_1 = require("../../../../../transaction/read-contract.js");
const viem_1 = require("viem");
const detectExtension_js_1 = require("../../../../../utils/bytecode/detectExtension.js");
exports.FN_SELECTOR = "0xf5b75d2a";
const FN_INPUTS = [];
const FN_OUTPUTS = [
    {
        name: "",
 ...
 * ```
 */
function isEncodeBytesOnUninstallSupported(availableSelectors) {
 ...
 * ```
 */
function decodeEncodeBytesOnUninstallResult(result) {
 ...
 * ```
 */
async function encodeBytesOnUninstall(options) {
...
//# sourceMappingURL=encodeBytesOnUninstall.js.map