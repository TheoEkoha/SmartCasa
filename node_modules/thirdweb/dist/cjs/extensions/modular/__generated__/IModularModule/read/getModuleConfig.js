...
exports.isGetModuleConfigSupported = isGetModuleConfigSupported;
exports.decodeGetModuleConfigResult = decodeGetModuleConfigResult;
exports.getModuleConfig = getModuleConfig;
const read_contract_js_1 = require("../../../../../transaction/read-contract.js");
const viem_1 = require("viem");
const detectExtension_js_1 = require("../../../../../utils/bytecode/detectExtension.js");
exports.FN_SELECTOR = "0x89e04e0e";
const FN_INPUTS = [];
const FN_OUTPUTS = [
    {
        name: "",
 ...
 * ```
 */
function isGetModuleConfigSupported(availableSelectors) {
 ...
 * ```
 */
function decodeGetModuleConfigResult(result) {
 ...
 * ```
 */
async function getModuleConfig(options) {
