...
exports.isUploadMetadataSupported = isUploadMetadataSupported;
exports.encodeUploadMetadataParams = encodeUploadMetadataParams;
exports.encodeUploadMetadata = encodeUploadMetadata;
exports.uploadMetadata = uploadMetadata;
const prepare_contract_call_js_1 = require("../../../../../transaction/prepare-contract-call.js");
const encodeAbiParameters_js_1 = require("../../../../../utils/abi/encodeAbiParameters.js");
const once_js_1 = require("../../../../../utils/promise/once.js");
const detectExtension_js_1 = require("../../../../../utils/bytecode/detectExtension.js");
exports.FN_SELECTOR = "0xbfa2f36e";
const FN_INPUTS = [
    {
        name: "_amount",
        type: "uint256",
 ...
 * ```
 */
function isUploadMetadataSupported(availableSelectors) {
 ...
 * ```
 */
function encodeUploadMetadataParams(options) {
    return (0, encodeAbiParameters_js_1.encodeAbiParameters)(FN_INPUTS, [options.amount, options.baseURI]);
}
/**
 ...
 * ```
 */
function encodeUploadMetadata(options) {
    // we do a "manual" concat here to avoid the overhead of the "concatHex" function
    // we can do this because we know the specific formats of the values
    return (exports.FN_SELECTOR +
        encodeUploadMetadataParams(options).slice(2));
}
/**
...
function uploadMetadata(options) {
    ...
    return (0, prepare_contract_call_js_1.prepareContractCall)({
        ...
        params: async () => {
            ...
            return [resolvedOptions.amount, resolvedOptions.baseURI];
        },
