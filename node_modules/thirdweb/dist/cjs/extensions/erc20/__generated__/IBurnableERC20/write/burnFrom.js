...
exports.isBurnFromSupported = isBurnFromSupported;
exports.encodeBurnFromParams = encodeBurnFromParams;
exports.encodeBurnFrom = encodeBurnFrom;
exports.burnFrom = burnFrom;
const prepare_contract_call_js_1 = require("../../../../../transaction/prepare-contract-call.js");
const encodeAbiParameters_js_1 = require("../../../../../utils/abi/encodeAbiParameters.js");
const once_js_1 = require("../../../../../utils/promise/once.js");
const detectExtension_js_1 = require("../../../../../utils/bytecode/detectExtension.js");
exports.FN_SELECTOR = "0x79cc6790";
const FN_INPUTS = [
    {
        type: "address",
        name: "account",
 ...
 * ```
 */
function isBurnFromSupported(availableSelectors) {
 ...
 * ```
 */
function encodeBurnFromParams(options) {
    return (0, encodeAbiParameters_js_1.encodeAbiParameters)(FN_INPUTS, [options.account, options.amount]);
}
/**
 ...
 * ```
 */
function encodeBurnFrom(options) {
    // we do a "manual" concat here to avoid the overhead of the "concatHex" function
    // we can do this because we know the specific formats of the values
    return (exports.FN_SELECTOR +
        encodeBurnFromParams(options).slice(2));
}
/**
...
//# sourceMappingURL=burnFrom.js.map