...
exports.isBalanceOfSupported = isBalanceOfSupported;
...
exports.FN_SELECTOR = "0x70a08231";
const FN_INPUTS = [
    {
        type: "address",
        name: "_address",
...
function encodeBalanceOfParams(options) {
    return (0, encodeAbiParameters_js_1.encodeAbiParameters)(FN_INPUTS, [options.address]);
}
/**
