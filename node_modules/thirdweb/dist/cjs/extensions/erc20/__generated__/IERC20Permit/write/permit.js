...
exports.encodePermitParams = encodePermitParams;
...
exports.FN_SELECTOR = "0xd505accf";
const FN_INPUTS = [
    {
        type: "address",
        name: "owner",
 ...
 * ```
 */
function isPermitSupported(availableSelectors) {
 ...
 * ```
 */
function encodePermitParams(options) {
 ...
 * ```
 */
function encodePermit(options) {
    // we do a "manual" concat here to avoid the overhead of the "concatHex" function
    // we can do this because we know the specific formats of the values
    return (exports.FN_SELECTOR +
        encodePermitParams(options).slice(2));
}
/**
