...
exports.isIsTrustedForwarderSupported = isIsTrustedForwarderSupported;
exports.encodeIsTrustedForwarderParams = encodeIsTrustedForwarderParams;
exports.encodeIsTrustedForwarder = encodeIsTrustedForwarder;
...
exports.FN_SELECTOR = "0x572b6c05";
const FN_INPUTS = [
    {
        type: "address",
        name: "forwarder",
 ...
 * ```
 */
function isIsTrustedForwarderSupported(availableSelectors) {
 ...
 * ```
 */
function encodeIsTrustedForwarder(options) {
