...
exports.isGetLastBlockHashSupported = isGetLastBlockHashSupported;
exports.decodeGetLastBlockHashResult = decodeGetLastBlockHashResult;
exports.getLastBlockHash = getLastBlockHash;
const read_contract_js_1 = require("../../../../../transaction/read-contract.js");
const viem_1 = require("viem");
const detectExtension_js_1 = require("../../../../../utils/bytecode/detectExtension.js");
exports.FN_SELECTOR = "0x27e86d6e";
const FN_INPUTS = [];
const FN_OUTPUTS = [
    {
 ...
 * ```
 */
function isGetLastBlockHashSupported(availableSelectors) {
 ...
 * ```
 */
function decodeGetLastBlockHashResult(result) {
 ...
 * ```
 */
async function getLastBlockHash(options) {
...
//# sourceMappingURL=getLastBlockHash.js.map