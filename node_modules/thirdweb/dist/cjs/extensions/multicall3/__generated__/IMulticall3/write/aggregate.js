...
exports.isAggregateSupported = isAggregateSupported;
exports.encodeAggregateParams = encodeAggregateParams;
...
exports.FN_SELECTOR = "0x252dba42";
const FN_INPUTS = [
    {
        components: [
            {
 ...
 * ```
 */
function isAggregateSupported(availableSelectors) {
 ...
 * ```
 */
function encodeAggregateParams(options) {
 ...
 * ```
 */
function encodeAggregate(options) {
    // we do a "manual" concat here to avoid the overhead of the "concatHex" function
    // we can do this because we know the specific formats of the values
    return (exports.FN_SELECTOR +
        encodeAggregateParams(options).slice(2));
}
/**
