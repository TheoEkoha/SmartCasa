...
exports.isGetBasefeeSupported = isGetBasefeeSupported;
exports.decodeGetBasefeeResult = decodeGetBasefeeResult;
exports.getBasefee = getBasefee;
const read_contract_js_1 = require("../../../../../transaction/read-contract.js");
const viem_1 = require("viem");
const detectExtension_js_1 = require("../../../../../utils/bytecode/detectExtension.js");
exports.FN_SELECTOR = "0x3e64a696";
const FN_INPUTS = [];
const FN_OUTPUTS = [
    {
 ...
 * ```
 */
function isGetBasefeeSupported(availableSelectors) {
 ...
 * ```
 */
function decodeGetBasefeeResult(result) {
 ...
 * ```
 */
async function getBasefee(options) {
...
//# sourceMappingURL=getBasefee.js.map