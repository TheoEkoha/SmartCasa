...
exports.isIsAdminSupported = isIsAdminSupported;
exports.encodeIsAdminParams = encodeIsAdminParams;
exports.encodeIsAdmin = encodeIsAdmin;
exports.decodeIsAdminResult = decodeIsAdminResult;
exports.isAdmin = isAdmin;
const read_contract_js_1 = require("../../../../../transaction/read-contract.js");
const encodeAbiParameters_js_1 = require("../../../../../utils/abi/encodeAbiParameters.js");
const viem_1 = require("viem");
const detectExtension_js_1 = require("../../../../../utils/bytecode/detectExtension.js");
exports.FN_SELECTOR = "0x24d7806c";
const FN_INPUTS = [
    {
        type: "address",
        name: "signer",
 ...
 * ```
 */
function encodeIsAdminParams(options) {
 ...
 * ```
 */
function encodeIsAdmin(options) {
    // we do a "manual" concat here to avoid the overhead of the "concatHex" function
    // we can do this because we know the specific formats of the values
    return (exports.FN_SELECTOR +
        encodeIsAdminParams(options).slice(2));
}
/**
 ...
 * ```
 */
function decodeIsAdminResult(result) {
