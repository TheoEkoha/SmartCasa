...
exports.isAddStakeSupported = isAddStakeSupported;
exports.encodeAddStakeParams = encodeAddStakeParams;
exports.encodeAddStake = encodeAddStake;
exports.addStake = addStake;
const prepare_contract_call_js_1 = require("../../../../../transaction/prepare-contract-call.js");
const encodeAbiParameters_js_1 = require("../../../../../utils/abi/encodeAbiParameters.js");
const once_js_1 = require("../../../../../utils/promise/once.js");
const detectExtension_js_1 = require("../../../../../utils/bytecode/detectExtension.js");
exports.FN_SELECTOR = "0x0396cb60";
const FN_INPUTS = [
    {
        type: "uint32",
 ...
 * ```
 */
function isAddStakeSupported(availableSelectors) {
 ...
 * ```
 */
function encodeAddStakeParams(options) {
    return (0, encodeAbiParameters_js_1.encodeAbiParameters)(FN_INPUTS, [options.unstakeDelaySec]);
}
/**
 ...
 * ```
 */
function encodeAddStake(options) {
