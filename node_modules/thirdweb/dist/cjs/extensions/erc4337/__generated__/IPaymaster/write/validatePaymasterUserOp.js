...
exports.isValidatePaymasterUserOpSupported = isValidatePaymasterUserOpSupported;
exports.encodeValidatePaymasterUserOpParams = encodeValidatePaymasterUserOpParams;
exports.encodeValidatePaymasterUserOp = encodeValidatePaymasterUserOp;
exports.validatePaymasterUserOp = validatePaymasterUserOp;
const prepare_contract_call_js_1 = require("../../../../../transaction/prepare-contract-call.js");
const encodeAbiParameters_js_1 = require("../../../../../utils/abi/encodeAbiParameters.js");
const once_js_1 = require("../../../../../utils/promise/once.js");
const detectExtension_js_1 = require("../../../../../utils/bytecode/detectExtension.js");
exports.FN_SELECTOR = "0xf465c77e";
const FN_INPUTS = [
    {
        type: "tuple",
        name: "userOp",
 ...
 * ```
 */
function isValidatePaymasterUserOpSupported(availableSelectors) {
 ...
 * ```
 */
function encodeValidatePaymasterUserOpParams(options) {
 ...
 * ```
 */
function encodeValidatePaymasterUserOp(options) {
    // we do a "manual" concat here to avoid the overhead of the "concatHex" function
    // we can do this because we know the specific formats of the values
    return (exports.FN_SELECTOR +
        encodeValidatePaymasterUserOpParams(options).slice(2));
}
/**
 ...
 * ```
 */
function validatePaymasterUserOp(options) {
