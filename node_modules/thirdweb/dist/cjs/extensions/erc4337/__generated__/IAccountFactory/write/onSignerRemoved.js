...
exports.isOnSignerRemovedSupported = isOnSignerRemovedSupported;
exports.encodeOnSignerRemovedParams = encodeOnSignerRemovedParams;
exports.encodeOnSignerRemoved = encodeOnSignerRemoved;
exports.onSignerRemoved = onSignerRemoved;
const prepare_contract_call_js_1 = require("../../../../../transaction/prepare-contract-call.js");
const encodeAbiParameters_js_1 = require("../../../../../utils/abi/encodeAbiParameters.js");
const once_js_1 = require("../../../../../utils/promise/once.js");
const detectExtension_js_1 = require("../../../../../utils/bytecode/detectExtension.js");
exports.FN_SELECTOR = "0x0db33003";
const FN_INPUTS = [
    {
        type: "address",
        name: "signer",
 ...
 * ```
 */
function isOnSignerRemovedSupported(availableSelectors) {
 ...
 * ```
 */
function encodeOnSignerRemovedParams(options) {
 ...
 * ```
 */
function encodeOnSignerRemoved(options) {
    // we do a "manual" concat here to avoid the overhead of the "concatHex" function
    // we can do this because we know the specific formats of the values
    return (exports.FN_SELECTOR +
        encodeOnSignerRemovedParams(options).slice(2));
}
/**
 ...
 * ```
 */
function onSignerRemoved(options) {
...
//# sourceMappingURL=onSignerRemoved.js.map