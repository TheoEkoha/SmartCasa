...
exports.isCreateAccountSupported = isCreateAccountSupported;
exports.encodeCreateAccountParams = encodeCreateAccountParams;
...
exports.FN_SELECTOR = "0xd8fd8f44";
const FN_INPUTS = [
    {
        type: "address",
        name: "admin",
 ...
 * ```
 */
function encodeCreateAccountParams(options) {
    return (0, encodeAbiParameters_js_1.encodeAbiParameters)(FN_INPUTS, [options.admin, options.data]);
}
/**
 ...
 * ```
 */
function encodeCreateAccount(options) {
    // we do a "manual" concat here to avoid the overhead of the "concatHex" function
    // we can do this because we know the specific formats of the values
    return (exports.FN_SELECTOR +
        encodeCreateAccountParams(options).slice(2));
}
/**
