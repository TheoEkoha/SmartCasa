...
exports.isEnableFeeAmountSupported = isEnableFeeAmountSupported;
exports.encodeEnableFeeAmountParams = encodeEnableFeeAmountParams;
exports.encodeEnableFeeAmount = encodeEnableFeeAmount;
exports.enableFeeAmount = enableFeeAmount;
const prepare_contract_call_js_1 = require("../../../../../transaction/prepare-contract-call.js");
const encodeAbiParameters_js_1 = require("../../../../../utils/abi/encodeAbiParameters.js");
const once_js_1 = require("../../../../../utils/promise/once.js");
const detectExtension_js_1 = require("../../../../../utils/bytecode/detectExtension.js");
exports.FN_SELECTOR = "0x8a7c195f";
const FN_INPUTS = [
    {
        type: "uint24",
        name: "fee",
 ...
 * ```
 */
function isEnableFeeAmountSupported(availableSelectors) {
 ...
 * ```
 */
function encodeEnableFeeAmountParams(options) {
    return (0, encodeAbiParameters_js_1.encodeAbiParameters)(FN_INPUTS, [options.fee, options.tickSpacing]);
}
/**
 ...
 * ```
 */
function encodeEnableFeeAmount(options) {
    // we do a "manual" concat here to avoid the overhead of the "concatHex" function
    // we can do this because we know the specific formats of the values
    return (exports.FN_SELECTOR +
        encodeEnableFeeAmountParams(options).slice(2));
}
/**
 ...
 * ```
 */
function enableFeeAmount(options) {
    ...
    return (0, prepare_contract_call_js_1.prepareContractCall)({
        ...
        params: async () => {
            ...
            return [resolvedOptions.fee, resolvedOptions.tickSpacing];
        },
