...
exports.isQuoteExactOutputSupported = isQuoteExactOutputSupported;
exports.encodeQuoteExactOutputParams = encodeQuoteExactOutputParams;
exports.encodeQuoteExactOutput = encodeQuoteExactOutput;
exports.quoteExactOutput = quoteExactOutput;
const prepare_contract_call_js_1 = require("../../../../../transaction/prepare-contract-call.js");
const encodeAbiParameters_js_1 = require("../../../../../utils/abi/encodeAbiParameters.js");
const once_js_1 = require("../../../../../utils/promise/once.js");
const detectExtension_js_1 = require("../../../../../utils/bytecode/detectExtension.js");
exports.FN_SELECTOR = "0x2f80bb1d";
const FN_INPUTS = [
    {
        type: "bytes",
        name: "path",
 ...
 * ```
 */
function isQuoteExactOutputSupported(availableSelectors) {
 ...
 * ```
 */
function encodeQuoteExactOutputParams(options) {
    return (0, encodeAbiParameters_js_1.encodeAbiParameters)(FN_INPUTS, [options.path, options.amountOut]);
}
/**
 ...
 * ```
 */
function encodeQuoteExactOutput(options) {
    // we do a "manual" concat here to avoid the overhead of the "concatHex" function
    // we can do this because we know the specific formats of the values
    return (exports.FN_SELECTOR +
        encodeQuoteExactOutputParams(options).slice(2));
}
/**
 ...
 * ```
 */
function quoteExactOutput(options) {
    ...
    return (0, prepare_contract_call_js_1.prepareContractCall)({
        ...
        params: async () => {
            ...
            return [resolvedOptions.path, resolvedOptions.amountOut];
        },
...
//# sourceMappingURL=quoteExactOutput.js.map