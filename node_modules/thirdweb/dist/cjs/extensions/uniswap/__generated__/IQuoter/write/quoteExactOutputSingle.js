...
exports.isQuoteExactOutputSingleSupported = isQuoteExactOutputSingleSupported;
exports.encodeQuoteExactOutputSingleParams = encodeQuoteExactOutputSingleParams;
exports.encodeQuoteExactOutputSingle = encodeQuoteExactOutputSingle;
exports.quoteExactOutputSingle = quoteExactOutputSingle;
const prepare_contract_call_js_1 = require("../../../../../transaction/prepare-contract-call.js");
const encodeAbiParameters_js_1 = require("../../../../../utils/abi/encodeAbiParameters.js");
const once_js_1 = require("../../../../../utils/promise/once.js");
const detectExtension_js_1 = require("../../../../../utils/bytecode/detectExtension.js");
exports.FN_SELECTOR = "0x30d07f21";
const FN_INPUTS = [
    {
        type: "address",
        name: "tokenIn",
 ...
 * ```
 */
function isQuoteExactOutputSingleSupported(availableSelectors) {
 ...
 * ```
 */
function encodeQuoteExactOutputSingleParams(options) {
 ...
 * ```
 */
function encodeQuoteExactOutputSingle(options) {
    // we do a "manual" concat here to avoid the overhead of the "concatHex" function
    // we can do this because we know the specific formats of the values
    return (exports.FN_SELECTOR +
        encodeQuoteExactOutputSingleParams(options).slice(2));
}
/**
 ...
 * ```
 */
function quoteExactOutputSingle(options) {
