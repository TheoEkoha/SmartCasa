...
exports.isSetContractURISupported = isSetContractURISupported;
exports.encodeSetContractURIParams = encodeSetContractURIParams;
exports.encodeSetContractURI = encodeSetContractURI;
exports.setContractURI = setContractURI;
const prepare_contract_call_js_1 = require("../../../../../transaction/prepare-contract-call.js");
const encodeAbiParameters_js_1 = require("../../../../../utils/abi/encodeAbiParameters.js");
const once_js_1 = require("../../../../../utils/promise/once.js");
const detectExtension_js_1 = require("../../../../../utils/bytecode/detectExtension.js");
exports.FN_SELECTOR = "0x938e3d7b";
const FN_INPUTS = [
    {
        type: "string",
        name: "_uri",
 ...
 * ```
 */
function isSetContractURISupported(availableSelectors) {
 ...
 * ```
 */
function encodeSetContractURIParams(options) {
 ...
 * ```
 */
function encodeSetContractURI(options) {
 ...
 * ```
 */
function setContractURI(options) {
