...
exports.isSetRulesEngineOverrideSupported = isSetRulesEngineOverrideSupported;
exports.encodeSetRulesEngineOverrideParams = encodeSetRulesEngineOverrideParams;
exports.encodeSetRulesEngineOverride = encodeSetRulesEngineOverride;
exports.setRulesEngineOverride = setRulesEngineOverride;
const prepare_contract_call_js_1 = require("../../../../../transaction/prepare-contract-call.js");
const encodeAbiParameters_js_1 = require("../../../../../utils/abi/encodeAbiParameters.js");
const once_js_1 = require("../../../../../utils/promise/once.js");
const detectExtension_js_1 = require("../../../../../utils/bytecode/detectExtension.js");
exports.FN_SELECTOR = "0x0eb0adb6";
const FN_INPUTS = [
    {
        type: "address",
 ...
 * ```
 */
function isSetRulesEngineOverrideSupported(availableSelectors) {
 ...
 * ```
 */
function encodeSetRulesEngineOverrideParams(options) {
    return (0, encodeAbiParameters_js_1.encodeAbiParameters)(FN_INPUTS, [options.rulesEngineAddress]);
}
/**
 ...
 * ```
 */
function encodeSetRulesEngineOverride(options) {
    // we do a "manual" concat here to avoid the overhead of the "concatHex" function
    // we can do this because we know the specific formats of the values
    return (exports.FN_SELECTOR +
        encodeSetRulesEngineOverrideParams(options).slice(2));
}
/**
 ...
 * ```
 */
function setRulesEngineOverride(options) {
    ...
    return (0, prepare_contract_call_js_1.prepareContractCall)({
        ...
        params: async () => {
            ...
            return [resolvedOptions.rulesEngineAddress];
        },
...
//# sourceMappingURL=setRulesEngineOverride.js.map