...
exports.isDeleteRuleSupported = isDeleteRuleSupported;
exports.encodeDeleteRuleParams = encodeDeleteRuleParams;
exports.encodeDeleteRule = encodeDeleteRule;
exports.deleteRule = deleteRule;
const prepare_contract_call_js_1 = require("../../../../../transaction/prepare-contract-call.js");
const encodeAbiParameters_js_1 = require("../../../../../utils/abi/encodeAbiParameters.js");
const once_js_1 = require("../../../../../utils/promise/once.js");
const detectExtension_js_1 = require("../../../../../utils/bytecode/detectExtension.js");
exports.FN_SELECTOR = "0x9d907761";
const FN_INPUTS = [
    {
        type: "bytes32",
        name: "ruleId",
 ...
 * ```
 */
function isDeleteRuleSupported(availableSelectors) {
 ...
 * ```
 */
function encodeDeleteRuleParams(options) {
    return (0, encodeAbiParameters_js_1.encodeAbiParameters)(FN_INPUTS, [options.ruleId]);
}
/**
 ...
 * ```
 */
function encodeDeleteRule(options) {
    // we do a "manual" concat here to avoid the overhead of the "concatHex" function
    // we can do this because we know the specific formats of the values
    return (exports.FN_SELECTOR +
        encodeDeleteRuleParams(options).slice(2));
}
/**
