...
exports.isGetScoreSupported = isGetScoreSupported;
exports.encodeGetScoreParams = encodeGetScoreParams;
exports.encodeGetScore = encodeGetScore;
...
exports.FN_SELECTOR = "0xd47875d0";
const FN_INPUTS = [
    {
        type: "address",
        name: "_tokenOwner",
 ...
 * ```
 */
function isGetScoreSupported(availableSelectors) {
 ...
 * ```
 */
function encodeGetScore(options) {
