...
exports.isPublishContractSupported = isPublishContractSupported;
exports.encodePublishContractParams = encodePublishContractParams;
exports.encodePublishContract = encodePublishContract;
exports.publishContract = publishContract;
const prepare_contract_call_js_1 = require("../../../../../transaction/prepare-contract-call.js");
const encodeAbiParameters_js_1 = require("../../../../../utils/abi/encodeAbiParameters.js");
const once_js_1 = require("../../../../../utils/promise/once.js");
const detectExtension_js_1 = require("../../../../../utils/bytecode/detectExtension.js");
exports.FN_SELECTOR = "0xd50299e6";
const FN_INPUTS = [
    {
        type: "address",
        name: "publisher",
 ...
 * ```
 */
function isPublishContractSupported(availableSelectors) {
 ...
 * ```
 */
function encodePublishContractParams(options) {
 ...
 * ```
 */
function encodePublishContract(options) {
    // we do a "manual" concat here to avoid the overhead of the "concatHex" function
    // we can do this because we know the specific formats of the values
    return (exports.FN_SELECTOR +
        encodePublishContractParams(options).slice(2));
}
/**
