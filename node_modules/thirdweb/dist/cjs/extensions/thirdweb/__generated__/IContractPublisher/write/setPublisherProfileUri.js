...
exports.isSetPublisherProfileUriSupported = isSetPublisherProfileUriSupported;
exports.encodeSetPublisherProfileUriParams = encodeSetPublisherProfileUriParams;
exports.encodeSetPublisherProfileUri = encodeSetPublisherProfileUri;
exports.setPublisherProfileUri = setPublisherProfileUri;
const prepare_contract_call_js_1 = require("../../../../../transaction/prepare-contract-call.js");
const encodeAbiParameters_js_1 = require("../../../../../utils/abi/encodeAbiParameters.js");
const once_js_1 = require("../../../../../utils/promise/once.js");
const detectExtension_js_1 = require("../../../../../utils/bytecode/detectExtension.js");
exports.FN_SELECTOR = "0x6e578e54";
const FN_INPUTS = [
    {
        type: "address",
        name: "publisher",
 ...
 * ```
 */
function isSetPublisherProfileUriSupported(availableSelectors) {
 ...
 * ```
 */
function encodeSetPublisherProfileUriParams(options) {
    return (0, encodeAbiParameters_js_1.encodeAbiParameters)(FN_INPUTS, [options.publisher, options.uri]);
}
/**
 ...
 * ```
 */
function encodeSetPublisherProfileUri(options) {
    // we do a "manual" concat here to avoid the overhead of the "concatHex" function
    // we can do this because we know the specific formats of the values
    return (exports.FN_SELECTOR +
        encodeSetPublisherProfileUriParams(options).slice(2));
}
/**
 ...
 * ```
 */
function setPublisherProfileUri(options) {
    ...
    return (0, prepare_contract_call_js_1.prepareContractCall)({
        ...
        params: async () => {
            ...
            return [resolvedOptions.publisher, resolvedOptions.uri];
        },
...
//# sourceMappingURL=setPublisherProfileUri.js.map