...
exports.FN_SELECTOR = "0x696b0c1a";
const FN_INPUTS = [
    {
        type: "tuple",
        name: "metadata",
...
function encodeSetSharedMetadataParams(options) {
    return (0, encodeAbiParameters_js_1.encodeAbiParameters)(FN_INPUTS, [options.metadata, options.id]);
}
/**
...
function setSharedMetadata(options) {
    ...
    return (0, prepare_contract_call_js_1.prepareContractCall)({
        ...
        params: async () => {
            ...
            return [resolvedOptions.metadata, resolvedOptions.id];
        },
