...
exports.isDepositRewardTokensSupported = isDepositRewardTokensSupported;
exports.encodeDepositRewardTokensParams = encodeDepositRewardTokensParams;
exports.encodeDepositRewardTokens = encodeDepositRewardTokens;
exports.depositRewardTokens = depositRewardTokens;
const prepare_contract_call_js_1 = require("../../../../../transaction/prepare-contract-call.js");
const encodeAbiParameters_js_1 = require("../../../../../utils/abi/encodeAbiParameters.js");
const once_js_1 = require("../../../../../utils/promise/once.js");
const detectExtension_js_1 = require("../../../../../utils/bytecode/detectExtension.js");
exports.FN_SELECTOR = "0x16c621e0";
const FN_INPUTS = [
    {
        type: "uint256",
        name: "_amount",
 ...
 * @example
 * ```ts
 * import { isDepositRewardTokensSupported } from "thirdweb/extensions/erc721";
 *
 * const supported = isDepositRewardTokensSupported(["0x..."]);
 * ```
 */
function isDepositRewardTokensSupported(availableSelectors) {
 ...
 * ```
 */
function encodeDepositRewardTokensParams(options) {
 ...
 * @example
 * ```ts
 * import { encodeDepositRewardTokens } "thirdweb/extensions/erc721";
 * const result = encodeDepositRewardTokens({
 *  amount: ...,
 * });
 * ```
 */
function encodeDepositRewardTokens(options) {
    // we do a "manual" concat here to avoid the overhead of the "concatHex" function
    // we can do this because we know the specific formats of the values
    return (exports.FN_SELECTOR +
        encodeDepositRewardTokensParams(options).slice(2));
}
/**
 ...
 * ```
 */
function depositRewardTokens(options) {
...
//# sourceMappingURL=depositRewardTokens.js.map