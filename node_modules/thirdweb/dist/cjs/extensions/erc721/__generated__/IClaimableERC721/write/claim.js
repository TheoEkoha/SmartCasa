...
exports.FN_SELECTOR = "0xaad3ec96";
const FN_INPUTS = [
    {
        type: "address",
        name: "_receiver",
...
function encodeClaimParams(options) {
    return (0, encodeAbiParameters_js_1.encodeAbiParameters)(FN_INPUTS, [options.receiver, options.quantity]);
}
/**
...
function claim(options) {
    ...
    return (0, prepare_contract_call_js_1.prepareContractCall)({
        ...
        params: async () => {
            ...
            return [resolvedOptions.receiver, resolvedOptions.quantity];
        },
