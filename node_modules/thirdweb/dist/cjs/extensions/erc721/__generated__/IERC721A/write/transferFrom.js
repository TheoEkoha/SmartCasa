...
exports.isTransferFromSupported = isTransferFromSupported;
exports.encodeTransferFromParams = encodeTransferFromParams;
...
exports.FN_SELECTOR = "0x23b872dd";
const FN_INPUTS = [
    {
        type: "address",
        name: "from",
 ...
 * ```
 */
function encodeTransferFromParams(options) {
 ...
 * @example
 * ```ts
 * import { encodeTransferFrom } "thirdweb/extensions/erc721";
 ...
 * ```
 */
function encodeTransferFrom(options) {
    // we do a "manual" concat here to avoid the overhead of the "concatHex" function
    // we can do this because we know the specific formats of the values
    return (exports.FN_SELECTOR +
        encodeTransferFromParams(options).slice(2));
}
/**
