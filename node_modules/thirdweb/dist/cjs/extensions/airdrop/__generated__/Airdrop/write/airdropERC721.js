...
exports.isAirdropERC721Supported = isAirdropERC721Supported;
exports.encodeAirdropERC721Params = encodeAirdropERC721Params;
exports.encodeAirdropERC721 = encodeAirdropERC721;
exports.airdropERC721 = airdropERC721;
const prepare_contract_call_js_1 = require("../../../../../transaction/prepare-contract-call.js");
const encodeAbiParameters_js_1 = require("../../../../../utils/abi/encodeAbiParameters.js");
const once_js_1 = require("../../../../../utils/promise/once.js");
const detectExtension_js_1 = require("../../../../../utils/bytecode/detectExtension.js");
exports.FN_SELECTOR = "0x6d582ebe";
const FN_INPUTS = [
    {
        name: "_tokenAddress",
        type: "address",
 ...
 * ```
 */
function isAirdropERC721Supported(availableSelectors) {
 ...
 * ```
 */
function encodeAirdropERC721Params(options) {
 ...
 * ```
 */
function encodeAirdropERC721(options) {
    // we do a "manual" concat here to avoid the overhead of the "concatHex" function
    // we can do this because we know the specific formats of the values
    return (exports.FN_SELECTOR +
        encodeAirdropERC721Params(options).slice(2));
}
/**
 ...
 * ```
 */
function airdropERC721(options) {
...
//# sourceMappingURL=airdropERC721.js.map