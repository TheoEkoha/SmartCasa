...
exports.isPayeeCountSupported = isPayeeCountSupported;
exports.decodePayeeCountResult = decodePayeeCountResult;
exports.payeeCount = payeeCount;
const read_contract_js_1 = require("../../../../../transaction/read-contract.js");
const viem_1 = require("viem");
const detectExtension_js_1 = require("../../../../../utils/bytecode/detectExtension.js");
exports.FN_SELECTOR = "0x00dbe109";
const FN_INPUTS = [];
const FN_OUTPUTS = [
    {
        type: "uint256",
 ...
 * ```
 */
function isPayeeCountSupported(availableSelectors) {
 ...
 * ```
 */
function decodePayeeCountResult(result) {
 ...
 * ```
 */
async function payeeCount(options) {
...
//# sourceMappingURL=payeeCount.js.map