...
exports.isReleasedSupported = isReleasedSupported;
exports.encodeReleasedParams = encodeReleasedParams;
exports.encodeReleased = encodeReleased;
exports.decodeReleasedResult = decodeReleasedResult;
exports.released = released;
const read_contract_js_1 = require("../../../../../transaction/read-contract.js");
const encodeAbiParameters_js_1 = require("../../../../../utils/abi/encodeAbiParameters.js");
const viem_1 = require("viem");
const detectExtension_js_1 = require("../../../../../utils/bytecode/detectExtension.js");
exports.FN_SELECTOR = "0x9852595c";
const FN_INPUTS = [
    {
        type: "address",
        name: "account",
 ...
 * ```
 */
function isReleasedSupported(availableSelectors) {
 ...
 * ```
 */
function encodeReleasedParams(options) {
 ...
 * ```
 */
function encodeReleased(options) {
    // we do a "manual" concat here to avoid the overhead of the "concatHex" function
    // we can do this because we know the specific formats of the values
    return (exports.FN_SELECTOR +
        encodeReleasedParams(options).slice(2));
}
/**
 ...
 * ```
 */
function decodeReleasedResult(result) {
 ...
 * ```
 */
async function released(options) {
