...
exports.isTotalReleasedSupported = isTotalReleasedSupported;
exports.decodeTotalReleasedResult = decodeTotalReleasedResult;
exports.totalReleased = totalReleased;
const read_contract_js_1 = require("../../../../../transaction/read-contract.js");
const viem_1 = require("viem");
const detectExtension_js_1 = require("../../../../../utils/bytecode/detectExtension.js");
exports.FN_SELECTOR = "0xe33b7de3";
const FN_INPUTS = [];
const FN_OUTPUTS = [
    {
        type: "uint256",
 ...
 * ```
 */
function isTotalReleasedSupported(availableSelectors) {
 ...
 * ```
 */
function decodeTotalReleasedResult(result) {
 ...
 * ```
 */
async function totalReleased(options) {
...
//# sourceMappingURL=totalReleased.js.map