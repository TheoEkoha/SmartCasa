...
exports.isReleaseSupported = isReleaseSupported;
exports.encodeReleaseParams = encodeReleaseParams;
...
exports.FN_SELECTOR = "0x19165587";
const FN_INPUTS = [
    {
        type: "address",
        name: "account",
 ...
 * ```
 */
function isReleaseSupported(availableSelectors) {
 ...
 * ```
 */
function encodeReleaseParams(options) {
 ...
 * ```
 */
function encodeRelease(options) {
    // we do a "manual" concat here to avoid the overhead of the "concatHex" function
    // we can do this because we know the specific formats of the values
    return (exports.FN_SELECTOR +
        encodeReleaseParams(options).slice(2));
}
/**
...
function release(options) {
    ...
    return (0, prepare_contract_call_js_1.prepareContractCall)({
        ...
        params: async () => {
            ...
            return [resolvedOptions.account];
        },
