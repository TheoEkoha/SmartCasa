...
exports.isTotalSharesSupported = isTotalSharesSupported;
exports.decodeTotalSharesResult = decodeTotalSharesResult;
exports.totalShares = totalShares;
const read_contract_js_1 = require("../../../../../transaction/read-contract.js");
const viem_1 = require("viem");
const detectExtension_js_1 = require("../../../../../utils/bytecode/detectExtension.js");
exports.FN_SELECTOR = "0x3a98ef39";
const FN_INPUTS = [];
const FN_OUTPUTS = [
    {
        type: "uint256",
 ...
 * ```
 */
function isTotalSharesSupported(availableSelectors) {
 ...
 * ```
 */
function decodeTotalSharesResult(result) {
 ...
 * ```
 */
async function totalShares(options) {
