...
exports.isGetLocalNameSupported = isGetLocalNameSupported;
exports.encodeGetLocalNameParams = encodeGetLocalNameParams;
exports.encodeGetLocalName = encodeGetLocalName;
exports.decodeGetLocalNameResult = decodeGetLocalNameResult;
exports.getLocalName = getLocalName;
const read_contract_js_1 = require("../../../../../transaction/read-contract.js");
const encodeAbiParameters_js_1 = require("../../../../../utils/abi/encodeAbiParameters.js");
const viem_1 = require("viem");
const detectExtension_js_1 = require("../../../../../utils/bytecode/detectExtension.js");
exports.FN_SELECTOR = "0x4985e504";
const FN_INPUTS = [
    {
        type: "uint256",
        name: "tokenId",
 ...
 * ```
 */
function isGetLocalNameSupported(availableSelectors) {
 ...
 * ```
 */
function encodeGetLocalNameParams(options) {
 ...
 * ```
 */
function encodeGetLocalName(options) {
    // we do a "manual" concat here to avoid the overhead of the "concatHex" function
    // we can do this because we know the specific formats of the values
    return (exports.FN_SELECTOR +
        encodeGetLocalNameParams(options).slice(2));
}
/**
 ...
 * ```
 */
function decodeGetLocalNameResult(result) {
 ...
 * ```
 */
async function getLocalName(options) {
...
//# sourceMappingURL=getLocalName.js.map