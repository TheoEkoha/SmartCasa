...
exports.isGetTokenIdSupported = isGetTokenIdSupported;
exports.encodeGetTokenIdParams = encodeGetTokenIdParams;
exports.encodeGetTokenId = encodeGetTokenId;
exports.decodeGetTokenIdResult = decodeGetTokenIdResult;
exports.getTokenId = getTokenId;
const read_contract_js_1 = require("../../../../../transaction/read-contract.js");
const encodeAbiParameters_js_1 = require("../../../../../utils/abi/encodeAbiParameters.js");
const viem_1 = require("viem");
const detectExtension_js_1 = require("../../../../../utils/bytecode/detectExtension.js");
exports.FN_SELECTOR = "0x1e7663bc";
const FN_INPUTS = [
    {
        type: "string",
        name: "localName",
 ...
 * ```
 */
function isGetTokenIdSupported(availableSelectors) {
 ...
 * ```
 */
function encodeGetTokenIdParams(options) {
    return (0, encodeAbiParameters_js_1.encodeAbiParameters)(FN_INPUTS, [options.localName]);
}
/**
 ...
 * ```
 */
function encodeGetTokenId(options) {
    // we do a "manual" concat here to avoid the overhead of the "concatHex" function
    // we can do this because we know the specific formats of the values
    return (exports.FN_SELECTOR +
        encodeGetTokenIdParams(options).slice(2));
}
/**
 ...
 * ```
 */
function decodeGetTokenIdResult(result) {
 ...
 * ```
 */
async function getTokenId(options) {
...
//# sourceMappingURL=getTokenId.js.map