...
exports.isGetHandleSupported = isGetHandleSupported;
exports.encodeGetHandleParams = encodeGetHandleParams;
exports.encodeGetHandle = encodeGetHandle;
exports.decodeGetHandleResult = decodeGetHandleResult;
exports.getHandle = getHandle;
const read_contract_js_1 = require("../../../../../transaction/read-contract.js");
const encodeAbiParameters_js_1 = require("../../../../../utils/abi/encodeAbiParameters.js");
const viem_1 = require("viem");
const detectExtension_js_1 = require("../../../../../utils/bytecode/detectExtension.js");
exports.FN_SELECTOR = "0xec81d194";
const FN_INPUTS = [
    {
        type: "uint256",
        name: "tokenId",
 ...
 * ```
 */
function isGetHandleSupported(availableSelectors) {
 ...
 * ```
 */
function encodeGetHandleParams(options) {
 ...
 * ```
 */
function encodeGetHandle(options) {
    // we do a "manual" concat here to avoid the overhead of the "concatHex" function
    // we can do this because we know the specific formats of the values
    return (exports.FN_SELECTOR +
        encodeGetHandleParams(options).slice(2));
}
/**
 ...
 * ```
 */
function decodeGetHandleResult(result) {
...
//# sourceMappingURL=getHandle.js.map