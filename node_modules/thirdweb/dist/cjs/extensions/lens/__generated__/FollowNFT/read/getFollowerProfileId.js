...
exports.isGetFollowerProfileIdSupported = isGetFollowerProfileIdSupported;
exports.encodeGetFollowerProfileIdParams = encodeGetFollowerProfileIdParams;
exports.encodeGetFollowerProfileId = encodeGetFollowerProfileId;
exports.decodeGetFollowerProfileIdResult = decodeGetFollowerProfileIdResult;
exports.getFollowerProfileId = getFollowerProfileId;
const read_contract_js_1 = require("../../../../../transaction/read-contract.js");
const encodeAbiParameters_js_1 = require("../../../../../utils/abi/encodeAbiParameters.js");
const viem_1 = require("viem");
const detectExtension_js_1 = require("../../../../../utils/bytecode/detectExtension.js");
exports.FN_SELECTOR = "0x886a65c3";
const FN_INPUTS = [
    {
        type: "uint256",
        name: "followTokenId",
 ...
 * ```
 */
function isGetFollowerProfileIdSupported(availableSelectors) {
 ...
 * ```
 */
function encodeGetFollowerProfileIdParams(options) {
 ...
 * ```
 */
function encodeGetFollowerProfileId(options) {
    // we do a "manual" concat here to avoid the overhead of the "concatHex" function
    // we can do this because we know the specific formats of the values
    return (exports.FN_SELECTOR +
        encodeGetFollowerProfileIdParams(options).slice(2));
}
/**
 ...
 * ```
 */
function decodeGetFollowerProfileIdResult(result) {
 ...
 * ```
 */
async function getFollowerProfileId(options) {
...
//# sourceMappingURL=getFollowerProfileId.js.map