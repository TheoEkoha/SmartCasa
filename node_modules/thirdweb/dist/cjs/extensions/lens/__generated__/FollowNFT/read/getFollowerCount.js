...
exports.isGetFollowerCountSupported = isGetFollowerCountSupported;
exports.decodeGetFollowerCountResult = decodeGetFollowerCountResult;
exports.getFollowerCount = getFollowerCount;
const read_contract_js_1 = require("../../../../../transaction/read-contract.js");
const viem_1 = require("viem");
const detectExtension_js_1 = require("../../../../../utils/bytecode/detectExtension.js");
exports.FN_SELECTOR = "0x7829ae4a";
const FN_INPUTS = [];
const FN_OUTPUTS = [
    {
        type: "uint256",
 ...
 * ```
 */
function isGetFollowerCountSupported(availableSelectors) {
 ...
 * ```
 */
function decodeGetFollowerCountResult(result) {
 ...
 * ```
 */
async function getFollowerCount(options) {
