...
exports.isCastVoteBySigSupported = isCastVoteBySigSupported;
exports.encodeCastVoteBySigParams = encodeCastVoteBySigParams;
exports.encodeCastVoteBySig = encodeCastVoteBySig;
exports.castVoteBySig = castVoteBySig;
const prepare_contract_call_js_1 = require("../../../../../transaction/prepare-contract-call.js");
const encodeAbiParameters_js_1 = require("../../../../../utils/abi/encodeAbiParameters.js");
const once_js_1 = require("../../../../../utils/promise/once.js");
const detectExtension_js_1 = require("../../../../../utils/bytecode/detectExtension.js");
exports.FN_SELECTOR = "0x3bccf4fd";
const FN_INPUTS = [
    {
        type: "uint256",
        name: "proposalId",
 ...
 * ```
 */
function isCastVoteBySigSupported(availableSelectors) {
 ...
 * ```
 */
function encodeCastVoteBySigParams(options) {
 ...
 * ```
 */
function encodeCastVoteBySig(options) {
    // we do a "manual" concat here to avoid the overhead of the "concatHex" function
    // we can do this because we know the specific formats of the values
    return (exports.FN_SELECTOR +
        encodeCastVoteBySigParams(options).slice(2));
}
/**
 ...
 * ```
 */
function castVoteBySig(options) {
...
//# sourceMappingURL=castVoteBySig.js.map