...
exports.isVotingPeriodSupported = isVotingPeriodSupported;
exports.decodeVotingPeriodResult = decodeVotingPeriodResult;
exports.votingPeriod = votingPeriod;
const read_contract_js_1 = require("../../../../../transaction/read-contract.js");
const viem_1 = require("viem");
const detectExtension_js_1 = require("../../../../../utils/bytecode/detectExtension.js");
exports.FN_SELECTOR = "0x02a251a3";
const FN_INPUTS = [];
const FN_OUTPUTS = [
    {
        type: "uint256",
 ...
 * ```
 */
function isVotingPeriodSupported(availableSelectors) {
 ...
 * ```
 */
function decodeVotingPeriodResult(result) {
 ...
 * ```
 */
async function votingPeriod(options) {
...
//# sourceMappingURL=votingPeriod.js.map