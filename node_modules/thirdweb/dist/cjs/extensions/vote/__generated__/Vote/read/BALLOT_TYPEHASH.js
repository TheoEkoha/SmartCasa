...
exports.isBALLOT_TYPEHASHSupported = isBALLOT_TYPEHASHSupported;
exports.decodeBALLOT_TYPEHASHResult = decodeBALLOT_TYPEHASHResult;
exports.BALLOT_TYPEHASH = BALLOT_TYPEHASH;
const read_contract_js_1 = require("../../../../../transaction/read-contract.js");
const viem_1 = require("viem");
const detectExtension_js_1 = require("../../../../../utils/bytecode/detectExtension.js");
exports.FN_SELECTOR = "0xdeaaa7cc";
const FN_INPUTS = [];
const FN_OUTPUTS = [
    {
        type: "bytes32",
 ...
 * ```
 */
function isBALLOT_TYPEHASHSupported(availableSelectors) {
 ...
 * ```
 */
function decodeBALLOT_TYPEHASHResult(result) {
 ...
 * ```
 */
async function BALLOT_TYPEHASH(options) {
...
//# sourceMappingURL=BALLOT_TYPEHASH.js.map