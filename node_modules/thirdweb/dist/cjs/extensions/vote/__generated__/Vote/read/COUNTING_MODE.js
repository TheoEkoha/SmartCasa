...
exports.isCOUNTING_MODESupported = isCOUNTING_MODESupported;
exports.decodeCOUNTING_MODEResult = decodeCOUNTING_MODEResult;
exports.COUNTING_MODE = COUNTING_MODE;
const read_contract_js_1 = require("../../../../../transaction/read-contract.js");
const viem_1 = require("viem");
const detectExtension_js_1 = require("../../../../../utils/bytecode/detectExtension.js");
exports.FN_SELECTOR = "0xdd4e2ba5";
const FN_INPUTS = [];
const FN_OUTPUTS = [
    {
        type: "string",
 ...
 * ```
 */
function isCOUNTING_MODESupported(availableSelectors) {
 ...
 * ```
 */
function decodeCOUNTING_MODEResult(result) {
 ...
 * ```
 */
async function COUNTING_MODE(options) {
...
//# sourceMappingURL=COUNTING_MODE.js.map