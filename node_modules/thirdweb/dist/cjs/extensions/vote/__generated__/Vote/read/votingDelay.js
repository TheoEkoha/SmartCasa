...
exports.isVotingDelaySupported = isVotingDelaySupported;
exports.decodeVotingDelayResult = decodeVotingDelayResult;
exports.votingDelay = votingDelay;
const read_contract_js_1 = require("../../../../../transaction/read-contract.js");
const viem_1 = require("viem");
const detectExtension_js_1 = require("../../../../../utils/bytecode/detectExtension.js");
exports.FN_SELECTOR = "0x3932abb1";
const FN_INPUTS = [];
const FN_OUTPUTS = [
    {
        type: "uint256",
 ...
 * ```
 */
function isVotingDelaySupported(availableSelectors) {
 ...
 * ```
 */
function decodeVotingDelayResult(result) {
 ...
 * ```
 */
async function votingDelay(options) {
...
//# sourceMappingURL=votingDelay.js.map