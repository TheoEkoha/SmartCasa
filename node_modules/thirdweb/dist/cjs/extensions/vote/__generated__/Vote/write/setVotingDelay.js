...
exports.isSetVotingDelaySupported = isSetVotingDelaySupported;
exports.encodeSetVotingDelayParams = encodeSetVotingDelayParams;
exports.encodeSetVotingDelay = encodeSetVotingDelay;
exports.setVotingDelay = setVotingDelay;
const prepare_contract_call_js_1 = require("../../../../../transaction/prepare-contract-call.js");
const encodeAbiParameters_js_1 = require("../../../../../utils/abi/encodeAbiParameters.js");
const once_js_1 = require("../../../../../utils/promise/once.js");
const detectExtension_js_1 = require("../../../../../utils/bytecode/detectExtension.js");
exports.FN_SELECTOR = "0x70b0f660";
const FN_INPUTS = [
    {
        type: "uint256",
        name: "newVotingDelay",
 ...
 * ```
 */
function isSetVotingDelaySupported(availableSelectors) {
 ...
 * ```
 */
function encodeSetVotingDelayParams(options) {
    return (0, encodeAbiParameters_js_1.encodeAbiParameters)(FN_INPUTS, [options.newVotingDelay]);
}
/**
 ...
 * ```
 */
function encodeSetVotingDelay(options) {
    // we do a "manual" concat here to avoid the overhead of the "concatHex" function
    // we can do this because we know the specific formats of the values
    return (exports.FN_SELECTOR +
        encodeSetVotingDelayParams(options).slice(2));
}
/**
 ...
 * ```
 */
function setVotingDelay(options) {
    ...
    return (0, prepare_contract_call_js_1.prepareContractCall)({
        ...
        params: async () => {
            ...
            return [resolvedOptions.newVotingDelay];
        },
...
//# sourceMappingURL=setVotingDelay.js.map