...
exports.isUpdateQuorumNumeratorSupported = isUpdateQuorumNumeratorSupported;
exports.encodeUpdateQuorumNumeratorParams = encodeUpdateQuorumNumeratorParams;
exports.encodeUpdateQuorumNumerator = encodeUpdateQuorumNumerator;
exports.updateQuorumNumerator = updateQuorumNumerator;
const prepare_contract_call_js_1 = require("../../../../../transaction/prepare-contract-call.js");
const encodeAbiParameters_js_1 = require("../../../../../utils/abi/encodeAbiParameters.js");
const once_js_1 = require("../../../../../utils/promise/once.js");
const detectExtension_js_1 = require("../../../../../utils/bytecode/detectExtension.js");
exports.FN_SELECTOR = "0x06f3f9e6";
const FN_INPUTS = [
    {
        type: "uint256",
 ...
 * ```
 */
function isUpdateQuorumNumeratorSupported(availableSelectors) {
 ...
 * ```
 */
function encodeUpdateQuorumNumeratorParams(options) {
    return (0, encodeAbiParameters_js_1.encodeAbiParameters)(FN_INPUTS, [options.newQuorumNumerator]);
}
/**
 ...
 * ```
 */
function encodeUpdateQuorumNumerator(options) {
    // we do a "manual" concat here to avoid the overhead of the "concatHex" function
    // we can do this because we know the specific formats of the values
    return (exports.FN_SELECTOR +
        encodeUpdateQuorumNumeratorParams(options).slice(2));
}
/**
 ...
 * ```
 */
function updateQuorumNumerator(options) {
    ...
    return (0, prepare_contract_call_js_1.prepareContractCall)({
        ...
        params: async () => {
            ...
            return [resolvedOptions.newQuorumNumerator];
        },
...
//# sourceMappingURL=updateQuorumNumerator.js.map