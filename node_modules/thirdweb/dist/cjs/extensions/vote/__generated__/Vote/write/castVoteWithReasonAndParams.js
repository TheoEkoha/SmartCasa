...
exports.isCastVoteWithReasonAndParamsSupported = isCastVoteWithReasonAndParamsSupported;
exports.encodeCastVoteWithReasonAndParamsParams = encodeCastVoteWithReasonAndParamsParams;
exports.encodeCastVoteWithReasonAndParams = encodeCastVoteWithReasonAndParams;
exports.castVoteWithReasonAndParams = castVoteWithReasonAndParams;
const prepare_contract_call_js_1 = require("../../../../../transaction/prepare-contract-call.js");
const encodeAbiParameters_js_1 = require("../../../../../utils/abi/encodeAbiParameters.js");
const once_js_1 = require("../../../../../utils/promise/once.js");
const detectExtension_js_1 = require("../../../../../utils/bytecode/detectExtension.js");
exports.FN_SELECTOR = "0x5f398a14";
const FN_INPUTS = [
    {
        type: "uint256",
        name: "proposalId",
 ...
 * ```
 */
function isCastVoteWithReasonAndParamsSupported(availableSelectors) {
 ...
 * ```
 */
function encodeCastVoteWithReasonAndParamsParams(options) {
 ...
 * ```
 */
function encodeCastVoteWithReasonAndParams(options) {
    // we do a "manual" concat here to avoid the overhead of the "concatHex" function
    // we can do this because we know the specific formats of the values
    return (exports.FN_SELECTOR +
        encodeCastVoteWithReasonAndParamsParams(options).slice(2));
}
/**
 ...
 * ```
 */
function castVoteWithReasonAndParams(options) {
...
//# sourceMappingURL=castVoteWithReasonAndParams.js.map