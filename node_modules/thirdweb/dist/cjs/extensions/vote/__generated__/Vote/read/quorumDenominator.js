...
exports.isQuorumDenominatorSupported = isQuorumDenominatorSupported;
exports.decodeQuorumDenominatorResult = decodeQuorumDenominatorResult;
exports.quorumDenominator = quorumDenominator;
const read_contract_js_1 = require("../../../../../transaction/read-contract.js");
const viem_1 = require("viem");
const detectExtension_js_1 = require("../../../../../utils/bytecode/detectExtension.js");
exports.FN_SELECTOR = "0x97c3d334";
const FN_INPUTS = [];
const FN_OUTPUTS = [
    {
        type: "uint256",
 ...
 * ```
 */
function isQuorumDenominatorSupported(availableSelectors) {
 ...
 * ```
 */
function decodeQuorumDenominatorResult(result) {
 ...
 * ```
 */
async function quorumDenominator(options) {
...
//# sourceMappingURL=quorumDenominator.js.map