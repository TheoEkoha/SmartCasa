...
exports.isGetRoyaltyInfoForTokenSupported = isGetRoyaltyInfoForTokenSupported;
exports.encodeGetRoyaltyInfoForTokenParams = encodeGetRoyaltyInfoForTokenParams;
exports.encodeGetRoyaltyInfoForToken = encodeGetRoyaltyInfoForToken;
...
exports.FN_SELECTOR = "0x4cc157df";
const FN_INPUTS = [
    {
        type: "uint256",
        name: "tokenId",
 ...
 * ```
 */
function isGetRoyaltyInfoForTokenSupported(availableSelectors) {
 ...
 * ```
 */
function encodeGetRoyaltyInfoForToken(options) {
