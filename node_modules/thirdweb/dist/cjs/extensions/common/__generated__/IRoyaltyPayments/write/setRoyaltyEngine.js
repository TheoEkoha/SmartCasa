...
exports.isSetRoyaltyEngineSupported = isSetRoyaltyEngineSupported;
exports.encodeSetRoyaltyEngineParams = encodeSetRoyaltyEngineParams;
exports.encodeSetRoyaltyEngine = encodeSetRoyaltyEngine;
exports.setRoyaltyEngine = setRoyaltyEngine;
const prepare_contract_call_js_1 = require("../../../../../transaction/prepare-contract-call.js");
const encodeAbiParameters_js_1 = require("../../../../../utils/abi/encodeAbiParameters.js");
const once_js_1 = require("../../../../../utils/promise/once.js");
const detectExtension_js_1 = require("../../../../../utils/bytecode/detectExtension.js");
exports.FN_SELECTOR = "0x21ede032";
const FN_INPUTS = [
    {
        type: "address",
 ...
 * ```
 */
function isSetRoyaltyEngineSupported(availableSelectors) {
 ...
 * ```
 */
function encodeSetRoyaltyEngineParams(options) {
    return (0, encodeAbiParameters_js_1.encodeAbiParameters)(FN_INPUTS, [options.royaltyEngineAddress]);
}
/**
 ...
 * ```
 */
function encodeSetRoyaltyEngine(options) {
    // we do a "manual" concat here to avoid the overhead of the "concatHex" function
    // we can do this because we know the specific formats of the values
    return (exports.FN_SELECTOR +
        encodeSetRoyaltyEngineParams(options).slice(2));
}
/**
 ...
 * ```
 */
function setRoyaltyEngine(options) {
    ...
    return (0, prepare_contract_call_js_1.prepareContractCall)({
        ...
        params: async () => {
            ...
            return [resolvedOptions.royaltyEngineAddress];
        },
...
//# sourceMappingURL=setRoyaltyEngine.js.map