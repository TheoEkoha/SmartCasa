...
exports.isSetPlatformFeeInfoSupported = isSetPlatformFeeInfoSupported;
exports.encodeSetPlatformFeeInfoParams = encodeSetPlatformFeeInfoParams;
exports.encodeSetPlatformFeeInfo = encodeSetPlatformFeeInfo;
exports.setPlatformFeeInfo = setPlatformFeeInfo;
const prepare_contract_call_js_1 = require("../../../../../transaction/prepare-contract-call.js");
const encodeAbiParameters_js_1 = require("../../../../../utils/abi/encodeAbiParameters.js");
const once_js_1 = require("../../../../../utils/promise/once.js");
const detectExtension_js_1 = require("../../../../../utils/bytecode/detectExtension.js");
exports.FN_SELECTOR = "0x1e7ac488";
const FN_INPUTS = [
    {
        type: "address",
 ...
 * ```
 */
function isSetPlatformFeeInfoSupported(availableSelectors) {
 ...
 * ```
 */
function encodeSetPlatformFeeInfoParams(options) {
 ...
 * ```
 */
function encodeSetPlatformFeeInfo(options) {
 ...
 * ```
 */
function setPlatformFeeInfo(options) {
