...
exports.resolveContractAbi = resolveContractAbi;
exports.resolveAbiFromContractApi = resolveAbiFromContractApi;
exports.resolveAbiFromBytecode = resolveAbiFromBytecode;
exports.resolveCompositeAbi = resolveCompositeAbi;
const abitype_1 = require("abitype");
const getInstalledModules_js_1 = require("../../extensions/modular/__generated__/ModularCore/read/getInstalledModules.js");
const download_js_1 = require("../../storage/download.js");
const extractIPFS_js_1 = require("../../utils/bytecode/extractIPFS.js");
const fetch_js_1 = require("../../utils/fetch.js");
const get_bytecode_js_1 = require("./get-bytecode.js");
...
contract, contractApiBaseUrl = "https://contract.thirdweb.com/abi") {
    const response = await (0, fetch_js_1.getClientFetch)(contract.client)(`${contractApiBaseUrl}/${contract.chain.id}/${contract.address}`);
...
async function resolvePluginPatternAddresses(contract) {
    try {
        const { readContract } = await Promise.resolve().then(() => require("../../transaction/read-contract.js"));
...
function joinAbis(options) {
    ...
    const humanReadableAbi = [...new Set((0, abitype_1.formatAbi)(mergedPlugins))];
    // finally parse it back out
    return (0, abitype_1.parseAbi)(humanReadableAbi);
}
