...
var SVGComponent = function SVGComponent(props) {
  return /*#__PURE__*/_jsx("svg", {
    ...
    children: /*#__PURE__*/_jsx("path", {
      d: "m1726.6 681.4-129.8-230.6 251.5.1c6.7 0 14.6 4.5 18.2 10.5 4 6.6 24.4 40.3 49 80.7 29.4 48.4 64.5 106.3 84.6 139.3h-273.5zM1261.4 2078c-6.1 10.9-14 10.9-16.6 10.9H1142c-54.4 0-117.1-.1-154.5-.1l399.6-717.4c10.4-18.5 3.7-42-14.8-52.3-5.7-3.2-12.1-4.9-18.6-4.9l-681 .9-135.5-234.5H1529.8c.6 0 1.1-.2 1.6-.2 2.2-.1 4.4-.4 6.6-.9 1.6-.4 3.3-.9 4.8-1.5.8-.3 1.7-.7 2.5-1 7.7-3.3 14.1-9.1 18.2-16.5L1727 758.2h270L1261.4 2078zm-340.3-27.3c-8.7-14.3-20-32.9-32.3-53.1-41.3-68.2-94.2-155.5-100.2-165.1-2-3.2-2.9-11.1 1.3-18.7 9.6-17.2 190.4-343 234.5-422.4l264.1-.3-367.4 659.6zm-450.3-448.9-131.3-233.2 132.3-248 132.7 229.7c-41.2 77.7-105.6 198.8-133.7 251.5zm-176.2 36.3h-143c-6.5 0-14.4-4.6-18-10.5l-42.7-70.4C60.4 1507 21.5 1442.9 0 1407.5h273.4l129.8 230.6H294.6zM738.6 11c6.1-11 14-11 16.5-11h258.3L612.7 717.4c-.3.6-.5 1.2-.8 1.9-.6 1.2-1.1 2.4-1.6 3.7-.4 1.2-.8 2.4-1.1 3.7s-.6 2.3-.8 3.5c-.2 1.4-.4 2.8-.4 4.3 0 .6-.2 1.2-.2 1.9 0 .5.1.9.2 1.4 0 1.4.2 2.8.4 4.2.1 1.2.3 2.3.6 3.5.3 1.2.7 2.4 1.1 3.6.4 1.2.8 2.3 1.3 3.5s1.1 2.2 1.7 3.2 1.2 2.1 2 3.1c.7 1 1.5 2 2.4 2.9.8.9 1.6 1.8 2.5 2.7s1.8 1.5 2.8 2.3c1.1.8 2.2 1.6 3.3 2.3l1.2.9c.4.3.9.3 1.4.6 2 1 4.1 1.9 6.2 2.5.8.2 1.5.5 2.3.7 2.8.7 5.7 1.1 8.7 1.1h17.4l663.9-.9c17.6 30.5 50.4 88 78.3 136.9 21.4 37.6 39.2 68.6 53.2 93h-988c-.4 0-.8.1-1.3.2-13.9.1-26.6 7.9-33.2 20.1l-163.6 306.6H3.1C120.8 1119.3 730.7 25 738.6 11zm340.8 28.1 24 39.5c42.1 69.5 101.6 167.6 107.9 177.8 2 3.2 2.9 11.1-1.3 18.7L975.6 697.3l-264 .3 367.8-658.5zm449.7 447.8 131.3 233.3-133.9 247.5c-16-27.8-35.8-62.6-54.4-95.2-36.8-64.4-63.6-111.3-78.7-137.5 28.7-52.2 104.1-190.5 135.7-248.1z",
      fillRule: "evenodd",
      clipRule: "evenodd"
    })
  });
...
SVGComponent.defaultProps = {
  ...
  viewBox: "0 0 2000 2088.9",
  xmlSpace: "preserve",
  enableBackground: "new 0 0 2000 2088.9"
};
...
export const HnsColorful = /*#__PURE__*/React.forwardRef((props, ref) => {
  const {
    getPrefixCls
