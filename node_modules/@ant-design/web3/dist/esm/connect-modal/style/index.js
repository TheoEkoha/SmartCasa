      ...
      [`${componentCls}-list-panel`]: {
        ...
        [`${componentCls}-footer-container`]: {
          ...
          [`&::before`]: {
            ...
            backgroundImage: `linear-gradient(to bottom, ${new TinyColor(token.colorBgContainer).setAlpha(0).toRgbString()}, ${new TinyColor(token.colorBgContainer).setAlpha(1).toRgbString()})`,
            pointerEvents: 'none'
          }
        },
        [`${componentCls}-footer`]: {
...
export function useStyle(prefixCls) {
  return useAntdStyle('ConnectModal', token => {
    ...
    const hoverBg = new TinyColor(isDark ? token.colorWhite : '#000').setAlpha(0.08).onBackground(token.colorBgContainer).toRgbString();
