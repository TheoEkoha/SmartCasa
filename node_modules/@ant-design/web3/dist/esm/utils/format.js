 ...
 */
export const fillWithPrefix = (address = '', prefixProp, prefixContext) => {
...
export const formatAddress = (address = '', groupSize = 4) => {
...
export const formatBalance = (value, decimals, fixed) => {
