...
import type { ConnectOptions, ConnectorTriggerProps, Locale, Wallet } from '@ant-design/web3-common';
...
export type ConnectModalProps = ModalProps & ConnectorTriggerProps & {
    /**
     * @desc 选中钱包回调
