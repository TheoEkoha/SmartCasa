...
var _createGetBrowserLink = require("./createGetBrowserLink");
Object.keys(_createGetBrowserLink).forEach(function (key) {
  if (key === "default" || key === "__esModule") return;
  if (key in exports && exports[key] === _createGetBrowserLink[key]) return;
  Object.defineProperty(exports, key, {
    enumerable: true,
    get: function () {
      return _createGetBrowserLink[key];
    }
  });
});
