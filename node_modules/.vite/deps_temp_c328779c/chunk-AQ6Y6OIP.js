...
function TOS(props) {
  ...
  return (0, import_jsx_runtime.jsx)(Container, { flex: "row", center: "x", children: (0, import_jsx_runtime.jsxs)(Text, { size: "xs", multiline: true, balance: true, inline: true, center: true, style: {
    maxWidth: "250px"
  }, children: [requireApproval && (0, import_jsx_runtime.jsx)("input", { style: {
    transform: "translateY(3px)",
    marginRight: spacing["3xs"]
  }, type: "checkbox", onChange: props.onApprove, checked: props.isApproved, disabled: !requireApproval }), locale.prefix, " ", termsOfServiceUrl && (0, import_jsx_runtime.jsxs)(Link, { inline: true, size: "xs", href: termsOfServiceUrl, target: "_blank", style: {
    whiteSpace: "nowrap"
  }, children: [" ", locale.termsOfService, " "] }), bothGiven && `${locale.and} `, privacyPolicyUrl && (0, import_jsx_runtime.jsx)(Link, { inline: true, size: "xs", href: privacyPolicyUrl, target: "_blank", children: locale.privacyPolicy }), !privacyPolicyUrl && !termsOfServiceUrl && (0, import_jsx_runtime.jsx)(Text, { inline: true, size: "xs", children: "Terms of Service and Privacy Policy" })] }) });
}
...
//# sourceMappingURL=chunk-AQ6Y6OIP.js.map
