...
import {
  isERC721
} from "./chunk-JUGOK72B.js";
import {
  isERC1155
} from "./chunk-RXMACMWB.js";
import {
  Fuse,
  useDebouncedValue,
  useShowMore
...
import {
  getNFT as getNFT2
} from "./chunk-NRB66BMT.js";
import {
  getCurrencyMetadata
} from "./chunk-JQMPMYYI.js";
import {
  deleteConnectParamsFromStorage
} from "./chunk-RMLEFI72.js";
import {
  getNFT
} from "./chunk-EUCIZN62.js";
import {
  isInAppWallet
} from "./chunk-O3JE26RG.js";
import {
  decimals
} from "./chunk-HKZELVWN.js";
import {
...
import {
  getWalletBalance
} from "./chunk-3YQHSQR5.js";
import {
  isEcosystemWallet
} from "./chunk-XLZ33T4S.js";
import {
  smartWallet
} from "./chunk-IK4CI57H.js";
import {
...
import {
  sendTransaction
} from "./chunk-AMZH42T2.js";
import {
  getGasPrice
} from "./chunk-USDSUBYK.js";
import {
...
import {
  polygon
} from "./chunk-QLICVGK2.js";
import {
  ethereum
} from "./chunk-LMWHDZPK.js";
import {
  cacheChains,
  ...
  useQueries({
    queries: wallets.filter((w) => w.id === COINBASE || w.id === "inApp" || isEcosystemWallet(w.id)).map((w) => ({
      ...
      queryFn: async () => {
        ...
        switch (true) {
          case COINBASE === w.id: {
            const { getCoinbaseWebProvider } = await import("./coinbaseWebSDK-PF3BUJDG.js");
            await getCoinbaseWebProvider(w.getConfig());
            return true;
          }
          case "inApp" === w.id: {
            const [{ InAppWebConnector }, { getOrCreateInAppWalletConnector }] = await Promise.all([
              import("./web-connector-JRRERP3Q.js"),
              import("./in-app-core-S7P3DQ4M.js")
            ]);
...
var BuyScreen = (0, import_react32.lazy)(() => import("./BuyScreen-X6CSFEAW.js"));
...
// node_modules/thirdweb/dist/esm/react/web/ui/ConnectWallet/Modal/ConnectModalContent.js
var AllWalletsUI = (0, import_react37.lazy)(() => import("./AllWalletsUI-PFHMCFDA.js"));
...
var InAppWalletConnectUI = (0, import_react39.lazy)(() => import("./InAppWalletConnectUI-EDZC4F5S.js"));
  ...
  return transfer({
    ...
    asyncParams: async () => {
      ...
      if ("amount" in options) {
        const { decimals: decimals2 } = await import("./decimals-XOOO36JS.js");
...
async function getTokenBalance(options) {
  ...
  if (tokenAddress) {
    const { getBalance } = await import("./getBalance-OQMIVBM4.js");
    return getBalance({
...
function useTokenInfo(options) {
  ...
  return useQuery({
    ...
    queryFn: async () => {
      if (tokenAddress) {
        const { getCurrencyMetadata: getCurrencyMetadata2 } = await import("./getCurrencyMetadata-L7L4BE2R.js");
        const result2 = await getCurrencyMetadata2({
          contract: getContract({ client, chain, address: tokenAddress })
        });
        return result2;
      }
      const { getChainDecimals: getChainDecimals2, getChainNativeCurrencyName: getChainNativeCurrencyName2, getChainSymbol: getChainSymbol2 } = await import("./utils-2D3HESOV.js");
...
function InAppWalletUserInfo(props) {
  ...
  const userInfoQuery = useQuery({
    ...
    queryFn: async () => {
      const { getUserEmail, getUserPhoneNumber } = await import("./auth-37KVXDOR.js");
...
//# sourceMappingURL=chunk-HQ7NVZ2D.js.map
