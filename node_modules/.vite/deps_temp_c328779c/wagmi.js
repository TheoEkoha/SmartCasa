...
import {
  ...
  useQuery,
  useQueryClient
} from "./chunk-7FQPT2VN.js";
import "./chunk-TOLWOKRH.js";
...
async function getWebSocketRpcClient(url, options = {}) {
  ...
  return getSocketRpcClient({
    async getSocket({ onClose, onError, onOpen, onResponse }) {
      const WebSocket = await import("./native-AXATY2WX.js").then((module) => module.WebSocket);
...
function webSocket2(url, config = {}) {
  const { keepAlive, key = "webSocket", name = "WebSocket JSON-RPC", reconnect: reconnect2, retryDelay } = config;
  return ({ chain, retryCount: retryCount_, timeout: timeout_ }) => {
    var _a;
    const retryCount = config.retryCount ?? retryCount_;
    const timeout = timeout_ ?? config.timeout ?? 1e4;
