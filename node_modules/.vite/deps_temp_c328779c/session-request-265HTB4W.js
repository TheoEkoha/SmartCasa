    ...
    switch (request.method) {
      case "personal_sign": {
        if (handlers == null ? void 0 : handlers.personal_sign) {
          ...
          const { handleSignRequest } = await import("./sign-7IDP42GJ.js");
      ...
      case "eth_signTypedData": {
        if (handlers == null ? void 0 : handlers.eth_signTypedData) {
          ...
          const { handleSignTypedDataRequest } = await import("./sign-typed-data-F4ZKPTVG.js");
      ...
      case "eth_signTransaction": {
        if (handlers == null ? void 0 : handlers.eth_signTransaction) {
          ...
          const { handleSignTransactionRequest } = await import("./sign-transaction-6XEKU7S6.js");
      ...
      case "eth_sendTransaction": {
        ...
        if (handlers == null ? void 0 : handlers.eth_sendTransaction) {
          ...
          const { handleSendTransactionRequest } = await import("./send-transaction-53CVV2OO.js");
      ...
      case "eth_sendRawTransaction": {
        ...
        if (handlers == null ? void 0 : handlers.eth_sendRawTransaction) {
          ...
          const { handleSendRawTransactionRequest } = await import("./send-raw-transaction-D2WRHXZW.js");
      ...
      case "wallet_switchEthereumChain": {
        if (handlers == null ? void 0 : handlers.wallet_switchEthereumChain) {
          ...
          const { handleSwitchChain } = await import("./switch-chain-KYB5J4SF.js");
...
//# sourceMappingURL=session-request-265HTB4W.js.map
