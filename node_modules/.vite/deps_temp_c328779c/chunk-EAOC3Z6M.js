...
async function download(options) {
  ...
  if (options.uri.startsWith("ar://")) {
    const { resolveArweaveScheme } = await import("./arweave-Z4O7LLPP.js");
  ...
  const res = await getClientFetch(options.client)(url, {
    ...
    requestTimeoutMs: ((_i = (_h = (_g = options.client.config) == null ? void 0 : _g.storage) == null ? void 0 : _h.fetch) == null ? void 0 : _i.requestTimeoutMs) ?? 6e4
  });
  if (!res.ok) {
...
//# sourceMappingURL=chunk-EAOC3Z6M.js.map
