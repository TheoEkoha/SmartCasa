...
async function isListingValid(options) {
  ...
  if (erc721) {
    const [{ isApprovedForAll }, { getApproved }, { ownerOf }] = await Promise.all([
      import("./isApprovedForAll-NBGMGNU7.js"),
      import("./getApproved-XBI6XLSO.js"),
      import("./ownerOf-BMJ57KWY.js")
    ]);
  ...
  if (erc1155) {
    const [{ isApprovedForAll }, { balanceOf }] = await Promise.all([
      import("./isApprovedForAll-MAFI77T7.js"),
      import("./balanceOf-DZCSZAEA.js")
    ]);
...
//# sourceMappingURL=chunk-545MRHWO.js.map
