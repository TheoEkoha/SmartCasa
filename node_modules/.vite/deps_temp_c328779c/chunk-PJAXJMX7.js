...
function ecosystemWallet(...args) {
  ...
  return createEcosystemWallet({
    ...
    connectorFactory: async (client) => {
      const { InAppWebConnector } = await import("./web-connector-JRRERP3Q.js");
...
function coinbaseWalletSDK(args) {
  ...
  return {
    ...
    getAccount: () => account,
    autoConnect: async (options) => {
      const { autoConnectCoinbaseWalletSDK } = await import("./coinbaseWebSDK-PF3BUJDG.js");
    ...
    connect: async (options) => {
      const { connectCoinbaseWalletSDK } = await import("./coinbaseWebSDK-PF3BUJDG.js");
      const provider = await args.providerFactory();
      ...
      const wallet = {
        ...
        autoConnect: async (options) => {
          ...
          if (id !== "walletConnect" && injectedProvider(id)) {
            const { autoConnectInjectedWallet } = await import("./injected-FNDQ3DMI.js");
          ...
          if (options && "client" in options) {
            const { autoConnectWC } = await import("./controller-HXI5N26E.js");
        ...
        connect: async (options) => {
          async function wcConnect(wcOptions) {
            const { connectWC } = await import("./controller-HXI5N26E.js");
          ...
          if (injectedProvider(id) && !forceWalletConnectOption) {
            const { connectInjectedWallet } = await import("./injected-FNDQ3DMI.js");
...
//# sourceMappingURL=chunk-PJAXJMX7.js.map
