...
import {
  ...
  getDefaultWallets,
  wait
} from "./chunk-KTP6Y2JB.js";
import {
  AccentFailIcon,
  PoweredByThirdweb,
  TOS
} from "./chunk-HCARD3XY.js";
import {
  InputSelectionUI,
  LoadingScreen,
  ScreenSetupContext,
...
} from "./chunk-KKQQ2VEH.js";
import {
  isERC721
} from "./chunk-N7GNTSDR.js";
import {
  Fuse,
  useDebouncedValue,
  useShowMore
...
import {
  WalletLogoSpinner
} from "./chunk-SQFOT3QK.js";
import {
  WalletImage,
  useActiveWallet
} from "./chunk-QN27EE6H.js";
import {
  ArrowRightIcon,
  Button,
  ButtonLink,
...
import {
  getNFT
} from "./chunk-Z3Y3UDB3.js";
import {
  getNFT as getNFT2
} from "./chunk-6RQBLG7T.js";
import {
  getCurrencyMetadata
} from "./chunk-QSZYPARS.js";
import {
  deleteConnectParamsFromStorage
} from "./chunk-RMLEFI72.js";
import {
  isInAppWallet
} from "./chunk-GRB6Y54H.js";
import {
  decimals
} from "./chunk-F2XRSPM7.js";
import {
  resolveArweaveScheme
} from "./chunk-FTGVVEWF.js";
import {
  polygon
} from "./chunk-R6C4A6A7.js";
import {
  ethereum
} from "./chunk-F2BPN3S5.js";
import {
  estimateGasCost,
...
import {
  createWallet,
  isMobile
} from "./chunk-7DYPU7K2.js";
import {
  getWalletBalance
} from "./chunk-7OQJK4I6.js";
import {
  createWalletConnectClient,
  createWalletConnectSession,
  disconnectWalletConnectSession,
  getActiveWalletConnectSessions
} from "./chunk-IUZDY2KG.js";
import {
  isEcosystemWallet
} from "./chunk-LXP7TCXQ.js";
import {
  smartWallet
} from "./chunk-WN63IUOE.js";
import {
  webLocalStorage
...
import {
  isContractDeployed
} from "./chunk-JY4AYTXB.js";
import {
  eth_getBalance
} from "./chunk-OULA2JUL.js";
import {
  sendTransaction
} from "./chunk-E2WH4Z7O.js";
import {
  getGasPrice
} from "./chunk-6WLPFFUO.js";
import {
  resolvePromisedValue
} from "./chunk-2FH4XCFL.js";
import {
  encode
} from "./chunk-LIZCRVOE.js";
import {
  toTokens,
  toUnits,
  toWei
...
import {
  readContract
} from "./chunk-RLTSCJEH.js";
import {
  encodeAbiParameters
} from "./chunk-CA5U54LE.js";
import {
  getAddress,
  isAddress,
  shortenAddress,
...
import {
  ...
  useMergeRefs,
  zeroRightClassName
} from "./chunk-U6AC6GUI.js";
import {
  require_jsx_runtime
} from "./chunk-VMSIDBJW.js";
import {
  require_react_dom
} from "./chunk-55CHAPOB.js";
import {
  require_react
...
var DialogPortal = (props) => {
  ...
  return (0, import_jsx_runtime9.jsx)(PortalProvider, { scope: __scopeDialog, forceMount, children: React18.Children.map(children, (child) => (0, import_jsx_runtime9.jsx)(Presence, { present: forceMount || context.open, children: (0, import_jsx_runtime9.jsx)(Portal, { asChild: true, container, children: child }) })) });
};
...
// node_modules/thirdweb/dist/esm/react/web/ui/components/Modal.js
var Modal = (props) => {
  const [open, setOpen] = (0, import_react4.useState)(props.open);
...
// node_modules/thirdweb/dist/esm/react/web/ui/components/Drawer.js
var Drawer = (0, import_react6.forwardRef)(function Drawer_(props, ref) {
...
function useDrawer() {
  const [isOpen, _setIsOpen] = (0, import_react6.useState)(false);
  const drawerRef = (0, import_react6.useRef)(null);
  const drawerOverlayRef = (0, import_react6.useRef)(null);
  const closeDrawerAnimation = (0, import_react6.useCallback)(() => {
  ...
  const setIsOpen = (0, import_react6.useCallback)(async (value) => {
    if (value) {
      _setIsOpen(true);
    } else {
  ...
  const loginMutation = useMutation({
    ...
    mutationFn: async () => {
      ...
      const [payload, { signLoginPayload }] = await Promise.all([
        ...
        import("./sign-login-payload-7VELMF6V.js")
      ]);
      if (payload.chain_id) {
...
function useActiveWalletConnectionStatus() {
  ...
  return (0, import_react8.useSyncExternalStore)(store.subscribe, store.getValue, store.getValue);
}
  ...
  useQueries({
    queries: wallets.filter((w) => w.id === COINBASE || w.id === "inApp" || isEcosystemWallet(w.id)).map((w) => ({
      ...
      queryFn: async () => {
        ...
        switch (true) {
          case COINBASE === w.id: {
            const { getCoinbaseWebProvider } = await import("./coinbaseWebSDK-FLWMHNPS.js");
            await getCoinbaseWebProvider(w.getConfig());
            return true;
          }
          case "inApp" === w.id: {
            const [{ InAppWebConnector }, { getOrCreateInAppWalletConnector }] = await Promise.all([
              import("./web-connector-UE6A6IOA.js"),
              import("./in-app-core-HPHAHQCJ.js")
            ]);
...
function useConnect(options) {
  ...
  const handleConnection = (0, import_react9.useCallback)(async (walletOrFn) => {
    setError(null);
...
function useAutoConnectCore(storage, props, getInstalledWallets) {
  ...
  const autoConnect = async () => {
    ...
    const activeWallet = lastActiveWalletId && (availableWallets.find((w) => w.id === lastActiveWalletId) || createWallet(lastActiveWalletId));
    if (activeWallet) {
      try {
        setConnectionStatus("connecting");
...
var SetRootElementContext = (0, import_react12.createContext)(() => {
});
...
function useClipboard(text) {
  ...
  const onCopy = (0, import_react13.useCallback)(async () => {
...
function useSize(element) {
  const [size3, setSize] = React21.useState(void 0);
  useLayoutEffect2(() => {
    if (element) {
...
var PopperContent = React23.forwardRef(
  (props, forwardedRef) => {
    ...
    const [arrow3, setArrow] = React23.useState(null);
...
var TooltipPortal = (props) => {
  ...
  return (0, import_jsx_runtime19.jsx)(PortalProvider2, { scope: __scopeTooltip, forceMount, children: (0, import_jsx_runtime19.jsx)(Presence, { present: forceMount || context.open, children: (0, import_jsx_runtime19.jsx)(Portal, { asChild: true, container, children }) }) });
};
...
var TooltipContent = React25.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime19.jsx)(Presence, { present: forceMount || context.open, children: context.disableHoverableContent ? (0, import_jsx_runtime19.jsx)(TooltipContentImpl, { side, ...contentProps, ref: forwardedRef }) : (0, import_jsx_runtime19.jsx)(TooltipContentHoverable, { side, ...contentProps, ref: forwardedRef }) });
  }
);
var TooltipContentHoverable = React25.forwardRef((props, forwardedRef) => {
  ...
  return (0, import_jsx_runtime19.jsx)(TooltipContentImpl, { ...props, ref: composedRefs });
});
      ...
      DismissableLayer,
      {
        ...
        children: (0, import_jsx_runtime19.jsxs)(
          Content2,
          {
            ...
            children: [
              (0, import_jsx_runtime19.jsx)(Slottable, { children }),
              (0, import_jsx_runtime19.jsx)(VisuallyHiddenContentContextProvider, { scope: __scopeTooltip, isInside: true, children: (0, import_jsx_runtime19.jsx)(Root3, { id: context.contentId, role: "tooltip", children: ariaLabel || children }) })
            ]
          }
        )
      }
...
var TooltipArrow = React25.forwardRef(
  (props, forwardedRef) => {
    ...
    return visuallyHiddenContentContext.isInside ? null : (0, import_jsx_runtime19.jsx)(Arrow2, { ...popperScope, ...arrowProps, ref: forwardedRef });
  }
);
...
// node_modules/thirdweb/dist/esm/react/web/ui/components/Tooltip.js
var ToolTip = (props) => {
  return (0, import_jsx_runtime20.jsx)(Provider, { delayDuration: 200, children: (0, import_jsx_runtime20.jsxs)(Root32, { children: [(0, import_jsx_runtime20.jsx)(Trigger2, { asChild: true, children: props.children }), (0, import_jsx_runtime20.jsx)(Portal3, { children: (0, import_jsx_runtime20.jsxs)(TooltipContent2, { sideOffset: props.sideOffset || 6, align: props.align || "center", side: props.side || "top", children: [props.tip, (0, import_jsx_runtime20.jsx)(TooltipArrow2, {})] }) })] }) });
};
...
var CopyIcon2 = (props) => {
  ...
  return (0, import_jsx_runtime21.jsx)("div", { onClick: onCopy, style: {
    display: "flex",
    alignItems: "center",
  ...
  }, children: (0, import_jsx_runtime21.jsx)(ToolTip, { tip: props.tip, side: props.side, align: props.align, children: (0, import_jsx_runtime21.jsx)("div", { children: (0, import_jsx_runtime21.jsx)(Container, { color: showCheckIcon ? "success" : void 0, flex: "row", center: "both", children: showCheckIcon ? (0, import_jsx_runtime21.jsx)(CheckIcon, {}) : (0, import_jsx_runtime21.jsx)(CopyIcon, {}) }) }) }) });
};
...
var IconContainer = (props) => {
  const theme = useCustomTheme();
  return (0, import_jsx_runtime22.jsx)("div", { style: {
    position: "relative",
    overflow: "hidden",
    display: "flex",
    justifyItems: "center",
...
function Blobbie(props) {
  ...
  const colors = (0, import_react16.useMemo)(() => COLOR_OPTIONS[Number(hexToNumber(props.address.slice(2, 4))) % COLOR_OPTIONS.length], [props.address]);
  return (0, import_jsx_runtime23.jsx)("div", { id, style: {
    width: `${props.size}px`,
...
async function getConnectLocale(localeId) {
  switch (localeId) {
    case "es_ES": {
      return (await import("./es-BO2Z5DIW.js")).default;
    }
    case "ja_JP": {
      return (await import("./ja-YXKOIGUJ.js")).default;
    }
    case "tl_PH": {
      return (await import("./tl-67U6P5NK.js")).default;
    }
    case "vi_VN": {
      return (await import("./vi-IOHNAUPR.js")).default;
    }
    case "de_DE": {
      return (await import("./de-GOJVGXNS.js")).default;
    }
    case "ko_KR": {
      return (await import("./kr-BU4VZ2H5.js")).default;
    }
    case "fr_FR": {
      return (await import("./fr-N5452363.js")).default;
    }
    default: {
      return (await import("./en-T45MSK5H.js")).default;
    }
  }
}
...
function NetworkSelectorContent(props) {
  ...
  const [selectedTab, setSelectedTab] = (0, import_react17.useState)("all");
  ...
  const { chainSections, allChains, allChainsToSectionMap } = (0, import_react17.useMemo)(() => {
    var _a2, _b2, _c2, _d2;
  ...
  const fuse = (0, import_react17.useMemo)(() => {
  ...
  const searchedChainSections = (0, import_react17.useMemo)(() => {
  ...
  const filteredChainSections = (0, import_react17.useMemo)(() => {
    if (selectedTab === "all") {
  ...
  const handleSwitch = (0, import_react17.useCallback)((chain) => {
    if (onSwitch) {
      onSwitch(chain);
    }
    props.closeModal();
  }, [onSwitch, props]);
  return (0, import_jsx_runtime24.jsxs)(Container, { children: [(0, import_jsx_runtime24.jsx)(Container, { p: "lg", children: props.onBack ? (0, import_jsx_runtime24.jsx)(ModalHeader, { title: locale.title, onBack: props.onBack }) : (0, import_jsx_runtime24.jsx)(ModalTitle, { children: locale.title }) }), props.showTabs !== false && (0, import_jsx_runtime24.jsxs)(import_jsx_runtime24.Fragment, { children: [(0, import_jsx_runtime24.jsx)(Container, { px: "lg", children: (0, import_jsx_runtime24.jsxs)(Container, { flex: "row", gap: "xxs", children: [(0, import_jsx_runtime24.jsx)(TabButton, { onClick: () => setSelectedTab("all"), "data-active": selectedTab === "all", children: locale.allNetworks }), (0, import_jsx_runtime24.jsx)(TabButton, { onClick: () => setSelectedTab("mainnet"), "data-active": selectedTab === "mainnet", children: locale.mainnets }), (0, import_jsx_runtime24.jsx)(TabButton, { onClick: () => setSelectedTab("testnet"), "data-active": selectedTab === "testnet", children: locale.testnets })] }) }), (0, import_jsx_runtime24.jsx)(Spacer, { y: "lg" })] }), props.showTabs === false && (0, import_jsx_runtime24.jsx)(Spacer, { y: "xxs" }), (0, import_jsx_runtime24.jsx)(Container, { px: "lg", children: (0, import_jsx_runtime24.jsxs)("div", { style: {
    display: "flex",
    alignItems: "center",
    position: "relative"
  }, children: [(0, import_jsx_runtime24.jsx)(StyledMagnifyingGlassIcon, { width: iconSize.md, height: iconSize.md }), (0, import_jsx_runtime24.jsx)(Input, { style: {
    padding: `${spacing.sm} ${spacing.md} ${spacing.sm} ${spacing.xxl}`
  }, tabIndex: -1, variant: "outline", value: searchTerm, onChange: (e) => {
    setSearchTerm(e.target.value);
  }, disabled: isAllChainsQueryLoading, placeholder: isAllChainsQueryLoading ? "Loading chains..." : locale.inputPlaceholder }), (deferredSearchTerm !== searchTerm || isAllChainsQueryLoading) && (0, import_jsx_runtime24.jsx)("div", { style: {
    position: "absolute",
    right: spacing.md
  }, children: (0, import_jsx_runtime24.jsx)(Spinner, { size: "md", color: "accentText" }) })] }) }), (0, import_jsx_runtime24.jsx)(Spacer, { y: "lg" }), (0, import_jsx_runtime24.jsx)(Container, { px: "md", children: (0, import_jsx_runtime24.jsx)(NetworkTabContent, { chainSections: filteredChainSections, onSwitch: handleSwitch, renderChain: (_d = props.networkSelector) == null ? void 0 : _d.renderChain, connectLocale: props.connectLocale, client: props.client, close: props.closeModal }) }), onCustomClick && (0, import_jsx_runtime24.jsxs)(import_jsx_runtime24.Fragment, { children: [(0, import_jsx_runtime24.jsx)(Line, {}), (0, import_jsx_runtime24.jsx)(Container, { p: "lg", children: (0, import_jsx_runtime24.jsx)(Button, { fullWidth: true, variant: "link", onClick: () => {
    onCustomClick();
    props.closeModal();
  }, style: {
    display: "flex",
...
var NetworkTabContent = (props) => {
  ...
  return (0, import_jsx_runtime24.jsx)(Container, { scrollY: true, animate: "fadein", style: {
    height: "330px",
    paddingBottom: spacing.lg
  }, children: noChainsToShow ? (0, import_jsx_runtime24.jsxs)(Container, { flex: "column", gap: "md", center: "both", color: "secondaryText", children: [(0, import_jsx_runtime24.jsx)(Spacer, { y: "xl" }), (0, import_jsx_runtime24.jsx)(CrossCircledIcon, { width: iconSize.xl, height: iconSize.xl }), (0, import_jsx_runtime24.jsx)(Text, { children: " No Results " })] }) : chainSections.map((section, idx) => {
    if (section.chains.length === 0) {
      return null;
    }
    return (0, import_jsx_runtime24.jsxs)(import_react17.Fragment, { children: [idx !== 0 && (0, import_jsx_runtime24.jsx)(Spacer, { y: "lg" }), (0, import_jsx_runtime24.jsx)(SectionLabel, { children: section.label }), (0, import_jsx_runtime24.jsx)(Spacer, { y: "xs" }), (0, import_jsx_runtime24.jsx)(NetworkList, { chains: section.chains, onSwitch: props.onSwitch, renderChain: props.renderChain, close: props.close, client: props.client, connectLocale: props.connectLocale })] }, section.label);
  }) });
};
var NetworkList = (0, import_react17.memo)(function NetworkList2(props) {
  const { itemsToShow, lastItemRef } = useShowMore(10, 10);
  const switchChain = useSwitchActiveWalletChain();
  const activeChain = useActiveWalletChain();
  const [switchingChainId, setSwitchingChainId] = (0, import_react17.useState)(-1);
  const [errorSwitchingChainId, setErrorSwitchingChainId] = (0, import_react17.useState)(-1);
  ...
  return (0, import_jsx_runtime24.jsx)(NetworkListUl, { children: chainsToShow.map((chain, i) => {
    if (!chain) {
      return null;
    }
    ...
    return (0, import_jsx_runtime24.jsx)("li", { ref: isLast ? lastItemRef : void 0, children: RenderChain ? (0, import_jsx_runtime24.jsx)(RenderChain, { switchChain: () => {
      handleSwitch(chain);
    }, chain, switching: switchingChainId === chain.id, switchFailed: errorSwitchingChainId === chain.id, close: props.close }) : (0, import_jsx_runtime24.jsx)(ChainButton, { chain, confirming, onClick: () => handleSwitch(chain), switchingFailed, client: props.client, connectLocale: props.connectLocale }) }, chain.id);
  }) });
});
var ChainButton = (0, import_react17.memo)(function ChainButton2(props) {
  ...
  if (chainNameQuery.name) {
    chainName = (0, import_jsx_runtime24.jsxs)("span", { children: [chainNameQuery.name, " "] });
  } else {
    chainName = (0, import_jsx_runtime24.jsx)(Skeleton, { width: "150px", height: "20px" });
  }
  return (0, import_jsx_runtime24.jsxs)(NetworkButton, { "data-active": (activeChain == null ? void 0 : activeChain.id) === chain.id, onClick: props.onClick, children: [!chainIconQuery.isLoading ? (0, import_jsx_runtime24.jsx)(ChainIcon, { chainIconUrl: chainIconQuery.url, size: iconSize.lg, active: (activeChain == null ? void 0 : activeChain.id) === chain.id, loading: "lazy", client: props.client }) : (0, import_jsx_runtime24.jsx)(Skeleton, { width: `${iconSize.lg}px`, height: `${iconSize.lg}px` }), confirming || switchingFailed ? (0, import_jsx_runtime24.jsxs)("div", { style: {
    display: "flex",
    flexDirection: "column",
    gap: spacing.xs
  }, children: [chainName, (0, import_jsx_runtime24.jsxs)(Container, { animate: "fadein", flex: "row", gap: "xxs", center: "y", children: [confirming && (0, import_jsx_runtime24.jsxs)(import_jsx_runtime24.Fragment, { children: [(0, import_jsx_runtime24.jsx)(Text, { size: "xs", color: "accentText", children: locale.confirmInWallet }), (0, import_jsx_runtime24.jsx)(Spinner, { size: "xs", color: "accentText" })] }), switchingFailed && (0, import_jsx_runtime24.jsx)(Container, { animate: "fadein", children: (0, import_jsx_runtime24.jsx)(Text, { size: "xs", color: "danger", children: locale.networkSelector.failedToSwitch }) })] })] }) : chainName] });
});
...
function useNetworkSwitcherModal() {
  const activeChain = useActiveWalletChain();
  const setRootEl = (0, import_react17.useContext)(SetRootElementContext);
  const closeModal = (0, import_react17.useCallback)(() => {
    setRootEl(null);
  }, [setRootEl]);
  const openNetworkSwitcher = (0, import_react17.useCallback)(async (props) => {
    if (!activeChain) {
      throw new Error("No active wallet found");
    }
    const locale = await getConnectLocale(props.locale || "en_US");
    setRootEl((0, import_jsx_runtime24.jsx)(CustomThemeProvider, { theme: props.theme, children: (0, import_jsx_runtime24.jsx)(Modal, { size: "compact", open: true, setOpen: (value) => {
      if (!value) {
        closeModal();
      }
    }, style: {
      paddingBottom: props.onCustomClick ? spacing.md : "0px"
    }, children: (0, import_jsx_runtime24.jsx)(NetworkSelectorContent, { client: props.client, closeModal, chains: [activeChain], connectLocale: locale, networkSelector: {
...
function Tabs({ selected, onSelect, options, children }) {
  const theme = useCustomTheme();
  return (0, import_jsx_runtime25.jsxs)("div", { children: [(0, import_jsx_runtime25.jsx)(Container, { flex: "row", center: "y", style: { width: "100%", borderRadius: radius.lg }, p: "xxs", bg: "secondaryButtonBg", children: options.map((option) => (0, import_jsx_runtime25.jsx)(Button, { variant: "accent", type: "button", onClick: () => onSelect(option.value), style: {
    flex: 1,
  ...
  }, children: (0, import_jsx_runtime25.jsx)(Text, { color: option.value === selected ? "primaryText" : "secondaryText", style: { textAlign: "center" }, size: "sm", children: option.label }) }, option.value)) }), (0, import_jsx_runtime25.jsx)(Spacer, { y: "sm" }), children] });
}

// node_modules/thirdweb/dist/esm/react/web/ui/ConnectWallet/icons/CoinsIcon.js
var import_jsx_runtime26 = __toESM(require_jsx_runtime(), 1);
var CoinsIcon = (props) => {
  return (0, import_jsx_runtime26.jsxs)("svg", { width: props.size, height: props.size, role: "presentation", viewBox: "0 0 24 24", fill: "none", xmlns: "http://www.w3.org/2000/svg", children: [(0, import_jsx_runtime26.jsx)("path", { d: "M8 14C11.3137 14 14 11.3137 14 8C14 4.68629 11.3137 2 8 2C4.68629 2 2 4.68629 2 8C2 11.3137 4.68629 14 8 14Z", stroke: "currentColor", strokeWidth: "1.5", strokeLinecap: "round", strokeLinejoin: "round" }), (0, import_jsx_runtime26.jsx)("path", { d: "M18.0901 10.37C19.0354 10.7224 19.8766 11.3075 20.5358 12.0712C21.1951 12.8349 21.6512 13.7524 21.8618 14.7391C22.0725 15.7257 22.031 16.7495 21.7411 17.7158C21.4513 18.6822 20.9224 19.5598 20.2035 20.2676C19.4846 20.9754 18.5988 21.4905 17.6281 21.7652C16.6573 22.04 15.633 22.0655 14.6498 21.8395C13.6666 21.6134 12.7562 21.1431 12.0029 20.472C11.2496 19.8009 10.6777 18.9507 10.3401 18", stroke: "currentColor", strokeWidth: "1.5", strokeLinecap: "round", strokeLinejoin: "round" }), (0, import_jsx_runtime26.jsx)("path", { d: "M7 6H8V10", stroke: "currentColor", strokeWidth: "1.5", strokeLinecap: "round", strokeLinejoin: "round" }), (0, import_jsx_runtime26.jsx)("path", { d: "M16.7101 13.88L17.4101 14.59L14.5901 17.41", stroke: "currentColor", strokeWidth: "1.5", strokeLinecap: "round", strokeLinejoin: "round" })] });
};

// node_modules/thirdweb/dist/esm/react/web/ui/ConnectWallet/icons/FundsIcon.js
var import_jsx_runtime27 = __toESM(require_jsx_runtime(), 1);
var FundsIcon = ({ size: size3 }) => {
  return (0, import_jsx_runtime27.jsxs)("svg", { width: size3, height: size3, viewBox: "0 0 16 16", fill: "none", xmlns: "http://www.w3.org/2000/svg", role: "presentation", children: [(0, import_jsx_runtime27.jsx)("path", { d: "M14.001 8.00048C14.001 9.18726 13.649 10.3474 12.9897 11.3342C12.3304 12.3209 11.3932 13.09 10.2968 13.5442C9.20032 13.9984 7.99382 14.1172 6.82984 13.8857C5.66587 13.6541 4.59668 13.0826 3.7575 12.2435C2.91832 11.4043 2.34683 10.3351 2.1153 9.17111C1.88377 8.00713 2.0026 6.80064 2.45676 5.70419C2.91092 4.60775 3.68002 3.6706 4.66679 3.01126C5.65357 2.35192 6.8137 2 8.00048 2", stroke: "currentColor", strokeWidth: "1.2001", strokeLinecap: "round", strokeLinejoin: "round" }), (0, import_jsx_runtime27.jsx)("path", { d: "M14.0005 2L8 8.00048", stroke: "currentColor", strokeWidth: "1.2001", strokeLinecap: "round", strokeLinejoin: "round" }), (0, import_jsx_runtime27.jsx)("path", { d: "M10.3984 2H13.9987V5.60029", stroke: "currentColor", strokeWidth: "1.2001", strokeLinecap: "round", strokeLinejoin: "round" })] });
};
...
function TokenIcon(props) {
  ...
  const tokenImage = (0, import_react18.useMemo)(() => {
  ...
  return (0, import_jsx_runtime28.jsx)(Img, { src: tokenImage || "", width: iconSize[props.size], height: iconSize[props.size], fallbackImage: genericTokenIcon, client: props.client });
}
...
function PayTokenIcon(props) {
  ...
  return (0, import_jsx_runtime29.jsx)(TokenIcon, { token: isNativeToken(token) ? { nativeToken: true } : {
...
function BuyTxHistoryButton(props) {
  ...
  return (0, import_jsx_runtime30.jsxs)(TxButton, { onClick: props.onClick, variant: "secondary", fullWidth: true, style: {
    paddingBlock: spacing.sm
  }, children: [(0, import_jsx_runtime30.jsxs)(Container, { flex: "row", center: "y", gap: "sm", style: {
    flex: 1
  }, children: [(0, import_jsx_runtime30.jsx)(PayTokenIcon, { client: props.client, chain: getCachedChain(props.txInfo.status.quote.toToken.chainId), size: "md", token: {
    address: props.txInfo.status.quote.toToken.tokenAddress
  } }), (0, import_jsx_runtime30.jsxs)("div", { style: {
    flex: 1,
    display: "flex",
    flexDirection: "column",
    justifyContent: "center"
  }, children: [(0, import_jsx_runtime30.jsxs)(Container, { flex: "row", gap: "xs", center: "y", style: {
    justifyContent: "space-between"
  }, children: [(0, import_jsx_runtime30.jsxs)(Text, { size: "sm", color: "primaryText", children: ["Buy", " ", formatNumber(Number(props.txInfo.type === "swap" ? props.txInfo.status.quote.toAmount : props.txInfo.status.quote.estimatedToTokenAmount), 6), " ", props.txInfo.status.quote.toToken.symbol] }), " "] }), (0, import_jsx_runtime30.jsx)(Spacer, { y: "xxs" }), (0, import_jsx_runtime30.jsx)(Container, { flex: "row", center: "y", gap: "xxs", style: {
    justifyContent: "space-between"
  }, children: (0, import_jsx_runtime30.jsx)(ChainName, { chain: getCachedChain(props.txInfo.status.quote.toToken.chainId), size: "xs", client: props.client }) })] })] }), (0, import_jsx_runtime30.jsx)(Container, { flex: "row", gap: "xxs", center: "y", children: (0, import_jsx_runtime30.jsx)(Text, { size: "xs", color: statusMeta.color, children: statusMeta.status }) })] });
}
...
function TokenInfoRow(props) {
  const chainObj = (0, import_react19.useMemo)(() => getCachedChain(props.chainId), [props.chainId]);
  const { name } = useChainName(chainObj);
  return (0, import_jsx_runtime31.jsxs)(Container, { flex: "row", style: {
    justifyContent: "space-between"
  }, children: [(0, import_jsx_runtime31.jsx)(Text, { size: "sm", children: props.label }), (0, import_jsx_runtime31.jsxs)(Container, { flex: "column", gap: "xxs", style: {
    alignItems: "flex-end"
  }, children: [(0, import_jsx_runtime31.jsxs)(Container, { flex: "row", gap: "xs", center: "y", children: [(0, import_jsx_runtime31.jsx)(PayTokenIcon, { chain: chainObj, size: "sm", token: {
    address: props.tokenAddress
  }, client: props.client }), (0, import_jsx_runtime31.jsxs)(Text, { color: "primaryText", children: [formatNumber(Number(props.tokenAmount), 6), " ", props.tokenSymbol] })] }), (0, import_jsx_runtime31.jsx)(Text, { size: "sm", children: name })] })] });
}
...
var CADIcon = (props) => {
  return (0, import_jsx_runtime32.jsxs)("svg", { xmlns: "http://www.w3.org/2000/svg", width: props.size, height: props.size, viewBox: "0 0 512 512", "aria-hidden": "true", children: [(0, import_jsx_runtime32.jsx)("mask", { id: "a", children: (0, import_jsx_runtime32.jsx)("circle", { cx: "256", cy: "256", r: "256", fill: "#fff" }) }), (0, import_jsx_runtime32.jsxs)("g", { mask: "url(#a)", children: [(0, import_jsx_runtime32.jsx)("path", { fill: "#d80027", d: "M0 0v512h144l112-64 112 64h144V0H368L256 64 144 0Z" }), (0, import_jsx_runtime32.jsx)("path", { fill: "#eee", d: "M144 0h224v512H144Z" }), (0, import_jsx_runtime32.jsx)("path", { fill: "#d80027", d: "m301 289 44-22-22-11v-22l-45 22 23-44h-23l-22-34-22 33h-23l23 45-45-22v22l-22 11 45 22-12 23h45v33h22v-33h45z" })] })] });
};

// node_modules/thirdweb/dist/esm/react/web/ui/ConnectWallet/icons/currencies/EURIcon.js
var import_jsx_runtime33 = __toESM(require_jsx_runtime(), 1);
var EURIcon = (props) => {
  return (0, import_jsx_runtime33.jsxs)("svg", { xmlns: "http://www.w3.org/2000/svg", width: props.size, height: props.size, viewBox: "0 0 512 512", "aria-hidden": "true", children: [(0, import_jsx_runtime33.jsx)("mask", { id: "a", children: (0, import_jsx_runtime33.jsx)("circle", { cx: "256", cy: "256", r: "256", fill: "#fff" }) }), (0, import_jsx_runtime33.jsxs)("g", { mask: "url(#a)", children: [(0, import_jsx_runtime33.jsx)("path", { fill: "#0052b4", d: "M0 0h512v512H0z" }), (0, import_jsx_runtime33.jsx)("path", { fill: "#ffda44", d: "m256 100.2 8.3 25.5H291l-21.7 15.7 8.3 25.6-21.7-15.8-21.7 15.8 8.3-25.6-21.7-15.7h26.8zm-110.2 45.6 24 12.2 18.9-19-4.2 26.5 23.9 12.2-26.5 4.2-4.2 26.5-12.2-24-26.5 4.3 19-19zM100.2 256l25.5-8.3V221l15.7 21.7 25.6-8.3-15.8 21.7 15.8 21.7-25.6-8.3-15.7 21.7v-26.8zm45.6 110.2 12.2-24-19-18.9 26.5 4.2 12.2-23.9 4.2 26.5 26.5 4.2-24 12.2 4.3 26.5-19-19zM256 411.8l-8.3-25.5H221l21.7-15.7-8.3-25.6 21.7 15.8 21.7-15.8-8.3 25.6 21.7 15.7h-26.8zm110.2-45.6-24-12.2-18.9 19 4.2-26.5-23.9-12.2 26.5-4.2 4.2-26.5 12.2 24 26.5-4.3-19 19zM411.8 256l-25.5 8.3V291l-15.7-21.7-25.6 8.3 15.8-21.7-15.8-21.7 25.6 8.3 15.7-21.7v26.8zm-45.6-110.2-12.2 24 19 18.9-26.5-4.2-12.2 23.9-4.2-26.5-26.5-4.2 24-12.2-4.3-26.5 19 19z" })] })] });
};

// node_modules/thirdweb/dist/esm/react/web/ui/ConnectWallet/icons/currencies/GBPIcon.js
var import_jsx_runtime34 = __toESM(require_jsx_runtime(), 1);
var GBPIcon = (props) => {
  return (0, import_jsx_runtime34.jsxs)("svg", { xmlns: "http://www.w3.org/2000/svg", version: "1.1", id: "Layer_1", x: "0px", y: "0px", width: props.size, height: props.size, viewBox: "0 0 512 512", "aria-hidden": "true", children: [(0, import_jsx_runtime34.jsx)("circle", { fill: "#F0F0F0", cx: "256", cy: "256", r: "256" }), (0, import_jsx_runtime34.jsxs)("g", { children: [(0, import_jsx_runtime34.jsx)("path", { fill: "#0052B4", d: "M52.92,100.142c-20.109,26.163-35.272,56.318-44.101,89.077h133.178L52.92,100.142z" }), (0, import_jsx_runtime34.jsx)("path", { fill: "#0052B4", d: "M503.181,189.219c-8.829-32.758-23.993-62.913-44.101-89.076l-89.075,89.076H503.181z" }), (0, import_jsx_runtime34.jsx)("path", { fill: "#0052B4", d: "M8.819,322.784c8.83,32.758,23.993,62.913,44.101,89.075l89.074-89.075L8.819,322.784L8.819,322.784   z" }), (0, import_jsx_runtime34.jsx)("path", { fill: "#0052B4", d: "M411.858,52.921c-26.163-20.109-56.317-35.272-89.076-44.102v133.177L411.858,52.921z" }), (0, import_jsx_runtime34.jsx)("path", { fill: "#0052B4", d: "M100.142,459.079c26.163,20.109,56.318,35.272,89.076,44.102V370.005L100.142,459.079z" }), (0, import_jsx_runtime34.jsx)("path", { fill: "#0052B4", d: "M189.217,8.819c-32.758,8.83-62.913,23.993-89.075,44.101l89.075,89.075V8.819z" }), (0, import_jsx_runtime34.jsx)("path", { fill: "#0052B4", d: "M322.783,503.181c32.758-8.83,62.913-23.993,89.075-44.101l-89.075-89.075V503.181z" }), (0, import_jsx_runtime34.jsx)("path", { fill: "#0052B4", d: "M370.005,322.784l89.075,89.076c20.108-26.162,35.272-56.318,44.101-89.076H370.005z" })] }), (0, import_jsx_runtime34.jsxs)("g", { children: [(0, import_jsx_runtime34.jsx)("path", { fill: "#D80027", d: "M509.833,222.609h-220.44h-0.001V2.167C278.461,0.744,267.317,0,256,0   c-11.319,0-22.461,0.744-33.391,2.167v220.44v0.001H2.167C0.744,233.539,0,244.683,0,256c0,11.319,0.744,22.461,2.167,33.391   h220.44h0.001v220.442C233.539,511.256,244.681,512,256,512c11.317,0,22.461-0.743,33.391-2.167v-220.44v-0.001h220.442   C511.256,278.461,512,267.319,512,256C512,244.683,511.256,233.539,509.833,222.609z" }), (0, import_jsx_runtime34.jsx)("path", { fill: "#D80027", d: "M322.783,322.784L322.783,322.784L437.019,437.02c5.254-5.252,10.266-10.743,15.048-16.435   l-97.802-97.802h-31.482V322.784z" }), (0, import_jsx_runtime34.jsx)("path", { fill: "#D80027", d: "M189.217,322.784h-0.002L74.98,437.019c5.252,5.254,10.743,10.266,16.435,15.048l97.802-97.804   V322.784z" }), (0, import_jsx_runtime34.jsx)("path", { fill: "#D80027", d: "M189.217,189.219v-0.002L74.981,74.98c-5.254,5.252-10.266,10.743-15.048,16.435l97.803,97.803   H189.217z" }), (0, import_jsx_runtime34.jsx)("path", { fill: "#D80027", d: "M322.783,189.219L322.783,189.219L437.02,74.981c-5.252-5.254-10.743-10.266-16.435-15.047   l-97.802,97.803V189.219z" })] })] });
};

// node_modules/thirdweb/dist/esm/react/web/ui/ConnectWallet/icons/currencies/JPYIcon.js
var import_jsx_runtime35 = __toESM(require_jsx_runtime(), 1);
var JPYIcon = (props) => {
  return (0, import_jsx_runtime35.jsx)("svg", { width: props.size, height: props.size, viewBox: "0 0 32 32", xmlns: "http://www.w3.org/2000/svg", role: "presentation", children: (0, import_jsx_runtime35.jsxs)("g", { fill: "none", "fill-rule": "evenodd", children: [(0, import_jsx_runtime35.jsx)("circle", { cx: "16", cy: "16", fill: "#a81b1b", r: "16" }), (0, import_jsx_runtime35.jsx)("path", { d: "M17.548 18.711v1.878h5.063v2.288h-5.063V25.5h-3.096v-2.623H9.389v-2.288h5.063v-1.878H9.389v-2.288h4.171L7.5 7.5h3.752l4.8 7.534L20.853 7.5H24.5l-6.086 8.923h4.197v2.288z", fill: "#ffffff" })] }) });
};

// node_modules/thirdweb/dist/esm/react/web/ui/ConnectWallet/icons/currencies/USDIcon.js
var import_jsx_runtime36 = __toESM(require_jsx_runtime(), 1);
var USDIcon = (props) => {
  return (0, import_jsx_runtime36.jsxs)("svg", { xmlns: "http://www.w3.org/2000/svg", version: "1.1", width: props.size, height: props.size, x: "0px", y: "0px", viewBox: "0 0 512 512", "aria-hidden": "true", children: [(0, import_jsx_runtime36.jsx)("circle", { fill: "#F0F0F0", cx: "256", cy: "256", r: "256" }), (0, import_jsx_runtime36.jsxs)("g", { children: [(0, import_jsx_runtime36.jsx)("path", { fill: "#D80027", d: "M244.87,256H512c0-23.106-3.08-45.49-8.819-66.783H244.87V256z" }), (0, import_jsx_runtime36.jsx)("path", { fill: "#D80027", d: "M244.87,122.435h229.556c-15.671-25.572-35.708-48.175-59.07-66.783H244.87V122.435z" }), (0, import_jsx_runtime36.jsx)("path", { fill: "#D80027", d: "M256,512c60.249,0,115.626-20.824,159.356-55.652H96.644C140.374,491.176,195.751,512,256,512z" }), (0, import_jsx_runtime36.jsx)("path", { fill: "#D80027", d: "M37.574,389.565h436.852c12.581-20.529,22.338-42.969,28.755-66.783H8.819   C15.236,346.596,24.993,369.036,37.574,389.565z" })] }), (0, import_jsx_runtime36.jsx)("path", { fill: "#0052B4", d: "M118.584,39.978h23.329l-21.7,15.765l8.289,25.509l-21.699-15.765L85.104,81.252l7.16-22.037  C73.158,75.13,56.412,93.776,42.612,114.552h7.475l-13.813,10.035c-2.152,3.59-4.216,7.237-6.194,10.938l6.596,20.301l-12.306-8.941  c-3.059,6.481-5.857,13.108-8.372,19.873l7.267,22.368h26.822l-21.7,15.765l8.289,25.509l-21.699-15.765l-12.998,9.444  C0.678,234.537,0,245.189,0,256h256c0-141.384,0-158.052,0-256C205.428,0,158.285,14.67,118.584,39.978z M128.502,230.4  l-21.699-15.765L85.104,230.4l8.289-25.509l-21.7-15.765h26.822l8.288-25.509l8.288,25.509h26.822l-21.7,15.765L128.502,230.4z   M120.213,130.317l8.289,25.509l-21.699-15.765l-21.699,15.765l8.289-25.509l-21.7-15.765h26.822l8.288-25.509l8.288,25.509h26.822  L120.213,130.317z M220.328,230.4l-21.699-15.765L176.93,230.4l8.289-25.509l-21.7-15.765h26.822l8.288-25.509l8.288,25.509h26.822  l-21.7,15.765L220.328,230.4z M212.039,130.317l8.289,25.509l-21.699-15.765l-21.699,15.765l8.289-25.509l-21.7-15.765h26.822  l8.288-25.509l8.288,25.509h26.822L212.039,130.317z M212.039,55.743l8.289,25.509l-21.699-15.765L176.93,81.252l8.289-25.509  l-21.7-15.765h26.822l8.288-25.509l8.288,25.509h26.822L212.039,55.743z" })] });
};
...
var UnknownCurrencyIcon = (props) => {
  return (0, import_jsx_runtime37.jsx)(RadiobuttonIcon, { width: props.size, height: props.size });
};
...
function OnRampTxDetailsTable(props) {
  ...
  const lineSpacer = (0, import_jsx_runtime38.jsxs)(import_jsx_runtime38.Fragment, { children: [(0, import_jsx_runtime38.jsx)(Spacer, { y: "md" }), (0, import_jsx_runtime38.jsx)(Line, {}), (0, import_jsx_runtime38.jsx)(Spacer, { y: "md" })] });
  return (0, import_jsx_runtime38.jsxs)("div", { children: [(0, import_jsx_runtime38.jsxs)(Container, { flex: "row", style: {
    justifyContent: "space-between"
  }, children: [(0, import_jsx_runtime38.jsx)(Text, { children: "Pay" }), (0, import_jsx_runtime38.jsx)(Container, { flex: "column", gap: "xxs", style: {
    alignItems: "flex-end"
  }, children: (0, import_jsx_runtime38.jsxs)(Container, { flex: "row", gap: "xs", center: "y", children: [(0, import_jsx_runtime38.jsx)(currencyMeta.icon, { size: iconSize.sm }), (0, import_jsx_runtime38.jsxs)(Text, { color: "primaryText", children: [formatNumber(Number(props.fiat.amount), 2), " ", props.fiat.currencySymbol] })] }) })] }), lineSpacer, (0, import_jsx_runtime38.jsx)(TokenInfoRow, { chainId: props.token.chainId, client: props.client, label: "Receive", tokenAmount: props.token.amount, tokenSymbol: props.token.symbol, tokenAddress: props.token.address }), props.statusMeta && (0, import_jsx_runtime38.jsxs)(import_jsx_runtime38.Fragment, { children: [lineSpacer, (0, import_jsx_runtime38.jsxs)(Container, { flex: "row", center: "y", style: {
    justifyContent: "space-between"
  }, children: [(0, import_jsx_runtime38.jsx)(Text, { children: "Status" }), (0, import_jsx_runtime38.jsx)(Container, { flex: "row", gap: "xs", center: "y", children: (0, import_jsx_runtime38.jsx)(Text, { color: props.statusMeta.color, children: props.statusMeta.text }) })] })] }), lineSpacer, onrampTxHash && ((_c = (_b = onRampExplorers.explorers) == null ? void 0 : _b[0]) == null ? void 0 : _c.url) && (0, import_jsx_runtime38.jsxs)(import_jsx_runtime38.Fragment, { children: [(0, import_jsx_runtime38.jsx)(Spacer, { y: "md" }), (0, import_jsx_runtime38.jsxs)(ButtonLink, { fullWidth: true, variant: "outline", href: `${onRampExplorers.explorers[0].url || ""}/tx/${onrampTxHash}`, target: "_blank", gap: "xs", style: {
    fontSize: fontSize.sm
  }, children: ["View on Explorer", (0, import_jsx_runtime38.jsx)(ExternalLinkIcon, { width: iconSize.sm, height: iconSize.sm })] })] })] });
}
...
function StepIcon(props) {
  return (0, import_jsx_runtime39.jsx)(Container, { flex: "row", center: "both", color: props.isDone ? "success" : props.isActive ? "accentText" : "secondaryText", children: (0, import_jsx_runtime39.jsx)(Circle, { children: props.isDone ? (0, import_jsx_runtime39.jsx)(CheckIcon, { width: iconSize.sm, height: iconSize.sm }) : (0, import_jsx_runtime39.jsx)(PulsingDot, { "data-active": props.isActive }) }) });
}
function Step(props) {
  return (0, import_jsx_runtime39.jsxs)(Container, { flex: "row", center: "y", gap: "xs", style: {
    fontSize: fontSize.sm
  }, color: props.isDone ? "success" : props.isActive ? "accentText" : "secondaryText", children: [(0, import_jsx_runtime39.jsx)(StepIcon, { isDone: props.isDone, isActive: props.isActive }), props.label] });
}
...
function FiatSteps(props) {
  ...
  const toChain = (0, import_react21.useMemo)(() => getCachedChain(toTokenMeta.chainId), [toTokenMeta.chainId]);
  const destinationChain = (0, import_react21.useMemo)(() => {
    var _a2, _b2, _c2;
  ...
  const onRampChain = (0, import_react21.useMemo)(() => getCachedChain(onRampTokenMeta.chainId), [onRampTokenMeta.chainId]);
  const onRampToken = (0, import_react21.useMemo)(() => {
  ...
  const onRampTokenInfo = (0, import_jsx_runtime40.jsx)("div", { children: (0, import_jsx_runtime40.jsxs)(Text, { color: "primaryText", size: "sm", children: [formatNumber(Number(onRampTokenAmount), 6), " ", (0, import_jsx_runtime40.jsx)(TokenSymbol, { token: onRampToken, chain: onRampChain, size: "sm", inline: true })] }) });
  const fiatIcon = (0, import_jsx_runtime40.jsx)(currency.icon, { size: iconSize.sm });
  const onRampTokenIcon = (0, import_jsx_runtime40.jsx)(PayTokenIcon, { token: onRampToken, chain: onRampChain, size: "sm", client: props.client });
  const toTokenIcon = (0, import_jsx_runtime40.jsx)(PayTokenIcon, { token: toToken, chain: toChain, size: "sm", client: props.client });
  const onRampChainInfo = (0, import_jsx_runtime40.jsx)(Text, { size: "xs", children: onRampName.name });
  const partialSuccessToTokenInfo = ((_a = props.status) == null ? void 0 : _a.status) === "CRYPTO_SWAP_FALLBACK" && props.status.destination ? (0, import_jsx_runtime40.jsxs)("div", { children: [(0, import_jsx_runtime40.jsxs)(Text, { color: "secondaryText", size: "sm", inline: true, style: {
    textDecoration: "line-through"
  }, children: [formatNumber(Number(toTokenAmount), 6), " ", (0, import_jsx_runtime40.jsx)(TokenSymbol, { token: toToken, chain: toChain, size: "sm", inline: true, color: "secondaryText" })] }), " ", (0, import_jsx_runtime40.jsxs)(Text, { color: "danger", size: "sm", inline: true, children: [formatNumber(Number(props.status.destination.amount), 6), " ", (0, import_jsx_runtime40.jsx)(TokenSymbol, { token: {
  ...
  const toTokenInfo = partialSuccessToTokenInfo || (0, import_jsx_runtime40.jsxs)(Text, { color: "primaryText", size: "sm", children: [formatNumber(Number(toTokenAmount), 6), " ", (0, import_jsx_runtime40.jsx)(TokenSymbol, { token: toToken, chain: toChain, size: "sm", inline: true })] });
  const partialSuccessToChainInfo = ((_b = props.status) == null ? void 0 : _b.status) === "CRYPTO_SWAP_FALLBACK" && props.status.destination && props.status.destination.token.chainId !== props.status.quote.toToken.chainId ? (0, import_jsx_runtime40.jsxs)("div", { children: [(0, import_jsx_runtime40.jsx)(Text, { size: "xs", inline: true, style: {
    textDecoration: "line-through"
  }, children: toChainName.name }), " ", (0, import_jsx_runtime40.jsx)(Text, { size: "xs", inline: true, children: destinationName.name })] }) : null;
  const toTokehChainInfo = partialSuccessToChainInfo || (0, import_jsx_runtime40.jsx)(Text, { size: "xs", children: toChainName.name });
  ...
  return (0, import_jsx_runtime40.jsxs)(Container, { p: "lg", children: [(0, import_jsx_runtime40.jsx)(ModalHeader, { title: props.title, onBack: props.onBack }), (0, import_jsx_runtime40.jsx)(Spacer, { y: "lg" }), (0, import_jsx_runtime40.jsx)(PaymentStep, { title: (0, import_jsx_runtime40.jsxs)(Text, { color: "primaryText", size: "md", children: ["Get", " ", (0, import_jsx_runtime40.jsx)(TokenSymbol, { token: onRampToken, chain: onRampChain, size: "md", inline: true }), " ", "with ", props.partialQuote.fromCurrencySymbol] }), step: 1, from: {
    icon: fiatIcon,
    primaryText: (0, import_jsx_runtime40.jsxs)(Text, { color: "primaryText", size: "sm", children: [formatNumber(Number(fromCurrencyAmount), 6), " ", fromCurrencySymbol] })
  }, to: {
  ...
  } : void 0 }), (0, import_jsx_runtime40.jsx)(Spacer, { y: "md" }), (0, import_jsx_runtime40.jsx)(PaymentStep, { title: (0, import_jsx_runtime40.jsxs)(Text, { color: "primaryText", size: "md", children: ["Convert", " ", (0, import_jsx_runtime40.jsx)(TokenSymbol, { token: onRampToken, chain: onRampChain, size: "md", inline: true }), " ", "to ", (0, import_jsx_runtime40.jsx)(TokenSymbol, { token: toToken, chain: toChain, size: "md", inline: true })] }), step: 2, from: {
    icon: onRampTokenIcon,
    primaryText: onRampTokenInfo,
    secondaryText: onRampChainInfo
  }, to: {
  ...
  } : void 0 }), isPartialSuccess && props.status && props.status.status !== "NOT_FOUND" && props.status.source && props.status.destination && (0, import_jsx_runtime40.jsxs)(import_jsx_runtime40.Fragment, { children: [(0, import_jsx_runtime40.jsx)(Spacer, { y: "md" }), (0, import_jsx_runtime40.jsxs)(Text, { color: "danger", size: "sm", center: true, children: ["Expected ", (_l = props.status.source) == null ? void 0 : _l.token.symbol, ", Got", " ", (_m = props.status.destination) == null ? void 0 : _m.token.symbol, " instead"] }), (0, import_jsx_runtime40.jsx)(Spacer, { y: "sm" })] }), showContinueBtn && (0, import_jsx_runtime40.jsxs)(import_jsx_runtime40.Fragment, { children: [(0, import_jsx_runtime40.jsx)(Spacer, { y: "md" }), (0, import_jsx_runtime40.jsx)(Button, { variant: "accent", onClick: props.onContinue, fullWidth: true, children: "Continue" })] })] });
}
function PaymentStep(props) {
  return (0, import_jsx_runtime40.jsxs)(StepContainer, { state: props.state, children: [(0, import_jsx_runtime40.jsxs)(Text, { size: "sm", children: ["Step ", props.step] }), (0, import_jsx_runtime40.jsx)(Spacer, { y: "sm" }), props.title, (0, import_jsx_runtime40.jsx)(Spacer, { y: "sm" }), (0, import_jsx_runtime40.jsx)(Line, {}), (0, import_jsx_runtime40.jsx)(Spacer, { y: "md" }), (0, import_jsx_runtime40.jsx)(PaymentSubStep, { ...props.from }), (0, import_jsx_runtime40.jsxs)(Container, { color: "borderColor", style: {
    paddingLeft: "18px",
    position: "relative",
    marginBlock: "3px"
  }, children: [(0, import_jsx_runtime40.jsx)("div", { style: {
    height: "18px",
    width: "2px",
    backgroundColor: "currentColor",
    transform: "translateX(-50%)"
  } }), (0, import_jsx_runtime40.jsx)(TriangleDownIcon, { width: iconSize.sm, height: iconSize.sm, style: {
    position: "absolute",
    bottom: "0",
    transform: "translate(-50%, 50%)"
  } })] }), (0, import_jsx_runtime40.jsx)(PaymentSubStep, { ...props.to }), props.explorer && (0, import_jsx_runtime40.jsxs)(import_jsx_runtime40.Fragment, { children: [(0, import_jsx_runtime40.jsx)(Spacer, { y: "md" }), (0, import_jsx_runtime40.jsxs)(ButtonLink, { variant: "outline", fullWidth: true, href: props.explorer.url, style: {
    fontSize: fontSize.xs,
    padding: spacing.xs
  }, gap: "xxs", target: "_blank", children: [props.explorer.label, " ", (0, import_jsx_runtime40.jsx)(ExternalLinkIcon, { width: iconSize.xs, height: iconSize.xs })] })] })] });
}
function PaymentSubStep(props) {
  return (0, import_jsx_runtime40.jsxs)(Container, { flex: "row", gap: "sm", center: "y", style: {
    flexWrap: "nowrap"
  }, children: [(0, import_jsx_runtime40.jsx)(Container, { p: "xs", borderColor: "borderColor", flex: "row", center: "both", style: {
    borderStyle: "solid",
    borderWidth: "1.5px",
    borderRadius: radius.lg
  }, children: props.icon }), (0, import_jsx_runtime40.jsxs)(Container, { flex: "column", gap: "xxs", children: [props.primaryText, props.secondaryText] })] });
}
function StepContainer(props) {
  ...
  return (0, import_jsx_runtime40.jsxs)(Container, { bg: "tertiaryBg", borderColor: color === "success" ? "borderColor" : color, py: "sm", px: "md", style: {
    borderRadius: radius.lg,
    alignItems: "flex-start",
    borderWidth: "1px",
    borderStyle: "solid",
    position: "relative"
  }, children: [props.children, (0, import_jsx_runtime40.jsxs)("div", { style: {
    position: "absolute",
    right: spacing.sm,
    top: spacing.sm,
    display: "flex",
    gap: spacing.xs,
    alignItems: "center"
  }, children: [props.state && text && (0, import_jsx_runtime40.jsx)(Text, { size: "sm", color, children: text }), (props.state === "actionRequired" || props.state === "completed") && (0, import_jsx_runtime40.jsx)(StepIcon, { isActive: props.state === "actionRequired", isDone: props.state === "completed" }), props.state === "pending" && (0, import_jsx_runtime40.jsx)(Spinner, { color: "accentText", size: "sm" }), props.state === "failed" && (0, import_jsx_runtime40.jsx)(Container, { color: "danger", flex: "row", center: "both", children: (0, import_jsx_runtime40.jsx)(Cross1Icon, { width: iconSize.sm, height: iconSize.sm }) })] })] });
}
...
function StepBar(props) {
  return (0, import_jsx_runtime41.jsx)(Container, { bg: "tertiaryBg", flex: "row", style: {
    height: "8px",
    borderRadius: radius.lg
  }, children: (0, import_jsx_runtime41.jsx)(Container, { bg: "accentText", style: {
...
function SwapFees(props) {
  return (0, import_jsx_runtime42.jsx)(Container, { flex: "column", gap: "xs", style: {
    ...
    return (0, import_jsx_runtime42.jsxs)(Container, { flex: "column", gap: "xxs", children: [(0, import_jsx_runtime42.jsxs)(Text, { color: "primaryText", size: "sm", style: { textAlign: "right" }, children: [feeAmount === 0 ? "~" : "", feeAmount, " ", fee.token.symbol] }), (0, import_jsx_runtime42.jsxs)(Text, { color: "secondaryText", size: "xs", style: { textAlign: "right" }, children: ["$", (fee.amountUSDCents / 100).toFixed(2)] })] }, `${fee.token.chainId}_${fee.token.tokenAddress}_${feeAmount}`);
  }) });
}
function FiatFees(props) {
  return (0, import_jsx_runtime42.jsxs)(Container, { flex: "column", gap: "xs", children: [(0, import_jsx_runtime42.jsxs)("div", { style: {
    display: "flex",
    justifyContent: "space-between"
  }, children: [(0, import_jsx_runtime42.jsx)(Text, { inline: true, color: "secondaryText", children: "Amount" }), (0, import_jsx_runtime42.jsxs)(Text, { color: "primaryText", inline: true, children: [formatNumber(Number(props.quote.fromCurrency.amount), 2), " ", props.quote.fromCurrency.currencySymbol] })] }), props.quote.processingFees.map((fee, i) => {
    const feeAmount = formatNumber(Number(fee.amount), 6);
    return (0, import_jsx_runtime42.jsxs)("div", { style: {
      display: "flex",
      justifyContent: "space-between"
    }, children: [(0, import_jsx_runtime42.jsx)(Text, { inline: true, color: "secondaryText", children: fee.feeType === "NETWORK" ? "Network Fee" : "Processing Fee" }), (0, import_jsx_runtime42.jsxs)(Text, { color: "primaryText", inline: true, children: [feeAmount === 0 ? "~" : "", feeAmount, " ", fee.currencySymbol, " "] })] }, i);
  }), (0, import_jsx_runtime42.jsx)(Spacer, { y: "xxs" }), (0, import_jsx_runtime42.jsx)(Line, {}), (0, import_jsx_runtime42.jsx)(Spacer, { y: "xxs" }), (0, import_jsx_runtime42.jsxs)("div", { style: {
    display: "flex",
    justifyContent: "space-between"
  }, children: [(0, import_jsx_runtime42.jsx)(Text, { inline: true, color: "secondaryText", children: "Total" }), (0, import_jsx_runtime42.jsxs)(Text, { color: "primaryText", inline: true, children: [formatNumber(Number(props.quote.fromCurrencyWithFees.amount), 6), " ", props.quote.fromCurrencyWithFees.currencySymbol] })] })] });
}
...
function SwapConfirmationScreen(props) {
  ...
  const [step, setStep] = (0, import_react22.useState)(initialStep);
  ...
  return (0, import_jsx_runtime43.jsxs)(Container, { p: "lg", children: [(0, import_jsx_runtime43.jsx)(ModalHeader, { title: props.title, onBack: props.onBack }), props.isFiatFlow ? (0, import_jsx_runtime43.jsxs)(import_jsx_runtime43.Fragment, { children: [(0, import_jsx_runtime43.jsx)(Spacer, { y: "lg" }), (0, import_jsx_runtime43.jsx)(StepBar, { steps: 2, currentStep: 2 }), (0, import_jsx_runtime43.jsx)(Spacer, { y: "sm" }), (0, import_jsx_runtime43.jsxs)(Text, { size: "xs", children: ["Step 2 of 2 - Converting ", props.fromTokenSymbol, " to", " ", props.toTokenSymbol] }), (0, import_jsx_runtime43.jsx)(Spacer, { y: "md" })] }) : (0, import_jsx_runtime43.jsx)(Spacer, { y: "lg" }), (0, import_jsx_runtime43.jsx)(ConfirmItem, { label: "Pay", children: (0, import_jsx_runtime43.jsx)(RenderTokenInfo, { chain: props.fromChain, amount: String(formatNumber(Number(props.fromAmount), 6)), symbol: props.fromTokenSymbol || "", token: props.fromToken, client: props.client }) }), !isDifferentRecipient && (0, import_jsx_runtime43.jsx)(ConfirmItem, { label: "Receive", children: (0, import_jsx_runtime43.jsx)(RenderTokenInfo, { chain: props.toChain, amount: String(formatNumber(Number(props.toAmount), 6)), symbol: props.toTokenSymbol, token: props.toToken, client: props.client }) }), (0, import_jsx_runtime43.jsx)(ConfirmItem, { label: "Fees", children: (0, import_jsx_runtime43.jsx)(SwapFees, { quote: props.quote, align: "right" }) }), (0, import_jsx_runtime43.jsx)(ConfirmItem, { label: "Time", children: (0, import_jsx_runtime43.jsxs)(Text, { size: "sm", color: "primaryText", children: ["~", formatSeconds(props.quote.swapDetails.estimated.durationSeconds || 0)] }) }), isDifferentRecipient && (0, import_jsx_runtime43.jsx)(ConfirmItem, { label: "Seller", children: (0, import_jsx_runtime43.jsx)(Text, { color: "primaryText", size: "sm", children: ensName.data || shortenAddress(receiver) }) }), (0, import_jsx_runtime43.jsx)(Spacer, { y: "xl" }), isApprovalRequired && (0, import_jsx_runtime43.jsxs)(import_jsx_runtime43.Fragment, { children: [(0, import_jsx_runtime43.jsx)(Spacer, { y: "sm" }), (0, import_jsx_runtime43.jsxs)(Container, { gap: "sm", flex: "row", style: {
    justifyContent: "space-between"
  }, center: "y", color: "accentText", children: [(0, import_jsx_runtime43.jsx)(Step, { isDone: step === "swap", isActive: step === "approval", label: step === "approval" ? "Approve" : "Approved" }), (0, import_jsx_runtime43.jsx)(ConnectorLine, {}), (0, import_jsx_runtime43.jsx)(Step, { isDone: false, label: "Confirm", isActive: step === "swap" })] }), (0, import_jsx_runtime43.jsx)(Spacer, { y: "lg" })] }), status === "error" && (0, import_jsx_runtime43.jsxs)(import_jsx_runtime43.Fragment, { children: [(0, import_jsx_runtime43.jsxs)(Container, { flex: "row", gap: "xs", center: "both", color: "danger", children: [(0, import_jsx_runtime43.jsx)(CrossCircledIcon, { width: iconSize.sm, height: iconSize.sm }), (0, import_jsx_runtime43.jsx)(Text, { color: "danger", size: "sm", children: step === "approval" ? "Failed to Approve" : "Failed to Confirm" })] }), (0, import_jsx_runtime43.jsx)(Spacer, { y: "md" })] }), props.payer.chain.id !== props.fromChain.id ? (0, import_jsx_runtime43.jsx)(SwitchNetworkButton, { fullWidth: true, variant: "accent", switchChain: async () => {
    await props.payer.wallet.switchChain(props.fromChain);
  } }) : (0, import_jsx_runtime43.jsxs)(Button, { variant: "accent", fullWidth: true, disabled: status === "pending", onClick: async () => {
  ...
  }, gap: "xs", children: [step === "approval" && (status === "pending" ? "Approving" : "Approve"), step === "swap" && (status === "pending" ? "Confirming" : "Confirm"), status === "pending" && (0, import_jsx_runtime43.jsx)(Spinner, { size: "sm", color: "accentButtonText" })] })] });
}
...
function RenderTokenInfo(props) {
  const { name } = useChainName(props.chain);
  return (0, import_jsx_runtime43.jsxs)(Container, { flex: "column", gap: "xxs", style: {
    alignItems: "flex-end"
  }, children: [(0, import_jsx_runtime43.jsxs)(Container, { flex: "row", center: "y", gap: "xs", children: [(0, import_jsx_runtime43.jsxs)(Text, { color: "primaryText", size: "sm", children: [props.amount, " ", props.symbol] }), (0, import_jsx_runtime43.jsx)(PayTokenIcon, { token: props.token, chain: props.chain, size: "xs", client: props.client })] }), name ? (0, import_jsx_runtime43.jsx)(Text, { size: "xs", children: name }) : (0, import_jsx_runtime43.jsx)(Skeleton, { width: "100px", height: fontSize.xs })] });
}
function ConfirmItem(props) {
  return (0, import_jsx_runtime43.jsxs)(import_jsx_runtime43.Fragment, { children: [(0, import_jsx_runtime43.jsxs)(Container, { flex: "row", gap: "md", py: "md", style: {
    justifyContent: "space-between"
  }, children: [(0, import_jsx_runtime43.jsx)(Text, { size: "sm", color: "secondaryText", children: props.label }), props.children] }), (0, import_jsx_runtime43.jsx)(Line, {})] });
}
...
function SwapDetailsScreen(props) {
  ...
  return (0, import_jsx_runtime44.jsxs)(Container, { children: [(0, import_jsx_runtime44.jsx)(Container, { p: "lg", children: (0, import_jsx_runtime44.jsx)(ModalHeader, { title: "Transaction Details", onBack: props.onBack }) }), (0, import_jsx_runtime44.jsx)(Line, {}), (0, import_jsx_runtime44.jsx)(Container, { p: "lg", children: (0, import_jsx_runtime44.jsx)(SwapTxDetailsTable, { type: "status", status, client }) })] });
}
function SwapTxDetailsTable(props) {
  ...
  const lineSpacer = (0, import_jsx_runtime44.jsxs)(import_jsx_runtime44.Fragment, { children: [(0, import_jsx_runtime44.jsx)(Spacer, { y: "md" }), (0, import_jsx_runtime44.jsx)(Line, {}), (0, import_jsx_runtime44.jsx)(Spacer, { y: "md" })] });
  if (isTransfer) {
    return (0, import_jsx_runtime44.jsx)("div", { children: ((_d = (_c = fromChainExplorers.explorers) == null ? void 0 : _c[0]) == null ? void 0 : _d.url) && sourceTxHash && (0, import_jsx_runtime44.jsxs)(ButtonLink, { fullWidth: true, variant: "outline", href: `${fromChainExplorers.explorers[0].url}/tx/${sourceTxHash}`, target: "_blank", gap: "xs", style: {
      fontSize: fontSize.sm,
      padding: spacing.sm
    }, children: ["View on ", fromChainName.name, " Explorer", (0, import_jsx_runtime44.jsx)(ExternalLinkIcon, { width: iconSize.sm, height: iconSize.sm })] }) });
  }
  return (0, import_jsx_runtime44.jsxs)("div", { children: [isPartialSuccess && gotToken ? (
    // Expected + Got
    (0, import_jsx_runtime44.jsxs)(import_jsx_runtime44.Fragment, { children: [(0, import_jsx_runtime44.jsx)(TokenInfoRow, { chainId: toToken.chainId, client, label: isPartialSuccess ? "Expected" : "Received", tokenAmount: toToken.amount, tokenSymbol: toToken.symbol || "", tokenAddress: toToken.address }), lineSpacer, (0, import_jsx_runtime44.jsx)(TokenInfoRow, { chainId: gotToken.chainId, client, label: "Got", tokenAmount: gotToken.amount, tokenSymbol: gotToken.symbol || "", tokenAddress: gotToken.address })] })
  ) : (
    // Receive
    (0, import_jsx_runtime44.jsx)(TokenInfoRow, { chainId: toToken.chainId, client, label: "Receive", tokenAmount: toToken.amount, tokenSymbol: toToken.symbol || "", tokenAddress: toToken.address })
  ), lineSpacer, (0, import_jsx_runtime44.jsx)(TokenInfoRow, { chainId: fromToken.chainId, client, label: "Pay", tokenAmount: fromToken.amount, tokenSymbol: fromToken.symbol || "", tokenAddress: fromToken.address }), lineSpacer, (0, import_jsx_runtime44.jsxs)(Container, { flex: "row", center: "y", style: {
    justifyContent: "space-between"
  }, children: [(0, import_jsx_runtime44.jsx)(Text, { children: " Time " }), (0, import_jsx_runtime44.jsx)(Container, { flex: "row", gap: "xs", center: "y", children: (0, import_jsx_runtime44.jsxs)(Text, { color: "primaryText", children: ["~", formatSeconds(estimatedDuration || 0)] }) })] }), statusMeta && showStatusRow && (0, import_jsx_runtime44.jsxs)(import_jsx_runtime44.Fragment, { children: [lineSpacer, (0, import_jsx_runtime44.jsxs)(Container, { flex: "row", center: "y", style: {
    justifyContent: "space-between"
  }, children: [(0, import_jsx_runtime44.jsx)(Text, { children: "Status" }), (0, import_jsx_runtime44.jsx)(Container, { flex: "row", gap: "xs", center: "y", children: (0, import_jsx_runtime44.jsx)(Text, { color: statusMeta.color, children: statusMeta.status }) })] })] }), uiData.fromAddress.toLowerCase() !== uiData.toAddress.toLowerCase() && (0, import_jsx_runtime44.jsxs)(import_jsx_runtime44.Fragment, { children: [lineSpacer, (0, import_jsx_runtime44.jsxs)(Container, { flex: "row", center: "y", style: {
    justifyContent: "space-between"
  }, children: [(0, import_jsx_runtime44.jsx)(Text, { children: "Send to" }), (0, import_jsx_runtime44.jsx)(Container, { flex: "row", gap: "xs", center: "y", children: (0, import_jsx_runtime44.jsx)(Text, { color: "primaryText", size: "sm", children: shortenAddress(uiData.toAddress) }) })] })] }), lineSpacer, ((_f = (_e = fromChainExplorers.explorers) == null ? void 0 : _e[0]) == null ? void 0 : _f.url) && sourceTxHash && (0, import_jsx_runtime44.jsxs)(ButtonLink, { fullWidth: true, variant: "outline", href: `${fromChainExplorers.explorers[0].url}/tx/${sourceTxHash}`, target: "_blank", gap: "xs", style: {
    fontSize: fontSize.sm,
    padding: spacing.sm
  }, children: ["View on ", fromChainName.name, " Explorer", (0, import_jsx_runtime44.jsx)(ExternalLinkIcon, { width: iconSize.sm, height: iconSize.sm })] }), destinationTxHash && sourceTxHash !== destinationTxHash && ((_h = (_g = toChainExplorers == null ? void 0 : toChainExplorers.explorers) == null ? void 0 : _g[0]) == null ? void 0 : _h.url) && (0, import_jsx_runtime44.jsxs)(import_jsx_runtime44.Fragment, { children: [(0, import_jsx_runtime44.jsx)(Spacer, { y: "sm" }), (0, import_jsx_runtime44.jsxs)(ButtonLink, { fullWidth: true, variant: "outline", href: `${toChainExplorers.explorers[0].url}/tx/${destinationTxHash}`, target: "_blank", gap: "xs", style: {
    fontSize: fontSize.sm,
    padding: spacing.sm
  }, children: ["View on ", toChainName.name, " Explorer", (0, import_jsx_runtime44.jsx)(ExternalLinkIcon, { width: iconSize.sm, height: iconSize.sm })] })] })] });
}
...
function SwapStatusScreen(props) {
  ...
  const purchaseCbCalled = (0, import_react23.useRef)(false);
  ...
  const queryClient = useQueryClient();
  const balanceInvalidated = (0, import_react23.useRef)(false);
  (0, import_react23.useEffect)(() => {
  ...
  const swapDetails = swapStatus.data && swapStatus.data.status !== "NOT_FOUND" ? (0, import_jsx_runtime45.jsx)(SwapTxDetailsTable, { status: swapStatus.data, type: "status", hideStatusRow: true, client: props.client }) : props.quote ? (0, import_jsx_runtime45.jsx)(SwapTxDetailsTable, { type: "quote", quote: props.quote, client: props.client }) : null;
  return (0, import_jsx_runtime45.jsx)(Container, { animate: "fadein", children: (0, import_jsx_runtime45.jsxs)(Container, { p: "lg", children: [(0, import_jsx_runtime45.jsx)(ModalHeader, { title: props.title, onBack: props.onBack }), (0, import_jsx_runtime45.jsx)(Spacer, { y: "sm" }), uiStatus === "success" && (0, import_jsx_runtime45.jsxs)(import_jsx_runtime45.Fragment, { children: [(0, import_jsx_runtime45.jsx)(Spacer, { y: "md" }), (0, import_jsx_runtime45.jsxs)(Container, { color: "success", flex: "column", center: "x", children: [(0, import_jsx_runtime45.jsx)(CheckCircledIcon, { width: iconSize["3xl"], height: iconSize["3xl"] }), (0, import_jsx_runtime45.jsx)(Spacer, { y: "sm" }), (0, import_jsx_runtime45.jsx)(Text, { color: "primaryText", size: "lg", children: "Buy Complete" })] }), (0, import_jsx_runtime45.jsx)(Spacer, { y: "xl" }), swapDetails, (0, import_jsx_runtime45.jsx)(Spacer, { y: "sm" }), !props.isEmbed && (0, import_jsx_runtime45.jsx)(Button, { variant: "accent", fullWidth: true, onClick: props.onDone, children: props.transactionMode ? "Continue Transaction" : "Done" })] }), uiStatus === "partialSuccess" && ((_e = swapStatus.data) == null ? void 0 : _e.status) !== "NOT_FOUND" && ((_f = swapStatus.data) == null ? void 0 : _f.destination) && (0, import_jsx_runtime45.jsxs)(import_jsx_runtime45.Fragment, { children: [(0, import_jsx_runtime45.jsx)(Spacer, { y: "lg" }), (0, import_jsx_runtime45.jsxs)(Container, { color: "success", flex: "column", center: "x", children: [(0, import_jsx_runtime45.jsx)(AccentFailIcon, { size: iconSize["3xl"] }), (0, import_jsx_runtime45.jsx)(Spacer, { y: "xl" }), (0, import_jsx_runtime45.jsx)(Text, { color: "primaryText", size: "lg", children: "Incomplete" }), (0, import_jsx_runtime45.jsx)(Spacer, { y: "sm" }), (0, import_jsx_runtime45.jsxs)(Text, { size: "sm", color: "danger", children: ["Expected ", swapStatus.data.quote.toToken.symbol, ", Got", " ", swapStatus.data.destination.token.symbol, " instead"] })] }), (0, import_jsx_runtime45.jsx)(Spacer, { y: "xl" }), swapDetails] }), uiStatus === "failed" && (0, import_jsx_runtime45.jsxs)(import_jsx_runtime45.Fragment, { children: [(0, import_jsx_runtime45.jsx)(Spacer, { y: "xxl" }), (0, import_jsx_runtime45.jsxs)(Container, { flex: "column", children: [(0, import_jsx_runtime45.jsxs)(Container, { flex: "column", center: "both", children: [(0, import_jsx_runtime45.jsx)(AccentFailIcon, { size: iconSize["3xl"] }), (0, import_jsx_runtime45.jsx)(Spacer, { y: "xl" }), (0, import_jsx_runtime45.jsx)(Text, { color: "primaryText", size: "lg", children: "Transaction Failed" }), (0, import_jsx_runtime45.jsx)(Spacer, { y: "sm" }), (0, import_jsx_runtime45.jsxs)(Text, { size: "sm", children: ["Your transaction ", `couldn't`, " be processed"] })] }), (0, import_jsx_runtime45.jsx)(Spacer, { y: "md" }), (0, import_jsx_runtime45.jsx)(Button, { variant: "accent", fullWidth: true, onClick: props.onTryAgain, children: "Try Again" }), (0, import_jsx_runtime45.jsx)(Spacer, { y: "xl" }), swapDetails] })] }), uiStatus === "pending" && (0, import_jsx_runtime45.jsxs)(import_jsx_runtime45.Fragment, { children: [(0, import_jsx_runtime45.jsx)(Spacer, { y: "xl" }), (0, import_jsx_runtime45.jsxs)(Container, { flex: "column", animate: "fadein", center: "both", children: [(0, import_jsx_runtime45.jsx)("div", { style: {
    position: "relative",
    display: "flex",
    alignItems: "center",
    justifyContent: "center"
  }, children: (0, import_jsx_runtime45.jsx)(Spinner, { size: "3xl", color: "accentText" }) }), (0, import_jsx_runtime45.jsx)(Spacer, { y: "lg" }), (0, import_jsx_runtime45.jsx)(Text, { color: "primaryText", size: "lg", children: "Buy Pending" })] }), (0, import_jsx_runtime45.jsx)(Spacer, { y: "xxl" }), swapDetails] })] }) });
}

// node_modules/thirdweb/dist/esm/react/web/ui/ConnectWallet/screens/Buy/swap/SwapFlow.js
function SwapFlow(props) {
  const [swapTxHash, setSwapTxHash] = (0, import_react24.useState)();
  const quote = props.buyWithCryptoQuote;
  const fromChain = (0, import_react24.useMemo)(() => getCachedChain(quote.swapDetails.fromToken.chainId), [quote]);
  const toChain = (0, import_react24.useMemo)(() => getCachedChain(quote.swapDetails.toToken.chainId), [quote]);
  ...
  const toToken = (0, import_react24.useMemo)(() => {
  ...
  const fromToken = (0, import_react24.useMemo)(() => {
  ...
  if (swapTxHash) {
    return (0, import_jsx_runtime46.jsx)(SwapStatusScreen, { title: props.title, onBack: props.onBack, onTryAgain: props.onTryAgain, swapTxHash, client: props.client, onDone: props.onDone, transactionMode: props.transactionMode, isEmbed: props.isEmbed, quote, onSuccess: props.onSuccess });
  }
  return (0, import_jsx_runtime46.jsx)(SwapConfirmationScreen, { title: props.title, setSwapTxHash, toChain, toAmount, toTokenSymbol, fromChain, toToken, fromAmount, fromToken, fromTokenSymbol, client: props.client, onBack: props.onBack, onTryAgain: props.onTryAgain, quote, isFiatFlow: props.isFiatFlow, payer: props.payer });
}

// node_modules/thirdweb/dist/esm/react/web/ui/ConnectWallet/screens/Buy/fiat/PostOnRampSwap.js
function PostOnRampSwap(props) {
  const [lockedOnRampQuote, setLockedOnRampQuote] = (0, import_react25.useState)(void 0);
  ...
  if (postOnRampQuoteQuery.isError) {
    return (0, import_jsx_runtime47.jsxs)(Container, { fullHeight: true, children: [(0, import_jsx_runtime47.jsx)(Container, { p: "lg", children: (0, import_jsx_runtime47.jsx)(ModalHeader, { title: props.title, onBack: props.onBack }) }), (0, import_jsx_runtime47.jsxs)(Container, { style: {
      minHeight: "300px"
    }, flex: "column", center: "both", p: "lg", children: [(0, import_jsx_runtime47.jsx)(AccentFailIcon, { size: iconSize["3xl"] }), (0, import_jsx_runtime47.jsx)(Spacer, { y: "xl" }), (0, import_jsx_runtime47.jsx)(Text, { color: "primaryText", children: "Failed to get a price quote" }), (0, import_jsx_runtime47.jsx)(Spacer, { y: "lg" }), (0, import_jsx_runtime47.jsx)(Button, { fullWidth: true, variant: "primary", onClick: () => {
      postOnRampQuoteQuery.refetch();
    }, children: "Try Again" })] }), (0, import_jsx_runtime47.jsx)(Spacer, { y: "xxl" })] });
  }
  if (!lockedOnRampQuote) {
    return (0, import_jsx_runtime47.jsxs)(Container, { fullHeight: true, children: [(0, import_jsx_runtime47.jsx)(Container, { p: "lg", children: (0, import_jsx_runtime47.jsx)(ModalHeader, { title: props.title, onBack: props.onBack }) }), (0, import_jsx_runtime47.jsxs)(Container, { style: {
      minHeight: "300px"
    }, flex: "column", center: "both", children: [(0, import_jsx_runtime47.jsx)(Spinner, { size: "xxl", color: "accentText" }), (0, import_jsx_runtime47.jsx)(Spacer, { y: "xl" }), (0, import_jsx_runtime47.jsx)(Text, { color: "primaryText", children: "Getting price quote" })] }), (0, import_jsx_runtime47.jsx)(Spacer, { y: "xxl" })] });
  }
  return (0, import_jsx_runtime47.jsx)(SwapFlow, { title: props.title, payer: props.payer, buyWithCryptoQuote: lockedOnRampQuote, client: props.client, onBack: props.onBack, isFiatFlow: true, onDone: props.onDone, onTryAgain: () => {
...
function PostOnRampSwapFlow(props) {
  const [statusForSwap, setStatusForSwap] = (0, import_react26.useState)();
  if (statusForSwap) {
    return (0, import_jsx_runtime48.jsx)(PostOnRampSwap, { title: props.title, buyWithFiatStatus: statusForSwap, client: props.client, onDone: props.onDone, transactionMode: props.transactionMode, isEmbed: props.isEmbed, payer: props.payer, onSuccess: props.onSuccess });
  }
  return (0, import_jsx_runtime48.jsx)(FiatSteps, { title: props.title, client: props.client, onBack: props.onBack, partialQuote: props.quote, step: 2, onContinue: () => {
...
function FiatDetailsScreen(props) {
  ...
  const [stopPolling, setStopPolling] = (0, import_react27.useState)(false);
  ...
  if (hasTwoSteps) {
    ...
    return (0, import_jsx_runtime49.jsx)(PostOnRampSwapFlow, {
      title: props.title,
      client: props.client,
      status,
      onBack: props.onBack,
  ...
  return (0, import_jsx_runtime49.jsxs)(Container, { children: [(0, import_jsx_runtime49.jsx)(Container, { p: "lg", children: (0, import_jsx_runtime49.jsx)(ModalHeader, { title: "Transaction Details", onBack: props.onBack }) }), (0, import_jsx_runtime49.jsx)(Line, {}), (0, import_jsx_runtime49.jsx)(Container, { p: "lg", children: (0, import_jsx_runtime49.jsx)(OnRampTxDetailsTable, { client: props.client, token: status.source ? {
...
function TxDetailsScreen(props) {
  ...
  if (statusInfo.type === "swap") {
    return (0, import_jsx_runtime50.jsx)(SwapDetailsScreen, { client: props.client, status: statusInfo.status, onBack: props.onBack });
  }
  if (statusInfo.type === "fiat") {
    return (0, import_jsx_runtime50.jsx)(FiatDetailsScreen, { title: props.title, client: props.client, status: statusInfo.status, onBack: props.onBack, onDone: props.onDone, transactionMode: props.transactionMode, isEmbed: props.isEmbed, payer: props.payer });
  }
  return null;
}
...
function useBuyTransactionsToShow(client) {
  ...
  const [pageIndex, setPageIndex] = (0, import_react28.useState)(0);
  const txStatusList = [];
  const PAGE_SIZE = 10;
  ...
  const pendingTxStoreValue = (0, import_react28.useSyncExternalStore)(pendingTransactions.subscribe, pendingTransactions.getValue);
...
function PayTxHistoryList(props) {
  ...
  return (0, import_jsx_runtime51.jsxs)(Container, { scrollY: true, flex: "column", fullHeight: true, style: {
    width: "100%",
    minHeight: "250px",
    maxHeight: "370px",
    paddingBottom: spacing.lg
  }, children: [(0, import_jsx_runtime51.jsxs)(Container, { flex: "column", gap: "xs", expand: true, children: [noTransactions && !isLoading && (0, import_jsx_runtime51.jsxs)(Container, { flex: "column", gap: "md", center: "both", color: "secondaryText", style: {
    minHeight: "250px"
  }, children: [(0, import_jsx_runtime51.jsx)(CrossCircledIcon, { width: iconSize.xl, height: iconSize.xl }), (0, import_jsx_runtime51.jsx)(Text, { children: "No Transactions" })] }), noTransactions && isLoading && (0, import_jsx_runtime51.jsx)(Container, { flex: "row", center: "both", style: {
    minHeight: "250px"
  }, children: (0, import_jsx_runtime51.jsx)(Spinner, { size: "xl", color: "accentText" }) }), txInfosToShow.length > 0 && (0, import_jsx_runtime51.jsx)(Container, { animate: "fadein", flex: "column", gap: "xs", children: txInfosToShow.map((txInfo) => {
    var _a;
    return (0, import_jsx_runtime51.jsx)(BuyTxHistoryButton, { txInfo, client: props.client, onClick: () => {
      props.onSelectTx(txInfo);
    } }, txInfo.type === "swap" ? (_a = txInfo.status.source) == null ? void 0 : _a.transactionHash : txInfo.status.intentId);
  }) }), isLoading && txInfosToShow.length > 0 && (0, import_jsx_runtime51.jsxs)(import_jsx_runtime51.Fragment, { children: [(0, import_jsx_runtime51.jsx)(Skeleton, { width: "100%", height: BuyTxHistoryButtonHeight }), (0, import_jsx_runtime51.jsx)(Skeleton, { width: "100%", height: BuyTxHistoryButtonHeight }), (0, import_jsx_runtime51.jsx)(Skeleton, { width: "100%", height: BuyTxHistoryButtonHeight })] })] }), pagination && !hidePagination && (0, import_jsx_runtime51.jsx)(Container, { py: "md", children: (0, import_jsx_runtime51.jsxs)("div", { style: {
    display: "grid",
    gridTemplateColumns: "1fr 1fr",
    gap: spacing.sm
  }, children: [(0, import_jsx_runtime51.jsxs)(Button, { variant: "outline", gap: "xs", disabled: pageIndex === 0, "data-disabled": pageIndex === 0, style: {
    fontSize: fontSize.sm,
    paddingBlock: spacing.sm
  }, onClick: () => {
    setPageIndex((prev) => prev - 1);
  }, children: [(0, import_jsx_runtime51.jsx)(ArrowRightIcon, { width: iconSize.sm, height: iconSize.sm, style: {
    transform: "rotate(180deg)"
  } }), "Prev"] }), (0, import_jsx_runtime51.jsxs)(Button, { variant: "outline", gap: "xs", disabled: !pagination.hasNextPage, "data-disabled": !pagination.hasNextPage, style: {
    fontSize: fontSize.sm,
    paddingBlock: spacing.sm
  }, onClick: () => {
    setPageIndex((prev) => prev + 1);
  }, children: ["Next", (0, import_jsx_runtime51.jsx)(ArrowRightIcon, { width: iconSize.sm, height: iconSize.sm })] })] }) })] });
}
...
function WalletTransactionHistory(props) {
  ...
  const reverseChronologicalTransactions = (0, import_react30.useSyncExternalStore)(transactionStore.subscribe, transactionStore.getValue);
...
function TransactionsScreen(props) {
  var _a;
  const [activeTab, setActiveTab] = (0, import_react31.useState)("Transactions");
  const [selectedTx, setSelectedTx] = (0, import_react31.useState)(null);
  const activeChain = useActiveWalletChain();
...
var BuyScreen = (0, import_react32.lazy)(() => import("./BuyScreen-S6HNF6AH.js"));
function LazyBuyScreen(props) {
  return (0, import_jsx_runtime55.jsx)(import_react32.Suspense, { fallback: (0, import_jsx_runtime55.jsx)(LoadingScreen, {}), children: (0, import_jsx_runtime55.jsx)(BuyScreen, { ...props }) });
}
...
function useConnectedWallets() {
  ...
  return (0, import_react33.useSyncExternalStore)(store.subscribe, store.getValue, store.getValue);
}
...
var SignatureScreen = (props) => {
  ...
  const signIn = (0, import_react35.useCallback)(async () => {
    try {
      setStatus("signing");
...
function HeadlessSignIn({ signIn, status, connectLocale, wallet }) {
  const locale = connectLocale.signatureScreen;
  const mounted = (0, import_react35.useRef)(false);
  const { disconnect } = useDisconnect();
  ...
  return (0, import_jsx_runtime56.jsxs)(Container, { p: "lg", fullHeight: true, flex: "column", animate: "fadein", children: [(0, import_jsx_runtime56.jsx)(ModalHeader, { title: locale.signingScreen.title }), (0, import_jsx_runtime56.jsxs)(Container, { expand: true, flex: "row", center: "both", style: {
    minHeight: "250px"
  }, children: [status === "signing" && (0, import_jsx_runtime56.jsx)(Spinner, { size: "xl", color: "accentText" }), status === "failed" && (0, import_jsx_runtime56.jsx)(import_jsx_runtime56.Fragment, { children: (0, import_jsx_runtime56.jsxs)(Container, { children: [(0, import_jsx_runtime56.jsx)(Spacer, { y: "lg" }), (0, import_jsx_runtime56.jsx)(Text, { size: "lg", center: true, color: "danger", children: locale.signingScreen.failedToSignIn }), (0, import_jsx_runtime56.jsx)(Spacer, { y: "lg" }), (0, import_jsx_runtime56.jsxs)(Button, { fullWidth: true, variant: "accent", onClick: () => {
    signIn();
  }, style: {
    gap: spacing.xs,
    alignItems: "center",
...
// node_modules/thirdweb/dist/esm/react/web/ui/ConnectWallet/Modal/ConnectModalContent.js
var AllWalletsUI = (0, import_react37.lazy)(() => import("./AllWalletsUI-36YTHPUD.js"));
var ConnectModalContent = (props) => {
  ...
  const handleConnected = (0, import_react37.useCallback)((wallet) => {
    if (shouldSetActive) {
  ...
  const handleBack = (0, import_react37.useCallback)(() => {
    setSelectionData({});
    setScreen(initialScreen);
...
function WalletManagerScreen(props) {
  var _a;
  const [screen, setScreen] = (0, import_react38.useState)("wallets");
  const connectedWallets = useConnectedWallets();
  ...
  return (0, import_jsx_runtime62.jsxs)(Container, { children: [(0, import_jsx_runtime62.jsx)(Container, { p: "lg", children: (0, import_jsx_runtime62.jsx)(ModalHeader, { title: "Wallets", onBack: props.onBack }) }), (0, import_jsx_runtime62.jsx)(Line, {}), (0, import_jsx_runtime62.jsx)(Spacer, { y: "md" }), (0, import_jsx_runtime62.jsx)(Container, { px: "md", style: {
    minHeight: "150px"
  }, children: (0, import_jsx_runtime62.jsx)(Container, { flex: "column", gap: "xs", children: connectedWallets.map((w) => {
...
var InAppWalletConnectUI = (0, import_react39.lazy)(() => import("./InAppWalletConnectUI-BRXQQQOF.js"));
function LinkProfileScreen(props) {
  ...
  if (activeWallet.id === "inApp") {
    return (0, import_jsx_runtime63.jsx)(import_react39.Suspense, { fallback: (0, import_jsx_runtime63.jsx)(LoadingScreen, {}), children: (0, import_jsx_runtime63.jsx)(InAppWalletConnectUI, { walletConnect: props.walletConnect, wallet: activeWallet, done: () => {
...
// node_modules/thirdweb/dist/esm/react/core/hooks/others/useProfiles.js
...
function LinkedProfilesScreen(props) {
  ...
  return (0, import_jsx_runtime65.jsxs)(Container, { style: {
    ...
    fontSize: fontSize.sm
  }, children: [(0, import_jsx_runtime65.jsx)(AddUserIcon, { size: iconSize.md }), (0, import_jsx_runtime65.jsx)(Text, { color: "primaryText", children: props.locale.manageWallet.linkProfile })] }), (0, import_jsx_runtime65.jsx)(Spacer, { y: "xs" }), connectedProfiles == null ? void 0 : connectedProfiles.map((profile) => (0, import_jsx_runtime65.jsxs)(MenuButton, { onClick: () => {
    props.setScreen("linked-profiles");
  }, style: {
    fontSize: fontSize.sm,
    cursor: "default"
  }, disabled: true, children: [profile.type === "wallet" && profile.details.address ? (0, import_jsx_runtime65.jsx)(Container, { style: {
    width: "24px",
    height: "24px",
    borderRadius: "100%",
    overflow: "hidden"
  }, children: (0, import_jsx_runtime65.jsx)(Blobbie, { address: profile.details.address, size: 24 }) }) : (0, import_jsx_runtime65.jsx)(Img, { src: getWalletIcon(profile.type), width: iconSize.md, height: iconSize.md, loading: "eager", client: props.client }), (0, import_jsx_runtime65.jsx)(Text, { color: "primaryText", children: getProfileDisplayName(profile) })] }, `${profile.type}-${getProfileDisplayName(profile)}`))] }), (0, import_jsx_runtime65.jsx)(Spacer, { y: "md" })] })] });
}
...
function PrivateKey(props) {
  var _a;
  const [isLoading, setLoading] = (0, import_react40.useState)(true);
  if (!props.wallet) {
  ...
  return transfer({
    ...
    asyncParams: async () => {
      ...
      if ("amount" in options) {
        const { decimals: decimals2 } = await import("./decimals-4LN7A37R.js");
...
async function getTokenBalance(options) {
  ...
  if (tokenAddress) {
    const { getBalance } = await import("./getBalance-BIMLPELX.js");
    return getBalance({
...
function useTokenInfo(options) {
  ...
  return useQuery({
    ...
    queryFn: async () => {
      if (tokenAddress) {
        const { getCurrencyMetadata: getCurrencyMetadata2 } = await import("./getCurrencyMetadata-W3TQKFXA.js");
        const result2 = await getCurrencyMetadata2({
          contract: getContract({ client, chain, address: tokenAddress })
        });
        return result2;
      }
      const { getChainDecimals: getChainDecimals2, getChainNativeCurrencyName: getChainNativeCurrencyName2, getChainSymbol: getChainSymbol2 } = await import("./utils-KSYMBN4D.js");
...
function TokenSelector(props) {
  const [screen, setScreen] = (0, import_react41.useState)("base");
  const [input, setInput] = (0, import_react41.useState)("");
...
function SendFunds(props) {
  ...
  const [token, setToken] = (0, import_react42.useState)(defaultToken);
  const [receiverAddress, setReceiverAddress] = (0, import_react42.useState)("");
  const [amount, setAmount] = (0, import_react42.useState)("0");
  const chain = useActiveWalletChain();
...
async function getOwnedNFTs2(options) {
  ...
  const nfts = await Promise.all(ownedBalances.map((ob) => getNFT2({ ...options, tokenId: BigInt(ob.tokenId) })));
...
function useResolvedMediaType(client, uri, mimeType, gatewayUrl) {
  const resolvedUrl = (0, import_react43.useMemo)(() => {
    if (!uri) {
      return "";
    }
...
// node_modules/thirdweb/dist/esm/react/web/ui/MediaRenderer/MediaRenderer.js
var MediaRenderer = (() => import_react44.default.forwardRef(function Media_Renderer({ src, poster, alt, gatewayUrl, requireInteraction = false, width = "300px", height = "300px", style, mimeType, client, controls, className }, ref) {
  var _a;
  const mergedStyle = {
    objectFit: "contain",
    ...style
  ...
  if (mediaInfo.mimeType) {
    ...
    if (mediaInfo.mimeType.startsWith("model")) {
      return (0, import_jsx_runtime76.jsx)(import_react44.Suspense, { fallback: poster ? (0, import_jsx_runtime76.jsx)("img", { style: mergedStyle, src: poster, alt, ref, className }) : null, children: (0, import_jsx_runtime76.jsx)(ModelViewer, { style: mergedStyle, src: mediaInfo.url || "", poster, alt, className }) });
    }
...
var ModelViewer = (0, import_react44.lazy)(() => import("./ModelViewer-T3NWNIGH.js"));
var PlayButton = ({ onClick, isPlaying }) => {
  const [isHovering, setIsHovering] = (0, import_react44.useState)(false);
...
var ImageRenderer = (() => import_react44.default.forwardRef(function Image_Renderer(props, ref) {
  const { style, src, alt, className, height, width } = props;
  const [error, setError] = (0, import_react44.useState)(false);
  if (error) {
...
var VideoPlayer = (() => import_react44.default.forwardRef(function Video_Player({ src, alt, poster, requireInteraction, style, width, height, controls, className }, ref) {
  const videoRef = (0, import_react44.useRef)(null);
  const [playing, setPlaying] = (0, import_react44.useState)(!requireInteraction);
  const [muted, setMuted] = (0, import_react44.useState)(true);
  const [error, setError] = (0, import_react44.useState)(false);
  ...
  return (0, import_jsx_runtime76.jsxs)("div", { style: { position: "relative", ...style }, className, children: [(0, import_jsx_runtime76.jsx)("video", { ref: mergeRefs([videoRef, ref]), src: src ?? void 0, poster: poster ?? void 0, loop: true, playsInline: true, controlsList: "nodownload", muted, preload: poster ? "metadata" : "auto", onCanPlay: () => {
    var _a;
    if (playing) {
...
var AudioPlayer = (() => import_react44.default.forwardRef(function Audio_Player({ src, alt, poster, style, height, width, className, controls }, ref) {
  ...
  return (0, import_jsx_runtime76.jsxs)("div", { style: { position: "relative", ...style }, className, children: [poster ? (0, import_jsx_runtime76.jsx)("img", { height, width, src: poster, style: {
    ...
    setPlaying((prev) => !prev);
    setMuted(false);
  }, isPlaying: playing }), (0, import_jsx_runtime76.jsx)("audio", { ref: mergeRefs([audioRef, ref]), src: src ?? void 0, loop: true, playsInline: true, controls, muted, preload: "none", controlsList: "nodownload", style: {
    position: "absolute",
    opacity: 0,
    pointerEvents: "none",
    zIndex: -1,
...
var IframePlayer = (() => import_react44.default.forwardRef(function Iframe_Player({ src, alt, poster, requireInteraction, style, ...restProps }, ref) {
  const [playing, setPlaying] = (0, import_react44.useState)(!requireInteraction);
...
var LinkPlayer = (() => import_react44.default.forwardRef(function Link_Player({ src, alt, style, className }, ref) {
...
function ViewNFTsContent(props) {
  const activeAccount = useActiveAccount();
  const activeChain = useActiveWalletChain();
  const nftList = (0, import_react45.useMemo)(() => {
    const nfts = [];
...
function ViewAssets(props) {
  const [activeTab, setActiveTab] = (0, import_react46.useState)("Tokens");
...
function WalletConnectReceiverScreen(props) {
  ...
  const [errorConnecting, setErrorConnecting] = (0, import_react47.useState)(false);
  const queryClient = useQueryClient();
...
var ConnectedWalletDetails = (props) => {
  ...
  const setRootEl = (0, import_react48.useContext)(SetRootElementContext);
  const activeAccount = useActiveAccount();
  const walletChain = useActiveWalletChain();
  const { ensAvatarQuery, addressOrENS, balanceQuery } = useConnectedWalletDetails(client, walletChain, activeAccount, (_a = props.detailsButton) == null ? void 0 : _a.displayBalanceToken);
  function closeModal() {
    setRootEl(null);
  }
  function openModal() {
  ...
  const avatarSrc = ((_f = props.detailsButton) == null ? void 0 : _f.connectedAccountAvatarUrl) ?? ensAvatarQuery.data;
  return (0, import_jsx_runtime82.jsxs)(WalletInfoButton, { type: "button", className: `${TW_CONNECTED_WALLET} ${((_g = props.detailsButton) == null ? void 0 : _g.className) || ""}`, style: (_h = props.detailsButton) == null ? void 0 : _h.style, "data-test": "connected-wallet-details", onClick: openModal, children: [(0, import_jsx_runtime82.jsx)(Container, { style: {
    borderRadius: "100%",
    overflow: "hidden",
    width: "35px",
    height: "35px"
  ...
  }, children: [(0, import_jsx_runtime82.jsx)(Text, { size: "xs", color: "primaryText", weight: 500, className: `${TW_CONNECTED_WALLET}__address`, children: ((_i = props.detailsButton) == null ? void 0 : _i.connectedAccountName) ?? addressOrENS }), balanceQuery.data ? (0, import_jsx_runtime82.jsxs)(Text, { className: `${TW_CONNECTED_WALLET}__balance`, size: "xs", color: "secondaryText", weight: 400, children: [formatBalanceOnButton(Number(balanceQuery.data.displayValue)), " ", balanceQuery.data.symbol] }) : (0, import_jsx_runtime82.jsx)(Skeleton, { height: fontSize.xs, width: "70px" })] })] });
};
function DetailsModal(props) {
  var _a, _b, _c, _d, _e, _f, _g, _h, _i, _j, _k, _l, _m, _n, _o, _p, _q, _r, _s;
  const [screen, setScreen] = (0, import_react48.useState)("main");
  const { disconnect } = useDisconnect();
  const [isOpen, setIsOpen] = (0, import_react48.useState)(true);
  ...
  const avatarSrc = ((_b = props.detailsModal) == null ? void 0 : _b.connectedAccountAvatarUrl) ?? ensAvatarQuery.data;
  ...
  let content = (0, import_jsx_runtime82.jsxs)("div", { children: [(0, import_jsx_runtime82.jsx)(Spacer, { y: "xs" }), (0, import_jsx_runtime82.jsxs)(Container, { p: "lg", gap: "sm", flex: "row", center: "y", children: [((_d = props.detailsModal) == null ? void 0 : _d.hideSwitchWallet) ? avatarContent : (0, import_jsx_runtime82.jsx)(ToolTip, { tip: "Switch wallet", children: (0, import_jsx_runtime82.jsx)("div", { style: {
    cursor: "pointer"
  }, onKeyDown: (e) => {
    if (e.key === "w") {
  ...
  } }) }), locale.send] }), (0, import_jsx_runtime82.jsxs)(Button, { variant: "outline", style: {
    fontSize: fontSize.sm,
    display: "flex",
    gap: spacing.xs,
    alignItems: "center",
    ...
    setScreen("receive");
  }, children: [(0, import_jsx_runtime82.jsxs)(Container, { color: "secondaryText", flex: "row", center: "both", children: [(0, import_jsx_runtime82.jsx)(PinBottomIcon, { width: iconSize.sm, height: iconSize.sm }), " "] }), locale.receive, " "] }), (0, import_jsx_runtime82.jsxs)(Button, { variant: "outline", style: {
    fontSize: fontSize.sm,
    display: "flex",
    gap: spacing.xs,
    alignItems: "center",
  ...
  if (screen === "wallet-manager" && activeAccount && walletChain && activeWallet) {
    content = (0, import_jsx_runtime82.jsx)(WalletManagerScreen, { onBack: () => setScreen("main"), accountAbstraction: (_i = props.connectOptions) == null ? void 0 : _i.accountAbstraction, appMetadata: (_j = props.connectOptions) == null ? void 0 : _j.appMetadata, chain: (_k = props.connectOptions) == null ? void 0 : _k.chain, chains: (_l = props.connectOptions) == null ? void 0 : _l.chains, client, connectLocale: locale, recommendedWallets: (_m = props.connectOptions) == null ? void 0 : _m.recommendedWallets, showAllWallets: !!((_n = props.connectOptions) == null ? void 0 : _n.showAllWallets), walletConnect: (_o = props.connectOptions) == null ? void 0 : _o.walletConnect, wallets: (_p = props.connectOptions) == null ? void 0 : _p.wallets, activeAccount, activeChain: walletChain, activeWallet });
  }
  if (screen === "network-switcher") {
    content = (0, import_jsx_runtime82.jsx)(
      NetworkSelectorContent,
      {
        ...
        closeModal,
        networkSelector: (_q = props.detailsModal) == null ? void 0 : _q.networkSelector,
        onBack: () => {
          setScreen("main");
        },
    ...
    }, client, locale, walletConnect: (_r = props.connectOptions) == null ? void 0 : _r.walletConnect });
  } else if (screen === "send") {
    ...
    content = (0, import_jsx_runtime82.jsx)(LazyBuyScreen, { title: locale.buy, isEmbed: false, client, onBack: () => setScreen("main"), supportedTokens: props.supportedTokens, connectLocale: locale, payOptions: ((_s = props.detailsModal) == null ? void 0 : _s.payOptions) || {
      mode: "fund_wallet"
    }, theme: typeof props.theme === "string" ? props.theme : props.theme.type, onDone: closeModal, connectOptions: void 0 });
  }
...
function ConnectedToSmartWallet(props) {
  ...
  const [isSmartWalletDeployed, setIsSmartWalletDeployed] = (0, import_react48.useState)(false);
...
function InAppWalletUserInfo(props) {
  ...
  const userInfoQuery = useQuery({
    ...
    queryFn: async () => {
      const { getUserEmail, getUserPhoneNumber } = await import("./auth-YGF3ODPE.js");
  ...
  if (userInfoQuery.data || walletInfo) {
    return (0, import_jsx_runtime82.jsx)(Text, { size: "xs", weight: 400, children: userInfoQuery.data || (walletInfo == null ? void 0 : walletInfo.name) });
  }
  return (0, import_jsx_runtime82.jsx)(Skeleton, { width: "50px", height: "10px" });
}
function SwitchNetworkButton2(props) {
  const switchChain = useSwitchActiveWalletChain();
  const [switching, setSwitching] = (0, import_react48.useState)(false);
  const locale = props.connectLocale;
...
var ConnectModal = (props) => {
  ...
  const [hideModal, setHideModal] = (0, import_react49.useState)(false);
  const closeModal = (0, import_react49.useCallback)(() => {
    var _a;
  ...
  const setModalVisibility = (0, import_react49.useCallback)((value) => setHideModal(!value), []);
  (0, import_react49.useEffect)(() => {
...
function ConnectButton(props) {
  ...
  const wallets = (0, import_react50.useMemo)(() => props.wallets || getDefaultWallets({
    appMetadata: props.appMetadata,
    chains: props.chains
  ...
  const size3 = (0, import_react50.useMemo)(() => {
    var _a2;
  ...
  const autoConnectComp = props.autoConnect !== false && (0, import_jsx_runtime85.jsx)(AutoConnect, { appMetadata: props.appMetadata, client: props.client, wallets, timeout: typeof props.autoConnect === "boolean" ? void 0 : (_b = props.autoConnect) == null ? void 0 : _b.timeout, accountAbstraction: props.accountAbstraction, onConnect: props.onConnect });
  if (!localeQuery.data) {
    return (0, import_jsx_runtime85.jsxs)(AnimatedButton, { disabled: true, className: `${((_c = props.connectButton) == null ? void 0 : _c.className) || ""} ${TW_CONNECT_WALLET}`, variant: "primary", type: "button", style: {
      minWidth: "165px",
      height: "50px",
  ...
  return (0, import_jsx_runtime85.jsxs)(WalletUIStatesProvider, { theme: props.theme, isOpen: false, children: [(0, import_jsx_runtime85.jsx)(ConnectButtonInner, { ...props, connectLocale: localeQuery.data }), (0, import_jsx_runtime85.jsx)(ConnectModal_default, { shouldSetActive: true, accountAbstraction: props.accountAbstraction, auth: props.auth, chain: props.chain || ((_e = props.accountAbstraction) == null ? void 0 : _e.chain), chains: props.chains, client: props.client, connectLocale: localeQuery.data, meta: {
    title: (_f = props.connectModal) == null ? void 0 : _f.title,
    titleIconUrl: (_g = props.connectModal) == null ? void 0 : _g.titleIcon,
    showThirdwebBranding: (_h = props.connectModal) == null ? void 0 : _h.showThirdwebBranding,
    termsOfServiceUrl: (_i = props.connectModal) == null ? void 0 : _i.termsOfServiceUrl,
    privacyPolicyUrl: (_j = props.connectModal) == null ? void 0 : _j.privacyPolicyUrl,
    requireApproval: (_k = props.connectModal) == null ? void 0 : _k.requireApproval
  }, welcomeScreen: (_l = props.connectModal) == null ? void 0 : _l.welcomeScreen, size: size3, localeId: props.locale || "en_US", onConnect: props.onConnect, recommendedWallets: props.recommendedWallets, showAllWallets: props.showAllWallets, walletConnect: props.walletConnect, wallets }), autoConnectComp] });
}
function ConnectButtonInner(props) {
  ...
  const activeAccount = useActiveAccount();
  const siweAuth = useSiweAuth(activeWallet, activeAccount, props.auth);
  const [showSignatureModal, setShowSignatureModal] = (0, import_react50.useState)(false);
  (0, import_react50.useEffect)(() => {
    if (!activeAccount) {
  ...
  const setIsWalletModalOpen = useSetIsWalletModalOpen();
  const supportedTokens = (0, import_react50.useMemo)(() => {
  ...
  if (!activeAccount) {
    return (0, import_jsx_runtime85.jsx)(AnimatedButton, { disabled: isLoading, className: `${((_b = props.connectButton) == null ? void 0 : _b.className) || ""} ${TW_CONNECT_WALLET}`, "data-theme": theme, "data-is-loading": isLoading, variant: "primary", type: "button", style: {
      minWidth: "165px",
      height: "50px",
      fontSize: "16px",
  ...
  if (siweAuth.requiresAuth) {
    if (siweAuth.isLoading || siweAuth.isLoggingIn || siweAuth.isLoggingOut) {
      return (0, import_jsx_runtime85.jsx)(AnimatedButton, { disabled: true, className: `${((_d = props.connectButton) == null ? void 0 : _d.className) || ""} ${TW_CONNECT_WALLET}`, variant: "primary", type: "button", style: {
        minWidth: "165px",
        height: "50px",
...
function useTransactionCostAndData(args) {
  ...
  const [txQueryKey, setTxQueryKey] = (0, import_react51.useState)();
...
function OnrampStatusScreen(props) {
  ...
  const purchaseCbCalled = (0, import_react52.useRef)(false);
  ...
  const invalidatedBalance = (0, import_react52.useRef)(false);
  (0, import_react52.useEffect)(() => {
    var _a2;
...
function FiatFlow(props) {
  ...
  const [screen, setScreen] = (0, import_react53.useState)(hasTwoSteps ? {
    id: "step-1"
  } : {
    id: "onramp-status"
  });
  const [popupWindow, setPopupWindow] = (0, import_react53.useState)(props.openedWindow);
  const onPostOnrampSuccess = (0, import_react53.useCallback)(() => {
...
function useUISelectionStates(options) {
  ...
  const [tokenAmount, setTokenAmount] = (0, import_react54.useState)(initialTokenAmount);
  const deferredTokenAmount = useDebouncedValue(tokenAmount, 300);
  const [toChain, setToChain] = (0, import_react54.useState)(
  ...
  const [toToken, setToToken] = (0, import_react54.useState)((prefillBuy == null ? void 0 : prefillBuy.token) || payOptions.mode === "direct_payment" && payOptions.paymentInfo.token || NATIVE_TOKEN);
  const [fromChain, setFromChain] = (0, import_react54.useState)(
    // use prefill chain if available
    payOptions.buyWithCrypto !== false && ((_e = (_d = payOptions.buyWithCrypto) == null ? void 0 : _d.prefillSource) == null ? void 0 : _e.chain) || payOptions.mode === "transaction" && ((_f = payOptions.transaction) == null ? void 0 : _f.chain) || payOptions.mode === "direct_payment" && ((_g = payOptions.paymentInfo) == null ? void 0 : _g.chain) || // default to polygon
    polygon
  );
  const [fromToken, setFromToken] = (0, import_react54.useState)(
    // use prefill token if available
    payOptions.buyWithCrypto !== false && ((_i = (_h = payOptions.buyWithCrypto) == null ? void 0 : _h.prefillSource) == null ? void 0 : _i.token) || payOptions.mode === "direct_payment" && payOptions.paymentInfo.token || // default to native token
    NATIVE_TOKEN
  );
  const devSpecifiedDefaultCurrency = payOptions.buyWithFiat !== false ? (_k = (_j = payOptions.buyWithFiat) == null ? void 0 : _j.prefillSource) == null ? void 0 : _k.currency : void 0;
  const defaultSelectedCurrencyShorthand = devSpecifiedDefaultCurrency || getDefaultCurrencyBasedOnLocation();
  const [selectedCurrency, setSelectedCurrency] = (0, import_react54.useState)(currencies.find((x) => x.shorthand === defaultSelectedCurrencyShorthand) || usdCurrency);
  return {
    tokenAmount,
    setTokenAmount,
    toChain,
...
var GenericWalletIcon = (props) => {
  return (0, import_jsx_runtime95.jsx)("svg", { xmlns: "http://www.w3.org/2000/svg", fill: "none", viewBox: "0 0 18 18", width: props.size, height: props.size, role: "presentation", children: (0, import_jsx_runtime95.jsx)("path", { fill: "currentColor", d: "M15.6 4.6H1.85v-.55l12.1-.968v.968h1.65V2.4c0-1.21-.98-2.059-2.177-1.888L2.378 2.089C1.18 2.26.2 3.39.2 4.6v11a2.2 2.2 0 002.2 2.2h13.2a2.2 2.2 0 002.2-2.2V6.8a2.2 2.2 0 00-2.2-2.2zm-1.65 7.707a1.65 1.65 0 01-.63-3.176 1.65 1.65 0 11.63 3.176z" }) });
};
...
function PayWithCrypto(props) {
  ...
  return (0, import_jsx_runtime96.jsxs)(Container, { bg: "tertiaryBg", borderColor: "borderColor", flex: "row", style: {
    borderWidth: "1px",
    borderTopWidth: 0,
    borderStyle: "solid",
    flexWrap: "nowrap",
  ...
  }, children: [(0, import_jsx_runtime96.jsxs)(Button, { variant: "ghost", onClick: props.onSelectToken, gap: "sm", style: {
    paddingInline: spacing.sm,
    paddingBlock: spacing.sm,
    minWidth: "50%",
    justifyContent: "flex-start"
  }, disabled: props.freezeChainAndTokenSelection, children: [(0, import_jsx_runtime96.jsx)(PayTokenIcon, { token: props.token, chain: props.chain, size: "md", client: props.client }), (0, import_jsx_runtime96.jsxs)(Container, { flex: "column", gap: "3xs", children: [(0, import_jsx_runtime96.jsxs)(Container, { flex: "row", gap: "xs", center: "y", color: "primaryText", children: [(0, import_jsx_runtime96.jsx)(TokenSymbol, { token: props.token, chain: props.chain, size: "sm" }), (0, import_jsx_runtime96.jsx)(ChevronDownIcon, { width: iconSize.sm, height: iconSize.sm })] }), name ? (0, import_jsx_runtime96.jsx)(Text, { size: "xs", children: name }) : (0, import_jsx_runtime96.jsx)(Skeleton, { width: "90px", height: fontSize.xs })] })] }), (0, import_jsx_runtime96.jsxs)("div", { style: {
    flexGrow: 1,
    flexShrink: 1,
    display: "flex",
    flexDirection: "column",
    ...
    justifyContent: "center",
    paddingRight: spacing.sm
  }, children: [props.isLoading ? (0, import_jsx_runtime96.jsx)(Skeleton, { width: "120px", height: fontSize.md, color: "borderColor" }) : (0, import_jsx_runtime96.jsx)(Text, { size: "md", color: props.value ? "primaryText" : "secondaryText", style: {}, children: formatNumber(Number(props.value), 6) || "" }), (0, import_jsx_runtime96.jsxs)(Container, { flex: "row", gap: "xxs", center: "y", color: "secondaryText", children: [(0, import_jsx_runtime96.jsx)(GenericWalletIcon, { size: fontSize.xs }), balanceQuery.data ? (0, import_jsx_runtime96.jsx)(Text, { size: "xs", color: "secondaryText", weight: 500, children: formatTokenBalance(balanceQuery.data, false) }) : (0, import_jsx_runtime96.jsx)(Skeleton, { width: "70px", height: fontSize.xs })] })] })] });
}
...
function TransferConfirmationScreen(props) {
  ...
  const [step, setStep] = (0, import_react55.useState)("transfer");
  const [status, setStatus] = (0, import_react55.useState)("idle");
  ...
  return (0, import_jsx_runtime97.jsxs)(Container, { p: "lg", children: [(0, import_jsx_runtime97.jsx)(ModalHeader, { title, onBack }), (0, import_jsx_runtime97.jsx)(Spacer, { y: "xl" }), transactionMode && (0, import_jsx_runtime97.jsxs)(import_jsx_runtime97.Fragment, { children: [(0, import_jsx_runtime97.jsx)(StepBar, { steps: 2, currentStep: step === "transfer" ? 1 : 2 }), (0, import_jsx_runtime97.jsx)(Spacer, { y: "sm" }), (0, import_jsx_runtime97.jsx)(Text, { size: "sm", children: step === "transfer" ? "Step 1 of 2 - Transfer funds" : "Step 2 of 2 - Finalize transaction" }), (0, import_jsx_runtime97.jsx)(Spacer, { y: "xl" })] }), (0, import_jsx_runtime97.jsxs)(Container, { flex: "row", center: "y", style: {
    ...
    justifyContent: "space-between"
  }, center: "y", color: "accentText", children: [(0, import_jsx_runtime97.jsx)(Step, { isDone: step === "execute", isActive: step === "transfer", label: step === "transfer" ? "Transfer" : "Done" }), (0, import_jsx_runtime97.jsx)(ConnectorLine, {}), (0, import_jsx_runtime97.jsx)(Step, { isDone: false, label: "Finalize", isActive: step === "execute" })] }), (0, import_jsx_runtime97.jsx)(Spacer, { y: "lg" })] }), status === "error" && (0, import_jsx_runtime97.jsxs)(import_jsx_runtime97.Fragment, { children: [(0, import_jsx_runtime97.jsxs)(Container, { flex: "row", gap: "xs", center: "both", color: "danger", children: [(0, import_jsx_runtime97.jsx)(CrossCircledIcon, { width: iconSize.sm, height: iconSize.sm }), (0, import_jsx_runtime97.jsx)(Text, { color: "danger", size: "sm", children: step === "transfer" ? "Failed to Transfer" : "Failed to Execute" })] }), (0, import_jsx_runtime97.jsx)(Spacer, { y: "md" })] }), !transactionMode && step === "execute" && status === "done" && (0, import_jsx_runtime97.jsxs)(import_jsx_runtime97.Fragment, { children: [(0, import_jsx_runtime97.jsxs)(Container, { flex: "row", gap: "xs", center: "both", color: "success", children: [(0, import_jsx_runtime97.jsx)(CheckCircledIcon, { width: iconSize.sm, height: iconSize.sm }), (0, import_jsx_runtime97.jsx)(Text, { color: "success", size: "sm", children: "Payment completed" })] }), (0, import_jsx_runtime97.jsx)(Spacer, { y: "md" })] }), payer.chain.id !== chain.id ? (0, import_jsx_runtime97.jsx)(SwitchNetworkButton, { fullWidth: true, variant: "accent", switchChain: async () => {
    await props.payer.wallet.switchChain(chain);
  } }) : (0, import_jsx_runtime97.jsxs)(Button, { variant: "accent", fullWidth: true, disabled: status === "pending", onClick: async () => {
    if (step === "execute") {
      onDone();
      return;
    }
  ...
  }, gap: "xs", children: [step === "execute" && (status === "done" ? "Done" : "Continue"), step === "transfer" && (status === "pending" ? "Confirming" : "Confirm"), step === "approve" && (status === "pending" ? "Approving" : "Approve"), status === "pending" && (0, import_jsx_runtime97.jsx)(Spinner, { size: "sm", color: "accentButtonText" })] })] });
}

// node_modules/thirdweb/dist/esm/react/web/ui/ConnectWallet/screens/Buy/swap/TransferFlow.js
function TransferFlow(props) {
  const [transferTxHash, setTransferTxHash] = (0, import_react56.useState)();
  if (transferTxHash) {
...
function WalletSwitcherDrawerContent(props) {
  ...
  const connectedWallets = useConnectedWallets();
  const hideConnectButton = !props.showAllWallets && ((_a = props.wallets) == null ? void 0 : _a.every((w) => connectedWallets.includes(w)));
  return (0, import_jsx_runtime99.jsxs)(Container, { children: [(0, import_jsx_runtime99.jsxs)(Container, { flex: "column", gap: "xs", children: [connectedWallets.map((w) => {
    var _a2;
    const address = (_a2 = w.getAccount()) == null ? void 0 : _a2.address;
    return (0, import_jsx_runtime99.jsx)(WalletSelectorButton, { walletId: w.id, client: props.client, address: address || "", onClick: () => {
      props.onSelect(w);
      props.onBack();
    }, disableChevron: true, checked: false }, w.id);
  }), !hideConnectButton && (0, import_jsx_runtime99.jsx)(Button, { variant: "secondary", fullWidth: true, onClick: props.onConnect, gap: "xs", bg: "tertiaryBg", style: {
    borderRadius: radius.lg,
    border: `1px solid ${theme.colors.borderColor}`,
    padding: spacing.sm
  }, children: (0, import_jsx_runtime99.jsxs)(Container, { flex: "row", gap: "sm", center: "y", expand: true, children: [(0, import_jsx_runtime99.jsx)(PlusIcon, { width: iconSize.md, height: iconSize.md }), (0, import_jsx_runtime99.jsx)(Text, { size: "sm", color: "primaryText", children: "Add Another Wallet" })] }) })] }), (0, import_jsx_runtime99.jsx)(Spacer, { y: "sm" })] });
}
...
function usePayerSetup() {
  ...
  (0, import_react57.useEffect)(() => {
    ...
    function update() {
      ...
      if (account2 && chain) {
        console.log("updated to", account2, chain);
        setPayer({
          account: account2,
          chain,
          wallet: wallet2
...
function BuyScreen2(props) {
  ...
  if (!supportedDestinationsQuery.data) {
    return (0, import_jsx_runtime100.jsx)(LoadingScreen, {});
  }
  return (0, import_jsx_runtime100.jsx)(BuyScreenContent, { ...props, supportedDestinations: supportedDestinationsQuery.data });
}
function BuyScreenContent(props) {
  ...
  const sourceSupportedTokens = (0, import_react58.useMemo)(() => {
    ...
    if ((_a2 = supportedSources[0]) == null ? void 0 : _a2.chain) {
      setFromChain((_b2 = supportedSources[0]) == null ? void 0 : _b2.chain);
    }
  ...
  if (screen.id === "fiat-flow" && payer) {
    return (0, import_jsx_runtime100.jsx)(FiatFlow, { title: props.title, transactionMode: payOptions.mode === "transaction", quote: screen.quote, onBack: () => {
      setScreen({
        id: "buy-with-fiat"
      });
    }, client, testMode: props.payOptions.buyWithFiat !== false && ((_j = props.payOptions.buyWithFiat) == null ? void 0 : _j.testMode) === true, theme: typeof props.theme === "string" ? props.theme : props.theme.type, openedWindow: screen.openedWindow, onDone, isEmbed: props.isEmbed, payer, onSuccess: onFiatSuccess });
  }
  if (screen.id === "transfer-flow" && payer && activeAccount) {
    ...
    return (0, import_jsx_runtime100.jsx)(TransferFlow, { title: props.title, onBack: goBack, payer, client: props.client, chain: toChain, token: toToken, tokenAmount, receiverAddress, transactionMode: props.payOptions.mode === "transaction", isEmbed: props.isEmbed, onDone, onTryAgain: () => {
      setScreen({
        id: "buy-with-crypto"
      });
    }, onSuccess: onSwapSuccess });
  ...
  if (screen.id === "select-currency") {
    ...
    return (0, import_jsx_runtime100.jsx)(CurrencySelection, { onSelect: (currency) => {
      goBack();
  ...
  if (screen.id === "select-to-token") {
    ...
    const goBack = () => setScreen(screen.backScreen);
    const allowEdits = (_m = payOptions == null ? void 0 : payOptions.prefillBuy) == null ? void 0 : _m.allowEdits;
    if ((allowEdits == null ? void 0 : allowEdits.token) === false) {
      return (0, import_jsx_runtime100.jsx)(ChainSelectionScreen, { chains, client: props.client, connectLocale: props.connectLocale, setChain: setToChain, goBack });
    }
    return (0, import_jsx_runtime100.jsx)(TokenSelector, { onBack: goBack, tokenList: (((toChain == null ? void 0 : toChain.id) ? destinationSupportedTokens[toChain.id] : void 0) || []).filter((x) => x.address !== NATIVE_TOKEN_ADDRESS), onTokenSelect: (tokenInfo) => {
  ...
  if (screen.id === "select-from-token" && supportedSourcesQuery.data && sourceSupportedTokens) {
    ...
    const goBack = () => setScreen(screen.backScreen);
    if (payOptions.buyWithCrypto !== false && ((_p = (_o = (_n = payOptions.buyWithCrypto) == null ? void 0 : _n.prefillSource) == null ? void 0 : _o.allowEdits) == null ? void 0 : _p.token) === false) {
      return (0, import_jsx_runtime100.jsx)(ChainSelectionScreen, { chains, client: props.client, connectLocale: props.connectLocale, setChain: setFromChain, goBack });
    }
    return (0, import_jsx_runtime100.jsx)(TokenSelector, { onBack: goBack, tokenList: (((fromChain == null ? void 0 : fromChain.id) ? sourceSupportedTokens[fromChain.id] : void 0) || []).filter((x) => x.address !== NATIVE_TOKEN_ADDRESS), onTokenSelect: (tokenInfo) => {
      setFromToken(tokenInfo);
      goBack();
    }, chain: fromChain, chainSelection: (
      // hide chain selection if it's disabled
      payOptions.buyWithCrypto !== false && ((_s = (_r = (_q = payOptions.buyWithCrypto) == null ? void 0 : _q.prefillSource) == null ? void 0 : _r.allowEdits) == null ? void 0 : _s.chain) !== false ? {
        chains: supportedSourcesQuery.data.map((x) => x.chain),
        select: (c) => setFromChain(c)
      } : void 0
    ), connectLocale, client, modalTitle: "Pay with" });
  }
  return (0, import_jsx_runtime100.jsx)(Container, { animate: "fadein", children: (0, import_jsx_runtime100.jsxs)("div", { children: [screen.id === "main" && (0, import_jsx_runtime100.jsx)(MainScreen, { title: props.title, payerAccount: payer == null ? void 0 : payer.account, client, onSelectBuyToken: () => setScreen({ id: "select-to-token", backScreen: screen }), payOptions, setTokenAmount, setToChain, setToToken, setFromChain, setFromToken, toChain, toToken, tokenAmount, connectOptions: props.connectOptions, setScreen, supportedDestinations, onBack: props.onBack, theme: props.theme, hasEditedAmount, setHasEditedAmount, enabledPaymentMethods }), (screen.id === "select-payment-method" || screen.id === "select-wallet" || screen.id === "buy-with-crypto" || screen.id === "buy-with-fiat") && payer && (0, import_jsx_runtime100.jsxs)(TokenSelectedLayout, { title: props.title, selectedChain: toChain, selectedToken: toToken, tokenAmount, client, onBack: () => {
  ...
  }, children: [screen.id === "select-payment-method" && (0, import_jsx_runtime100.jsx)(PaymentMethodSelection, { setScreen: (id) => setScreen({ id }) }), screen.id === "select-wallet" && (0, import_jsx_runtime100.jsx)(WalletSwitcherDrawerContent, { client, onSelect: (w) => {
    const chain = w.getChain();
    const account = w.getAccount();
    if (chain && account) {
      setPayer({
  ...
  }, showAllWallets: !!((_t = props.connectOptions) == null ? void 0 : _t.showAllWallets), wallets: (_u = props.connectOptions) == null ? void 0 : _u.wallets, onBack: () => {
  }, onConnect: () => {
    setScreen({
  ...
  }, selectedAddress: payer.account.address }), screen.id === "buy-with-crypto" && activeAccount && (0, import_jsx_runtime100.jsx)(SwapScreenContent, {
    setScreen,
    ...
    setTokenAmount,
    setHasEditedAmount,
    disableTokenSelection: payDisabled === true || payOptions.buyWithCrypto !== false && ((_x = (_w = (_v = payOptions.buyWithCrypto) == null ? void 0 : _v.prefillSource) == null ? void 0 : _w.allowEdits) == null ? void 0 : _x.chain) === false && ((_A = (_z = (_y = payOptions.buyWithCrypto) == null ? void 0 : _y.prefillSource) == null ? void 0 : _z.allowEdits) == null ? void 0 : _A.token) === false
  }), screen.id === "buy-with-fiat" && (0, import_jsx_runtime100.jsx)(FiatScreenContent, { setScreen, tokenAmount: deferredTokenAmount, toChain, toToken, selectedCurrency, client, isEmbed: props.isEmbed, onDone, payOptions, theme: props.theme, showCurrencySelector: () => {
    setScreen({
      id: "select-currency",
      backScreen: screen
    });
...
function SelectedTokenInfo(props) {
  return (0, import_jsx_runtime100.jsx)("div", { children: (0, import_jsx_runtime100.jsxs)(Container, { flex: "row", gap: "sm", center: "y", style: {
    justifyContent: "space-between"
  }, children: [(0, import_jsx_runtime100.jsxs)(Container, { flex: "row", gap: "xs", center: "y", children: [(0, import_jsx_runtime100.jsx)(Text, { color: "primaryText", "data-testid": "tokenAmount", size: "xl", children: formatNumber(Number(props.tokenAmount), 6) }), (0, import_jsx_runtime100.jsxs)(Container, { flex: "row", gap: "xxs", center: "y", children: [(0, import_jsx_runtime100.jsx)(TokenSymbol, { token: props.selectedToken, chain: props.selectedChain, size: "md", color: "secondaryText" }), (0, import_jsx_runtime100.jsx)(PayTokenIcon, { chain: props.selectedChain, client: props.client, size: "sm", token: props.selectedToken })] })] }), (0, import_jsx_runtime100.jsx)(ChainName, { chain: props.selectedChain, client: props.client, size: "sm", short: true })] }) });
}
function MainScreen(props) {
  ...
  switch (payOptions.mode) {
    case "transaction": {
      return (0, import_jsx_runtime100.jsx)(TransactionModeScreen, { supportedDestinations, payUiOptions: payOptions, payerAccount, connectOptions: props.connectOptions, client, onContinue: (tokenAmount2, toChain2, toToken2) => {
    ...
    case "direct_payment": {
      return (0, import_jsx_runtime100.jsx)(DirectPaymentModeScreen, { client, payUiOptions: payOptions, payerAccount, connectOptions: props.connectOptions, supportedDestinations, onContinue: (tokenAmount2, toChain2, toToken2) => {
        setTokenAmount(tokenAmount2);
        setToChain(toChain2);
        setFromChain(toChain2);
        setFromToken(toToken2);
    ...
    default: {
      return (0, import_jsx_runtime100.jsxs)(Container, { p: "lg", children: [(0, import_jsx_runtime100.jsx)(ModalHeader, { title: props.title, onBack: props.onBack }), (0, import_jsx_runtime100.jsx)(Spacer, { y: "xl" }), (0, import_jsx_runtime100.jsx)(BuyTokenInput, { value: tokenAmount, onChange: async (value) => {
        props.setHasEditedAmount(true);
        setTokenAmount(value);
      }, freezeAmount: ((_b = (_a = payOptions.prefillBuy) == null ? void 0 : _a.allowEdits) == null ? void 0 : _b.amount) === false, freezeChainAndToken: ((_d = (_c = payOptions.prefillBuy) == null ? void 0 : _c.allowEdits) == null ? void 0 : _d.chain) === false && ((_f = (_e = payOptions.prefillBuy) == null ? void 0 : _e.allowEdits) == null ? void 0 : _f.token) === false, token: toToken, chain: toChain, onSelectToken: props.onSelectBuyToken, client: props.client }), (0, import_jsx_runtime100.jsx)(Spacer, { y: "xl" }), (0, import_jsx_runtime100.jsx)(Container, { flex: "column", gap: "sm", children: !payerAccount ? (0, import_jsx_runtime100.jsx)("div", { children: (0, import_jsx_runtime100.jsx)(ConnectButton, { ...props.connectOptions, client: props.client, theme: props.theme, connectButton: {
        style: {
          width: "100%"
        }
      } }) }) : (0, import_jsx_runtime100.jsx)(Button, { variant: "accent", fullWidth: true, disabled: disableContinue, "data-disabled": disableContinue, onClick: () => {
        if (showPaymentSelection) {
          props.setScreen({ id: "select-payment-method" });
        } else if (buyWithCryptoEnabled) {
          props.setScreen({ id: "buy-with-crypto" });
...
function TokenSelectedLayout(props) {
  return (0, import_jsx_runtime100.jsxs)(Container, { children: [(0, import_jsx_runtime100.jsx)(Container, { p: "lg", children: (0, import_jsx_runtime100.jsx)(ModalHeader, { title: props.title, onBack: props.onBack }) }), (0, import_jsx_runtime100.jsxs)(Container, { px: "lg", style: {
    paddingBottom: spacing.lg
  }, children: [(0, import_jsx_runtime100.jsx)(Spacer, { y: "xs" }), (0, import_jsx_runtime100.jsx)(SelectedTokenInfo, { selectedToken: props.selectedToken, selectedChain: props.selectedChain, tokenAmount: props.tokenAmount, client: props.client }), (0, import_jsx_runtime100.jsx)(Spacer, { y: "md" }), (0, import_jsx_runtime100.jsx)(Line, {}), (0, import_jsx_runtime100.jsx)(Spacer, { y: "lg" }), (0, import_jsx_runtime100.jsx)(Text, { size: "sm", children: " Pay with " }), (0, import_jsx_runtime100.jsx)(Spacer, { y: "sm" }), props.children] })] });
}
function PaymentMethodSelection(props) {
  return (0, import_jsx_runtime100.jsx)(Container, { animate: "fadein", children: (0, import_jsx_runtime100.jsxs)(Container, { flex: "column", gap: "sm", children: [(0, import_jsx_runtime100.jsxs)(Button, { variant: "outline", bg: "tertiaryBg", onClick: () => props.setScreen("buy-with-fiat"), gap: "sm", style: {
    justifyContent: "flex-start",
    textAlign: "left"
  }, children: [(0, import_jsx_runtime100.jsx)(Container, { color: "secondaryText", flex: "row", center: "both", children: (0, import_jsx_runtime100.jsx)(IdCardIcon, { style: {
    width: iconSize.md,
    height: iconSize.md
  } }) }), (0, import_jsx_runtime100.jsxs)(Container, { flex: "column", gap: "xxs", children: [(0, import_jsx_runtime100.jsx)(Text, { size: "md", color: "primaryText", children: "Credit Card" }), (0, import_jsx_runtime100.jsx)(Text, { size: "xs", children: "Securely pay with credit card" })] })] }), (0, import_jsx_runtime100.jsxs)(Button, { variant: "outline", bg: "tertiaryBg", onClick: () => props.setScreen("select-wallet"), style: {
    justifyContent: "flex-start"
  }, gap: "sm", children: [(0, import_jsx_runtime100.jsx)(Container, { color: "secondaryText", flex: "row", center: "both", children: (0, import_jsx_runtime100.jsx)(CoinsIcon, { size: iconSize.md }) }), (0, import_jsx_runtime100.jsxs)(Container, { flex: "column", gap: "xxs", children: [(0, import_jsx_runtime100.jsx)(Text, { size: "md", color: "primaryText", children: "Crypto" }), (0, import_jsx_runtime100.jsx)(Text, { size: "xs", children: "Pay with your connected wallet" })] })] })] }) });
}
function SwapScreenContent(props) {
  ...
  const [drawerScreen, setDrawerScreen] = (0, import_react58.useState)("fees");
  ...
  function showSwapFlow() {
    if ((props.payOptions.mode === "transaction" || props.payOptions.mode === "direct_payment") && !isNotEnoughBalance && !swapRequired) {
  ...
  return (0, import_jsx_runtime100.jsxs)(Container, { flex: "column", gap: "md", animate: "fadein", children: [isOpen && (0, import_jsx_runtime100.jsxs)(import_jsx_runtime100.Fragment, { children: [(0, import_jsx_runtime100.jsx)(DrawerOverlay, { ref: drawerOverlayRef }), (0, import_jsx_runtime100.jsx)(Drawer, { ref: drawerRef, close: () => setIsOpen(false), children: drawerScreen === "fees" && quoteQuery.data && (0, import_jsx_runtime100.jsxs)("div", { children: [(0, import_jsx_runtime100.jsx)(Text, { size: "lg", color: "primaryText", children: "Fees" }), (0, import_jsx_runtime100.jsx)(Spacer, { y: "lg" }), (0, import_jsx_runtime100.jsx)(SwapFees, { quote: quoteQuery.data, align: "left" })] }) })] }), (0, import_jsx_runtime100.jsxs)("div", { children: [(0, import_jsx_runtime100.jsx)(WalletSelectorButton, { client: props.client, onClick: () => {
    setScreen({ id: "select-wallet" });
  }, address: props.payer.account.address, walletId: props.payer.wallet.id, containerStyle: {
    borderBottomRightRadius: 0,
    borderBottomLeftRadius: 0
  } }), (0, import_jsx_runtime100.jsx)(PayWithCrypto, { value: sourceTokenAmount || "", onSelectToken: showFromTokenSelector, chain: fromChain, token: fromToken, isLoading: quoteQuery.isLoading && !sourceTokenAmount, client, freezeChainAndTokenSelection: disableTokenSelection, payerAccount: props.payer.account, swapRequired }), swapRequired && (0, import_jsx_runtime100.jsx)(EstimatedTimeAndFees, { quoteIsLoading: quoteQuery.isLoading, estimatedSeconds: (_d = quoteQuery.data) == null ? void 0 : _d.swapDetails.estimated.durationSeconds, onViewFees: showFees }), (0, import_jsx_runtime100.jsx)(Spacer, { y: "md" })] }), errorMsg && (0, import_jsx_runtime100.jsxs)("div", { children: [errorMsg.minAmount && (0, import_jsx_runtime100.jsxs)(Text, { color: "danger", size: "sm", center: true, multiline: true, children: ["Minimum amount is ", errorMsg.minAmount, " ", (0, import_jsx_runtime100.jsx)(TokenSymbol, { token: toToken, chain: toChain, size: "sm", inline: true, color: "danger" })] }), (_e = errorMsg.msg) == null ? void 0 : _e.map((msg) => (0, import_jsx_runtime100.jsx)(Text, { color: "danger", size: "sm", center: true, multiline: true, children: msg }, msg))] }), !errorMsg && isNotEnoughBalance && (0, import_jsx_runtime100.jsxs)("div", { children: [(0, import_jsx_runtime100.jsx)(Text, { color: "danger", size: "sm", center: true, multiline: true, children: "Not enough funds." }), (0, import_jsx_runtime100.jsx)(Text, { color: "danger", size: "sm", center: true, multiline: true, children: "Try a different wallet or token." })] }), (errorMsg == null ? void 0 : errorMsg.minAmount) ? (0, import_jsx_runtime100.jsx)(Button, { variant: "accent", fullWidth: true, onClick: () => {
    props.setTokenAmount(String(errorMsg.minAmount));
    props.setHasEditedAmount(true);
  }, children: "Set Minimum" }) : switchChainRequired && !quoteQuery.isLoading && !isNotEnoughBalance && !quoteQuery.error ? (0, import_jsx_runtime100.jsx)(SwitchNetworkButton, { variant: "accent", fullWidth: true, switchChain: async () => {
    await props.payer.wallet.switchChain(fromChain);
  } }) : (0, import_jsx_runtime100.jsx)(Button, { variant: disableContinue ? "outline" : "accent", fullWidth: true, "data-disabled": disableContinue, disabled: disableContinue, onClick: async () => {
    if (!disableContinue) {
      showSwapFlow();
    }
  }, gap: "xs", children: quoteQuery.isLoading ? (0, import_jsx_runtime100.jsxs)(import_jsx_runtime100.Fragment, { children: ["Getting price quote", (0, import_jsx_runtime100.jsx)(Spinner, { size: "sm", color: "accentText" })] }) : "Continue" })] });
}
function FiatScreenContent(props) {
  ...
  return (0, import_jsx_runtime100.jsxs)(Container, { flex: "column", gap: "md", animate: "fadein", children: [isOpen && (0, import_jsx_runtime100.jsxs)(import_jsx_runtime100.Fragment, { children: [(0, import_jsx_runtime100.jsx)(DrawerOverlay, { ref: drawerOverlayRef }), (0, import_jsx_runtime100.jsx)(Drawer, { ref: drawerRef, close: () => setIsOpen(false), children: drawerScreen === "fees" && fiatQuoteQuery.data && (0, import_jsx_runtime100.jsxs)("div", { children: [(0, import_jsx_runtime100.jsx)(Text, { size: "lg", color: "primaryText", children: "Fees" }), (0, import_jsx_runtime100.jsx)(Spacer, { y: "lg" }), (0, import_jsx_runtime100.jsx)(FiatFees, { quote: fiatQuoteQuery.data })] }) })] }), (0, import_jsx_runtime100.jsxs)("div", { children: [(0, import_jsx_runtime100.jsx)(PayWithCreditCard, { isLoading: fiatQuoteQuery.isLoading, value: (_c = fiatQuoteQuery.data) == null ? void 0 : _c.fromCurrencyWithFees.amount, client, currency: selectedCurrency, onSelectCurrency: showCurrencySelector }), (0, import_jsx_runtime100.jsx)(EstimatedTimeAndFees, { quoteIsLoading: fiatQuoteQuery.isLoading, estimatedSeconds: (_d = fiatQuoteQuery.data) == null ? void 0 : _d.estimatedDurationSeconds, onViewFees: showFees }), (0, import_jsx_runtime100.jsx)(Spacer, { y: "md" })] }), errorMsg && (0, import_jsx_runtime100.jsxs)("div", { children: [errorMsg.minAmount && (0, import_jsx_runtime100.jsxs)(Text, { color: "danger", size: "sm", center: true, multiline: true, children: ["Minimum amount is ", errorMsg.minAmount, " ", (0, import_jsx_runtime100.jsx)(TokenSymbol, { token: toToken, chain: toChain, size: "sm", inline: true, color: "danger" })] }), (_e = errorMsg.msg) == null ? void 0 : _e.map((msg) => (0, import_jsx_runtime100.jsx)(Text, { color: "danger", size: "sm", center: true, multiline: true, children: msg }, msg))] }), (errorMsg == null ? void 0 : errorMsg.minAmount) ? (0, import_jsx_runtime100.jsx)(Button, { variant: "accent", fullWidth: true, onClick: () => {
    props.setTokenAmount(String(errorMsg.minAmount));
    props.setHasEditedAmount(true);
  }, children: "Set Minimum" }) : (0, import_jsx_runtime100.jsx)(Button, { variant: disableSubmit ? "outline" : "accent", "data-disabled": disableSubmit, disabled: disableSubmit, fullWidth: true, onClick: handleSubmit, gap: "xs", children: fiatQuoteQuery.isLoading ? (0, import_jsx_runtime100.jsxs)(import_jsx_runtime100.Fragment, { children: ["Getting price quote", (0, import_jsx_runtime100.jsx)(Spinner, { size: "sm", color: "accentText" })] }) : "Continue" })] });
}
...
function ChainSelectionScreen(props) {
  return (0, import_jsx_runtime100.jsx)(NetworkSelectorContent, { client: props.client, connectLocale: props.connectLocale, showTabs: false, onBack: props.goBack, chains: props.chains, closeModal: props.goBack, networkSelector: {
    renderChain(renderChainProps) {
      return (0, import_jsx_runtime100.jsx)(ChainButton, { chain: renderChainProps.chain, confirming: false, switchingFailed: false, onClick: () => {
...
//# sourceMappingURL=chunk-3GA23B6K.js.map
