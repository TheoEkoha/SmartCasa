...
async function loginWithPasskey(options) {
  ...
  const challenge = challengeData.challenge;
  const credentialId = await storage.getPasskeyCredentialId() ?? void 0;
...
var InAppWebConnector = class {
  ...
  async passkeyAuth(args) {
    const { PasskeyWebClient } = await import("./passkeys-IWRM4QBJ.js");
...
//# sourceMappingURL=web-connector-UE6A6IOA.js.map
