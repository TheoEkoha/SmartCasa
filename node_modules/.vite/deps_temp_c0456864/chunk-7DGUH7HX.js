...
async function isListingValid(options) {
  ...
  if (erc721) {
    const [{ isApprovedForAll }, { getApproved }, { ownerOf }] = await Promise.all([
      import("./isApprovedForAll-TD6UEW55.js"),
      import("./getApproved-AFNYCYOI.js"),
      import("./ownerOf-6YDY3V65.js")
    ]);
  ...
  if (erc1155) {
    const [{ isApprovedForAll }, { balanceOf }] = await Promise.all([
      import("./isApprovedForAll-JE2QEDGB.js"),
      import("./balanceOf-ZEGBRFEN.js")
    ]);
...
//# sourceMappingURL=chunk-7DGUH7HX.js.map
