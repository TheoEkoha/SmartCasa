...
function __createBinding(o2, m2, k3, k22) {
  if (k22 === void 0)
    k22 = k3;
  o2[k22] = m2[k3];
}
    ...
    function hashBlocks(w3, v2, p2, pos, len) {
      while (len >= 64) {
        ...
        for (var i2 = 0; i2 < 16; i2++) {
          var j2 = pos + i2 * 4;
          w3[i2] = binary_1.readUint32BE(p2, j2);
        }
        ...
        for (var i2 = 0; i2 < 64; i2++) {
          var t1 = (((e2 >>> 6 | e2 << 32 - 6) ^ (e2 >>> 11 | e2 << 32 - 11) ^ (e2 >>> 25 | e2 << 32 - 25)) + (e2 & f3 ^ ~e2 & g2) | 0) + (h4 + (K2[i2] + w3[i2] | 0) | 0) | 0;
          var t2 = ((a2 >>> 2 | a2 << 32 - 2) ^ (a2 >>> 13 | a2 << 32 - 13) ^ (a2 >>> 22 | a2 << 32 - 22)) + (a2 & b3 ^ a2 & c3 ^ b3 & c3) | 0;
          h4 = g2;
          g2 = f3;
          f3 = e2;
          e2 = d2 + t1 | 0;
...
var require_x25519 = __commonJS({
  "node_modules/@stablelib/x25519/lib/x25519.js"(exports) {
    ...
    function scalarMult(n3, p2) {
      ...
      const a2 = gf(), b3 = gf(), c3 = gf(), d2 = gf(), e2 = gf(), f3 = gf();
...
var require_ed25519 = __commonJS({
  "node_modules/@stablelib/ed25519/lib/ed25519.js"(exports) {
    ...
    function edadd(p2, q) {
      const a2 = gf(), b3 = gf(), c3 = gf(), d2 = gf(), e2 = gf(), f3 = gf(), g2 = gf(), h4 = gf(), t = gf();
      sub(a2, p2[1], p2[0]);
      sub(t, q[1], q[0]);
      mul(a2, a2, t);
      add(b3, p2[0], p2[1]);
...
var O2 = async (i2, t, e2) => {
  ...
  await t.setItem(n3, y2), e2(t), j(i2, m2);
};
var j = async (i2, t) => {
...
var f2 = class {
  ...
  emitError(e2) {
    const t = this.parseError(new Error((e2 == null ? void 0 : e2.message) || `WebSocket connection failed for host: ${a(this.url)}`));
...
tslib/tslib.es6.js:
  ...
  ***************************************************************************** *)
*/
//# sourceMappingURL=chunk-IVAJZFIP.js.map
