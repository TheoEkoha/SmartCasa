import {
  getListing
} from "./chunk-7DGUH7HX.js";
import {
  getContractMetadata
} from "./chunk-HJSX2I2Y.js";
import {
  getApprovalForTransaction
} from "./chunk-3OKXSB6R.js";
import {
  AutoConnect,
  Blobbie,
  BuyScreen,
...
import "./chunk-T2IMCVYB.js";
import "./chunk-RD233YRR.js";
import "./chunk-KD7WCE55.js";
import {
  Spinner,
  WalletUIStatesProvider
} from "./chunk-HMHCVLCW.js";
import "./chunk-SQFOT3QK.js";
import {
  useActiveWallet
...
import "./chunk-MTJNDBQE.js";
import "./chunk-ZPXDD6L2.js";
import "./chunk-QSZYPARS.js";
import "./chunk-XSBIZQ3E.js";
import {
  isWalletConnect
} from "./chunk-AY3D3CMM.js";
import "./chunk-RMLEFI72.js";
import "./chunk-KEK33COQ.js";
import {
  getInjectedProvider
} from "./chunk-YC6NAZQY.js";
import {
  isSmartWallet
} from "./chunk-RRHS3SH2.js";
import "./chunk-CKG6ILT6.js";
import {
  isInAppWallet
} from "./chunk-GRB6Y54H.js";
import "./chunk-5J44TWHZ.js";
import "./chunk-CYOV7ZZ7.js";
import "./chunk-F2XRSPM7.js";
import "./chunk-BZEDVPDP.js";
import "./chunk-SFM6XPT6.js";
import "./chunk-FTGVVEWF.js";
import "./chunk-R6C4A6A7.js";
import "./chunk-F2BPN3S5.js";
import {
...
import "./chunk-4XYGIIDG.js";
import "./chunk-WXDNSQP3.js";
import "./chunk-TFIUXY62.js";
import {
  once,
  prepareContractCall
...
import "./chunk-YWKQN5PW.js";
import "./chunk-6VAKB2YV.js";
import "./chunk-7DYPU7K2.js";
import {
  getWalletBalance
} from "./chunk-7OQJK4I6.js";
import "./chunk-IUZDY2KG.js";
import "./chunk-47NWZBIE.js";
import "./chunk-ARW6RUHX.js";
import "./chunk-JCQSL66J.js";
import "./chunk-GUT7DEOA.js";
import "./chunk-G4K3WLFH.js";
import "./chunk-7ZEMYE2R.js";
import "./chunk-OB3T522R.js";
import "./chunk-IVAJZFIP.js";
import "./chunk-LXP7TCXQ.js";
import "./chunk-67YIWUOQ.js";
import "./chunk-WN63IUOE.js";
import "./chunk-QGQHK3VO.js";
import "./chunk-HM2UMVIK.js";
import "./chunk-6YBCAPAW.js";
import {
  webLocalStorage
...
import "./chunk-4JDC6NH3.js";
import "./chunk-U6AC6GUI.js";
        ...
        (async () => {
          try {
            ...
            const [nativeBalance, erc20Balance, gasCost] = await Promise.all([
              ...
              (_erc20Value == null ? void 0 : _erc20Value.tokenAddress) ? getWalletBalance({
                client: tx.client,
                address: account.address,
                chain: tx.chain
              }) : void 0,
...
async function getCapabilities({ wallet }) {
  ...
  if (isSmartWallet(wallet)) {
    const { smartWalletGetCapabilities } = await import("./smart-wallet-capabilities-TICUHJAP.js");
    return smartWalletGetCapabilities({ wallet });
  }
  if (isInAppWallet(wallet)) {
    const { inAppWalletGetCapabilities } = await import("./in-app-wallet-capabilities-XT3DEP25.js");
    return inAppWalletGetCapabilities({ wallet });
  }
  if (isCoinbaseSDKWallet(wallet)) {
    const { coinbaseSDKWalletGetCapabilities } = await import("./coinbaseWebSDK-FLWMHNPS.js");
...
async function sendCalls(options) {
  ...
  if (isSmartWallet(wallet) || isInAppWallet(wallet)) {
    const { inAppWalletSendCalls } = await import("./in-app-wallet-calls-3B4HAOCR.js");
  ...
  if (isCoinbaseSDKWallet(wallet)) {
    const { coinbaseSDKWalletSendCalls } = await import("./coinbaseWebSDK-FLWMHNPS.js");
...
async function getCallsStatus({ wallet, client, bundleId }) {
  ...
  if (isSmartWallet(wallet) || isInAppWallet(wallet)) {
    const { inAppWalletGetCallsStatus } = await import("./in-app-wallet-calls-3B4HAOCR.js");
    return inAppWalletGetCallsStatus({ wallet, client, bundleId });
  }
  if (isCoinbaseSDKWallet(wallet)) {
    const { coinbaseSDKWalletGetCallsStatus } = await import("./coinbaseWebSDK-FLWMHNPS.js");
...
function ClaimButton(props) {
  ...
  return (0, import_jsx_runtime10.jsx)(TransactionButton, { payModal: {
    ...
    const [claimTx, { getApprovalForTransaction: getApprovalForTransaction2 }] = await Promise.all([
      ...
      import("./getApprovalForTransaction-XJ6N5ZQW.js")
    ]);
...
async function getERC721ClaimTo({ contract, account, claimParams }) {
  const { claimTo } = await import("./claimTo-BL2BIWZX.js");
  return claimTo({
    contract,
...
async function getERC1155ClaimTo({ contract, account, claimParams }) {
  const { claimTo } = await import("./claimTo-F7QAJ46Q.js");
  return claimTo({
    contract,
    to: (account == null ? void 0 : account.address) || "",
    quantity: claimParams.quantity,
...
async function getERC20ClaimTo({ contract, account, claimParams }) {
  const { claimTo } = await import("./claimTo-VJLD3LBS.js");
...
function BuyDirectListingButton(props) {
  ...
  const prepareBuyTransaction = (0, import_react12.useCallback)(async () => {
    ...
    const [listing, { getApprovalForTransaction: getApprovalForTransaction2 }, { buyFromListing }] = await Promise.all([
      ...
      import("./getApprovalForTransaction-XJ6N5ZQW.js"),
      import("./buyFromListing-STZR4SGH.js")
    ]);
    if (!listing) {
    ...
    asyncParams: async () => {
      ...
      if ("pricePerToken" in options) {
        if (isNativeTokenAddress(currencyAddress)) {
          ...
          const { decimals } = await import("./decimals-4LN7A37R.js");
...
async function getPayMetadata3(options) {
  ...
  const [{ isERC721: isERC7212 }, { isERC1155: isERC11552 }, { getContractMetadata: getContractMetadata2 }, { getNFT: getERC721 }, { getNFT: getERC1155 }] = await Promise.all([
    import("./isERC721-46F35X5L.js"),
    import("./isERC1155-VX4TR7QI.js"),
    import("./getContractMetadata-ST4D7CPZ.js"),
    import("./getNFT-G4GN4TIB.js"),
    import("./getNFT-62SOCW2L.js")
  ]);
