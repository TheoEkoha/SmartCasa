...
function createEcosystemWallet(args) {
  ...
  return {
    ...
    autoConnect: async (options) => {
      const { autoConnectInAppWallet } = await import("./wallet-4RJLN3SY.js");
    ...
    connect: async (options) => {
      const { connectInAppWallet } = await import("./wallet-4RJLN3SY.js");
      const connector = await getOrCreateInAppWalletConnector(options.client, connectorFactory, {
        id,
        partnerId: createOptions == null ? void 0 : createOptions.partnerId
      });
...
function ecosystemWallet(...args) {
  ...
  return createEcosystemWallet({
    ...
    connectorFactory: async (client) => {
      const { InAppWebConnector } = await import("./web-connector-UE6A6IOA.js");
...
function coinbaseWalletSDK(args) {
  ...
  return {
    ...
    getAccount: () => account,
    autoConnect: async (options) => {
      const { autoConnectCoinbaseWalletSDK } = await import("./coinbaseWebSDK-FLWMHNPS.js");
    ...
    connect: async (options) => {
      const { connectCoinbaseWalletSDK } = await import("./coinbaseWebSDK-FLWMHNPS.js");
      const provider = await args.providerFactory();
  ...
  switch (true) {
    ...
    case id === COINBASE: {
      ...
      return coinbaseWalletSDK({
        ...
        onConnectRequested: async (provider) => {
          const { showCoinbasePopup } = await import("./utils-ZFMTXZEI.js");
    ...
    default: {
      ...
      const wallet = {
        ...
        getAccount: () => account,
        autoConnect: async (options) => {
          const { injectedProvider } = await import("./mipdStore-KAC73XGP.js");
          if (id !== "walletConnect" && injectedProvider(id)) {
            const { autoConnectInjectedWallet } = await import("./injected-PID2J64C.js");
          ...
          if (options && "client" in options) {
            const { autoConnectWC } = await import("./controller-NCGIZFYT.js");
        ...
        connect: async (options) => {
          async function wcConnect(wcOptions) {
            const { connectWC } = await import("./controller-NCGIZFYT.js");
          ...
          if (injectedProvider(id) && !forceWalletConnectOption) {
            const { connectInjectedWallet } = await import("./injected-PID2J64C.js");
...
//# sourceMappingURL=chunk-7DYPU7K2.js.map
